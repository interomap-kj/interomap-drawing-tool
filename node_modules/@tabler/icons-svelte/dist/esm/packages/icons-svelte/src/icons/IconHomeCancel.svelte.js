...
/* src/icons/IconHomeCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeCancel$1 = IconHomeCancel;

export { IconHomeCancel$1 as default };
//# sourceMappingURL=IconHomeCancel.svelte.js.map
