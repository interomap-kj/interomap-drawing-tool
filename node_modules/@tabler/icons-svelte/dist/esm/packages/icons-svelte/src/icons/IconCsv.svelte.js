...
/* src/icons/IconCsv.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "csv" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCsv extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCsv$1 = IconCsv;

export { IconCsv$1 as default };
//# sourceMappingURL=IconCsv.svelte.js.map
