...
/* src/icons/IconBadgeVr.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-vr" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeVr extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeVr$1 = IconBadgeVr;

export { IconBadgeVr$1 as default };
//# sourceMappingURL=IconBadgeVr.svelte.js.map
