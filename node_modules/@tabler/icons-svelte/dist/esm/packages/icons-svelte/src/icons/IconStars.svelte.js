...
/* src/icons/IconStars.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stars" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStars extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStars$1 = IconStars;

export { IconStars$1 as default };
//# sourceMappingURL=IconStars.svelte.js.map
