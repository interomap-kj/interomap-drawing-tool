...
/* src/icons/IconUvIndex.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "uv-index" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUvIndex extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUvIndex$1 = IconUvIndex;

export { IconUvIndex$1 as default };
//# sourceMappingURL=IconUvIndex.svelte.js.map
