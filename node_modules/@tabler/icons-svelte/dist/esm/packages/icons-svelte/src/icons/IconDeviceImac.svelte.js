...
/* src/icons/IconDeviceImac.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "device-imac" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDeviceImac extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeviceImac$1 = IconDeviceImac;

export { IconDeviceImac$1 as default };
//# sourceMappingURL=IconDeviceImac.svelte.js.map
