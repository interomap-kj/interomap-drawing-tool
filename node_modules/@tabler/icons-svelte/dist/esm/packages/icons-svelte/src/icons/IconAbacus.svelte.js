...
/* src/icons/IconAbacus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "abacus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAbacus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAbacus$1 = IconAbacus;

export { IconAbacus$1 as default };
//# sourceMappingURL=IconAbacus.svelte.js.map
