...
/* src/icons/IconFoldersOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "folders-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFoldersOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFoldersOff$1 = IconFoldersOff;

export { IconFoldersOff$1 as default };
//# sourceMappingURL=IconFoldersOff.svelte.js.map
