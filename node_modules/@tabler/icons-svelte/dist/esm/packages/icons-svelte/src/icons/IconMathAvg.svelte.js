...
/* src/icons/IconMathAvg.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-avg" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMathAvg extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathAvg$1 = IconMathAvg;

export { IconMathAvg$1 as default };
//# sourceMappingURL=IconMathAvg.svelte.js.map
