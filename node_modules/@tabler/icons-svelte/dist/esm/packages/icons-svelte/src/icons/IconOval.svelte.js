...
/* src/icons/IconOval.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "oval" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOval extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOval$1 = IconOval;

export { IconOval$1 as default };
//# sourceMappingURL=IconOval.svelte.js.map
