...
/* src/icons/IconHexagon3d.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hexagon-3d" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHexagon3d extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHexagon3d$1 = IconHexagon3d;

export { IconHexagon3d$1 as default };
//# sourceMappingURL=IconHexagon3d.svelte.js.map
