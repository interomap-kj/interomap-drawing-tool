...
/* src/icons/IconBrandLine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-line" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandLine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandLine$1 = IconBrandLine;

export { IconBrandLine$1 as default };
//# sourceMappingURL=IconBrandLine.svelte.js.map
