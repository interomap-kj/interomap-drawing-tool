...
/* src/icons/IconRegistered.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "registered" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRegistered extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRegistered$1 = IconRegistered;

export { IconRegistered$1 as default };
//# sourceMappingURL=IconRegistered.svelte.js.map
