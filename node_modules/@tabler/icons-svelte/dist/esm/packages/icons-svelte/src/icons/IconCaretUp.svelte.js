...
/* src/icons/IconCaretUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "caret-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M18 14l-6 -6l-6 6h12" }]];
...
class IconCaretUp extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconCaretUp$1 as default };
//# sourceMappingURL=IconCaretUp.svelte.js.map
