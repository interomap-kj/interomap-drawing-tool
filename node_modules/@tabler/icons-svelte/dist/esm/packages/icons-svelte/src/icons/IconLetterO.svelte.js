...
/* src/icons/IconLetterO.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-o" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterO extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterO$1 = IconLetterO;

export { IconLetterO$1 as default };
//# sourceMappingURL=IconLetterO.svelte.js.map
