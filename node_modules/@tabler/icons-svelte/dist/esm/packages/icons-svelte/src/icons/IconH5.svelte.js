...
/* src/icons/IconH5.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "h-5" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconH5 extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconH5$1 as default };
//# sourceMappingURL=IconH5.svelte.js.map
