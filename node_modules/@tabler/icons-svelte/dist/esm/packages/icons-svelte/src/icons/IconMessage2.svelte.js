...
/* src/icons/IconMessage2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessage2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessage2$1 = IconMessage2;

export { IconMessage2$1 as default };
//# sourceMappingURL=IconMessage2.svelte.js.map
