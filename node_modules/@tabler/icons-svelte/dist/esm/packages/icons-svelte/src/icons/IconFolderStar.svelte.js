...
/* src/icons/IconFolderStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "folder-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFolderStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFolderStar$1 = IconFolderStar;

export { IconFolderStar$1 as default };
//# sourceMappingURL=IconFolderStar.svelte.js.map
