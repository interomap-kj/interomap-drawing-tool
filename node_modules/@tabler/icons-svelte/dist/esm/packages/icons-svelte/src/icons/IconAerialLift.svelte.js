...
/* src/icons/IconAerialLift.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "aerial-lift" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAerialLift extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAerialLift$1 = IconAerialLift;

export { IconAerialLift$1 as default };
//# sourceMappingURL=IconAerialLift.svelte.js.map
