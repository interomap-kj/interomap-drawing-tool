...
/* src/icons/IconDimensions.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dimensions" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDimensions extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDimensions$1 = IconDimensions;

export { IconDimensions$1 as default };
//# sourceMappingURL=IconDimensions.svelte.js.map
