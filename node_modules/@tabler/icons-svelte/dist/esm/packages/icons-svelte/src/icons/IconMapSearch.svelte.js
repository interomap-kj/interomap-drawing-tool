...
/* src/icons/IconMapSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapSearch$1 = IconMapSearch;

export { IconMapSearch$1 as default };
//# sourceMappingURL=IconMapSearch.svelte.js.map
