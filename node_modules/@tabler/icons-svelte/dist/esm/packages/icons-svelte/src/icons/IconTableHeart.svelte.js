...
/* src/icons/IconTableHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTableHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTableHeart$1 = IconTableHeart;

export { IconTableHeart$1 as default };
//# sourceMappingURL=IconTableHeart.svelte.js.map
