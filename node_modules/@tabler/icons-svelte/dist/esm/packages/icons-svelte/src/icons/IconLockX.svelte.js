...
/* src/icons/IconLockX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockX$1 = IconLockX;

export { IconLockX$1 as default };
//# sourceMappingURL=IconLockX.svelte.js.map
