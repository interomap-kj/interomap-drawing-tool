...
/* src/icons/IconGhostOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ghost-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGhostOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGhostOff$1 = IconGhostOff;

export { IconGhostOff$1 as default };
//# sourceMappingURL=IconGhostOff.svelte.js.map
