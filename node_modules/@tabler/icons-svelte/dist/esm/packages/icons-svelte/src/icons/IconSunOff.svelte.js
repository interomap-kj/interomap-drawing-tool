...
/* src/icons/IconSunOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sun-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSunOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSunOff$1 = IconSunOff;

export { IconSunOff$1 as default };
//# sourceMappingURL=IconSunOff.svelte.js.map
