...
/* src/icons/IconGrave2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grave-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrave2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrave2$1 = IconGrave2;

export { IconGrave2$1 as default };
//# sourceMappingURL=IconGrave2.svelte.js.map
