...
/* src/icons/IconBeach.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "beach" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBeach extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBeach$1 = IconBeach;

export { IconBeach$1 as default };
//# sourceMappingURL=IconBeach.svelte.js.map
