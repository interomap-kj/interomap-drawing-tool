...
/* src/icons/IconBrandOauth.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-oauth" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandOauth extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandOauth$1 = IconBrandOauth;

export { IconBrandOauth$1 as default };
//# sourceMappingURL=IconBrandOauth.svelte.js.map
