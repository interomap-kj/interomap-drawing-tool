...
/* src/icons/IconClockUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockUp$1 = IconClockUp;

export { IconClockUp$1 as default };
//# sourceMappingURL=IconClockUp.svelte.js.map
