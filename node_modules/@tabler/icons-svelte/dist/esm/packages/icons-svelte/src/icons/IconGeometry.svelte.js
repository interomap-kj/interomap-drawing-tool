...
/* src/icons/IconGeometry.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "geometry" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGeometry extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGeometry$1 = IconGeometry;

export { IconGeometry$1 as default };
//# sourceMappingURL=IconGeometry.svelte.js.map
