...
/* src/icons/IconBrandTed.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-ted" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandTed extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandTed$1 = IconBrandTed;

export { IconBrandTed$1 as default };
//# sourceMappingURL=IconBrandTed.svelte.js.map
