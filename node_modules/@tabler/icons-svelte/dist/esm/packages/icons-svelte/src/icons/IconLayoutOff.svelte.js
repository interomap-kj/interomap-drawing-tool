...
/* src/icons/IconLayoutOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "layout-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLayoutOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLayoutOff$1 = IconLayoutOff;

export { IconLayoutOff$1 as default };
//# sourceMappingURL=IconLayoutOff.svelte.js.map
