...
/* src/icons/IconKeyOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "key-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconKeyOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconKeyOff$1 = IconKeyOff;

export { IconKeyOff$1 as default };
//# sourceMappingURL=IconKeyOff.svelte.js.map
