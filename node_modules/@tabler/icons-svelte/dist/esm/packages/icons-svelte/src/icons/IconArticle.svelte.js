...
/* src/icons/IconArticle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "article" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArticle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArticle$1 = IconArticle;

export { IconArticle$1 as default };
//# sourceMappingURL=IconArticle.svelte.js.map
