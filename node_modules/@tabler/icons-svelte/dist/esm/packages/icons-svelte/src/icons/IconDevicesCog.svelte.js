...
/* src/icons/IconDevicesCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevicesCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevicesCog$1 = IconDevicesCog;

export { IconDevicesCog$1 as default };
//# sourceMappingURL=IconDevicesCog.svelte.js.map
