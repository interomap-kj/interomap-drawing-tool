...
/* src/icons/IconLetterP.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-p" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 20v-16h5.5a4 4 0 0 1 0 9h-5.5" }]];
...
class IconLetterP extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterP$1 = IconLetterP;

export { IconLetterP$1 as default };
//# sourceMappingURL=IconLetterP.svelte.js.map
