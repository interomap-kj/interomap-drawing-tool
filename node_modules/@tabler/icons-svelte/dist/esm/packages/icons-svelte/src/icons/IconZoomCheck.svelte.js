...
/* src/icons/IconZoomCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomCheck$1 = IconZoomCheck;

export { IconZoomCheck$1 as default };
//# sourceMappingURL=IconZoomCheck.svelte.js.map
