...
/* src/icons/IconDevicesPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevicesPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevicesPin$1 = IconDevicesPin;

export { IconDevicesPin$1 as default };
//# sourceMappingURL=IconDevicesPin.svelte.js.map
