...
/* src/icons/IconSeeding.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "seeding" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSeeding extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSeeding$1 = IconSeeding;

export { IconSeeding$1 as default };
//# sourceMappingURL=IconSeeding.svelte.js.map
