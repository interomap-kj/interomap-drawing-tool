...
/* src/icons/IconSunWind.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sun-wind" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSunWind extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSunWind$1 = IconSunWind;

export { IconSunWind$1 as default };
//# sourceMappingURL=IconSunWind.svelte.js.map
