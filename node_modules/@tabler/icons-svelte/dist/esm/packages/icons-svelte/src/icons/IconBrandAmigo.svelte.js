...
/* src/icons/IconBrandAmigo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-amigo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandAmigo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandAmigo$1 = IconBrandAmigo;

export { IconBrandAmigo$1 as default };
//# sourceMappingURL=IconBrandAmigo.svelte.js.map
