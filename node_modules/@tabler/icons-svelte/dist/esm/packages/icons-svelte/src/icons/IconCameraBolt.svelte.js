...
/* src/icons/IconCameraBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraBolt$1 = IconCameraBolt;

export { IconCameraBolt$1 as default };
//# sourceMappingURL=IconCameraBolt.svelte.js.map
