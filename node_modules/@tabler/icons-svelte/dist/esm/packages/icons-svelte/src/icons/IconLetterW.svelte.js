...
/* src/icons/IconLetterW.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-w" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M4 4l4 16l4 -14l4 14l4 -16" }]];
...
class IconLetterW extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterW$1 = IconLetterW;

export { IconLetterW$1 as default };
//# sourceMappingURL=IconLetterW.svelte.js.map
