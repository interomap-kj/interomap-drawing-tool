...
/* src/icons/IconCodeDots.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "code-dots" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCodeDots extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCodeDots$1 = IconCodeDots;

export { IconCodeDots$1 as default };
//# sourceMappingURL=IconCodeDots.svelte.js.map
