...
/* src/icons/IconSquareRoot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-root" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M3 12h2l4 8l4 -16h8" }]];
...
class IconSquareRoot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareRoot$1 = IconSquareRoot;

export { IconSquareRoot$1 as default };
//# sourceMappingURL=IconSquareRoot.svelte.js.map
