...
/* src/icons/IconDropCircle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "drop-circle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDropCircle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDropCircle$1 = IconDropCircle;

export { IconDropCircle$1 as default };
//# sourceMappingURL=IconDropCircle.svelte.js.map
