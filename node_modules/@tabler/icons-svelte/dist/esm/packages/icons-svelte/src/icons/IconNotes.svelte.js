...
/* src/icons/IconNotes.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "notes" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNotes extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNotes$1 = IconNotes;

export { IconNotes$1 as default };
//# sourceMappingURL=IconNotes.svelte.js.map
