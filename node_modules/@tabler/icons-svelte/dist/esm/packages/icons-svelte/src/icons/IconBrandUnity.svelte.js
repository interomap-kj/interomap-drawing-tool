...
/* src/icons/IconBrandUnity.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-unity" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandUnity extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandUnity$1 = IconBrandUnity;

export { IconBrandUnity$1 as default };
//# sourceMappingURL=IconBrandUnity.svelte.js.map
