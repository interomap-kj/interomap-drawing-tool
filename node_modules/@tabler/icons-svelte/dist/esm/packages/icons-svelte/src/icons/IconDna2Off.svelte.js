...
/* src/icons/IconDna2Off.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dna-2-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDna2Off extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDna2Off$1 = IconDna2Off;

export { IconDna2Off$1 as default };
//# sourceMappingURL=IconDna2Off.svelte.js.map
