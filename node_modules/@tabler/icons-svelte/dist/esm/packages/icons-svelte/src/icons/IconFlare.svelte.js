...
/* src/icons/IconFlare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flare" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlare$1 = IconFlare;

export { IconFlare$1 as default };
//# sourceMappingURL=IconFlare.svelte.js.map
