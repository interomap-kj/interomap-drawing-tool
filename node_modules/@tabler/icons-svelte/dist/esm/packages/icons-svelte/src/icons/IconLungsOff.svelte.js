...
/* src/icons/IconLungsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lungs-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLungsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLungsOff$1 = IconLungsOff;

export { IconLungsOff$1 as default };
//# sourceMappingURL=IconLungsOff.svelte.js.map
