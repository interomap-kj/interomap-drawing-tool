...
/* src/icons/IconLine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "line" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLine$1 = IconLine;

export { IconLine$1 as default };
//# sourceMappingURL=IconLine.svelte.js.map
