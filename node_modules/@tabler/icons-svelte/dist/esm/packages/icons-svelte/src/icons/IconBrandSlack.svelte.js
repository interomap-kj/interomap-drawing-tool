...
/* src/icons/IconBrandSlack.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-slack" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandSlack extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandSlack$1 = IconBrandSlack;

export { IconBrandSlack$1 as default };
//# sourceMappingURL=IconBrandSlack.svelte.js.map
