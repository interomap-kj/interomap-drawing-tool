...
/* src/icons/IconDatabaseX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "database-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDatabaseX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDatabaseX$1 = IconDatabaseX;

export { IconDatabaseX$1 as default };
//# sourceMappingURL=IconDatabaseX.svelte.js.map
