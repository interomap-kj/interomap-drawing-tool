...
/* src/icons/IconChessRook.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chess-rook" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChessRook extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChessRook$1 = IconChessRook;

export { IconChessRook$1 as default };
//# sourceMappingURL=IconChessRook.svelte.js.map
