...
/* src/icons/IconGif.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gif" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGif extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGif$1 = IconGif;

export { IconGif$1 as default };
//# sourceMappingURL=IconGif.svelte.js.map
