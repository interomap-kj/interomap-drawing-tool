...
/* src/icons/IconNewSection.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "new-section" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNewSection extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNewSection$1 = IconNewSection;

export { IconNewSection$1 as default };
//# sourceMappingURL=IconNewSection.svelte.js.map
