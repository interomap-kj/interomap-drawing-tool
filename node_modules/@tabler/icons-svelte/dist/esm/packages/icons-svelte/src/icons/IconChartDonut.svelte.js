...
/* src/icons/IconChartDonut.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-donut" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartDonut extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartDonut$1 = IconChartDonut;

export { IconChartDonut$1 as default };
//# sourceMappingURL=IconChartDonut.svelte.js.map
