...
/* src/icons/IconBellBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellBolt$1 = IconBellBolt;

export { IconBellBolt$1 as default };
//# sourceMappingURL=IconBellBolt.svelte.js.map
