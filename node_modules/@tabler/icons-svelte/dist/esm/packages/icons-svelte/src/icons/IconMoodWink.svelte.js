...
/* src/icons/IconMoodWink.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-wink" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodWink extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodWink$1 = IconMoodWink;

export { IconMoodWink$1 as default };
//# sourceMappingURL=IconMoodWink.svelte.js.map
