...
/* src/icons/IconMeatOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "meat-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMeatOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMeatOff$1 = IconMeatOff;

export { IconMeatOff$1 as default };
//# sourceMappingURL=IconMeatOff.svelte.js.map
