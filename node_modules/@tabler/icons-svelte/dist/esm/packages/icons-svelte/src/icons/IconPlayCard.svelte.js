...
/* src/icons/IconPlayCard.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "play-card" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlayCard extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlayCard$1 = IconPlayCard;

export { IconPlayCard$1 as default };
//# sourceMappingURL=IconPlayCard.svelte.js.map
