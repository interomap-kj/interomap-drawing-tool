...
/* src/icons/IconChessQueen.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chess-queen" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChessQueen extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChessQueen$1 = IconChessQueen;

export { IconChessQueen$1 as default };
//# sourceMappingURL=IconChessQueen.svelte.js.map
