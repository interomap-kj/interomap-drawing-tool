...
/* src/icons/IconSignalH.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-h" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignalH extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignalH$1 = IconSignalH;

export { IconSignalH$1 as default };
//# sourceMappingURL=IconSignalH.svelte.js.map
