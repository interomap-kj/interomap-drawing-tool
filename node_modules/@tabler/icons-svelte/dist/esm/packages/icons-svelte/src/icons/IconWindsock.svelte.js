...
/* src/icons/IconWindsock.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "windsock" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWindsock extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWindsock$1 = IconWindsock;

export { IconWindsock$1 as default };
//# sourceMappingURL=IconWindsock.svelte.js.map
