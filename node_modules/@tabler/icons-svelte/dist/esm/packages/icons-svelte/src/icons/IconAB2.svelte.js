...
/* src/icons/IconAB2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "a-b-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAB2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAB2$1 = IconAB2;

export { IconAB2$1 as default };
//# sourceMappingURL=IconAB2.svelte.js.map
