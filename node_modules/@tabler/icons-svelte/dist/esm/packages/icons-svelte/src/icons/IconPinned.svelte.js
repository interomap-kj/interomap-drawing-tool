...
/* src/icons/IconPinned.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pinned" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPinned extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPinned$1 = IconPinned;

export { IconPinned$1 as default };
//# sourceMappingURL=IconPinned.svelte.js.map
