...
/* src/icons/IconMathXy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-xy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMathXy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathXy$1 = IconMathXy;

export { IconMathXy$1 as default };
//# sourceMappingURL=IconMathXy.svelte.js.map
