...
/* src/icons/IconExposure.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "exposure" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconExposure extends SvelteComponent {
	constructor(options) {
		super();
...
var IconExposure$1 = IconExposure;

export { IconExposure$1 as default };
//# sourceMappingURL=IconExposure.svelte.js.map
