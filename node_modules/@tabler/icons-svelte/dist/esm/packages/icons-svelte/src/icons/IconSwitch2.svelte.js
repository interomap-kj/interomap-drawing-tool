...
/* src/icons/IconSwitch2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "switch-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSwitch2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwitch2$1 = IconSwitch2;

export { IconSwitch2$1 as default };
//# sourceMappingURL=IconSwitch2.svelte.js.map
