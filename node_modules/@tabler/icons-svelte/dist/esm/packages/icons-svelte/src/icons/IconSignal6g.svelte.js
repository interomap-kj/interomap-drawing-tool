...
/* src/icons/IconSignal6g.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-6g" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignal6g extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignal6g$1 = IconSignal6g;

export { IconSignal6g$1 as default };
//# sourceMappingURL=IconSignal6g.svelte.js.map
