...
/* src/icons/IconBedFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bed-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBedFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBedFilled$1 = IconBedFilled;

export { IconBedFilled$1 as default };
//# sourceMappingURL=IconBedFilled.svelte.js.map
