...
/* src/icons/IconBrandHbo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-hbo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandHbo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandHbo$1 = IconBrandHbo;

export { IconBrandHbo$1 as default };
//# sourceMappingURL=IconBrandHbo.svelte.js.map
