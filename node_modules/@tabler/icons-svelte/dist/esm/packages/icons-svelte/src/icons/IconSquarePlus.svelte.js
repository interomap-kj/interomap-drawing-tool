...
/* src/icons/IconSquarePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquarePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquarePlus$1 = IconSquarePlus;

export { IconSquarePlus$1 as default };
//# sourceMappingURL=IconSquarePlus.svelte.js.map
