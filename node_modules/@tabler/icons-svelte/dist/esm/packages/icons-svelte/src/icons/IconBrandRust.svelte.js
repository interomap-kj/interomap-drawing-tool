...
/* src/icons/IconBrandRust.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-rust" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandRust extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandRust$1 = IconBrandRust;

export { IconBrandRust$1 as default };
//# sourceMappingURL=IconBrandRust.svelte.js.map
