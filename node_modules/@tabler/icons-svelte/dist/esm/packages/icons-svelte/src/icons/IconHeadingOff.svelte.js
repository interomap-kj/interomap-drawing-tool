...
/* src/icons/IconHeadingOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heading-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeadingOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeadingOff$1 = IconHeadingOff;

export { IconHeadingOff$1 as default };
//# sourceMappingURL=IconHeadingOff.svelte.js.map
