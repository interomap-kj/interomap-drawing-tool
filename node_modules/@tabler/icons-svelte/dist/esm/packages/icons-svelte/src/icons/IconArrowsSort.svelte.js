...
/* src/icons/IconArrowsSort.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrows-sort" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowsSort extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowsSort$1 = IconArrowsSort;

export { IconArrowsSort$1 as default };
//# sourceMappingURL=IconArrowsSort.svelte.js.map
