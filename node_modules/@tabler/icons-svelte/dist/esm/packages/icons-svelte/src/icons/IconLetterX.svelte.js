...
/* src/icons/IconLetterX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 4l10 16" }], ["path", { "d": "M17 4l-10 16" }]];
...
class IconLetterX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterX$1 = IconLetterX;

export { IconLetterX$1 as default };
//# sourceMappingURL=IconLetterX.svelte.js.map
