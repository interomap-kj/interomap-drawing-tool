...
/* src/icons/IconSettingsX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "settings-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSettingsX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSettingsX$1 = IconSettingsX;

export { IconSettingsX$1 as default };
//# sourceMappingURL=IconSettingsX.svelte.js.map
