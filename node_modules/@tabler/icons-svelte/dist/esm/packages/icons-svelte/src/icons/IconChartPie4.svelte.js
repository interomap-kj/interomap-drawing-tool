...
/* src/icons/IconChartPie4.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-pie-4" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartPie4 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartPie4$1 = IconChartPie4;

export { IconChartPie4$1 as default };
//# sourceMappingURL=IconChartPie4.svelte.js.map
