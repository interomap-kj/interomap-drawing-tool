...
/* src/icons/IconBattery4.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "battery-4" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBattery4 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBattery4$1 = IconBattery4;

export { IconBattery4$1 as default };
//# sourceMappingURL=IconBattery4.svelte.js.map
