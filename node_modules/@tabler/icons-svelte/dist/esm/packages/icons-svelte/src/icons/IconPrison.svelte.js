...
/* src/icons/IconPrison.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "prison" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPrison extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPrison$1 = IconPrison;

export { IconPrison$1 as default };
//# sourceMappingURL=IconPrison.svelte.js.map
