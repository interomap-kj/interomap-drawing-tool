...
/* src/icons/IconDisabled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "disabled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDisabled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDisabled$1 = IconDisabled;

export { IconDisabled$1 as default };
//# sourceMappingURL=IconDisabled.svelte.js.map
