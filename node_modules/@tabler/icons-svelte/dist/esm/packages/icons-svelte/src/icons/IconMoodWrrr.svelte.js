...
/* src/icons/IconMoodWrrr.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-wrrr" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodWrrr extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodWrrr$1 = IconMoodWrrr;

export { IconMoodWrrr$1 as default };
//# sourceMappingURL=IconMoodWrrr.svelte.js.map
