...
/* src/icons/IconBreadOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bread-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBreadOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBreadOff$1 = IconBreadOff;

export { IconBreadOff$1 as default };
//# sourceMappingURL=IconBreadOff.svelte.js.map
