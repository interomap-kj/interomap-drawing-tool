...
/* src/icons/IconWorldCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldCode$1 = IconWorldCode;

export { IconWorldCode$1 as default };
//# sourceMappingURL=IconWorldCode.svelte.js.map
