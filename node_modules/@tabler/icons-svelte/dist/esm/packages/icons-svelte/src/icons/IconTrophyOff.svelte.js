...
/* src/icons/IconTrophyOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trophy-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrophyOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrophyOff$1 = IconTrophyOff;

export { IconTrophyOff$1 as default };
//# sourceMappingURL=IconTrophyOff.svelte.js.map
