...
/* src/icons/IconPacman.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pacman" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPacman extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPacman$1 = IconPacman;

export { IconPacman$1 as default };
//# sourceMappingURL=IconPacman.svelte.js.map
