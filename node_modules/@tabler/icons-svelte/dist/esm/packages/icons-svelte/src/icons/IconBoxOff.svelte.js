...
/* src/icons/IconBoxOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "box-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoxOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoxOff$1 = IconBoxOff;

export { IconBoxOff$1 as default };
//# sourceMappingURL=IconBoxOff.svelte.js.map
