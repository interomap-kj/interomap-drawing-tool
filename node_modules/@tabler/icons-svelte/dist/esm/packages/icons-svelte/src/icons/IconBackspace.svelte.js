...
/* src/icons/IconBackspace.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "backspace" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBackspace extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBackspace$1 = IconBackspace;

export { IconBackspace$1 as default };
//# sourceMappingURL=IconBackspace.svelte.js.map
