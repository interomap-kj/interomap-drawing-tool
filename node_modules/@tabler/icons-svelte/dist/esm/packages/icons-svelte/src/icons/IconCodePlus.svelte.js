...
/* src/icons/IconCodePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "code-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCodePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCodePlus$1 = IconCodePlus;

export { IconCodePlus$1 as default };
//# sourceMappingURL=IconCodePlus.svelte.js.map
