...
/* src/icons/IconAdCircle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ad-circle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAdCircle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAdCircle$1 = IconAdCircle;

export { IconAdCircle$1 as default };
//# sourceMappingURL=IconAdCircle.svelte.js.map
