...
/* src/icons/IconChartPpf.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-ppf" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartPpf extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartPpf$1 = IconChartPpf;

export { IconChartPpf$1 as default };
//# sourceMappingURL=IconChartPpf.svelte.js.map
