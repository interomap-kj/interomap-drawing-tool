...
/* src/icons/IconSailboat2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sailboat-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSailboat2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSailboat2$1 = IconSailboat2;

export { IconSailboat2$1 as default };
//# sourceMappingURL=IconSailboat2.svelte.js.map
