...
/* src/icons/IconStepOut.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "step-out" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStepOut extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStepOut$1 = IconStepOut;

export { IconStepOut$1 as default };
//# sourceMappingURL=IconStepOut.svelte.js.map
