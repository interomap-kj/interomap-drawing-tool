...
/* src/icons/IconShadowOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shadow-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShadowOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShadowOff$1 = IconShadowOff;

export { IconShadowOff$1 as default };
//# sourceMappingURL=IconShadowOff.svelte.js.map
