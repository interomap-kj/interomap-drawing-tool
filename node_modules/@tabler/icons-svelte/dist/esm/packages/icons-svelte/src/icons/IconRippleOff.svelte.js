...
/* src/icons/IconRippleOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ripple-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRippleOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRippleOff$1 = IconRippleOff;

export { IconRippleOff$1 as default };
//# sourceMappingURL=IconRippleOff.svelte.js.map
