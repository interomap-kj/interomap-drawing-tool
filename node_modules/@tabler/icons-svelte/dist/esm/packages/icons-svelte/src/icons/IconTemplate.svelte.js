...
/* src/icons/IconTemplate.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "template" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTemplate extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconTemplate$1 as default };
//# sourceMappingURL=IconTemplate.svelte.js.map
