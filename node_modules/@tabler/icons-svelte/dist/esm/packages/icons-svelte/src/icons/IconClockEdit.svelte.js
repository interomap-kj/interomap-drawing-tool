...
/* src/icons/IconClockEdit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-edit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockEdit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockEdit$1 = IconClockEdit;

export { IconClockEdit$1 as default };
//# sourceMappingURL=IconClockEdit.svelte.js.map
