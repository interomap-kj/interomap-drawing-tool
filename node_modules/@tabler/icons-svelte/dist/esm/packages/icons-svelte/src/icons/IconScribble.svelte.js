...
/* src/icons/IconScribble.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "scribble" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScribble extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScribble$1 = IconScribble;

export { IconScribble$1 as default };
//# sourceMappingURL=IconScribble.svelte.js.map
