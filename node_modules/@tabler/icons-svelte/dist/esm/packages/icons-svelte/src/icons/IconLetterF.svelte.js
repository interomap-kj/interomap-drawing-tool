...
/* src/icons/IconLetterF.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-f" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M17 4h-10v16" }], ["path", { "d": "M7 12l8 0" }]];
...
class IconLetterF extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterF$1 = IconLetterF;

export { IconLetterF$1 as default };
//# sourceMappingURL=IconLetterF.svelte.js.map
