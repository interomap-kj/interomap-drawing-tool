...
/* src/icons/IconLineDotted.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "line-dotted" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLineDotted extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLineDotted$1 = IconLineDotted;

export { IconLineDotted$1 as default };
//# sourceMappingURL=IconLineDotted.svelte.js.map
