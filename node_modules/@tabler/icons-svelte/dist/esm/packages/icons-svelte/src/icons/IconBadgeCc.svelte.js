...
/* src/icons/IconBadgeCc.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-cc" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeCc extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeCc$1 = IconBadgeCc;

export { IconBadgeCc$1 as default };
//# sourceMappingURL=IconBadgeCc.svelte.js.map
