...
/* src/icons/IconCrutches.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "crutches" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCrutches extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCrutches$1 = IconCrutches;

export { IconCrutches$1 as default };
//# sourceMappingURL=IconCrutches.svelte.js.map
