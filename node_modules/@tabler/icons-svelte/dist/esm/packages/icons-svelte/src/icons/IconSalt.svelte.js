...
/* src/icons/IconSalt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "salt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSalt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSalt$1 = IconSalt;

export { IconSalt$1 as default };
//# sourceMappingURL=IconSalt.svelte.js.map
