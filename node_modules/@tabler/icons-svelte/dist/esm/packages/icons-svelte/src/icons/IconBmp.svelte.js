...
/* src/icons/IconBmp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bmp" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBmp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBmp$1 = IconBmp;

export { IconBmp$1 as default };
//# sourceMappingURL=IconBmp.svelte.js.map
