...
/* src/icons/IconMoodMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodMinus$1 = IconMoodMinus;

export { IconMoodMinus$1 as default };
//# sourceMappingURL=IconMoodMinus.svelte.js.map
