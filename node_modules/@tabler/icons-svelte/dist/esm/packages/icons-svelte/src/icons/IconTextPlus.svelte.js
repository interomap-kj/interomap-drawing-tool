...
/* src/icons/IconTextPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "text-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTextPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTextPlus$1 = IconTextPlus;

export { IconTextPlus$1 as default };
//# sourceMappingURL=IconTextPlus.svelte.js.map
