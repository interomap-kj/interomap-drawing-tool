...
/* src/icons/Icon3dRotate.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "3d-rotate" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class Icon3dRotate extends SvelteComponent {
	constructor(options) {
		super();
...
var Icon3dRotate$1 = Icon3dRotate;

export { Icon3dRotate$1 as default };
//# sourceMappingURL=Icon3dRotate.svelte.js.map
