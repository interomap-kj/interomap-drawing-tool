...
/* src/icons/IconSignalE.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-e" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M14 8h-4v8h4" }], ["path", { "d": "M10 12h2.5" }]];
...
class IconSignalE extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignalE$1 = IconSignalE;

export { IconSignalE$1 as default };
//# sourceMappingURL=IconSignalE.svelte.js.map
