...
/* src/icons/IconChessKing.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chess-king" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChessKing extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChessKing$1 = IconChessKing;

export { IconChessKing$1 as default };
//# sourceMappingURL=IconChessKing.svelte.js.map
