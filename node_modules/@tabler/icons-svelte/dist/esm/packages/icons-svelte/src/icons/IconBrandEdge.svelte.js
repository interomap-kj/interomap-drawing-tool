...
/* src/icons/IconBrandEdge.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-edge" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandEdge extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandEdge$1 = IconBrandEdge;

export { IconBrandEdge$1 as default };
//# sourceMappingURL=IconBrandEdge.svelte.js.map
