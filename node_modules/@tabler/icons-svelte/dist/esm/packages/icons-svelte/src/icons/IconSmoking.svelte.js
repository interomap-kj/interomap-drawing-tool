...
/* src/icons/IconSmoking.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "smoking" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSmoking extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSmoking$1 = IconSmoking;

export { IconSmoking$1 as default };
//# sourceMappingURL=IconSmoking.svelte.js.map
