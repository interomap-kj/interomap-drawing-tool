...
/* src/icons/IconPhotoStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoStar$1 = IconPhotoStar;

export { IconPhotoStar$1 as default };
//# sourceMappingURL=IconPhotoStar.svelte.js.map
