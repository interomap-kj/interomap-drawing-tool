...
/* src/icons/IconRefresh.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "refresh" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRefresh extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRefresh$1 = IconRefresh;

export { IconRefresh$1 as default };
//# sourceMappingURL=IconRefresh.svelte.js.map
