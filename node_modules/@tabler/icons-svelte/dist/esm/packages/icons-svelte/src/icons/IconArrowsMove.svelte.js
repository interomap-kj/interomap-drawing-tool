...
/* src/icons/IconArrowsMove.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrows-move" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowsMove extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowsMove$1 = IconArrowsMove;

export { IconArrowsMove$1 as default };
//# sourceMappingURL=IconArrowsMove.svelte.js.map
