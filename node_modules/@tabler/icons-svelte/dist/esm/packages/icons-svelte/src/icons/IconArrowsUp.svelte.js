...
/* src/icons/IconArrowsUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrows-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowsUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowsUp$1 = IconArrowsUp;

export { IconArrowsUp$1 as default };
//# sourceMappingURL=IconArrowsUp.svelte.js.map
