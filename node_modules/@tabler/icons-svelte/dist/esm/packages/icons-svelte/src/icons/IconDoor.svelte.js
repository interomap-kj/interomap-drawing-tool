...
/* src/icons/IconDoor.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "door" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDoor extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDoor$1 = IconDoor;

export { IconDoor$1 as default };
//# sourceMappingURL=IconDoor.svelte.js.map
