...
/* src/icons/IconDice.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dice" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDice extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDice$1 = IconDice;

export { IconDice$1 as default };
//# sourceMappingURL=IconDice.svelte.js.map
