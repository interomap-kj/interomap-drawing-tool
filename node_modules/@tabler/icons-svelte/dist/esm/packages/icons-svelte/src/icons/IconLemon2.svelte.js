...
/* src/icons/IconLemon2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lemon-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLemon2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLemon2$1 = IconLemon2;

export { IconLemon2$1 as default };
//# sourceMappingURL=IconLemon2.svelte.js.map
