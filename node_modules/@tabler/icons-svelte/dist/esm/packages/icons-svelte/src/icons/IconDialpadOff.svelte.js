...
/* src/icons/IconDialpadOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dialpad-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDialpadOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDialpadOff$1 = IconDialpadOff;

export { IconDialpadOff$1 as default };
//# sourceMappingURL=IconDialpadOff.svelte.js.map
