...
/* src/icons/IconIroning1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ironing-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIroning1 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIroning1$1 = IconIroning1;

export { IconIroning1$1 as default };
//# sourceMappingURL=IconIroning1.svelte.js.map
