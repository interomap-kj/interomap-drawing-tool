...
/* src/icons/IconDeviceIpad.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "device-ipad" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDeviceIpad extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeviceIpad$1 = IconDeviceIpad;

export { IconDeviceIpad$1 as default };
//# sourceMappingURL=IconDeviceIpad.svelte.js.map
