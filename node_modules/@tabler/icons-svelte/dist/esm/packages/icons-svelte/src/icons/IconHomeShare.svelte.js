...
/* src/icons/IconHomeShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeShare$1 = IconHomeShare;

export { IconHomeShare$1 as default };
//# sourceMappingURL=IconHomeShare.svelte.js.map
