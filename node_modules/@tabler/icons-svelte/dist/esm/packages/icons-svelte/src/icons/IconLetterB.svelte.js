...
/* src/icons/IconLetterB.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-b" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterB extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterB$1 = IconLetterB;

export { IconLetterB$1 as default };
//# sourceMappingURL=IconLetterB.svelte.js.map
