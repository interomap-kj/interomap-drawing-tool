...
/* src/icons/IconOld.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "old" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOld extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOld$1 = IconOld;

export { IconOld$1 as default };
//# sourceMappingURL=IconOld.svelte.js.map
