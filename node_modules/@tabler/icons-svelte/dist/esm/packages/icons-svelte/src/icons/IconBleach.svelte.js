...
/* src/icons/IconBleach.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bleach" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBleach extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBleach$1 = IconBleach;

export { IconBleach$1 as default };
//# sourceMappingURL=IconBleach.svelte.js.map
