...
/* src/icons/IconBrandStorj.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-storj" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandStorj extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandStorj$1 = IconBrandStorj;

export { IconBrandStorj$1 as default };
//# sourceMappingURL=IconBrandStorj.svelte.js.map
