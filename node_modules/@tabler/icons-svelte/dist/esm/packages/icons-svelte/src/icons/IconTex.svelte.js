...
/* src/icons/IconTex.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tex" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTex extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTex$1 = IconTex;

export { IconTex$1 as default };
//# sourceMappingURL=IconTex.svelte.js.map
