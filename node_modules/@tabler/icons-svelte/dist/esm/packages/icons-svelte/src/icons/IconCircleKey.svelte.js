...
/* src/icons/IconCircleKey.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "circle-key" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCircleKey extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCircleKey$1 = IconCircleKey;

export { IconCircleKey$1 as default };
//# sourceMappingURL=IconCircleKey.svelte.js.map
