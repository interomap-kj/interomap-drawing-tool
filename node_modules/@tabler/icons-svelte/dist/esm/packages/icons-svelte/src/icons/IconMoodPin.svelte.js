...
/* src/icons/IconMoodPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodPin$1 = IconMoodPin;

export { IconMoodPin$1 as default };
//# sourceMappingURL=IconMoodPin.svelte.js.map
