...
/* src/icons/IconPhotoCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoCog$1 = IconPhotoCog;

export { IconPhotoCog$1 as default };
//# sourceMappingURL=IconPhotoCog.svelte.js.map
