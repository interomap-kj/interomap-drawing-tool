...
/* src/icons/IconAxisY.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "axis-y" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAxisY extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAxisY$1 = IconAxisY;

export { IconAxisY$1 as default };
//# sourceMappingURL=IconAxisY.svelte.js.map
