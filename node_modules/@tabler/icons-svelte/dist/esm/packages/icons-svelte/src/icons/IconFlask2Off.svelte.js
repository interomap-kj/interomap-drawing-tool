...
/* src/icons/IconFlask2Off.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flask-2-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlask2Off extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlask2Off$1 = IconFlask2Off;

export { IconFlask2Off$1 as default };
//# sourceMappingURL=IconFlask2Off.svelte.js.map
