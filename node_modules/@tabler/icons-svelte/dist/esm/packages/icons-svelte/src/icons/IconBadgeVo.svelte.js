...
/* src/icons/IconBadgeVo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-vo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeVo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeVo$1 = IconBadgeVo;

export { IconBadgeVo$1 as default };
//# sourceMappingURL=IconBadgeVo.svelte.js.map
