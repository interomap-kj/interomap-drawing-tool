...
/* src/icons/IconBatteryEco.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "battery-eco" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBatteryEco extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBatteryEco$1 = IconBatteryEco;

export { IconBatteryEco$1 as default };
//# sourceMappingURL=IconBatteryEco.svelte.js.map
