...
/* src/icons/IconBrandPhp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-php" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandPhp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandPhp$1 = IconBrandPhp;

export { IconBrandPhp$1 as default };
//# sourceMappingURL=IconBrandPhp.svelte.js.map
