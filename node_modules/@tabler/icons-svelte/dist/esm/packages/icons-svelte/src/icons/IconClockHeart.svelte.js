...
/* src/icons/IconClockHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockHeart$1 = IconClockHeart;

export { IconClockHeart$1 as default };
//# sourceMappingURL=IconClockHeart.svelte.js.map
