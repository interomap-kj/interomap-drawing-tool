...
/* src/icons/IconFlameOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flame-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlameOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlameOff$1 = IconFlameOff;

export { IconFlameOff$1 as default };
//# sourceMappingURL=IconFlameOff.svelte.js.map
