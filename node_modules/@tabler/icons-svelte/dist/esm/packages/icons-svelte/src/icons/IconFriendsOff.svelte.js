...
/* src/icons/IconFriendsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "friends-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFriendsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFriendsOff$1 = IconFriendsOff;

export { IconFriendsOff$1 as default };
//# sourceMappingURL=IconFriendsOff.svelte.js.map
