...
/* src/icons/IconWorldMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldMinus$1 = IconWorldMinus;

export { IconWorldMinus$1 as default };
//# sourceMappingURL=IconWorldMinus.svelte.js.map
