...
/* src/icons/IconLungs.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lungs" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLungs extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLungs$1 = IconLungs;

export { IconLungs$1 as default };
//# sourceMappingURL=IconLungs.svelte.js.map
