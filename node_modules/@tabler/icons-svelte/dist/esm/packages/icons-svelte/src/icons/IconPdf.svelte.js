...
/* src/icons/IconPdf.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pdf" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPdf extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPdf$1 = IconPdf;

export { IconPdf$1 as default };
//# sourceMappingURL=IconPdf.svelte.js.map
