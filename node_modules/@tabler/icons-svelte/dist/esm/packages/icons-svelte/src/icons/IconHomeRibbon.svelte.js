...
/* src/icons/IconHomeRibbon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-ribbon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeRibbon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeRibbon$1 = IconHomeRibbon;

export { IconHomeRibbon$1 as default };
//# sourceMappingURL=IconHomeRibbon.svelte.js.map
