...
/* src/icons/IconAlarmOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "alarm-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAlarmOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAlarmOff$1 = IconAlarmOff;

export { IconAlarmOff$1 as default };
//# sourceMappingURL=IconAlarmOff.svelte.js.map
