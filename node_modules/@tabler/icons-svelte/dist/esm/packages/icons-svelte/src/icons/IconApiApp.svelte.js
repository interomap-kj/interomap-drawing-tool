...
/* src/icons/IconApiApp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "api-app" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconApiApp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconApiApp$1 = IconApiApp;

export { IconApiApp$1 as default };
//# sourceMappingURL=IconApiApp.svelte.js.map
