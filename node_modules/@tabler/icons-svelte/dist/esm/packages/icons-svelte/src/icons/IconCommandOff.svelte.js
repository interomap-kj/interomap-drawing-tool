...
/* src/icons/IconCommandOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "command-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCommandOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCommandOff$1 = IconCommandOff;

export { IconCommandOff$1 as default };
//# sourceMappingURL=IconCommandOff.svelte.js.map
