...
/* src/icons/IconVocabulary.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vocabulary" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVocabulary extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVocabulary$1 = IconVocabulary;

export { IconVocabulary$1 as default };
//# sourceMappingURL=IconVocabulary.svelte.js.map
