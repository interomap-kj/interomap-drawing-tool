...
/* src/icons/IconHomeMove.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-move" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeMove extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeMove$1 = IconHomeMove;

export { IconHomeMove$1 as default };
//# sourceMappingURL=IconHomeMove.svelte.js.map
