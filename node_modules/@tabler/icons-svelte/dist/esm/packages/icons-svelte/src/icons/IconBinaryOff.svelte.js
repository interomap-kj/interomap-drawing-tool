...
/* src/icons/IconBinaryOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "binary-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBinaryOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBinaryOff$1 = IconBinaryOff;

export { IconBinaryOff$1 as default };
//# sourceMappingURL=IconBinaryOff.svelte.js.map
