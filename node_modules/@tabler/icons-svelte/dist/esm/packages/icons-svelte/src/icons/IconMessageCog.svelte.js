...
/* src/icons/IconMessageCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessageCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessageCog$1 = IconMessageCog;

export { IconMessageCog$1 as default };
//# sourceMappingURL=IconMessageCog.svelte.js.map
