...
/* src/icons/IconBellCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellCheck$1 = IconBellCheck;

export { IconBellCheck$1 as default };
//# sourceMappingURL=IconBellCheck.svelte.js.map
