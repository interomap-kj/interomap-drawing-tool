...
/* src/icons/IconFocusAuto.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "focus-auto" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFocusAuto extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFocusAuto$1 = IconFocusAuto;

export { IconFocusAuto$1 as default };
//# sourceMappingURL=IconFocusAuto.svelte.js.map
