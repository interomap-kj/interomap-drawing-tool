...
/* src/icons/IconSection.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "section" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSection extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSection$1 = IconSection;

export { IconSection$1 as default };
//# sourceMappingURL=IconSection.svelte.js.map
