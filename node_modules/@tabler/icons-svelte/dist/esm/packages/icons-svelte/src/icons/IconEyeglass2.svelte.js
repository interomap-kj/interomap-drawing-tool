...
/* src/icons/IconEyeglass2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eyeglass-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeglass2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeglass2$1 = IconEyeglass2;

export { IconEyeglass2$1 as default };
//# sourceMappingURL=IconEyeglass2.svelte.js.map
