...
/* src/icons/IconZzz.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zzz" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M4 12h6l-6 8h6" }], ["path", { "d": "M14 4h6l-6 8h6" }]];
...
class IconZzz extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZzz$1 = IconZzz;

export { IconZzz$1 as default };
//# sourceMappingURL=IconZzz.svelte.js.map
