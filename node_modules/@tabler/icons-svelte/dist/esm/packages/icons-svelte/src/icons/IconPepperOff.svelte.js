...
/* src/icons/IconPepperOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pepper-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPepperOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPepperOff$1 = IconPepperOff;

export { IconPepperOff$1 as default };
//# sourceMappingURL=IconPepperOff.svelte.js.map
