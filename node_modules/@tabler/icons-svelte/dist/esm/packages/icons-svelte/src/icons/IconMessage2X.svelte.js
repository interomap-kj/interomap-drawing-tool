...
/* src/icons/IconMessage2X.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message-2-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessage2X extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessage2X$1 = IconMessage2X;

export { IconMessage2X$1 as default };
//# sourceMappingURL=IconMessage2X.svelte.js.map
