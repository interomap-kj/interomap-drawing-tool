...
/* src/icons/IconScriptPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "script-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScriptPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScriptPlus$1 = IconScriptPlus;

export { IconScriptPlus$1 as default };
//# sourceMappingURL=IconScriptPlus.svelte.js.map
