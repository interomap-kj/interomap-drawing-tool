...
/* src/icons/IconSum.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sum" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSum extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSum$1 = IconSum;

export { IconSum$1 as default };
//# sourceMappingURL=IconSum.svelte.js.map
