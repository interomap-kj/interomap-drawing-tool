...
/* src/icons/IconCircles.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "circles" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCircles extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCircles$1 = IconCircles;

export { IconCircles$1 as default };
//# sourceMappingURL=IconCircles.svelte.js.map
