...
/* src/icons/IconFlask2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flask-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlask2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlask2$1 = IconFlask2;

export { IconFlask2$1 as default };
//# sourceMappingURL=IconFlask2.svelte.js.map
