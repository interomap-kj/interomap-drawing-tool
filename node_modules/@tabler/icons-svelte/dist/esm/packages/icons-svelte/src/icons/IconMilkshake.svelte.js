...
/* src/icons/IconMilkshake.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "milkshake" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMilkshake extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMilkshake$1 = IconMilkshake;

export { IconMilkshake$1 as default };
//# sourceMappingURL=IconMilkshake.svelte.js.map
