...
/* src/icons/IconStack2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stack-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStack2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStack2$1 = IconStack2;

export { IconStack2$1 as default };
//# sourceMappingURL=IconStack2.svelte.js.map
