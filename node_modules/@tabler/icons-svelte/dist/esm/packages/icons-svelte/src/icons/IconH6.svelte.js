...
/* src/icons/IconH6.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "h-6" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconH6 extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconH6$1 as default };
//# sourceMappingURL=IconH6.svelte.js.map
