...
/* src/icons/IconBrushOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brush-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrushOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrushOff$1 = IconBrushOff;

export { IconBrushOff$1 as default };
//# sourceMappingURL=IconBrushOff.svelte.js.map
