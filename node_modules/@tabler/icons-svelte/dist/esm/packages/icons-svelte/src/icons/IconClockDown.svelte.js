...
/* src/icons/IconClockDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockDown$1 = IconClockDown;

export { IconClockDown$1 as default };
//# sourceMappingURL=IconClockDown.svelte.js.map
