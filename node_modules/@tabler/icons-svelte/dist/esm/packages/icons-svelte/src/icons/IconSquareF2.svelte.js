...
/* src/icons/IconSquareF2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF2$1 = IconSquareF2;

export { IconSquareF2$1 as default };
//# sourceMappingURL=IconSquareF2.svelte.js.map
