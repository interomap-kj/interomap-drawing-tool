...
/* src/icons/IconTextSize.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "text-size" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTextSize extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTextSize$1 = IconTextSize;

export { IconTextSize$1 as default };
//# sourceMappingURL=IconTextSize.svelte.js.map
