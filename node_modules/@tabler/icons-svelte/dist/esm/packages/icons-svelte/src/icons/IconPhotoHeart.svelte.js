...
/* src/icons/IconPhotoHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoHeart$1 = IconPhotoHeart;

export { IconPhotoHeart$1 as default };
//# sourceMappingURL=IconPhotoHeart.svelte.js.map
