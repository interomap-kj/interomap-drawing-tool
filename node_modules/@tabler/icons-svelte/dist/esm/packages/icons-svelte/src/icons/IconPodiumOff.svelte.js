...
/* src/icons/IconPodiumOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "podium-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPodiumOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPodiumOff$1 = IconPodiumOff;

export { IconPodiumOff$1 as default };
//# sourceMappingURL=IconPodiumOff.svelte.js.map
