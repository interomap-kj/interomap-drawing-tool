...
/* src/icons/IconClockPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockPause$1 = IconClockPause;

export { IconClockPause$1 as default };
//# sourceMappingURL=IconClockPause.svelte.js.map
