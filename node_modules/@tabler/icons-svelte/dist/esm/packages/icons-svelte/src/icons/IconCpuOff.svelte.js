...
/* src/icons/IconCpuOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cpu-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCpuOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCpuOff$1 = IconCpuOff;

export { IconCpuOff$1 as default };
//# sourceMappingURL=IconCpuOff.svelte.js.map
