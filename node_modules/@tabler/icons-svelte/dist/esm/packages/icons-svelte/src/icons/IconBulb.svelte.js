...
/* src/icons/IconBulb.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bulb" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBulb extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBulb$1 = IconBulb;

export { IconBulb$1 as default };
//# sourceMappingURL=IconBulb.svelte.js.map
