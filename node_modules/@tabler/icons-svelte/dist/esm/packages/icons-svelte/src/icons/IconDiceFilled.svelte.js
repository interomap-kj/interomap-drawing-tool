...
/* src/icons/IconDiceFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dice-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiceFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiceFilled$1 = IconDiceFilled;

export { IconDiceFilled$1 as default };
//# sourceMappingURL=IconDiceFilled.svelte.js.map
