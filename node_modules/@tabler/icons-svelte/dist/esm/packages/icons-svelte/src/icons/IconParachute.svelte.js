...
/* src/icons/IconParachute.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "parachute" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconParachute extends SvelteComponent {
	constructor(options) {
		super();
...
var IconParachute$1 = IconParachute;

export { IconParachute$1 as default };
//# sourceMappingURL=IconParachute.svelte.js.map
