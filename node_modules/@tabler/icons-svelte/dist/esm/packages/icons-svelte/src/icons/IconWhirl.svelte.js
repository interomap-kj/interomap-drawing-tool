...
/* src/icons/IconWhirl.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "whirl" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWhirl extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWhirl$1 = IconWhirl;

export { IconWhirl$1 as default };
//# sourceMappingURL=IconWhirl.svelte.js.map
