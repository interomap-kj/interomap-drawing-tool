...
/* src/icons/IconHomeSignal.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-signal" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeSignal extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeSignal$1 = IconHomeSignal;

export { IconHomeSignal$1 as default };
//# sourceMappingURL=IconHomeSignal.svelte.js.map
