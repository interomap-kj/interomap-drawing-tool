...
/* src/icons/IconCertificate.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "certificate" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCertificate extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCertificate$1 = IconCertificate;

export { IconCertificate$1 as default };
//# sourceMappingURL=IconCertificate.svelte.js.map
