...
/* src/icons/IconBrandBeats.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-beats" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandBeats extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandBeats$1 = IconBrandBeats;

export { IconBrandBeats$1 as default };
//# sourceMappingURL=IconBrandBeats.svelte.js.map
