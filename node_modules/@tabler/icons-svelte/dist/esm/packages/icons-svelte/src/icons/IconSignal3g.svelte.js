...
/* src/icons/IconSignal3g.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-3g" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignal3g extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignal3g$1 = IconSignal3g;

export { IconSignal3g$1 as default };
//# sourceMappingURL=IconSignal3g.svelte.js.map
