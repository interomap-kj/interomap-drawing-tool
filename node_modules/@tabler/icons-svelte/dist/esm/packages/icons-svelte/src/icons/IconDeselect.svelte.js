...
/* src/icons/IconDeselect.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "deselect" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDeselect extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeselect$1 = IconDeselect;

export { IconDeselect$1 as default };
//# sourceMappingURL=IconDeselect.svelte.js.map
