...
/* src/icons/IconBrandAzure.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-azure" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandAzure extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandAzure$1 = IconBrandAzure;

export { IconBrandAzure$1 as default };
//# sourceMappingURL=IconBrandAzure.svelte.js.map
