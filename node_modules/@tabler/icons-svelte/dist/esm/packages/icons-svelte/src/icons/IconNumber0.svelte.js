...
/* src/icons/IconNumber0.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-0" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumber0 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber0$1 = IconNumber0;

export { IconNumber0$1 as default };
//# sourceMappingURL=IconNumber0.svelte.js.map
