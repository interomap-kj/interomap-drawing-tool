...
/* src/icons/IconJson.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "json" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconJson extends SvelteComponent {
	constructor(options) {
		super();
...
var IconJson$1 = IconJson;

export { IconJson$1 as default };
//# sourceMappingURL=IconJson.svelte.js.map
