...
/* src/icons/IconNote.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "note" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNote extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNote$1 = IconNote;

export { IconNote$1 as default };
//# sourceMappingURL=IconNote.svelte.js.map
