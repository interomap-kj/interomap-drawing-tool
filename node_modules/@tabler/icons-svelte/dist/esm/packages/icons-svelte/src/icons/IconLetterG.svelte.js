...
/* src/icons/IconLetterG.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-g" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterG extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterG$1 = IconLetterG;

export { IconLetterG$1 as default };
//# sourceMappingURL=IconLetterG.svelte.js.map
