...
/* src/icons/IconIroningOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ironing-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIroningOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIroningOff$1 = IconIroningOff;

export { IconIroningOff$1 as default };
//# sourceMappingURL=IconIroningOff.svelte.js.map
