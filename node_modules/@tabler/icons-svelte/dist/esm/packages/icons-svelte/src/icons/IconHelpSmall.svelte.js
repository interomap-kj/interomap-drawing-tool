...
/* src/icons/IconHelpSmall.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "help-small" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHelpSmall extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHelpSmall$1 = IconHelpSmall;

export { IconHelpSmall$1 as default };
//# sourceMappingURL=IconHelpSmall.svelte.js.map
