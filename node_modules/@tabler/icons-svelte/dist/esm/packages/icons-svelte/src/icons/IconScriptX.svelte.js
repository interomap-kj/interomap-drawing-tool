...
/* src/icons/IconScriptX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "script-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScriptX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScriptX$1 = IconScriptX;

export { IconScriptX$1 as default };
//# sourceMappingURL=IconScriptX.svelte.js.map
