...
/* src/icons/IconCloudPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudPin$1 = IconCloudPin;

export { IconCloudPin$1 as default };
//# sourceMappingURL=IconCloudPin.svelte.js.map
