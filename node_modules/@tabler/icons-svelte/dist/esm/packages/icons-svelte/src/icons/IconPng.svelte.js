...
/* src/icons/IconPng.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "png" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPng extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPng$1 = IconPng;

export { IconPng$1 as default };
//# sourceMappingURL=IconPng.svelte.js.map
