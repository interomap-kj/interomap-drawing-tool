...
/* src/icons/IconWindmill.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "windmill" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWindmill extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWindmill$1 = IconWindmill;

export { IconWindmill$1 as default };
//# sourceMappingURL=IconWindmill.svelte.js.map
