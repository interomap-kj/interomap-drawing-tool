...
/* src/icons/IconTrademark.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trademark" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrademark extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrademark$1 = IconTrademark;

export { IconTrademark$1 as default };
//# sourceMappingURL=IconTrademark.svelte.js.map
