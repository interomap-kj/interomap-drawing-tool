...
/* src/icons/IconTableAlias.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-alias" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTableAlias extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTableAlias$1 = IconTableAlias;

export { IconTableAlias$1 as default };
//# sourceMappingURL=IconTableAlias.svelte.js.map
