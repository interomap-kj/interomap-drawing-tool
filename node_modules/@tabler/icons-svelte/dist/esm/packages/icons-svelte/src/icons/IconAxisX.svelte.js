...
/* src/icons/IconAxisX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "axis-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAxisX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAxisX$1 = IconAxisX;

export { IconAxisX$1 as default };
//# sourceMappingURL=IconAxisX.svelte.js.map
