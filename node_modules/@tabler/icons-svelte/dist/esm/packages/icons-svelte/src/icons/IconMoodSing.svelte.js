...
/* src/icons/IconMoodSing.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-sing" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodSing extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodSing$1 = IconMoodSing;

export { IconMoodSing$1 as default };
//# sourceMappingURL=IconMoodSing.svelte.js.map
