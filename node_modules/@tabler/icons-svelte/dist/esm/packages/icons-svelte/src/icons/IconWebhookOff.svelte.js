...
/* src/icons/IconWebhookOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "webhook-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWebhookOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWebhookOff$1 = IconWebhookOff;

export { IconWebhookOff$1 as default };
//# sourceMappingURL=IconWebhookOff.svelte.js.map
