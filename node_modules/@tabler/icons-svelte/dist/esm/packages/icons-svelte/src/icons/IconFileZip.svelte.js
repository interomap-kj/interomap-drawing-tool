...
/* src/icons/IconFileZip.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-zip" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileZip extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileZip$1 = IconFileZip;

export { IconFileZip$1 as default };
//# sourceMappingURL=IconFileZip.svelte.js.map
