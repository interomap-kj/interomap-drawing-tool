...
/* src/icons/IconDiamondOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "diamond-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiamondOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiamondOff$1 = IconDiamondOff;

export { IconDiamondOff$1 as default };
//# sourceMappingURL=IconDiamondOff.svelte.js.map
