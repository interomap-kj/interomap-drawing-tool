...
/* src/icons/IconBadgeAd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-ad" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeAd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeAd$1 = IconBadgeAd;

export { IconBadgeAd$1 as default };
//# sourceMappingURL=IconBadgeAd.svelte.js.map
