...
/* src/icons/IconSignalLte.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-lte" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignalLte extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignalLte$1 = IconSignalLte;

export { IconSignalLte$1 as default };
//# sourceMappingURL=IconSignalLte.svelte.js.map
