...
/* src/icons/IconBinaryTree.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "binary-tree" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBinaryTree extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBinaryTree$1 = IconBinaryTree;

export { IconBinaryTree$1 as default };
//# sourceMappingURL=IconBinaryTree.svelte.js.map
