...
/* src/icons/IconSlideshow.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "slideshow" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSlideshow extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSlideshow$1 = IconSlideshow;

export { IconSlideshow$1 as default };
//# sourceMappingURL=IconSlideshow.svelte.js.map
