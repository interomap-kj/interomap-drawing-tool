...
/* src/icons/IconStackPush.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stack-push" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStackPush extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStackPush$1 = IconStackPush;

export { IconStackPush$1 as default };
//# sourceMappingURL=IconStackPush.svelte.js.map
