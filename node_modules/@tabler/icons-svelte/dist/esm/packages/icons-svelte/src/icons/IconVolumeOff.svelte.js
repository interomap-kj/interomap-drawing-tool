...
/* src/icons/IconVolumeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "volume-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVolumeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVolumeOff$1 = IconVolumeOff;

export { IconVolumeOff$1 as default };
//# sourceMappingURL=IconVolumeOff.svelte.js.map
