...
/* src/icons/IconLogicOr.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logic-or" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogicOr extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogicOr$1 = IconLogicOr;

export { IconLogicOr$1 as default };
//# sourceMappingURL=IconLogicOr.svelte.js.map
