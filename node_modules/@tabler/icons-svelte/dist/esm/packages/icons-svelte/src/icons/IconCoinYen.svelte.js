...
/* src/icons/IconCoinYen.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-yen" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinYen extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinYen$1 = IconCoinYen;

export { IconCoinYen$1 as default };
//# sourceMappingURL=IconCoinYen.svelte.js.map
