...
/* src/icons/IconLampOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lamp-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLampOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLampOff$1 = IconLampOff;

export { IconLampOff$1 as default };
//# sourceMappingURL=IconLampOff.svelte.js.map
