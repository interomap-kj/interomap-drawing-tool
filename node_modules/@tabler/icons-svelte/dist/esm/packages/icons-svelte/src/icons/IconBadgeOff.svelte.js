...
/* src/icons/IconBadgeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeOff$1 = IconBadgeOff;

export { IconBadgeOff$1 as default };
//# sourceMappingURL=IconBadgeOff.svelte.js.map
