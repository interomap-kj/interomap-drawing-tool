...
/* src/icons/IconABOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "a-b-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconABOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconABOff$1 = IconABOff;

export { IconABOff$1 as default };
//# sourceMappingURL=IconABOff.svelte.js.map
