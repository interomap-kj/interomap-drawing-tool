...
/* src/icons/IconMoodDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodDollar$1 = IconMoodDollar;

export { IconMoodDollar$1 as default };
//# sourceMappingURL=IconMoodDollar.svelte.js.map
