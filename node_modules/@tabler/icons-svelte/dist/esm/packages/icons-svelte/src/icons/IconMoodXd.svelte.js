...
/* src/icons/IconMoodXd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-xd" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodXd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodXd$1 = IconMoodXd;

export { IconMoodXd$1 as default };
//# sourceMappingURL=IconMoodXd.svelte.js.map
