...
/* src/icons/IconStormOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "storm-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStormOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStormOff$1 = IconStormOff;

export { IconStormOff$1 as default };
//# sourceMappingURL=IconStormOff.svelte.js.map
