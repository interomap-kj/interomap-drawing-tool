...
/* src/icons/IconBrandZeit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-zeit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M3 20h18l-9 -16z" }]];
...
class IconBrandZeit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandZeit$1 = IconBrandZeit;

export { IconBrandZeit$1 as default };
//# sourceMappingURL=IconBrandZeit.svelte.js.map
