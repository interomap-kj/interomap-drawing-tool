...
/* src/icons/IconMoodBoy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-boy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodBoy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodBoy$1 = IconMoodBoy;

export { IconMoodBoy$1 as default };
//# sourceMappingURL=IconMoodBoy.svelte.js.map
