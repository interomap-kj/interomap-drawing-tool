...
/* src/icons/IconBoneOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bone-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoneOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoneOff$1 = IconBoneOff;

export { IconBoneOff$1 as default };
//# sourceMappingURL=IconBoneOff.svelte.js.map
