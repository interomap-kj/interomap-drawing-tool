...
/* src/icons/IconWallOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wall-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWallOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWallOff$1 = IconWallOff;

export { IconWallOff$1 as default };
//# sourceMappingURL=IconWallOff.svelte.js.map
