...
/* src/icons/IconFlag2Off.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-2-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlag2Off extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlag2Off$1 = IconFlag2Off;

export { IconFlag2Off$1 as default };
//# sourceMappingURL=IconFlag2Off.svelte.js.map
