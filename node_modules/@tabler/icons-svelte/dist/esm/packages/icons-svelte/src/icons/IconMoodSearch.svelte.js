...
/* src/icons/IconMoodSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodSearch$1 = IconMoodSearch;

export { IconMoodSearch$1 as default };
//# sourceMappingURL=IconMoodSearch.svelte.js.map
