...
/* src/icons/IconLogicXnor.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logic-xnor" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogicXnor extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogicXnor$1 = IconLogicXnor;

export { IconLogicXnor$1 as default };
//# sourceMappingURL=IconLogicXnor.svelte.js.map
