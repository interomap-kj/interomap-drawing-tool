...
import { SvelteComponent, init, safe_not_equal, create_slot, assign, svg_element, empty, claim_svg_element, children, detach, set_svg_attributes, insert_hydration, append_hydration, update_slot_base, get_all_dirty_from_scope, get_slot_changes, get_spread_update, transition_in, transition_out, destroy_each, compute_rest_props, exclude_internal_props } from '../../../node_modules/.pnpm/svelte@3.55.0/node_modules/svelte/internal/index.mjs.js';
import defaultAttributes from './defaultAttributes.js';

/* src/Icon.svelte generated by Svelte v3.55.0 */
...
// (20:4) <svelte:element this={tag} {...attrs}/>
...
// (19:2) {#each iconNode as [tag, attrs]}
...
function create_fragment(ctx) {
	...
	let svg_levels = [
		...
		{ height: /*size*/ ctx[2] },
		{ stroke: /*color*/ ctx[1] },
		{ "stroke-width": /*stroke*/ ctx[3] },
		{
			class: svg_class_value = `tabler-icon tabler-icon-${/*name*/ ctx[0]} ${/*$$props*/ ctx[6].class ?? ''}`
		}
	];
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			set_svg_attributes(svg, svg_data = get_spread_update(svg_levels, [
				...
				(!current || dirty & /*stroke*/ 8) && { "stroke-width": /*stroke*/ ctx[3] },
				(!current || dirty & /*name, $$props*/ 65 && svg_class_value !== (svg_class_value = `tabler-icon tabler-icon-${/*name*/ ctx[0]} ${/*$$props*/ ctx[6].class ?? ''}`)) && { class: svg_class_value }
			]));
		},
		i(local) {
			if (current) return;
...
function instance($$self, $$props, $$invalidate) {
	const omit_props_names = ["name","color","size","stroke","iconNode"];
	...
	return [name, color, size, stroke, iconNode, $$restProps, $$props, $$scope, slots];
}
