...
/* src/icons/IconUserHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserHeart$1 = IconUserHeart;

export { IconUserHeart$1 as default };
//# sourceMappingURL=IconUserHeart.svelte.js.map
