...
/* src/icons/IconCompassOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "compass-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCompassOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCompassOff$1 = IconCompassOff;

export { IconCompassOff$1 as default };
//# sourceMappingURL=IconCompassOff.svelte.js.map
