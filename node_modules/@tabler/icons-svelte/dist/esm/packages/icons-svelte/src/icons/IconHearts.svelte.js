...
/* src/icons/IconHearts.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hearts" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHearts extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHearts$1 = IconHearts;

export { IconHearts$1 as default };
//# sourceMappingURL=IconHearts.svelte.js.map
