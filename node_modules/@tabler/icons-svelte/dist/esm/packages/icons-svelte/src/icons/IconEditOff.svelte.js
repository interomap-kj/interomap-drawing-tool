...
/* src/icons/IconEditOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "edit-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEditOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEditOff$1 = IconEditOff;

export { IconEditOff$1 as default };
//# sourceMappingURL=IconEditOff.svelte.js.map
