...
/* src/icons/IconNumber8.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-8" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumber8 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber8$1 = IconNumber8;

export { IconNumber8$1 as default };
//# sourceMappingURL=IconNumber8.svelte.js.map
