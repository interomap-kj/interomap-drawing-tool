...
/* src/icons/IconPlant2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plant-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlant2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlant2$1 = IconPlant2;

export { IconPlant2$1 as default };
//# sourceMappingURL=IconPlant2.svelte.js.map
