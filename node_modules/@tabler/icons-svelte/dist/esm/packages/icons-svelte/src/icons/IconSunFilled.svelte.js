...
/* src/icons/IconSunFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sun-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSunFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSunFilled$1 = IconSunFilled;

export { IconSunFilled$1 as default };
//# sourceMappingURL=IconSunFilled.svelte.js.map
