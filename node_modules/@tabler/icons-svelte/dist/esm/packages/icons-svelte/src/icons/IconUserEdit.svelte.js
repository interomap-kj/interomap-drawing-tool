...
/* src/icons/IconUserEdit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-edit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserEdit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserEdit$1 = IconUserEdit;

export { IconUserEdit$1 as default };
//# sourceMappingURL=IconUserEdit.svelte.js.map
