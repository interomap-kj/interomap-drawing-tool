...
/* src/icons/IconHttpGet.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-get" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpGet extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpGet$1 = IconHttpGet;

export { IconHttpGet$1 as default };
//# sourceMappingURL=IconHttpGet.svelte.js.map
