...
/* src/icons/IconPhoneCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "phone-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhoneCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhoneCheck$1 = IconPhoneCheck;

export { IconPhoneCheck$1 as default };
//# sourceMappingURL=IconPhoneCheck.svelte.js.map
