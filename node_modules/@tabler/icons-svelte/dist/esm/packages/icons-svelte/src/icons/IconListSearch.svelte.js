...
/* src/icons/IconListSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "list-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconListSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconListSearch$1 = IconListSearch;

export { IconListSearch$1 as default };
//# sourceMappingURL=IconListSearch.svelte.js.map
