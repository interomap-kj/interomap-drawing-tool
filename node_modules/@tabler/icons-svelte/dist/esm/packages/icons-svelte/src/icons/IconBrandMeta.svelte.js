...
/* src/icons/IconBrandMeta.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-meta" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandMeta extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandMeta$1 = IconBrandMeta;

export { IconBrandMeta$1 as default };
//# sourceMappingURL=IconBrandMeta.svelte.js.map
