...
/* src/icons/IconSolarPanel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "solar-panel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSolarPanel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSolarPanel$1 = IconSolarPanel;

export { IconSolarPanel$1 as default };
//# sourceMappingURL=IconSolarPanel.svelte.js.map
