...
/* src/icons/IconBrandZhihu.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-zhihu" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandZhihu extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandZhihu$1 = IconBrandZhihu;

export { IconBrandZhihu$1 as default };
//# sourceMappingURL=IconBrandZhihu.svelte.js.map
