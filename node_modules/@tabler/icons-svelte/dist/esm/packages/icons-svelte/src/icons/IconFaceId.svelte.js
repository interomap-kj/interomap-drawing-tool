...
/* src/icons/IconFaceId.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "face-id" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFaceId extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFaceId$1 = IconFaceId;

export { IconFaceId$1 as default };
//# sourceMappingURL=IconFaceId.svelte.js.map
