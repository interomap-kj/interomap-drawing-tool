...
/* src/icons/IconMask.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mask" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMask extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMask$1 = IconMask;

export { IconMask$1 as default };
//# sourceMappingURL=IconMask.svelte.js.map
