...
/* src/icons/IconZeppelin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zeppelin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZeppelin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZeppelin$1 = IconZeppelin;

export { IconZeppelin$1 as default };
//# sourceMappingURL=IconZeppelin.svelte.js.map
