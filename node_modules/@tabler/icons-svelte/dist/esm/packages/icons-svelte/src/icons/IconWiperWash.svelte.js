...
/* src/icons/IconWiperWash.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wiper-wash" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWiperWash extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWiperWash$1 = IconWiperWash;

export { IconWiperWash$1 as default };
//# sourceMappingURL=IconWiperWash.svelte.js.map
