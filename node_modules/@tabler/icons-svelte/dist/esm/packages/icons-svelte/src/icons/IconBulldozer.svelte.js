...
/* src/icons/IconBulldozer.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bulldozer" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBulldozer extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBulldozer$1 = IconBulldozer;

export { IconBulldozer$1 as default };
//# sourceMappingURL=IconBulldozer.svelte.js.map
