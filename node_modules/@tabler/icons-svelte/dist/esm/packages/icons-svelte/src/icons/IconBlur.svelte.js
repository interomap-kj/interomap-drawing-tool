...
/* src/icons/IconBlur.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "blur" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBlur extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBlur$1 = IconBlur;

export { IconBlur$1 as default };
//# sourceMappingURL=IconBlur.svelte.js.map
