...
/* src/icons/IconSlashes.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "slashes" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M14 5l-10 14" }], ["path", { "d": "M20 5l-10 14" }]];
...
class IconSlashes extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSlashes$1 = IconSlashes;

export { IconSlashes$1 as default };
//# sourceMappingURL=IconSlashes.svelte.js.map
