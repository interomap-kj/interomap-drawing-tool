...
/* src/icons/IconSTurnDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "s-turn-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSTurnDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSTurnDown$1 = IconSTurnDown;

export { IconSTurnDown$1 as default };
//# sourceMappingURL=IconSTurnDown.svelte.js.map
