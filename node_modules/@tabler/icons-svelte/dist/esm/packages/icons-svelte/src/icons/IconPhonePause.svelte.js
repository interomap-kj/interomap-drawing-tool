...
/* src/icons/IconPhonePause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "phone-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhonePause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhonePause$1 = IconPhonePause;

export { IconPhonePause$1 as default };
//# sourceMappingURL=IconPhonePause.svelte.js.map
