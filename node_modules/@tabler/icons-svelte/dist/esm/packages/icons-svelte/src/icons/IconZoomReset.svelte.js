...
/* src/icons/IconZoomReset.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-reset" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomReset extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomReset$1 = IconZoomReset;

export { IconZoomReset$1 as default };
//# sourceMappingURL=IconZoomReset.svelte.js.map
