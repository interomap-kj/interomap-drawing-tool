...
/* src/icons/IconCircleX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "circle-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCircleX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCircleX$1 = IconCircleX;

export { IconCircleX$1 as default };
//# sourceMappingURL=IconCircleX.svelte.js.map
