...
/* src/icons/IconDirections.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "directions" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDirections extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDirections$1 = IconDirections;

export { IconDirections$1 as default };
//# sourceMappingURL=IconDirections.svelte.js.map
