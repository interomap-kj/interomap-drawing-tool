...
/* src/icons/IconPodium.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "podium" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPodium extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPodium$1 = IconPodium;

export { IconPodium$1 as default };
//# sourceMappingURL=IconPodium.svelte.js.map
