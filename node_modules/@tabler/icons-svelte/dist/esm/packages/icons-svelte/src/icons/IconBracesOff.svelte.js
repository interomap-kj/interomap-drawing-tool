...
/* src/icons/IconBracesOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "braces-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBracesOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBracesOff$1 = IconBracesOff;

export { IconBracesOff$1 as default };
//# sourceMappingURL=IconBracesOff.svelte.js.map
