...
/* src/icons/IconBlurOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "blur-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBlurOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBlurOff$1 = IconBlurOff;

export { IconBlurOff$1 as default };
//# sourceMappingURL=IconBlurOff.svelte.js.map
