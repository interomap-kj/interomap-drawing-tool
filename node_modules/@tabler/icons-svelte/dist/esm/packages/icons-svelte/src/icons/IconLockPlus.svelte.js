...
/* src/icons/IconLockPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockPlus$1 = IconLockPlus;

export { IconLockPlus$1 as default };
//# sourceMappingURL=IconLockPlus.svelte.js.map
