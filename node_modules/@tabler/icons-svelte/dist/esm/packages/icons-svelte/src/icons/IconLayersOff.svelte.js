...
/* src/icons/IconLayersOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "layers-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLayersOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLayersOff$1 = IconLayersOff;

export { IconLayersOff$1 as default };
//# sourceMappingURL=IconLayersOff.svelte.js.map
