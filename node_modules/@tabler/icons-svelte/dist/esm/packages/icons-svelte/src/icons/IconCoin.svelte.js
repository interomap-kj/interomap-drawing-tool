...
/* src/icons/IconCoin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoin$1 = IconCoin;

export { IconCoin$1 as default };
//# sourceMappingURL=IconCoin.svelte.js.map
