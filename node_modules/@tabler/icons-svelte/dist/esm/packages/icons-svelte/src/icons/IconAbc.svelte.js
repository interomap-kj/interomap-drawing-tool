...
/* src/icons/IconAbc.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "abc" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAbc extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAbc$1 = IconAbc;

export { IconAbc$1 as default };
//# sourceMappingURL=IconAbc.svelte.js.map
