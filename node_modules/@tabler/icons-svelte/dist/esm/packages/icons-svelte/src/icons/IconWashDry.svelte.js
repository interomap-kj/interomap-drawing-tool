...
/* src/icons/IconWashDry.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDry extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDry$1 = IconWashDry;

export { IconWashDry$1 as default };
//# sourceMappingURL=IconWashDry.svelte.js.map
