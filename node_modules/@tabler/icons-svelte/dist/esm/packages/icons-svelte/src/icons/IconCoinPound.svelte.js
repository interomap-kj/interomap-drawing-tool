...
/* src/icons/IconCoinPound.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-pound" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinPound extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinPound$1 = IconCoinPound;

export { IconCoinPound$1 as default };
//# sourceMappingURL=IconCoinPound.svelte.js.map
