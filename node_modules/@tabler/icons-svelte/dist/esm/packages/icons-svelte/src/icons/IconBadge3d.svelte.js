...
/* src/icons/IconBadge3d.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-3d" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadge3d extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadge3d$1 = IconBadge3d;

export { IconBadge3d$1 as default };
//# sourceMappingURL=IconBadge3d.svelte.js.map
