...
/* src/icons/IconVenus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "venus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVenus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVenus$1 = IconVenus;

export { IconVenus$1 as default };
//# sourceMappingURL=IconVenus.svelte.js.map
