...
/* src/icons/IconFountain.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fountain" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFountain extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFountain$1 = IconFountain;

export { IconFountain$1 as default };
//# sourceMappingURL=IconFountain.svelte.js.map
