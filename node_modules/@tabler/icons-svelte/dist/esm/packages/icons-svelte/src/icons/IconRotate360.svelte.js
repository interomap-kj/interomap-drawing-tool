...
/* src/icons/IconRotate360.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rotate-360" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRotate360 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRotate360$1 = IconRotate360;

export { IconRotate360$1 as default };
//# sourceMappingURL=IconRotate360.svelte.js.map
