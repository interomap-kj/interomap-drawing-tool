...
/* src/icons/IconForms.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "forms" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconForms extends SvelteComponent {
	constructor(options) {
		super();
...
var IconForms$1 = IconForms;

export { IconForms$1 as default };
//# sourceMappingURL=IconForms.svelte.js.map
