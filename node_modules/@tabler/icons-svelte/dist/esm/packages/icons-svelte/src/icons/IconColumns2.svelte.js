...
/* src/icons/IconColumns2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "columns-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconColumns2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconColumns2$1 = IconColumns2;

export { IconColumns2$1 as default };
//# sourceMappingURL=IconColumns2.svelte.js.map
