...
/* src/icons/IconChartLine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-line" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M4 19l16 0" }], ["path", { "d": "M4 15l4 -6l4 2l4 -5l4 4" }]];
...
class IconChartLine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartLine$1 = IconChartLine;

export { IconChartLine$1 as default };
//# sourceMappingURL=IconChartLine.svelte.js.map
