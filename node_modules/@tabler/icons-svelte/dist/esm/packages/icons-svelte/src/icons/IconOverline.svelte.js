...
/* src/icons/IconOverline.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "overline" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 9v5a5 5 0 0 0 10 0v-5" }], ["path", { "d": "M5 5h14" }]];
...
class IconOverline extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOverline$1 = IconOverline;

export { IconOverline$1 as default };
//# sourceMappingURL=IconOverline.svelte.js.map
