...
/* src/icons/IconMoodWink2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-wink-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodWink2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodWink2$1 = IconMoodWink2;

export { IconMoodWink2$1 as default };
//# sourceMappingURL=IconMoodWink2.svelte.js.map
