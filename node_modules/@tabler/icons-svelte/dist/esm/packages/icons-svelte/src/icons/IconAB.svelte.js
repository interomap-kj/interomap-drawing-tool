...
/* src/icons/IconAB.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "a-b" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAB extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconAB$1 as default };
//# sourceMappingURL=IconAB.svelte.js.map
