...
/* src/icons/IconUfo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ufo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUfo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUfo$1 = IconUfo;

export { IconUfo$1 as default };
//# sourceMappingURL=IconUfo.svelte.js.map
