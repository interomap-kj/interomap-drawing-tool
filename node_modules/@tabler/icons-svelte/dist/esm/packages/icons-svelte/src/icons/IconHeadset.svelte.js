...
/* src/icons/IconHeadset.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "headset" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeadset extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeadset$1 = IconHeadset;

export { IconHeadset$1 as default };
//# sourceMappingURL=IconHeadset.svelte.js.map
