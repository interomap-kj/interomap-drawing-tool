...
/* src/icons/IconUserOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserOff$1 = IconUserOff;

export { IconUserOff$1 as default };
//# sourceMappingURL=IconUserOff.svelte.js.map
