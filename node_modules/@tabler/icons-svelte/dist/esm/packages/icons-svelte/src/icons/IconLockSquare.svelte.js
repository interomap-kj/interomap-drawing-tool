...
/* src/icons/IconLockSquare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-square" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockSquare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockSquare$1 = IconLockSquare;

export { IconLockSquare$1 as default };
//# sourceMappingURL=IconLockSquare.svelte.js.map
