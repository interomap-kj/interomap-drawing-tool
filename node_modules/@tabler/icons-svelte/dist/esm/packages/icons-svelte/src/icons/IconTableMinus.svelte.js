...
/* src/icons/IconTableMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTableMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTableMinus$1 = IconTableMinus;

export { IconTableMinus$1 as default };
//# sourceMappingURL=IconTableMinus.svelte.js.map
