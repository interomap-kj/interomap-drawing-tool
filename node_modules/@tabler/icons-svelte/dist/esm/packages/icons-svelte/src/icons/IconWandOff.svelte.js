...
/* src/icons/IconWandOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wand-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWandOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWandOff$1 = IconWandOff;

export { IconWandOff$1 as default };
//# sourceMappingURL=IconWandOff.svelte.js.map
