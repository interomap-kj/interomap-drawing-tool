...
/* src/icons/IconMathMax.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-max" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMathMax extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathMax$1 = IconMathMax;

export { IconMathMax$1 as default };
//# sourceMappingURL=IconMathMax.svelte.js.map
