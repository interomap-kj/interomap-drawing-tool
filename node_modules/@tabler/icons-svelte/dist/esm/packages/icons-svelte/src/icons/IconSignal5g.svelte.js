...
/* src/icons/IconSignal5g.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-5g" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignal5g extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignal5g$1 = IconSignal5g;

export { IconSignal5g$1 as default };
//# sourceMappingURL=IconSignal5g.svelte.js.map
