...
/* src/icons/IconLockBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockBolt$1 = IconLockBolt;

export { IconLockBolt$1 as default };
//# sourceMappingURL=IconLockBolt.svelte.js.map
