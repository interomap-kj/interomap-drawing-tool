...
/* src/icons/IconRecycleOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "recycle-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRecycleOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRecycleOff$1 = IconRecycleOff;

export { IconRecycleOff$1 as default };
//# sourceMappingURL=IconRecycleOff.svelte.js.map
