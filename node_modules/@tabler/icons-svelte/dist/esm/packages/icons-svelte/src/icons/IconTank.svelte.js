...
/* src/icons/IconTank.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tank" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTank extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTank$1 = IconTank;

export { IconTank$1 as default };
//# sourceMappingURL=IconTank.svelte.js.map
