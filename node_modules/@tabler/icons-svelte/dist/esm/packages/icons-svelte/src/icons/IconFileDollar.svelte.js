...
/* src/icons/IconFileDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileDollar$1 = IconFileDollar;

export { IconFileDollar$1 as default };
//# sourceMappingURL=IconFileDollar.svelte.js.map
