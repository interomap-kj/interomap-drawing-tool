...
/* src/icons/IconBlockquote.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "blockquote" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBlockquote extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBlockquote$1 = IconBlockquote;

export { IconBlockquote$1 as default };
//# sourceMappingURL=IconBlockquote.svelte.js.map
