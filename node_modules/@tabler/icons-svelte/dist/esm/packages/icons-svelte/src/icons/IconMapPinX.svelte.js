...
/* src/icons/IconMapPinX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-pin-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapPinX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPinX$1 = IconMapPinX;

export { IconMapPinX$1 as default };
//# sourceMappingURL=IconMapPinX.svelte.js.map
