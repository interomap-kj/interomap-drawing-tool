...
/* src/icons/IconTextWrap.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "text-wrap" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTextWrap extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTextWrap$1 = IconTextWrap;

export { IconTextWrap$1 as default };
//# sourceMappingURL=IconTextWrap.svelte.js.map
