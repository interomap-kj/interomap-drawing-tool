...
/* src/icons/IconBrandAsana.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-asana" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandAsana extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandAsana$1 = IconBrandAsana;

export { IconBrandAsana$1 as default };
//# sourceMappingURL=IconBrandAsana.svelte.js.map
