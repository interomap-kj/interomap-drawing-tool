...
/* src/icons/IconLockPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockPause$1 = IconLockPause;

export { IconLockPause$1 as default };
//# sourceMappingURL=IconLockPause.svelte.js.map
