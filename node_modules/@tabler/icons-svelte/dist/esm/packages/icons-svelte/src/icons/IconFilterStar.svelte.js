...
/* src/icons/IconFilterStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterStar$1 = IconFilterStar;

export { IconFilterStar$1 as default };
//# sourceMappingURL=IconFilterStar.svelte.js.map
