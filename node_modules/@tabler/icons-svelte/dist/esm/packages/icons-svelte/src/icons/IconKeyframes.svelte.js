...
/* src/icons/IconKeyframes.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "keyframes" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconKeyframes extends SvelteComponent {
	constructor(options) {
		super();
...
var IconKeyframes$1 = IconKeyframes;

export { IconKeyframes$1 as default };
//# sourceMappingURL=IconKeyframes.svelte.js.map
