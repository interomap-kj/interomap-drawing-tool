...
/* src/icons/IconLayoutRows.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "layout-rows" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLayoutRows extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLayoutRows$1 = IconLayoutRows;

export { IconLayoutRows$1 as default };
//# sourceMappingURL=IconLayoutRows.svelte.js.map
