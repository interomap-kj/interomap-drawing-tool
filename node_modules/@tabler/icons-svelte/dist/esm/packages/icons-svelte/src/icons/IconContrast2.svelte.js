...
/* src/icons/IconContrast2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "contrast-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconContrast2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconContrast2$1 = IconContrast2;

export { IconContrast2$1 as default };
//# sourceMappingURL=IconContrast2.svelte.js.map
