...
/* src/icons/IconCategory.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "category" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCategory extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCategory$1 = IconCategory;

export { IconCategory$1 as default };
//# sourceMappingURL=IconCategory.svelte.js.map
