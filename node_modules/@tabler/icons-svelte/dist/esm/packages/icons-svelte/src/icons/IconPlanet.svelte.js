...
/* src/icons/IconPlanet.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "planet" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlanet extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlanet$1 = IconPlanet;

export { IconPlanet$1 as default };
//# sourceMappingURL=IconPlanet.svelte.js.map
