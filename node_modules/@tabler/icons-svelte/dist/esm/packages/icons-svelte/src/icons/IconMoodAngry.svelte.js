...
/* src/icons/IconMoodAngry.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-angry" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodAngry extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodAngry$1 = IconMoodAngry;

export { IconMoodAngry$1 as default };
//# sourceMappingURL=IconMoodAngry.svelte.js.map
