...
/* src/icons/IconNumber4.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-4" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M15 20v-15l-8 11h10" }]];
...
class IconNumber4 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber4$1 = IconNumber4;

export { IconNumber4$1 as default };
//# sourceMappingURL=IconNumber4.svelte.js.map
