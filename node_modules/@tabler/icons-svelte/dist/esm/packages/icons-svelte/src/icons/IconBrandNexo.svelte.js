...
/* src/icons/IconBrandNexo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-nexo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandNexo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandNexo$1 = IconBrandNexo;

export { IconBrandNexo$1 as default };
//# sourceMappingURL=IconBrandNexo.svelte.js.map
