...
/* src/icons/IconFileImport.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-import" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileImport extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileImport$1 = IconFileImport;

export { IconFileImport$1 as default };
//# sourceMappingURL=IconFileImport.svelte.js.map
