...
/* src/icons/IconSwimming.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "swimming" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSwimming extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwimming$1 = IconSwimming;

export { IconSwimming$1 as default };
//# sourceMappingURL=IconSwimming.svelte.js.map
