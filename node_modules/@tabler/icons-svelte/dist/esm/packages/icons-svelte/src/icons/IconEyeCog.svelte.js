...
/* src/icons/IconEyeCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeCog$1 = IconEyeCog;

export { IconEyeCog$1 as default };
//# sourceMappingURL=IconEyeCog.svelte.js.map
