...
/* src/icons/IconSitemapOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sitemap-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSitemapOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSitemapOff$1 = IconSitemapOff;

export { IconSitemapOff$1 as default };
//# sourceMappingURL=IconSitemapOff.svelte.js.map
