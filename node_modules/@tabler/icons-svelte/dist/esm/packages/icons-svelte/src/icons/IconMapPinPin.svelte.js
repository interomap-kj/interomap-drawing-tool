...
/* src/icons/IconMapPinPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-pin-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapPinPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPinPin$1 = IconMapPinPin;

export { IconMapPinPin$1 as default };
//# sourceMappingURL=IconMapPinPin.svelte.js.map
