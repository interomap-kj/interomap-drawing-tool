...
/* src/icons/IconClockPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockPlus$1 = IconClockPlus;

export { IconClockPlus$1 as default };
//# sourceMappingURL=IconClockPlus.svelte.js.map
