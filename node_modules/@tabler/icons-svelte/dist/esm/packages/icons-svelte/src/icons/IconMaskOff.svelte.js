...
/* src/icons/IconMaskOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mask-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMaskOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMaskOff$1 = IconMaskOff;

export { IconMaskOff$1 as default };
//# sourceMappingURL=IconMaskOff.svelte.js.map
