...
/* src/icons/IconChalkboard.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chalkboard" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChalkboard extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChalkboard$1 = IconChalkboard;

export { IconChalkboard$1 as default };
//# sourceMappingURL=IconChalkboard.svelte.js.map
