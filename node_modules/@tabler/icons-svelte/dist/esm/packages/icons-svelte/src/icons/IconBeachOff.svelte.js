...
/* src/icons/IconBeachOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "beach-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBeachOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBeachOff$1 = IconBeachOff;

export { IconBeachOff$1 as default };
//# sourceMappingURL=IconBeachOff.svelte.js.map
