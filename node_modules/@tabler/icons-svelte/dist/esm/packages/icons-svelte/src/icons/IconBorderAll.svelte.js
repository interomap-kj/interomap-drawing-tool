...
/* src/icons/IconBorderAll.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "border-all" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBorderAll extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBorderAll$1 = IconBorderAll;

export { IconBorderAll$1 as default };
//# sourceMappingURL=IconBorderAll.svelte.js.map
