...
/* src/icons/IconBrandYatse.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-yatse" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandYatse extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandYatse$1 = IconBrandYatse;

export { IconBrandYatse$1 as default };
//# sourceMappingURL=IconBrandYatse.svelte.js.map
