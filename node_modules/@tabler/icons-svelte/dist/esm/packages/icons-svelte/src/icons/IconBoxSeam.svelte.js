...
/* src/icons/IconBoxSeam.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "box-seam" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoxSeam extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoxSeam$1 = IconBoxSeam;

export { IconBoxSeam$1 as default };
//# sourceMappingURL=IconBoxSeam.svelte.js.map
