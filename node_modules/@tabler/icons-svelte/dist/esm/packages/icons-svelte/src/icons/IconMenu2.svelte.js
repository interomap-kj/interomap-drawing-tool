...
/* src/icons/IconMenu2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "menu-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMenu2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMenu2$1 = IconMenu2;

export { IconMenu2$1 as default };
//# sourceMappingURL=IconMenu2.svelte.js.map
