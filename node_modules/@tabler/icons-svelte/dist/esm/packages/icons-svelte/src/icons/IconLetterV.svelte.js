...
/* src/icons/IconLetterV.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-v" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M6 4l6 16l6 -16" }]];
...
class IconLetterV extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterV$1 = IconLetterV;

export { IconLetterV$1 as default };
//# sourceMappingURL=IconLetterV.svelte.js.map
