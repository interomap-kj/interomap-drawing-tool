...
/* src/icons/IconFilePower.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-power" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilePower extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilePower$1 = IconFilePower;

export { IconFilePower$1 as default };
//# sourceMappingURL=IconFilePower.svelte.js.map
