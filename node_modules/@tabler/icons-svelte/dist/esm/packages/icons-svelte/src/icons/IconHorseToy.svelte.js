...
/* src/icons/IconHorseToy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "horse-toy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHorseToy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHorseToy$1 = IconHorseToy;

export { IconHorseToy$1 as default };
//# sourceMappingURL=IconHorseToy.svelte.js.map
