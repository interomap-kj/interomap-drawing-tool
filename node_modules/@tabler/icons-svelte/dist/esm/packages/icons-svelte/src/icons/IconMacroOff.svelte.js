...
/* src/icons/IconMacroOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "macro-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMacroOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMacroOff$1 = IconMacroOff;

export { IconMacroOff$1 as default };
//# sourceMappingURL=IconMacroOff.svelte.js.map
