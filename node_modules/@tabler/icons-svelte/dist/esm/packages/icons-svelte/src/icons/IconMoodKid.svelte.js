...
/* src/icons/IconMoodKid.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-kid" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodKid extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodKid$1 = IconMoodKid;

export { IconMoodKid$1 as default };
//# sourceMappingURL=IconMoodKid.svelte.js.map
