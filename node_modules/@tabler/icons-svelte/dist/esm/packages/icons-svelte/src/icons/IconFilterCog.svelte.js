...
/* src/icons/IconFilterCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterCog$1 = IconFilterCog;

export { IconFilterCog$1 as default };
//# sourceMappingURL=IconFilterCog.svelte.js.map
