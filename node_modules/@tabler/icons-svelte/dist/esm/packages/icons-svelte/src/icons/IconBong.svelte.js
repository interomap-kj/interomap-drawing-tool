...
/* src/icons/IconBong.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bong" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBong extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBong$1 = IconBong;

export { IconBong$1 as default };
//# sourceMappingURL=IconBong.svelte.js.map
