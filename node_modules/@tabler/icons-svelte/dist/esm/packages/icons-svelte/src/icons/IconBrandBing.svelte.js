...
/* src/icons/IconBrandBing.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-bing" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandBing extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandBing$1 = IconBrandBing;

export { IconBrandBing$1 as default };
//# sourceMappingURL=IconBrandBing.svelte.js.map
