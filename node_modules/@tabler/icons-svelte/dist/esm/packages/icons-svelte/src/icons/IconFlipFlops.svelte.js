...
/* src/icons/IconFlipFlops.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flip-flops" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlipFlops extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlipFlops$1 = IconFlipFlops;

export { IconFlipFlops$1 as default };
//# sourceMappingURL=IconFlipFlops.svelte.js.map
