...
/* src/icons/IconFunction.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "function" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFunction extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFunction$1 = IconFunction;

export { IconFunction$1 as default };
//# sourceMappingURL=IconFunction.svelte.js.map
