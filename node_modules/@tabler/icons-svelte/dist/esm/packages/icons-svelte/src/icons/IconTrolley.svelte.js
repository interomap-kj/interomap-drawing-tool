...
/* src/icons/IconTrolley.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trolley" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrolley extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrolley$1 = IconTrolley;

export { IconTrolley$1 as default };
//# sourceMappingURL=IconTrolley.svelte.js.map
