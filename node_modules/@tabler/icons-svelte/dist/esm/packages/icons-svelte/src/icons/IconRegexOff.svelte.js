...
/* src/icons/IconRegexOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "regex-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRegexOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRegexOff$1 = IconRegexOff;

export { IconRegexOff$1 as default };
//# sourceMappingURL=IconRegexOff.svelte.js.map
