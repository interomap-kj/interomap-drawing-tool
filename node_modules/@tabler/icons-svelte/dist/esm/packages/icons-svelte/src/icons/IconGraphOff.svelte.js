...
/* src/icons/IconGraphOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "graph-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGraphOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGraphOff$1 = IconGraphOff;

export { IconGraphOff$1 as default };
//# sourceMappingURL=IconGraphOff.svelte.js.map
