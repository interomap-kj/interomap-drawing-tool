...
/* src/icons/IconWashDry3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDry3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDry3$1 = IconWashDry3;

export { IconWashDry3$1 as default };
//# sourceMappingURL=IconWashDry3.svelte.js.map
