...
/* src/icons/IconCell.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cell" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCell extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCell$1 = IconCell;

export { IconCell$1 as default };
//# sourceMappingURL=IconCell.svelte.js.map
