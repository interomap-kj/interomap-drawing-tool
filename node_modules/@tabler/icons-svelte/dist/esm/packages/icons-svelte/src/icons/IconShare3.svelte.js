...
/* src/icons/IconShare3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "share-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShare3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShare3$1 = IconShare3;

export { IconShare3$1 as default };
//# sourceMappingURL=IconShare3.svelte.js.map
