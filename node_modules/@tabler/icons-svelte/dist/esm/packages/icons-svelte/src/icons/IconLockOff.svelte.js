...
/* src/icons/IconLockOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockOff$1 = IconLockOff;

export { IconLockOff$1 as default };
//# sourceMappingURL=IconLockOff.svelte.js.map
