...
/* src/icons/IconBrandZoom.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-zoom" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandZoom extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandZoom$1 = IconBrandZoom;

export { IconBrandZoom$1 as default };
//# sourceMappingURL=IconBrandZoom.svelte.js.map
