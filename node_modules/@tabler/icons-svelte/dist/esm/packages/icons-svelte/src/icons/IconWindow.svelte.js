...
/* src/icons/IconWindow.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "window" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWindow extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWindow$1 = IconWindow;

export { IconWindow$1 as default };
//# sourceMappingURL=IconWindow.svelte.js.map
