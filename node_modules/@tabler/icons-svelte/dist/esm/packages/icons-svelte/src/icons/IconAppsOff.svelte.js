...
/* src/icons/IconAppsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "apps-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAppsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAppsOff$1 = IconAppsOff;

export { IconAppsOff$1 as default };
//# sourceMappingURL=IconAppsOff.svelte.js.map
