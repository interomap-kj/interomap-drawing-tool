...
/* src/icons/IconPlaylist.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "playlist" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlaylist extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlaylist$1 = IconPlaylist;

export { IconPlaylist$1 as default };
//# sourceMappingURL=IconPlaylist.svelte.js.map
