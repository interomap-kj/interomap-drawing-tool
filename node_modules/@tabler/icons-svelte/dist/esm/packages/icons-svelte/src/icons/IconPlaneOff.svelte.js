...
/* src/icons/IconPlaneOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plane-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlaneOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlaneOff$1 = IconPlaneOff;

export { IconPlaneOff$1 as default };
//# sourceMappingURL=IconPlaneOff.svelte.js.map
