...
/* src/icons/IconMailPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailPin$1 = IconMailPin;

export { IconMailPin$1 as default };
//# sourceMappingURL=IconMailPin.svelte.js.map
