...
/* src/icons/IconSock.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sock" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSock extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSock$1 = IconSock;

export { IconSock$1 as default };
//# sourceMappingURL=IconSock.svelte.js.map
