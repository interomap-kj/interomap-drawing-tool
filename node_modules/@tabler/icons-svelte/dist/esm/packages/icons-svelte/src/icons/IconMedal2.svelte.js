...
/* src/icons/IconMedal2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "medal-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMedal2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMedal2$1 = IconMedal2;

export { IconMedal2$1 as default };
//# sourceMappingURL=IconMedal2.svelte.js.map
