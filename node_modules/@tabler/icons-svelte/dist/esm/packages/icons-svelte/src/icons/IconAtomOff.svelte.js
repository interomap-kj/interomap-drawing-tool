...
/* src/icons/IconAtomOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "atom-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAtomOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAtomOff$1 = IconAtomOff;

export { IconAtomOff$1 as default };
//# sourceMappingURL=IconAtomOff.svelte.js.map
