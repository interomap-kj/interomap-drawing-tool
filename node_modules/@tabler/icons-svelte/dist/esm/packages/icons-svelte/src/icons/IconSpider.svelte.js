...
/* src/icons/IconSpider.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "spider" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpider extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpider$1 = IconSpider;

export { IconSpider$1 as default };
//# sourceMappingURL=IconSpider.svelte.js.map
