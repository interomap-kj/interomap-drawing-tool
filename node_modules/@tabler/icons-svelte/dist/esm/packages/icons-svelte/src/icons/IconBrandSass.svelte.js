...
/* src/icons/IconBrandSass.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-sass" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandSass extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandSass$1 = IconBrandSass;

export { IconBrandSass$1 as default };
//# sourceMappingURL=IconBrandSass.svelte.js.map
