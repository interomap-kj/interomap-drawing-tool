...
/* src/icons/IconPlusMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plus-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlusMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlusMinus$1 = IconPlusMinus;

export { IconPlusMinus$1 as default };
//# sourceMappingURL=IconPlusMinus.svelte.js.map
