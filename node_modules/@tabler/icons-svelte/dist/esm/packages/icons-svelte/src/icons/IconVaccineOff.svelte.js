...
/* src/icons/IconVaccineOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vaccine-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVaccineOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVaccineOff$1 = IconVaccineOff;

export { IconVaccineOff$1 as default };
//# sourceMappingURL=IconVaccineOff.svelte.js.map
