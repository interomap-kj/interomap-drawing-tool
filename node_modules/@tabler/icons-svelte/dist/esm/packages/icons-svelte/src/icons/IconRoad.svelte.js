...
/* src/icons/IconRoad.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "road" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRoad extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRoad$1 = IconRoad;

export { IconRoad$1 as default };
//# sourceMappingURL=IconRoad.svelte.js.map
