...
/* src/icons/IconIcons.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "icons" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIcons extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIcons$1 = IconIcons;

export { IconIcons$1 as default };
//# sourceMappingURL=IconIcons.svelte.js.map
