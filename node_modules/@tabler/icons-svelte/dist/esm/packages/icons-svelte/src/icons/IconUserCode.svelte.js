...
/* src/icons/IconUserCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserCode$1 = IconUserCode;

export { IconUserCode$1 as default };
//# sourceMappingURL=IconUserCode.svelte.js.map
