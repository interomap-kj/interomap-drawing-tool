...
/* src/icons/IconEaseInOut.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ease-in-out" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M3 20c8 0 10 -16 18 -16" }]];
...
class IconEaseInOut extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEaseInOut$1 = IconEaseInOut;

export { IconEaseInOut$1 as default };
//# sourceMappingURL=IconEaseInOut.svelte.js.map
