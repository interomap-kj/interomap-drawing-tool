...
/* src/icons/IconReceipt2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "receipt-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconReceipt2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconReceipt2$1 = IconReceipt2;

export { IconReceipt2$1 as default };
//# sourceMappingURL=IconReceipt2.svelte.js.map
