...
/* src/icons/IconBusOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bus-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBusOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBusOff$1 = IconBusOff;

export { IconBusOff$1 as default };
//# sourceMappingURL=IconBusOff.svelte.js.map
