...
/* src/icons/IconDiscount2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "discount-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiscount2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiscount2$1 = IconDiscount2;

export { IconDiscount2$1 as default };
//# sourceMappingURL=IconDiscount2.svelte.js.map
