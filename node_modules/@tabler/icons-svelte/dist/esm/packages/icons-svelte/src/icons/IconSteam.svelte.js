...
/* src/icons/IconSteam.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "steam" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSteam extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSteam$1 = IconSteam;

export { IconSteam$1 as default };
//# sourceMappingURL=IconSteam.svelte.js.map
