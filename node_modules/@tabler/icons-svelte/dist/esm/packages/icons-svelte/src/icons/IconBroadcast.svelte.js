...
/* src/icons/IconBroadcast.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "broadcast" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBroadcast extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBroadcast$1 = IconBroadcast;

export { IconBroadcast$1 as default };
//# sourceMappingURL=IconBroadcast.svelte.js.map
