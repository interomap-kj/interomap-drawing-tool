...
/* src/icons/IconRepeatOnce.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "repeat-once" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRepeatOnce extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRepeatOnce$1 = IconRepeatOnce;

export { IconRepeatOnce$1 as default };
//# sourceMappingURL=IconRepeatOnce.svelte.js.map
