...
/* src/icons/IconMoneybag.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "moneybag" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoneybag extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoneybag$1 = IconMoneybag;

export { IconMoneybag$1 as default };
//# sourceMappingURL=IconMoneybag.svelte.js.map
