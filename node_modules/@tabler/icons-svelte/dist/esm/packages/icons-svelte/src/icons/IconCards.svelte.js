...
/* src/icons/IconCards.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cards" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCards extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCards$1 = IconCards;

export { IconCards$1 as default };
//# sourceMappingURL=IconCards.svelte.js.map
