...
/* src/icons/IconAnkh.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ankh" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAnkh extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAnkh$1 = IconAnkh;

export { IconAnkh$1 as default };
//# sourceMappingURL=IconAnkh.svelte.js.map
