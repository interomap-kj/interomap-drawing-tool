...
/* src/icons/IconCurlyLoop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "curly-loop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCurlyLoop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCurlyLoop$1 = IconCurlyLoop;

export { IconCurlyLoop$1 as default };
//# sourceMappingURL=IconCurlyLoop.svelte.js.map
