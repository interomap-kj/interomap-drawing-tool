...
/* src/icons/IconFiretruck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "firetruck" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFiretruck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFiretruck$1 = IconFiretruck;

export { IconFiretruck$1 as default };
//# sourceMappingURL=IconFiretruck.svelte.js.map
