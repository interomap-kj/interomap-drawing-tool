...
/* src/icons/IconSmokingNo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "smoking-no" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSmokingNo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSmokingNo$1 = IconSmokingNo;

export { IconSmokingNo$1 as default };
//# sourceMappingURL=IconSmokingNo.svelte.js.map
