...
/* src/icons/IconBrandVite.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-vite" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandVite extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandVite$1 = IconBrandVite;

export { IconBrandVite$1 as default };
//# sourceMappingURL=IconBrandVite.svelte.js.map
