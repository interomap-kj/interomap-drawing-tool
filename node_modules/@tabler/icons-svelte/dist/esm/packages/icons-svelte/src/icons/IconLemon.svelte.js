...
/* src/icons/IconLemon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lemon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLemon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLemon$1 = IconLemon;

export { IconLemon$1 as default };
//# sourceMappingURL=IconLemon.svelte.js.map
