...
/* src/icons/IconWifi2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wifi-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWifi2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWifi2$1 = IconWifi2;

export { IconWifi2$1 as default };
//# sourceMappingURL=IconWifi2.svelte.js.map
