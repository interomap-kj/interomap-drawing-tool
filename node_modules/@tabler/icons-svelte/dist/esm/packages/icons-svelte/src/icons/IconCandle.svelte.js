...
/* src/icons/IconCandle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "candle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCandle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCandle$1 = IconCandle;

export { IconCandle$1 as default };
//# sourceMappingURL=IconCandle.svelte.js.map
