...
/* src/icons/IconDeviceTv.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "device-tv" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDeviceTv extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeviceTv$1 = IconDeviceTv;

export { IconDeviceTv$1 as default };
//# sourceMappingURL=IconDeviceTv.svelte.js.map
