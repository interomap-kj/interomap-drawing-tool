...
/* src/icons/IconLetterT.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-t" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M6 4l12 0" }], ["path", { "d": "M12 4l0 16" }]];
...
class IconLetterT extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterT$1 = IconLetterT;

export { IconLetterT$1 as default };
//# sourceMappingURL=IconLetterT.svelte.js.map
