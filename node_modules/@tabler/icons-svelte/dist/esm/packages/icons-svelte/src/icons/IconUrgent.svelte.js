...
/* src/icons/IconUrgent.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "urgent" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUrgent extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUrgent$1 = IconUrgent;

export { IconUrgent$1 as default };
//# sourceMappingURL=IconUrgent.svelte.js.map
