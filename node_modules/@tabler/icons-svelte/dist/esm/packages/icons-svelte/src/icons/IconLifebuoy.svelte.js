...
/* src/icons/IconLifebuoy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lifebuoy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLifebuoy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLifebuoy$1 = IconLifebuoy;

export { IconLifebuoy$1 as default };
//# sourceMappingURL=IconLifebuoy.svelte.js.map
