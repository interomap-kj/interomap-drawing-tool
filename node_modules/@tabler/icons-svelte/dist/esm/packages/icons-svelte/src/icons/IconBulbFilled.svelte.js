...
/* src/icons/IconBulbFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bulb-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBulbFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBulbFilled$1 = IconBulbFilled;

export { IconBulbFilled$1 as default };
//# sourceMappingURL=IconBulbFilled.svelte.js.map
