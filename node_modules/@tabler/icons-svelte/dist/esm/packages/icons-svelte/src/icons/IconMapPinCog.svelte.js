...
/* src/icons/IconMapPinCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-pin-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapPinCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPinCog$1 = IconMapPinCog;

export { IconMapPinCog$1 as default };
//# sourceMappingURL=IconMapPinCog.svelte.js.map
