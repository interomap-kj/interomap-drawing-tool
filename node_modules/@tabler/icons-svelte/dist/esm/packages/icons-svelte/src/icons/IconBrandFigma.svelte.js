...
/* src/icons/IconBrandFigma.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-figma" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandFigma extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandFigma$1 = IconBrandFigma;

export { IconBrandFigma$1 as default };
//# sourceMappingURL=IconBrandFigma.svelte.js.map
