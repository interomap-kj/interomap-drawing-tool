...
/* src/icons/IconCut.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cut" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCut extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCut$1 = IconCut;

export { IconCut$1 as default };
//# sourceMappingURL=IconCut.svelte.js.map
