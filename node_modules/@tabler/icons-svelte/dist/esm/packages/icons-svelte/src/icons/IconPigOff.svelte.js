...
/* src/icons/IconPigOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pig-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPigOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPigOff$1 = IconPigOff;

export { IconPigOff$1 as default };
//# sourceMappingURL=IconPigOff.svelte.js.map
