...
/* src/icons/IconGradienter.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gradienter" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGradienter extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGradienter$1 = IconGradienter;

export { IconGradienter$1 as default };
//# sourceMappingURL=IconGradienter.svelte.js.map
