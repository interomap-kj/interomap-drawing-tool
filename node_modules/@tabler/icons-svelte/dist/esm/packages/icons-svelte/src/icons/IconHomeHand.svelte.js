...
/* src/icons/IconHomeHand.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-hand" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeHand extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeHand$1 = IconHomeHand;

export { IconHomeHand$1 as default };
//# sourceMappingURL=IconHomeHand.svelte.js.map
