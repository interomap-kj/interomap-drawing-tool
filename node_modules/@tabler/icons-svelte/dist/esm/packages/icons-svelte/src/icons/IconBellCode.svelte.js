...
/* src/icons/IconBellCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellCode$1 = IconBellCode;

export { IconBellCode$1 as default };
//# sourceMappingURL=IconBellCode.svelte.js.map
