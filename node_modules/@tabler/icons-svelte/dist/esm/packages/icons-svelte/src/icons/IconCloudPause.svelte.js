...
/* src/icons/IconCloudPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudPause$1 = IconCloudPause;

export { IconCloudPause$1 as default };
//# sourceMappingURL=IconCloudPause.svelte.js.map
