...
/* src/icons/IconPawOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "paw-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPawOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPawOff$1 = IconPawOff;

export { IconPawOff$1 as default };
//# sourceMappingURL=IconPawOff.svelte.js.map
