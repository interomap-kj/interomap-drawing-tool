...
/* src/icons/IconGrillFork.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grill-fork" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrillFork extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrillFork$1 = IconGrillFork;

export { IconGrillFork$1 as default };
//# sourceMappingURL=IconGrillFork.svelte.js.map
