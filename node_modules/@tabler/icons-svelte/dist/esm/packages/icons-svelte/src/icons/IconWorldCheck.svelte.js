...
/* src/icons/IconWorldCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldCheck$1 = IconWorldCheck;

export { IconWorldCheck$1 as default };
//# sourceMappingURL=IconWorldCheck.svelte.js.map
