...
/* src/icons/IconBrandNem.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-nem" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandNem extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandNem$1 = IconBrandNem;

export { IconBrandNem$1 as default };
//# sourceMappingURL=IconBrandNem.svelte.js.map
