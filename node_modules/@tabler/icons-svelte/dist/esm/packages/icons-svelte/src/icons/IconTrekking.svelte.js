...
/* src/icons/IconTrekking.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trekking" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrekking extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrekking$1 = IconTrekking;

export { IconTrekking$1 as default };
//# sourceMappingURL=IconTrekking.svelte.js.map
