...
/* src/icons/IconMoodCry.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-cry" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodCry extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodCry$1 = IconMoodCry;

export { IconMoodCry$1 as default };
//# sourceMappingURL=IconMoodCry.svelte.js.map
