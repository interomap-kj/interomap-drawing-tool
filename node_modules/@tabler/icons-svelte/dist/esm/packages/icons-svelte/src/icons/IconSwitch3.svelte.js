...
/* src/icons/IconSwitch3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "switch-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSwitch3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwitch3$1 = IconSwitch3;

export { IconSwitch3$1 as default };
//# sourceMappingURL=IconSwitch3.svelte.js.map
