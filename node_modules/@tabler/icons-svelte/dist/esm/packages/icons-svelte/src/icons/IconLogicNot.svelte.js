...
/* src/icons/IconLogicNot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logic-not" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogicNot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogicNot$1 = IconLogicNot;

export { IconLogicNot$1 as default };
//# sourceMappingURL=IconLogicNot.svelte.js.map
