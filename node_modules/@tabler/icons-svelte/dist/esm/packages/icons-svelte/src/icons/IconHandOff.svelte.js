...
/* src/icons/IconHandOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hand-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHandOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHandOff$1 = IconHandOff;

export { IconHandOff$1 as default };
//# sourceMappingURL=IconHandOff.svelte.js.map
