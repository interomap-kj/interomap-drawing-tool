...
/* src/icons/IconBrandWaze.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-waze" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandWaze extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandWaze$1 = IconBrandWaze;

export { IconBrandWaze$1 as default };
//# sourceMappingURL=IconBrandWaze.svelte.js.map
