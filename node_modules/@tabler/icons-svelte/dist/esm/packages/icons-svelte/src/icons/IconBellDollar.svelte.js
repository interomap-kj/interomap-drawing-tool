...
/* src/icons/IconBellDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellDollar$1 = IconBellDollar;

export { IconBellDollar$1 as default };
//# sourceMappingURL=IconBellDollar.svelte.js.map
