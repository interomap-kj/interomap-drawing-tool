...
/* src/icons/IconPlusEqual.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plus-equal" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlusEqual extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlusEqual$1 = IconPlusEqual;

export { IconPlusEqual$1 as default };
//# sourceMappingURL=IconPlusEqual.svelte.js.map
