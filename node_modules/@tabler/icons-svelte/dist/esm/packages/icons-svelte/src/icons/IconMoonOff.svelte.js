...
/* src/icons/IconMoonOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "moon-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoonOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoonOff$1 = IconMoonOff;

export { IconMoonOff$1 as default };
//# sourceMappingURL=IconMoonOff.svelte.js.map
