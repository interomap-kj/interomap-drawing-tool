...
/* src/icons/IconDiscGolf.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "disc-golf" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiscGolf extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiscGolf$1 = IconDiscGolf;

export { IconDiscGolf$1 as default };
//# sourceMappingURL=IconDiscGolf.svelte.js.map
