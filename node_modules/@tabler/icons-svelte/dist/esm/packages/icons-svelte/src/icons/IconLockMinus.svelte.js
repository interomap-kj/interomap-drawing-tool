...
/* src/icons/IconLockMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockMinus$1 = IconLockMinus;

export { IconLockMinus$1 as default };
//# sourceMappingURL=IconLockMinus.svelte.js.map
