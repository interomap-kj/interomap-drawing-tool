...
/* src/icons/IconScubaMask.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "scuba-mask" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScubaMask extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScubaMask$1 = IconScubaMask;

export { IconScubaMask$1 as default };
//# sourceMappingURL=IconScubaMask.svelte.js.map
