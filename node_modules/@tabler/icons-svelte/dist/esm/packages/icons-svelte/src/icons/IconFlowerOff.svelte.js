...
/* src/icons/IconFlowerOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flower-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlowerOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlowerOff$1 = IconFlowerOff;

export { IconFlowerOff$1 as default };
//# sourceMappingURL=IconFlowerOff.svelte.js.map
