...
/* src/icons/IconMeteor.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "meteor" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMeteor extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMeteor$1 = IconMeteor;

export { IconMeteor$1 as default };
//# sourceMappingURL=IconMeteor.svelte.js.map
