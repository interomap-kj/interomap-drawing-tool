...
/* src/icons/IconCookieMan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cookie-man" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCookieMan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCookieMan$1 = IconCookieMan;

export { IconCookieMan$1 as default };
//# sourceMappingURL=IconCookieMan.svelte.js.map
