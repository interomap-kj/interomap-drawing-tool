...
/* src/icons/IconAntennaOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "antenna-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAntennaOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAntennaOff$1 = IconAntennaOff;

export { IconAntennaOff$1 as default };
//# sourceMappingURL=IconAntennaOff.svelte.js.map
