...
/* src/icons/IconThumbDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "thumb-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconThumbDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconThumbDown$1 = IconThumbDown;

export { IconThumbDown$1 as default };
//# sourceMappingURL=IconThumbDown.svelte.js.map
