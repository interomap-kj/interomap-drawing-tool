...
/* src/icons/IconCloudCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudCheck$1 = IconCloudCheck;

export { IconCloudCheck$1 as default };
//# sourceMappingURL=IconCloudCheck.svelte.js.map
