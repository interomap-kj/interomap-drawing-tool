...
/* src/icons/IconLockCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockCode$1 = IconLockCode;

export { IconLockCode$1 as default };
//# sourceMappingURL=IconLockCode.svelte.js.map
