...
/* src/icons/IconHelmet.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "helmet" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHelmet extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHelmet$1 = IconHelmet;

export { IconHelmet$1 as default };
//# sourceMappingURL=IconHelmet.svelte.js.map
