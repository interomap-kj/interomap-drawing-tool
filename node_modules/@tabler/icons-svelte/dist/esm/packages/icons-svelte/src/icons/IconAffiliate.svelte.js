...
/* src/icons/IconAffiliate.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "affiliate" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAffiliate extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAffiliate$1 = IconAffiliate;

export { IconAffiliate$1 as default };
//# sourceMappingURL=IconAffiliate.svelte.js.map
