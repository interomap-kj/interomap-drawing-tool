...
/* src/icons/IconBrandPepsi.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-pepsi" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandPepsi extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandPepsi$1 = IconBrandPepsi;

export { IconBrandPepsi$1 as default };
//# sourceMappingURL=IconBrandPepsi.svelte.js.map
