...
/* src/icons/IconDialpad.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dialpad" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDialpad extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDialpad$1 = IconDialpad;

export { IconDialpad$1 as default };
//# sourceMappingURL=IconDialpad.svelte.js.map
