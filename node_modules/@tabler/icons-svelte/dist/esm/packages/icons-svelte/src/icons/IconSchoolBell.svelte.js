...
/* src/icons/IconSchoolBell.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "school-bell" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSchoolBell extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSchoolBell$1 = IconSchoolBell;

export { IconSchoolBell$1 as default };
//# sourceMappingURL=IconSchoolBell.svelte.js.map
