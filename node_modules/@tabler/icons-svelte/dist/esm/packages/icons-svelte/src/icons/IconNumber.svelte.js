...
/* src/icons/IconNumber.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumber extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber$1 = IconNumber;

export { IconNumber$1 as default };
//# sourceMappingURL=IconNumber.svelte.js.map
