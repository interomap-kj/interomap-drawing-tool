...
/* src/icons/IconH1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "h-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconH1 extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconH1$1 as default };
//# sourceMappingURL=IconH1.svelte.js.map
