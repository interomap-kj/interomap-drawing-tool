...
/* src/icons/IconBadgesOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badges-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgesOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgesOff$1 = IconBadgesOff;

export { IconBadgesOff$1 as default };
//# sourceMappingURL=IconBadgesOff.svelte.js.map
