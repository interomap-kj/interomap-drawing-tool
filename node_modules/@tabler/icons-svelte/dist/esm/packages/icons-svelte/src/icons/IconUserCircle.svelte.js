...
/* src/icons/IconUserCircle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-circle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserCircle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserCircle$1 = IconUserCircle;

export { IconUserCircle$1 as default };
//# sourceMappingURL=IconUserCircle.svelte.js.map
