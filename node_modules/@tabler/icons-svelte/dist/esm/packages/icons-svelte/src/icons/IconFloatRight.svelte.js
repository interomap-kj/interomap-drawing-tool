...
/* src/icons/IconFloatRight.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "float-right" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFloatRight extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFloatRight$1 = IconFloatRight;

export { IconFloatRight$1 as default };
//# sourceMappingURL=IconFloatRight.svelte.js.map
