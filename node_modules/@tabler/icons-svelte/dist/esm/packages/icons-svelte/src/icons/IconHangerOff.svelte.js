...
/* src/icons/IconHangerOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hanger-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHangerOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHangerOff$1 = IconHangerOff;

export { IconHangerOff$1 as default };
//# sourceMappingURL=IconHangerOff.svelte.js.map
