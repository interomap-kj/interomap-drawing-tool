...
/* src/icons/IconCategory2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "category-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCategory2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCategory2$1 = IconCategory2;

export { IconCategory2$1 as default };
//# sourceMappingURL=IconCategory2.svelte.js.map
