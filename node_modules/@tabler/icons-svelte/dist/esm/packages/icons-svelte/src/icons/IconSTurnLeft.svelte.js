...
/* src/icons/IconSTurnLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "s-turn-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSTurnLeft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSTurnLeft$1 = IconSTurnLeft;

export { IconSTurnLeft$1 as default };
//# sourceMappingURL=IconSTurnLeft.svelte.js.map
