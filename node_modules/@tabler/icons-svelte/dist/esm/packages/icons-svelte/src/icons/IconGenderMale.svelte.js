...
/* src/icons/IconGenderMale.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gender-male" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGenderMale extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGenderMale$1 = IconGenderMale;

export { IconGenderMale$1 as default };
//# sourceMappingURL=IconGenderMale.svelte.js.map
