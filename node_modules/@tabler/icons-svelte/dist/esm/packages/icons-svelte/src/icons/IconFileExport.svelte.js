...
/* src/icons/IconFileExport.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-export" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileExport extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileExport$1 = IconFileExport;

export { IconFileExport$1 as default };
//# sourceMappingURL=IconFileExport.svelte.js.map
