...
/* src/icons/IconLanguage.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "language" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLanguage extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLanguage$1 = IconLanguage;

export { IconLanguage$1 as default };
//# sourceMappingURL=IconLanguage.svelte.js.map
