...
/* src/icons/IconFilePencil.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-pencil" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilePencil extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilePencil$1 = IconFilePencil;

export { IconFilePencil$1 as default };
//# sourceMappingURL=IconFilePencil.svelte.js.map
