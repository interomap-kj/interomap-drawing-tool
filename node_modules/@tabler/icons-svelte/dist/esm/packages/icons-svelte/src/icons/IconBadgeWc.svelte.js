...
/* src/icons/IconBadgeWc.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-wc" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeWc extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeWc$1 = IconBadgeWc;

export { IconBadgeWc$1 as default };
//# sourceMappingURL=IconBadgeWc.svelte.js.map
