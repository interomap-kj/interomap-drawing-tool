...
/* src/icons/IconTagOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tag-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTagOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTagOff$1 = IconTagOff;

export { IconTagOff$1 as default };
//# sourceMappingURL=IconTagOff.svelte.js.map
