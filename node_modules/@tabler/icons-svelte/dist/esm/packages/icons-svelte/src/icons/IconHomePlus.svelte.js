...
/* src/icons/IconHomePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomePlus$1 = IconHomePlus;

export { IconHomePlus$1 as default };
//# sourceMappingURL=IconHomePlus.svelte.js.map
