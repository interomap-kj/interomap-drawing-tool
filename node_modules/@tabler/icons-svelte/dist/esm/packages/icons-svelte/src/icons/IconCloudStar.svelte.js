...
/* src/icons/IconCloudStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudStar$1 = IconCloudStar;

export { IconCloudStar$1 as default };
//# sourceMappingURL=IconCloudStar.svelte.js.map
