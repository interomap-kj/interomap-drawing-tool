...
/* src/icons/IconLetterQ.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-q" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterQ extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterQ$1 = IconLetterQ;

export { IconLetterQ$1 as default };
//# sourceMappingURL=IconLetterQ.svelte.js.map
