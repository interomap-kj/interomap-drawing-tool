...
/* src/icons/IconUserBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserBolt$1 = IconUserBolt;

export { IconUserBolt$1 as default };
//# sourceMappingURL=IconUserBolt.svelte.js.map
