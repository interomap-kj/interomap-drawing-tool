...
/* src/icons/IconMickey.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mickey" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMickey extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMickey$1 = IconMickey;

export { IconMickey$1 as default };
//# sourceMappingURL=IconMickey.svelte.js.map
