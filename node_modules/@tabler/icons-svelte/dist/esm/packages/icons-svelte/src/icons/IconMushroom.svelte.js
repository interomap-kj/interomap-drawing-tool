...
/* src/icons/IconMushroom.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mushroom" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMushroom extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMushroom$1 = IconMushroom;

export { IconMushroom$1 as default };
//# sourceMappingURL=IconMushroom.svelte.js.map
