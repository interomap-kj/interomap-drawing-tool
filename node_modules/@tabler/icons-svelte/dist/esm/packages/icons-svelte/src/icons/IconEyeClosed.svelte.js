...
/* src/icons/IconEyeClosed.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-closed" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeClosed extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeClosed$1 = IconEyeClosed;

export { IconEyeClosed$1 as default };
//# sourceMappingURL=IconEyeClosed.svelte.js.map
