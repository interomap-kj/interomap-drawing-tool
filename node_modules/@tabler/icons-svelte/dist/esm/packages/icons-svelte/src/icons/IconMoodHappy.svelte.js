...
/* src/icons/IconMoodHappy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-happy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodHappy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodHappy$1 = IconMoodHappy;

export { IconMoodHappy$1 as default };
//# sourceMappingURL=IconMoodHappy.svelte.js.map
