...
/* src/icons/IconChecks.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "checks" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChecks extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChecks$1 = IconChecks;

export { IconChecks$1 as default };
//# sourceMappingURL=IconChecks.svelte.js.map
