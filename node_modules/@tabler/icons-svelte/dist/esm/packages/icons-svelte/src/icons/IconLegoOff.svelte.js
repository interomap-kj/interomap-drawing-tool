...
/* src/icons/IconLegoOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lego-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLegoOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLegoOff$1 = IconLegoOff;

export { IconLegoOff$1 as default };
//# sourceMappingURL=IconLegoOff.svelte.js.map
