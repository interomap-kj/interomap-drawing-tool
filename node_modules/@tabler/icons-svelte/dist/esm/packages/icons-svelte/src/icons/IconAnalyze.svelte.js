...
/* src/icons/IconAnalyze.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "analyze" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAnalyze extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAnalyze$1 = IconAnalyze;

export { IconAnalyze$1 as default };
//# sourceMappingURL=IconAnalyze.svelte.js.map
