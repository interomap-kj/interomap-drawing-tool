...
/* src/icons/IconShipOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ship-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShipOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShipOff$1 = IconShipOff;

export { IconShipOff$1 as default };
//# sourceMappingURL=IconShipOff.svelte.js.map
