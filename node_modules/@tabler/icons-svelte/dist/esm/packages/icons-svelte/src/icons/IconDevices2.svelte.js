...
/* src/icons/IconDevices2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevices2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevices2$1 = IconDevices2;

export { IconDevices2$1 as default };
//# sourceMappingURL=IconDevices2.svelte.js.map
