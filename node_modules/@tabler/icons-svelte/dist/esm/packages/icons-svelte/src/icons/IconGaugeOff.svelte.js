...
/* src/icons/IconGaugeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gauge-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGaugeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGaugeOff$1 = IconGaugeOff;

export { IconGaugeOff$1 as default };
//# sourceMappingURL=IconGaugeOff.svelte.js.map
