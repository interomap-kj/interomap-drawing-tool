...
/* src/icons/IconMailAi.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-ai" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailAi extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailAi$1 = IconMailAi;

export { IconMailAi$1 as default };
//# sourceMappingURL=IconMailAi.svelte.js.map
