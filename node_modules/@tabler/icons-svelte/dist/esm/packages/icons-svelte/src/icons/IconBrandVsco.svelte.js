...
/* src/icons/IconBrandVsco.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-vsco" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandVsco extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandVsco$1 = IconBrandVsco;

export { IconBrandVsco$1 as default };
//# sourceMappingURL=IconBrandVsco.svelte.js.map
