...
/* src/icons/IconBrandVimeo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-vimeo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandVimeo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandVimeo$1 = IconBrandVimeo;

export { IconBrandVimeo$1 as default };
//# sourceMappingURL=IconBrandVimeo.svelte.js.map
