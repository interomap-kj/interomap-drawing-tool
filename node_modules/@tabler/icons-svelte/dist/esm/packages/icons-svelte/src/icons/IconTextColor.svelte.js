...
/* src/icons/IconTextColor.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "text-color" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTextColor extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTextColor$1 = IconTextColor;

export { IconTextColor$1 as default };
//# sourceMappingURL=IconTextColor.svelte.js.map
