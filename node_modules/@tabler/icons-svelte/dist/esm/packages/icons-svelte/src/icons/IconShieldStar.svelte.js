...
/* src/icons/IconShieldStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldStar$1 = IconShieldStar;

export { IconShieldStar$1 as default };
//# sourceMappingURL=IconShieldStar.svelte.js.map
