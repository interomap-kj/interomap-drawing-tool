...
/* src/icons/IconEyeFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeFilled$1 = IconEyeFilled;

export { IconEyeFilled$1 as default };
//# sourceMappingURL=IconEyeFilled.svelte.js.map
