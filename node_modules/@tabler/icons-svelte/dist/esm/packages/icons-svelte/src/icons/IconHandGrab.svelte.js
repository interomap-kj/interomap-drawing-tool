...
/* src/icons/IconHandGrab.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hand-grab" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHandGrab extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHandGrab$1 = IconHandGrab;

export { IconHandGrab$1 as default };
//# sourceMappingURL=IconHandGrab.svelte.js.map
