...
/* src/icons/IconPlantOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plant-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlantOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlantOff$1 = IconPlantOff;

export { IconPlantOff$1 as default };
//# sourceMappingURL=IconPlantOff.svelte.js.map
