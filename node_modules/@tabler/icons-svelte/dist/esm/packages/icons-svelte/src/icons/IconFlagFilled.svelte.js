...
/* src/icons/IconFlagFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlagFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlagFilled$1 = IconFlagFilled;

export { IconFlagFilled$1 as default };
//# sourceMappingURL=IconFlagFilled.svelte.js.map
