...
/* src/icons/IconBrandHexo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-hexo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandHexo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandHexo$1 = IconBrandHexo;

export { IconBrandHexo$1 as default };
//# sourceMappingURL=IconBrandHexo.svelte.js.map
