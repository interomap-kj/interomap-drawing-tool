...
/* src/icons/IconBrandYahoo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-yahoo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandYahoo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandYahoo$1 = IconBrandYahoo;

export { IconBrandYahoo$1 as default };
//# sourceMappingURL=IconBrandYahoo.svelte.js.map
