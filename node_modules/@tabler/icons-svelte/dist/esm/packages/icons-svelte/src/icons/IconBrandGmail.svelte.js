...
/* src/icons/IconBrandGmail.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-gmail" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandGmail extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandGmail$1 = IconBrandGmail;

export { IconBrandGmail$1 as default };
//# sourceMappingURL=IconBrandGmail.svelte.js.map
