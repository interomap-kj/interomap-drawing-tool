...
/* src/icons/IconXboxB.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "xbox-b" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconXboxB extends SvelteComponent {
	constructor(options) {
		super();
...
var IconXboxB$1 = IconXboxB;

export { IconXboxB$1 as default };
//# sourceMappingURL=IconXboxB.svelte.js.map
