...
/* src/icons/IconWifi0.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wifi-0" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M12 18l.01 0" }]];
...
class IconWifi0 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWifi0$1 = IconWifi0;

export { IconWifi0$1 as default };
//# sourceMappingURL=IconWifi0.svelte.js.map
