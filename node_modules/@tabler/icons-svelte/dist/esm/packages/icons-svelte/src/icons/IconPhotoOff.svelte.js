...
/* src/icons/IconPhotoOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoOff$1 = IconPhotoOff;

export { IconPhotoOff$1 as default };
//# sourceMappingURL=IconPhotoOff.svelte.js.map
