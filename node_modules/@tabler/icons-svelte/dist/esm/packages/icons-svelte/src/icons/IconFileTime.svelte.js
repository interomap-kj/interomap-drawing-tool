...
/* src/icons/IconFileTime.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-time" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileTime extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileTime$1 = IconFileTime;

export { IconFileTime$1 as default };
//# sourceMappingURL=IconFileTime.svelte.js.map
