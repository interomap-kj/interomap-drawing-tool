...
/* src/icons/IconPhotoBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoBolt$1 = IconPhotoBolt;

export { IconPhotoBolt$1 as default };
//# sourceMappingURL=IconPhotoBolt.svelte.js.map
