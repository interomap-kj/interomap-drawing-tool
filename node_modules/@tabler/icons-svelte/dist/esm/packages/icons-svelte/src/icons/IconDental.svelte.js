...
/* src/icons/IconDental.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dental" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDental extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDental$1 = IconDental;

export { IconDental$1 as default };
//# sourceMappingURL=IconDental.svelte.js.map
