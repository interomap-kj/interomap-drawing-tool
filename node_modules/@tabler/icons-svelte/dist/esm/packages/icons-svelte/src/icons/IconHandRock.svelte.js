...
/* src/icons/IconHandRock.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hand-rock" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHandRock extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHandRock$1 = IconHandRock;

export { IconHandRock$1 as default };
//# sourceMappingURL=IconHandRock.svelte.js.map
