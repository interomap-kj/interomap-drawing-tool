...
/* src/icons/IconTree.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tree" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTree extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTree$1 = IconTree;

export { IconTree$1 as default };
//# sourceMappingURL=IconTree.svelte.js.map
