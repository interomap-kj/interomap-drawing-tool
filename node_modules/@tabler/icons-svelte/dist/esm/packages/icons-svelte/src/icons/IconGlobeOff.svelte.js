...
/* src/icons/IconGlobeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "globe-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGlobeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGlobeOff$1 = IconGlobeOff;

export { IconGlobeOff$1 as default };
//# sourceMappingURL=IconGlobeOff.svelte.js.map
