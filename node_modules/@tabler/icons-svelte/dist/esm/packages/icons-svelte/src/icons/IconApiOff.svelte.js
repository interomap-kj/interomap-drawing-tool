...
/* src/icons/IconApiOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "api-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconApiOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconApiOff$1 = IconApiOff;

export { IconApiOff$1 as default };
//# sourceMappingURL=IconApiOff.svelte.js.map
