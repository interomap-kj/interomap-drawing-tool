...
/* src/icons/IconPhotoDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoDown$1 = IconPhotoDown;

export { IconPhotoDown$1 as default };
//# sourceMappingURL=IconPhotoDown.svelte.js.map
