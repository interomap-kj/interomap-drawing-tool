...
/* src/icons/IconPointerUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pointer-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPointerUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPointerUp$1 = IconPointerUp;

export { IconPointerUp$1 as default };
//# sourceMappingURL=IconPointerUp.svelte.js.map
