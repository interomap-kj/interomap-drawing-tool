...
/* src/icons/IconBellCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellCog$1 = IconBellCog;

export { IconBellCog$1 as default };
//# sourceMappingURL=IconBellCog.svelte.js.map
