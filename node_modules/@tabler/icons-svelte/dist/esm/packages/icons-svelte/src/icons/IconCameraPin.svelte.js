...
/* src/icons/IconCameraPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraPin$1 = IconCameraPin;

export { IconCameraPin$1 as default };
//# sourceMappingURL=IconCameraPin.svelte.js.map
