...
/* src/icons/IconGiftCard.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gift-card" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGiftCard extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGiftCard$1 = IconGiftCard;

export { IconGiftCard$1 as default };
//# sourceMappingURL=IconGiftCard.svelte.js.map
