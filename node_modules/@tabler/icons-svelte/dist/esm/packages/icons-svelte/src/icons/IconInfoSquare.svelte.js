...
/* src/icons/IconInfoSquare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "info-square" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconInfoSquare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconInfoSquare$1 = IconInfoSquare;

export { IconInfoSquare$1 as default };
//# sourceMappingURL=IconInfoSquare.svelte.js.map
