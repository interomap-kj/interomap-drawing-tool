...
/* src/icons/IconMailHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailHeart$1 = IconMailHeart;

export { IconMailHeart$1 as default };
//# sourceMappingURL=IconMailHeart.svelte.js.map
