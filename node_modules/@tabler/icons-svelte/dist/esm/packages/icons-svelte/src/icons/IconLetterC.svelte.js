...
/* src/icons/IconLetterC.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-c" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterC extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterC$1 = IconLetterC;

export { IconLetterC$1 as default };
//# sourceMappingURL=IconLetterC.svelte.js.map
