...
/* src/icons/IconIconsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "icons-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIconsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIconsOff$1 = IconIconsOff;

export { IconIconsOff$1 as default };
//# sourceMappingURL=IconIconsOff.svelte.js.map
