...
/* src/icons/IconToolsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tools-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconToolsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconToolsOff$1 = IconToolsOff;

export { IconToolsOff$1 as default };
//# sourceMappingURL=IconToolsOff.svelte.js.map
