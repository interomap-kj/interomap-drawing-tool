...
/* src/icons/IconMathMin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-min" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMathMin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathMin$1 = IconMathMin;

export { IconMathMin$1 as default };
//# sourceMappingURL=IconMathMin.svelte.js.map
