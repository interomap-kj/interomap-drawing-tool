...
/* src/icons/IconSignature.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signature" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignature extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignature$1 = IconSignature;

export { IconSignature$1 as default };
//# sourceMappingURL=IconSignature.svelte.js.map
