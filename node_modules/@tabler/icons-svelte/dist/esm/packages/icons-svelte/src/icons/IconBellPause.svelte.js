...
/* src/icons/IconBellPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellPause$1 = IconBellPause;

export { IconBellPause$1 as default };
//# sourceMappingURL=IconBellPause.svelte.js.map
