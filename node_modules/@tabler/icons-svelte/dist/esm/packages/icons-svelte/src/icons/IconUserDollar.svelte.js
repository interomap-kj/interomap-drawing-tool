...
/* src/icons/IconUserDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserDollar$1 = IconUserDollar;

export { IconUserDollar$1 as default };
//# sourceMappingURL=IconUserDollar.svelte.js.map
