...
/* src/icons/IconTiltShift.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tilt-shift" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTiltShift extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTiltShift$1 = IconTiltShift;

export { IconTiltShift$1 as default };
//# sourceMappingURL=IconTiltShift.svelte.js.map
