...
/* src/icons/IconWritingOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "writing-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWritingOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWritingOff$1 = IconWritingOff;

export { IconWritingOff$1 as default };
//# sourceMappingURL=IconWritingOff.svelte.js.map
