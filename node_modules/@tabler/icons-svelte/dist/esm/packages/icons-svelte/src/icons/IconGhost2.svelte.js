...
/* src/icons/IconGhost2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ghost-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGhost2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGhost2$1 = IconGhost2;

export { IconGhost2$1 as default };
//# sourceMappingURL=IconGhost2.svelte.js.map
