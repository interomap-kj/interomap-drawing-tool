...
/* src/icons/IconLinkOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "link-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLinkOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLinkOff$1 = IconLinkOff;

export { IconLinkOff$1 as default };
//# sourceMappingURL=IconLinkOff.svelte.js.map
