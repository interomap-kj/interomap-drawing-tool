...
/* src/icons/IconMathOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMathOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathOff$1 = IconMathOff;

export { IconMathOff$1 as default };
//# sourceMappingURL=IconMathOff.svelte.js.map
