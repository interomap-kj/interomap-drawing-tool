...
/* src/icons/IconNumber6.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-6" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumber6 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber6$1 = IconNumber6;

export { IconNumber6$1 as default };
//# sourceMappingURL=IconNumber6.svelte.js.map
