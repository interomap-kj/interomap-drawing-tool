...
/* src/icons/IconFoldUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fold-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFoldUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFoldUp$1 = IconFoldUp;

export { IconFoldUp$1 as default };
//# sourceMappingURL=IconFoldUp.svelte.js.map
