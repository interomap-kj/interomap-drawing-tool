...
/* src/icons/IconGolfOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "golf-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGolfOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGolfOff$1 = IconGolfOff;

export { IconGolfOff$1 as default };
//# sourceMappingURL=IconGolfOff.svelte.js.map
