...
/* src/icons/IconTelescope.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "telescope" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTelescope extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTelescope$1 = IconTelescope;

export { IconTelescope$1 as default };
//# sourceMappingURL=IconTelescope.svelte.js.map
