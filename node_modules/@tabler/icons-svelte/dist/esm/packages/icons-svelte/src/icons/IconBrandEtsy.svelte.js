...
/* src/icons/IconBrandEtsy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-etsy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandEtsy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandEtsy$1 = IconBrandEtsy;

export { IconBrandEtsy$1 as default };
//# sourceMappingURL=IconBrandEtsy.svelte.js.map
