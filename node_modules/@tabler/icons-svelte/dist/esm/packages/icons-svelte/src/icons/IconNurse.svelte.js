...
/* src/icons/IconNurse.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "nurse" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNurse extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNurse$1 = IconNurse;

export { IconNurse$1 as default };
//# sourceMappingURL=IconNurse.svelte.js.map
