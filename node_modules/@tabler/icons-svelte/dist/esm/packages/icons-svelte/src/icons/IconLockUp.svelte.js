...
/* src/icons/IconLockUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockUp$1 = IconLockUp;

export { IconLockUp$1 as default };
//# sourceMappingURL=IconLockUp.svelte.js.map
