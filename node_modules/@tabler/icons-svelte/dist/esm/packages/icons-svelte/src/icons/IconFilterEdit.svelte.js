...
/* src/icons/IconFilterEdit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-edit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterEdit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterEdit$1 = IconFilterEdit;

export { IconFilterEdit$1 as default };
//# sourceMappingURL=IconFilterEdit.svelte.js.map
