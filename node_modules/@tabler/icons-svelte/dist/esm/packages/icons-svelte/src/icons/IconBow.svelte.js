...
/* src/icons/IconBow.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bow" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBow extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBow$1 = IconBow;

export { IconBow$1 as default };
//# sourceMappingURL=IconBow.svelte.js.map
