...
/* src/icons/IconBook2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "book-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBook2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBook2$1 = IconBook2;

export { IconBook2$1 as default };
//# sourceMappingURL=IconBook2.svelte.js.map
