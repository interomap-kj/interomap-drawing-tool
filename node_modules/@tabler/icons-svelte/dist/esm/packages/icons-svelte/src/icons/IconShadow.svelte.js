...
/* src/icons/IconShadow.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shadow" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShadow extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShadow$1 = IconShadow;

export { IconShadow$1 as default };
//# sourceMappingURL=IconShadow.svelte.js.map
