...
/* src/icons/IconShoeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shoe-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShoeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShoeOff$1 = IconShoeOff;

export { IconShoeOff$1 as default };
//# sourceMappingURL=IconShoeOff.svelte.js.map
