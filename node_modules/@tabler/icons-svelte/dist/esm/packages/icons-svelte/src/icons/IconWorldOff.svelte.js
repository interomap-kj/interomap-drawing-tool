...
/* src/icons/IconWorldOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldOff$1 = IconWorldOff;

export { IconWorldOff$1 as default };
//# sourceMappingURL=IconWorldOff.svelte.js.map
