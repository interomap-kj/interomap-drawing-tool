...
/* src/icons/IconLogicAnd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logic-and" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogicAnd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogicAnd$1 = IconLogicAnd;

export { IconLogicAnd$1 as default };
//# sourceMappingURL=IconLogicAnd.svelte.js.map
