...
/* src/icons/IconMathPi.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-pi" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMathPi extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathPi$1 = IconMathPi;

export { IconMathPi$1 as default };
//# sourceMappingURL=IconMathPi.svelte.js.map
