...
/* src/icons/IconSausage.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sausage" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSausage extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSausage$1 = IconSausage;

export { IconSausage$1 as default };
//# sourceMappingURL=IconSausage.svelte.js.map
