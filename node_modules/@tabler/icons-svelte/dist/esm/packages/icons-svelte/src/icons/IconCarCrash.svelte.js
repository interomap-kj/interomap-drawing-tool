...
/* src/icons/IconCarCrash.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "car-crash" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCarCrash extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCarCrash$1 = IconCarCrash;

export { IconCarCrash$1 as default };
//# sourceMappingURL=IconCarCrash.svelte.js.map
