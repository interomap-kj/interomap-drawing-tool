...
/* src/icons/IconCameraX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraX$1 = IconCameraX;

export { IconCameraX$1 as default };
//# sourceMappingURL=IconCameraX.svelte.js.map
