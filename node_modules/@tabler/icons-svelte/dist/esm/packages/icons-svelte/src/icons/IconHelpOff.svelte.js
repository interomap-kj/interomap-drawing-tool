...
/* src/icons/IconHelpOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "help-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHelpOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHelpOff$1 = IconHelpOff;

export { IconHelpOff$1 as default };
//# sourceMappingURL=IconHelpOff.svelte.js.map
