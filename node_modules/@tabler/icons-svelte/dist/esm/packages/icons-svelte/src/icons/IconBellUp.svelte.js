...
/* src/icons/IconBellUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellUp$1 = IconBellUp;

export { IconBellUp$1 as default };
//# sourceMappingURL=IconBellUp.svelte.js.map
