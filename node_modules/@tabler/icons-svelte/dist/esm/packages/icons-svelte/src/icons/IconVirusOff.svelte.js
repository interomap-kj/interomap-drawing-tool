...
/* src/icons/IconVirusOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "virus-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVirusOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVirusOff$1 = IconVirusOff;

export { IconVirusOff$1 as default };
//# sourceMappingURL=IconVirusOff.svelte.js.map
