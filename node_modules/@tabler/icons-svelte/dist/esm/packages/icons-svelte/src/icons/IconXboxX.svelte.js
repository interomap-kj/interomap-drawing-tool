...
/* src/icons/IconXboxX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "xbox-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconXboxX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconXboxX$1 = IconXboxX;

export { IconXboxX$1 as default };
//# sourceMappingURL=IconXboxX.svelte.js.map
