...
/* src/icons/IconArrowsDiff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrows-diff" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowsDiff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowsDiff$1 = IconArrowsDiff;

export { IconArrowsDiff$1 as default };
//# sourceMappingURL=IconArrowsDiff.svelte.js.map
