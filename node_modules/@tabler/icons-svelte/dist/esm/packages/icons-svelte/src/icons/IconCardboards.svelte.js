...
/* src/icons/IconCardboards.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cardboards" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCardboards extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCardboards$1 = IconCardboards;

export { IconCardboards$1 as default };
//# sourceMappingURL=IconCardboards.svelte.js.map
