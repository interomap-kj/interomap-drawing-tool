...
/* src/icons/IconWorldHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldHeart$1 = IconWorldHeart;

export { IconWorldHeart$1 as default };
//# sourceMappingURL=IconWorldHeart.svelte.js.map
