...
/* src/icons/IconVip.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vip" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVip extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVip$1 = IconVip;

export { IconVip$1 as default };
//# sourceMappingURL=IconVip.svelte.js.map
