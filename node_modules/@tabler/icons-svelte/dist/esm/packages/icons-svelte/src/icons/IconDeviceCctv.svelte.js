...
/* src/icons/IconDeviceCctv.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "device-cctv" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDeviceCctv extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeviceCctv$1 = IconDeviceCctv;

export { IconDeviceCctv$1 as default };
//# sourceMappingURL=IconDeviceCctv.svelte.js.map
