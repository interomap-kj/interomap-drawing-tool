...
/* src/icons/IconSdk.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sdk" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSdk extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSdk$1 = IconSdk;

export { IconSdk$1 as default };
//# sourceMappingURL=IconSdk.svelte.js.map
