...
/* src/icons/IconBellSchool.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-school" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellSchool extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellSchool$1 = IconBellSchool;

export { IconBellSchool$1 as default };
//# sourceMappingURL=IconBellSchool.svelte.js.map
