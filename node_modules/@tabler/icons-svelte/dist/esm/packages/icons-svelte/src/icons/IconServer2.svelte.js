...
/* src/icons/IconServer2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "server-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconServer2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconServer2$1 = IconServer2;

export { IconServer2$1 as default };
//# sourceMappingURL=IconServer2.svelte.js.map
