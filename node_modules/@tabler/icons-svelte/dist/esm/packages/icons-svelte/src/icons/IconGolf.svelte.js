...
/* src/icons/IconGolf.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "golf" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGolf extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGolf$1 = IconGolf;

export { IconGolf$1 as default };
//# sourceMappingURL=IconGolf.svelte.js.map
