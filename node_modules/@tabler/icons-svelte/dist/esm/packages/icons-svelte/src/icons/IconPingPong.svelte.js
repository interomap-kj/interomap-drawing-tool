...
/* src/icons/IconPingPong.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ping-pong" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPingPong extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPingPong$1 = IconPingPong;

export { IconPingPong$1 as default };
//# sourceMappingURL=IconPingPong.svelte.js.map
