...
/* src/icons/IconLetterN.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-n" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 20v-16l10 16v-16" }]];
...
class IconLetterN extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterN$1 = IconLetterN;

export { IconLetterN$1 as default };
//# sourceMappingURL=IconLetterN.svelte.js.map
