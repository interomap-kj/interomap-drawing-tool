...
/* src/icons/IconTool.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tool" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTool extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTool$1 = IconTool;

export { IconTool$1 as default };
//# sourceMappingURL=IconTool.svelte.js.map
