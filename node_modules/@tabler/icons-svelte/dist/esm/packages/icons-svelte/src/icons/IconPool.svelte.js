...
/* src/icons/IconPool.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pool" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPool extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPool$1 = IconPool;

export { IconPool$1 as default };
//# sourceMappingURL=IconPool.svelte.js.map
