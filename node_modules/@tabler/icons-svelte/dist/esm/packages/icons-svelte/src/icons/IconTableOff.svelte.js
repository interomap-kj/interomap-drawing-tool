...
/* src/icons/IconTableOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTableOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTableOff$1 = IconTableOff;

export { IconTableOff$1 as default };
//# sourceMappingURL=IconTableOff.svelte.js.map
