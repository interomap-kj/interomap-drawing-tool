...
/* src/icons/IconForbid.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "forbid" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconForbid extends SvelteComponent {
	constructor(options) {
		super();
...
var IconForbid$1 = IconForbid;

export { IconForbid$1 as default };
//# sourceMappingURL=IconForbid.svelte.js.map
