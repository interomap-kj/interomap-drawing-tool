...
/* src/icons/IconQrcode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "qrcode" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconQrcode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconQrcode$1 = IconQrcode;

export { IconQrcode$1 as default };
//# sourceMappingURL=IconQrcode.svelte.js.map
