...
/* src/icons/IconCloudBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudBolt$1 = IconCloudBolt;

export { IconCloudBolt$1 as default };
//# sourceMappingURL=IconCloudBolt.svelte.js.map
