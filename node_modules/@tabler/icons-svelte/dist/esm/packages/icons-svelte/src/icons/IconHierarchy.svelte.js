...
/* src/icons/IconHierarchy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hierarchy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHierarchy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHierarchy$1 = IconHierarchy;

export { IconHierarchy$1 as default };
//# sourceMappingURL=IconHierarchy.svelte.js.map
