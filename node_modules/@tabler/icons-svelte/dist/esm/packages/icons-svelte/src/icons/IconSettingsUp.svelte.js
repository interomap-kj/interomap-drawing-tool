...
/* src/icons/IconSettingsUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "settings-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSettingsUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSettingsUp$1 = IconSettingsUp;

export { IconSettingsUp$1 as default };
//# sourceMappingURL=IconSettingsUp.svelte.js.map
