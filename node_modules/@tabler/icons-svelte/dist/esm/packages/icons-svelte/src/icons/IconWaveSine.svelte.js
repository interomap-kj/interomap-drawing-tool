...
/* src/icons/IconWaveSine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wave-sine" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWaveSine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWaveSine$1 = IconWaveSine;

export { IconWaveSine$1 as default };
//# sourceMappingURL=IconWaveSine.svelte.js.map
