...
/* src/icons/IconFolderCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "folder-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFolderCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFolderCode$1 = IconFolderCode;

export { IconFolderCode$1 as default };
//# sourceMappingURL=IconFolderCode.svelte.js.map
