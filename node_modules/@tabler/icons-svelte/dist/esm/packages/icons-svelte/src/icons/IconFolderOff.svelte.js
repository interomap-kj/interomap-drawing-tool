...
/* src/icons/IconFolderOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "folder-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFolderOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFolderOff$1 = IconFolderOff;

export { IconFolderOff$1 as default };
//# sourceMappingURL=IconFolderOff.svelte.js.map
