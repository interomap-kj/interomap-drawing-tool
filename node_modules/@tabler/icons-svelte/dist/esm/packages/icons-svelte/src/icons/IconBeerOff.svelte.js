...
/* src/icons/IconBeerOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "beer-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBeerOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBeerOff$1 = IconBeerOff;

export { IconBeerOff$1 as default };
//# sourceMappingURL=IconBeerOff.svelte.js.map
