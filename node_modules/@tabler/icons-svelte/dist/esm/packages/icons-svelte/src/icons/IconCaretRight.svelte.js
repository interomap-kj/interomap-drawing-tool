...
/* src/icons/IconCaretRight.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "caret-right" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M10 18l6 -6l-6 -6v12" }]];
...
class IconCaretRight extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconCaretRight$1 as default };
//# sourceMappingURL=IconCaretRight.svelte.js.map
