...
/* src/icons/IconBadgeSd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-sd" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeSd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeSd$1 = IconBadgeSd;

export { IconBadgeSd$1 as default };
//# sourceMappingURL=IconBadgeSd.svelte.js.map
