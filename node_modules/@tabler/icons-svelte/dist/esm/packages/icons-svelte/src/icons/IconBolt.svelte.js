...
/* src/icons/IconBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBolt$1 = IconBolt;

export { IconBolt$1 as default };
//# sourceMappingURL=IconBolt.svelte.js.map
