...
/* src/icons/IconMoustache.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "moustache" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoustache extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoustache$1 = IconMoustache;

export { IconMoustache$1 as default };
//# sourceMappingURL=IconMoustache.svelte.js.map
