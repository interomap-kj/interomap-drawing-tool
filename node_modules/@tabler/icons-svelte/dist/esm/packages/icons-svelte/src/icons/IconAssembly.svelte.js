...
/* src/icons/IconAssembly.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "assembly" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAssembly extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAssembly$1 = IconAssembly;

export { IconAssembly$1 as default };
//# sourceMappingURL=IconAssembly.svelte.js.map
