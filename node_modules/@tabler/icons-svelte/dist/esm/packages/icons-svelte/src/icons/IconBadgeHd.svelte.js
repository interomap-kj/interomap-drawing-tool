...
/* src/icons/IconBadgeHd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-hd" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeHd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeHd$1 = IconBadgeHd;

export { IconBadgeHd$1 as default };
//# sourceMappingURL=IconBadgeHd.svelte.js.map
