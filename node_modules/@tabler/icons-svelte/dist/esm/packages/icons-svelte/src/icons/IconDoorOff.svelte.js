...
/* src/icons/IconDoorOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "door-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDoorOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDoorOff$1 = IconDoorOff;

export { IconDoorOff$1 as default };
//# sourceMappingURL=IconDoorOff.svelte.js.map
