...
/* src/icons/IconSquareF8.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f8" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF8 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF8$1 = IconSquareF8;

export { IconSquareF8$1 as default };
//# sourceMappingURL=IconSquareF8.svelte.js.map
