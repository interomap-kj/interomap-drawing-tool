...
/* src/icons/IconLocation.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "location" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLocation extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLocation$1 = IconLocation;

export { IconLocation$1 as default };
//# sourceMappingURL=IconLocation.svelte.js.map
