...
/* src/icons/IconFilterOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterOff$1 = IconFilterOff;

export { IconFilterOff$1 as default };
//# sourceMappingURL=IconFilterOff.svelte.js.map
