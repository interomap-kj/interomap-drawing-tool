...
/* src/icons/IconJacket.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "jacket" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconJacket extends SvelteComponent {
	constructor(options) {
		super();
...
var IconJacket$1 = IconJacket;

export { IconJacket$1 as default };
//# sourceMappingURL=IconJacket.svelte.js.map
