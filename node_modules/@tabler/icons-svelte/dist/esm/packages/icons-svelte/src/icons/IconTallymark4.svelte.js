...
/* src/icons/IconTallymark4.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tallymark-4" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTallymark4 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTallymark4$1 = IconTallymark4;

export { IconTallymark4$1 as default };
//# sourceMappingURL=IconTallymark4.svelte.js.map
