...
/* src/icons/IconTournament.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tournament" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTournament extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTournament$1 = IconTournament;

export { IconTournament$1 as default };
//# sourceMappingURL=IconTournament.svelte.js.map
