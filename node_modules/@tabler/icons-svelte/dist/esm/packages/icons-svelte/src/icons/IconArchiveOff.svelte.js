...
/* src/icons/IconArchiveOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "archive-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArchiveOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArchiveOff$1 = IconArchiveOff;

export { IconArchiveOff$1 as default };
//# sourceMappingURL=IconArchiveOff.svelte.js.map
