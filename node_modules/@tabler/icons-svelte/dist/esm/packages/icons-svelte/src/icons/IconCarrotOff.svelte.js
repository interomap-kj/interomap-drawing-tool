...
/* src/icons/IconCarrotOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "carrot-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCarrotOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCarrotOff$1 = IconCarrotOff;

export { IconCarrotOff$1 as default };
//# sourceMappingURL=IconCarrotOff.svelte.js.map
