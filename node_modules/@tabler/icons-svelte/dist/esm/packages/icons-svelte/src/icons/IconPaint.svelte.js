...
/* src/icons/IconPaint.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "paint" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPaint extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPaint$1 = IconPaint;

export { IconPaint$1 as default };
//# sourceMappingURL=IconPaint.svelte.js.map
