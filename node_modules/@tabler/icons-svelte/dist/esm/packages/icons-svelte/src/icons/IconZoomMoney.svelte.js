...
/* src/icons/IconZoomMoney.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-money" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomMoney extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomMoney$1 = IconZoomMoney;

export { IconZoomMoney$1 as default };
//# sourceMappingURL=IconZoomMoney.svelte.js.map
