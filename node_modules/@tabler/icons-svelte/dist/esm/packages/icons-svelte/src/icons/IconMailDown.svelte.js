...
/* src/icons/IconMailDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailDown$1 = IconMailDown;

export { IconMailDown$1 as default };
//# sourceMappingURL=IconMailDown.svelte.js.map
