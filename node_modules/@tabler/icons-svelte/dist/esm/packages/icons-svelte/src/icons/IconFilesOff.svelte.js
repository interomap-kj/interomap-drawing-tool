...
/* src/icons/IconFilesOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "files-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilesOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilesOff$1 = IconFilesOff;

export { IconFilesOff$1 as default };
//# sourceMappingURL=IconFilesOff.svelte.js.map
