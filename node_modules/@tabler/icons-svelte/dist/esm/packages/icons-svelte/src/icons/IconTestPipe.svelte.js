...
/* src/icons/IconTestPipe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "test-pipe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTestPipe extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTestPipe$1 = IconTestPipe;

export { IconTestPipe$1 as default };
//# sourceMappingURL=IconTestPipe.svelte.js.map
