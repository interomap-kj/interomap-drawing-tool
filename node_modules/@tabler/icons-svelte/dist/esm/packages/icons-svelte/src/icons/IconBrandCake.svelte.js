...
/* src/icons/IconBrandCake.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-cake" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandCake extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandCake$1 = IconBrandCake;

export { IconBrandCake$1 as default };
//# sourceMappingURL=IconBrandCake.svelte.js.map
