...
/* src/icons/IconEyeX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeX$1 = IconEyeX;

export { IconEyeX$1 as default };
//# sourceMappingURL=IconEyeX.svelte.js.map
