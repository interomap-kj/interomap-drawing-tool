...
/* src/icons/IconGrave.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grave" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrave extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrave$1 = IconGrave;

export { IconGrave$1 as default };
//# sourceMappingURL=IconGrave.svelte.js.map
