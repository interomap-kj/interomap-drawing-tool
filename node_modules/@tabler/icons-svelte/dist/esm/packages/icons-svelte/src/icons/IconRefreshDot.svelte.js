...
/* src/icons/IconRefreshDot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "refresh-dot" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRefreshDot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRefreshDot$1 = IconRefreshDot;

export { IconRefreshDot$1 as default };
//# sourceMappingURL=IconRefreshDot.svelte.js.map
