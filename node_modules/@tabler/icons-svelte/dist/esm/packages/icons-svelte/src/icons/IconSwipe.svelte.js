...
/* src/icons/IconSwipe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "swipe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSwipe extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwipe$1 = IconSwipe;

export { IconSwipe$1 as default };
//# sourceMappingURL=IconSwipe.svelte.js.map
