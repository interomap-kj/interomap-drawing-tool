...
/* src/icons/IconChartPie.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-pie" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartPie extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartPie$1 = IconChartPie;

export { IconChartPie$1 as default };
//# sourceMappingURL=IconChartPie.svelte.js.map
