...
/* src/icons/IconWashPress.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-press" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashPress extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashPress$1 = IconWashPress;

export { IconWashPress$1 as default };
//# sourceMappingURL=IconWashPress.svelte.js.map
