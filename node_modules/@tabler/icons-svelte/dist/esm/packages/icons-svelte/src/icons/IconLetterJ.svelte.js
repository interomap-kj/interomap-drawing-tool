...
/* src/icons/IconLetterJ.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-j" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterJ extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterJ$1 = IconLetterJ;

export { IconLetterJ$1 as default };
//# sourceMappingURL=IconLetterJ.svelte.js.map
