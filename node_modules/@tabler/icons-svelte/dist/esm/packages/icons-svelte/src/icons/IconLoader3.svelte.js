...
/* src/icons/IconLoader3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "loader-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLoader3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLoader3$1 = IconLoader3;

export { IconLoader3$1 as default };
//# sourceMappingURL=IconLoader3.svelte.js.map
