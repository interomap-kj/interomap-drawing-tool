...
/* src/icons/IconTerminal2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "terminal-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTerminal2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTerminal2$1 = IconTerminal2;

export { IconTerminal2$1 as default };
//# sourceMappingURL=IconTerminal2.svelte.js.map
