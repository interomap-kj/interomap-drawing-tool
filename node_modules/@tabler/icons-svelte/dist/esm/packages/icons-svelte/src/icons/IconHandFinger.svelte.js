...
/* src/icons/IconHandFinger.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hand-finger" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHandFinger extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHandFinger$1 = IconHandFinger;

export { IconHandFinger$1 as default };
//# sourceMappingURL=IconHandFinger.svelte.js.map
