...
/* src/icons/IconMoodPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodPlus$1 = IconMoodPlus;

export { IconMoodPlus$1 as default };
//# sourceMappingURL=IconMoodPlus.svelte.js.map
