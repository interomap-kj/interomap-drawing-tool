...
/* src/icons/IconSunHigh.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sun-high" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSunHigh extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSunHigh$1 = IconSunHigh;

export { IconSunHigh$1 as default };
//# sourceMappingURL=IconSunHigh.svelte.js.map
