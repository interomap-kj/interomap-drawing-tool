...
/* src/icons/IconFolderPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "folder-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFolderPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFolderPin$1 = IconFolderPin;

export { IconFolderPin$1 as default };
//# sourceMappingURL=IconFolderPin.svelte.js.map
