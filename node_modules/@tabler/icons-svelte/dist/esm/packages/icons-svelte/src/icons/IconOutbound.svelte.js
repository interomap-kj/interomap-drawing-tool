...
/* src/icons/IconOutbound.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "outbound" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOutbound extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOutbound$1 = IconOutbound;

export { IconOutbound$1 as default };
//# sourceMappingURL=IconOutbound.svelte.js.map
