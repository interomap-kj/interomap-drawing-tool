...
/* src/icons/IconDropletUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "droplet-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDropletUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDropletUp$1 = IconDropletUp;

export { IconDropletUp$1 as default };
//# sourceMappingURL=IconDropletUp.svelte.js.map
