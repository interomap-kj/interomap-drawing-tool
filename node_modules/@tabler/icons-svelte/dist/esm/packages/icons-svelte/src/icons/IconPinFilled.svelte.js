...
/* src/icons/IconPinFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pin-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPinFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPinFilled$1 = IconPinFilled;

export { IconPinFilled$1 as default };
//# sourceMappingURL=IconPinFilled.svelte.js.map
