...
/* src/icons/IconZodiacLeo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zodiac-leo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZodiacLeo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZodiacLeo$1 = IconZodiacLeo;

export { IconZodiacLeo$1 as default };
//# sourceMappingURL=IconZodiacLeo.svelte.js.map
