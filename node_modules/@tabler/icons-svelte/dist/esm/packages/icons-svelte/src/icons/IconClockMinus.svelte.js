...
/* src/icons/IconClockMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockMinus$1 = IconClockMinus;

export { IconClockMinus$1 as default };
//# sourceMappingURL=IconClockMinus.svelte.js.map
