...
/* src/icons/IconSeparator.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "separator" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSeparator extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSeparator$1 = IconSeparator;

export { IconSeparator$1 as default };
//# sourceMappingURL=IconSeparator.svelte.js.map
