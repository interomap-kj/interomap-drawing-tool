...
/* src/icons/IconStarsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stars-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStarsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStarsOff$1 = IconStarsOff;

export { IconStarsOff$1 as default };
//# sourceMappingURL=IconStarsOff.svelte.js.map
