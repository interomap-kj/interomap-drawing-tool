...
/* src/icons/IconCalendarUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "calendar-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCalendarUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCalendarUp$1 = IconCalendarUp;

export { IconCalendarUp$1 as default };
//# sourceMappingURL=IconCalendarUp.svelte.js.map
