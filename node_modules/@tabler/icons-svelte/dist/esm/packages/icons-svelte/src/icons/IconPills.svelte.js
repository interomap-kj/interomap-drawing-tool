...
/* src/icons/IconPills.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pills" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPills extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPills$1 = IconPills;

export { IconPills$1 as default };
//# sourceMappingURL=IconPills.svelte.js.map
