...
/* src/icons/IconBluetoothX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bluetooth-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBluetoothX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBluetoothX$1 = IconBluetoothX;

export { IconBluetoothX$1 as default };
//# sourceMappingURL=IconBluetoothX.svelte.js.map
