...
/* src/icons/IconEaseIn.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ease-in" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M3 20c8 0 18 -16 18 -16" }]];
...
class IconEaseIn extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEaseIn$1 = IconEaseIn;

export { IconEaseIn$1 as default };
//# sourceMappingURL=IconEaseIn.svelte.js.map
