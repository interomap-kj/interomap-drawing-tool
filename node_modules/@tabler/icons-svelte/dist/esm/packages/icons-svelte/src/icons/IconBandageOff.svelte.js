...
/* src/icons/IconBandageOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bandage-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBandageOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBandageOff$1 = IconBandageOff;

export { IconBandageOff$1 as default };
//# sourceMappingURL=IconBandageOff.svelte.js.map
