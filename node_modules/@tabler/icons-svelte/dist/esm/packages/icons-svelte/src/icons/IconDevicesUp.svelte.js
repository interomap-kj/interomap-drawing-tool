...
/* src/icons/IconDevicesUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevicesUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevicesUp$1 = IconDevicesUp;

export { IconDevicesUp$1 as default };
//# sourceMappingURL=IconDevicesUp.svelte.js.map
