...
/* src/icons/IconTestPipe2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "test-pipe-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTestPipe2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTestPipe2$1 = IconTestPipe2;

export { IconTestPipe2$1 as default };
//# sourceMappingURL=IconTestPipe2.svelte.js.map
