...
/* src/icons/IconApi.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "api" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconApi extends SvelteComponent {
	constructor(options) {
		super();
...
var IconApi$1 = IconApi;

export { IconApi$1 as default };
//# sourceMappingURL=IconApi.svelte.js.map
