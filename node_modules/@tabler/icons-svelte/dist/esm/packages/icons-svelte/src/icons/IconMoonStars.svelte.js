...
/* src/icons/IconMoonStars.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "moon-stars" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoonStars extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoonStars$1 = IconMoonStars;

export { IconMoonStars$1 as default };
//# sourceMappingURL=IconMoonStars.svelte.js.map
