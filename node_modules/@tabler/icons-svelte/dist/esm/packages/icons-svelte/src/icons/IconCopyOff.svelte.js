...
/* src/icons/IconCopyOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "copy-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCopyOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCopyOff$1 = IconCopyOff;

export { IconCopyOff$1 as default };
//# sourceMappingURL=IconCopyOff.svelte.js.map
