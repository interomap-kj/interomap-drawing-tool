...
/* src/icons/IconGardenCart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "garden-cart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGardenCart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGardenCart$1 = IconGardenCart;

export { IconGardenCart$1 as default };
//# sourceMappingURL=IconGardenCart.svelte.js.map
