...
/* src/icons/IconPlaneTilt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plane-tilt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlaneTilt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlaneTilt$1 = IconPlaneTilt;

export { IconPlaneTilt$1 as default };
//# sourceMappingURL=IconPlaneTilt.svelte.js.map
