...
/* src/icons/IconLetterL.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-l" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 4v16h10" }]];
...
class IconLetterL extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterL$1 = IconLetterL;

export { IconLetterL$1 as default };
//# sourceMappingURL=IconLetterL.svelte.js.map
