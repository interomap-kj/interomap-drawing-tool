...
/* src/icons/IconSeo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "seo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSeo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSeo$1 = IconSeo;

export { IconSeo$1 as default };
//# sourceMappingURL=IconSeo.svelte.js.map
