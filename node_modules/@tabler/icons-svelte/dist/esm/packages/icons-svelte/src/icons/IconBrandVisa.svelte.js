...
/* src/icons/IconBrandVisa.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-visa" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandVisa extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandVisa$1 = IconBrandVisa;

export { IconBrandVisa$1 as default };
//# sourceMappingURL=IconBrandVisa.svelte.js.map
