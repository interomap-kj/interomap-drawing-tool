...
/* src/icons/IconMars.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mars" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMars extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMars$1 = IconMars;

export { IconMars$1 as default };
//# sourceMappingURL=IconMars.svelte.js.map
