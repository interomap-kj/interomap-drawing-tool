...
/* src/icons/IconMeeple.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "meeple" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMeeple extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMeeple$1 = IconMeeple;

export { IconMeeple$1 as default };
//# sourceMappingURL=IconMeeple.svelte.js.map
