...
/* src/icons/IconBoxModel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "box-model" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoxModel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoxModel$1 = IconBoxModel;

export { IconBoxModel$1 as default };
//# sourceMappingURL=IconBoxModel.svelte.js.map
