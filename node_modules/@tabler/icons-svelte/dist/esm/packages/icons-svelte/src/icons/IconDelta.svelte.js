...
/* src/icons/IconDelta.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "delta" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M4 20h16l-8 -16z" }]];
...
class IconDelta extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDelta$1 = IconDelta;

export { IconDelta$1 as default };
//# sourceMappingURL=IconDelta.svelte.js.map
