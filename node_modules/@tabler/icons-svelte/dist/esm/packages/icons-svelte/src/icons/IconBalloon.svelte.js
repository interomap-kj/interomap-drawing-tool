...
/* src/icons/IconBalloon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "balloon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBalloon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBalloon$1 = IconBalloon;

export { IconBalloon$1 as default };
//# sourceMappingURL=IconBalloon.svelte.js.map
