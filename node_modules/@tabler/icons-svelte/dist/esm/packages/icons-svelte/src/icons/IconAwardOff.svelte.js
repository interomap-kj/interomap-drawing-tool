...
/* src/icons/IconAwardOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "award-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAwardOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAwardOff$1 = IconAwardOff;

export { IconAwardOff$1 as default };
//# sourceMappingURL=IconAwardOff.svelte.js.map
