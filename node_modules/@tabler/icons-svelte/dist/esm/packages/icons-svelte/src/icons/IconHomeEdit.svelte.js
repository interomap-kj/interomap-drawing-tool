...
/* src/icons/IconHomeEdit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-edit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeEdit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeEdit$1 = IconHomeEdit;

export { IconHomeEdit$1 as default };
//# sourceMappingURL=IconHomeEdit.svelte.js.map
