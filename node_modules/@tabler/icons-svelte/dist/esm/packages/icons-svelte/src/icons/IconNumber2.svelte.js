...
/* src/icons/IconNumber2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumber2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber2$1 = IconNumber2;

export { IconNumber2$1 as default };
//# sourceMappingURL=IconNumber2.svelte.js.map
