...
/* src/icons/IconBallpenOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ballpen-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBallpenOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBallpenOff$1 = IconBallpenOff;

export { IconBallpenOff$1 as default };
//# sourceMappingURL=IconBallpenOff.svelte.js.map
