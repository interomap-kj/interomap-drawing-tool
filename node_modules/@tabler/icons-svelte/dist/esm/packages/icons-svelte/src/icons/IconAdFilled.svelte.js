...
/* src/icons/IconAdFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ad-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAdFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAdFilled$1 = IconAdFilled;

export { IconAdFilled$1 as default };
//# sourceMappingURL=IconAdFilled.svelte.js.map
