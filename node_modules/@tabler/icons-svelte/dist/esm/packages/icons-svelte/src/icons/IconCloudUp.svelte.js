...
/* src/icons/IconCloudUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudUp$1 = IconCloudUp;

export { IconCloudUp$1 as default };
//# sourceMappingURL=IconCloudUp.svelte.js.map
