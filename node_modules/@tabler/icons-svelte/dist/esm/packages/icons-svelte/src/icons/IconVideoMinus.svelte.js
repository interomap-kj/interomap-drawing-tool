...
/* src/icons/IconVideoMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "video-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVideoMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVideoMinus$1 = IconVideoMinus;

export { IconVideoMinus$1 as default };
//# sourceMappingURL=IconVideoMinus.svelte.js.map
