...
/* src/icons/IconCursorOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cursor-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCursorOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCursorOff$1 = IconCursorOff;

export { IconCursorOff$1 as default };
//# sourceMappingURL=IconCursorOff.svelte.js.map
