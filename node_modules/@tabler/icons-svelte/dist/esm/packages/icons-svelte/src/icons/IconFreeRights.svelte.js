...
/* src/icons/IconFreeRights.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "free-rights" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFreeRights extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFreeRights$1 = IconFreeRights;

export { IconFreeRights$1 as default };
//# sourceMappingURL=IconFreeRights.svelte.js.map
