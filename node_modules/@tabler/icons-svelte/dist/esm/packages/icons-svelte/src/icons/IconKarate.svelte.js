...
/* src/icons/IconKarate.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "karate" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconKarate extends SvelteComponent {
	constructor(options) {
		super();
...
var IconKarate$1 = IconKarate;

export { IconKarate$1 as default };
//# sourceMappingURL=IconKarate.svelte.js.map
