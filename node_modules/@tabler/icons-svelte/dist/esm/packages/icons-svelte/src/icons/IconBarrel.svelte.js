...
/* src/icons/IconBarrel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "barrel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBarrel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBarrel$1 = IconBarrel;

export { IconBarrel$1 as default };
//# sourceMappingURL=IconBarrel.svelte.js.map
