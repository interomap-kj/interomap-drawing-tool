...
/* src/icons/IconNoteOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "note-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNoteOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNoteOff$1 = IconNoteOff;

export { IconNoteOff$1 as default };
//# sourceMappingURL=IconNoteOff.svelte.js.map
