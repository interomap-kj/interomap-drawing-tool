...
/* src/icons/IconFeatherOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "feather-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFeatherOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFeatherOff$1 = IconFeatherOff;

export { IconFeatherOff$1 as default };
//# sourceMappingURL=IconFeatherOff.svelte.js.map
