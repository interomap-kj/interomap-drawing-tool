...
/* src/icons/IconWorldShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldShare$1 = IconWorldShare;

export { IconWorldShare$1 as default };
//# sourceMappingURL=IconWorldShare.svelte.js.map
