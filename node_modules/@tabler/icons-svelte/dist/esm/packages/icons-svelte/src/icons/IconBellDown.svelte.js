...
/* src/icons/IconBellDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellDown$1 = IconBellDown;

export { IconBellDown$1 as default };
//# sourceMappingURL=IconBellDown.svelte.js.map
