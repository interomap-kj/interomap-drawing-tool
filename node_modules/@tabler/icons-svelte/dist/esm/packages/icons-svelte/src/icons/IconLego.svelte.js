...
/* src/icons/IconLego.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lego" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLego extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLego$1 = IconLego;

export { IconLego$1 as default };
//# sourceMappingURL=IconLego.svelte.js.map
