...
/* src/icons/IconMailCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailCancel$1 = IconMailCancel;

export { IconMailCancel$1 as default };
//# sourceMappingURL=IconMailCancel.svelte.js.map
