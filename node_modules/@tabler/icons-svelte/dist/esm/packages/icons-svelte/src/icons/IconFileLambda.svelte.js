...
/* src/icons/IconFileLambda.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-lambda" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileLambda extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileLambda$1 = IconFileLambda;

export { IconFileLambda$1 as default };
//# sourceMappingURL=IconFileLambda.svelte.js.map
