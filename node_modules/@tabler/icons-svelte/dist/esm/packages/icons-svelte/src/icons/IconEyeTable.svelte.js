...
/* src/icons/IconEyeTable.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-table" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeTable extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeTable$1 = IconEyeTable;

export { IconEyeTable$1 as default };
//# sourceMappingURL=IconEyeTable.svelte.js.map
