...
/* src/icons/IconBattery2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "battery-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBattery2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBattery2$1 = IconBattery2;

export { IconBattery2$1 as default };
//# sourceMappingURL=IconBattery2.svelte.js.map
