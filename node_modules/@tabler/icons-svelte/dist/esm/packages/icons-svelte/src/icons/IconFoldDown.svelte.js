...
/* src/icons/IconFoldDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fold-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFoldDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFoldDown$1 = IconFoldDown;

export { IconFoldDown$1 as default };
//# sourceMappingURL=IconFoldDown.svelte.js.map
