...
/* src/icons/IconMessage.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessage extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessage$1 = IconMessage;

export { IconMessage$1 as default };
//# sourceMappingURL=IconMessage.svelte.js.map
