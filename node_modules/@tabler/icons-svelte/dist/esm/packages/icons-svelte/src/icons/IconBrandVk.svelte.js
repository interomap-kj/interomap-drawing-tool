...
/* src/icons/IconBrandVk.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-vk" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandVk extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandVk$1 = IconBrandVk;

export { IconBrandVk$1 as default };
//# sourceMappingURL=IconBrandVk.svelte.js.map
