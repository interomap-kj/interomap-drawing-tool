...
/* src/icons/IconTimeline.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "timeline" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTimeline extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTimeline$1 = IconTimeline;

export { IconTimeline$1 as default };
//# sourceMappingURL=IconTimeline.svelte.js.map
