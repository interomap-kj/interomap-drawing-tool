...
/* src/icons/IconPhotoX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoX$1 = IconPhotoX;

export { IconPhotoX$1 as default };
//# sourceMappingURL=IconPhotoX.svelte.js.map
