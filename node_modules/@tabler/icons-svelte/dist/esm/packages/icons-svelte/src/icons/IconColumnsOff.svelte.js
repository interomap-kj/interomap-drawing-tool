...
/* src/icons/IconColumnsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "columns-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconColumnsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconColumnsOff$1 = IconColumnsOff;

export { IconColumnsOff$1 as default };
//# sourceMappingURL=IconColumnsOff.svelte.js.map
