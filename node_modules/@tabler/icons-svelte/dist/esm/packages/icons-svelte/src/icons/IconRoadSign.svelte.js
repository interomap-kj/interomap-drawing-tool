...
/* src/icons/IconRoadSign.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "road-sign" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRoadSign extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRoadSign$1 = IconRoadSign;

export { IconRoadSign$1 as default };
//# sourceMappingURL=IconRoadSign.svelte.js.map
