...
/* src/icons/IconSpaceOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "space-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpaceOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpaceOff$1 = IconSpaceOff;

export { IconSpaceOff$1 as default };
//# sourceMappingURL=IconSpaceOff.svelte.js.map
