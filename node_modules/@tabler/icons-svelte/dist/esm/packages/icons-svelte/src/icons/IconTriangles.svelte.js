...
/* src/icons/IconTriangles.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "triangles" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTriangles extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTriangles$1 = IconTriangles;

export { IconTriangles$1 as default };
//# sourceMappingURL=IconTriangles.svelte.js.map
