...
/* src/icons/IconLogin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "login" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogin$1 = IconLogin;

export { IconLogin$1 as default };
//# sourceMappingURL=IconLogin.svelte.js.map
