...
/* src/icons/IconGrowth.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "growth" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrowth extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrowth$1 = IconGrowth;

export { IconGrowth$1 as default };
//# sourceMappingURL=IconGrowth.svelte.js.map
