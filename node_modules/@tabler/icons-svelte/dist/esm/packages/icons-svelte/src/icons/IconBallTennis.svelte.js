...
/* src/icons/IconBallTennis.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ball-tennis" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBallTennis extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBallTennis$1 = IconBallTennis;

export { IconBallTennis$1 as default };
//# sourceMappingURL=IconBallTennis.svelte.js.map
