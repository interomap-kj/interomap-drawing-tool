...
/* src/icons/IconTransferIn.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "transfer-in" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTransferIn extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTransferIn$1 = IconTransferIn;

export { IconTransferIn$1 as default };
//# sourceMappingURL=IconTransferIn.svelte.js.map
