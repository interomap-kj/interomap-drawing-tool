...
/* src/icons/IconFloatLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "float-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFloatLeft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFloatLeft$1 = IconFloatLeft;

export { IconFloatLeft$1 as default };
//# sourceMappingURL=IconFloatLeft.svelte.js.map
