...
/* src/icons/IconCapture.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "capture" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCapture extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCapture$1 = IconCapture;

export { IconCapture$1 as default };
//# sourceMappingURL=IconCapture.svelte.js.map
