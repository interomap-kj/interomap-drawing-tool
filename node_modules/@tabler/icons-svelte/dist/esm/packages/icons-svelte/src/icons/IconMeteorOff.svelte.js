...
/* src/icons/IconMeteorOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "meteor-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMeteorOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMeteorOff$1 = IconMeteorOff;

export { IconMeteorOff$1 as default };
//# sourceMappingURL=IconMeteorOff.svelte.js.map
