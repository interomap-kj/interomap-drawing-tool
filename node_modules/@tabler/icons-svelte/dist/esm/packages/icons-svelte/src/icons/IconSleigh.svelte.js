...
/* src/icons/IconSleigh.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sleigh" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSleigh extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSleigh$1 = IconSleigh;

export { IconSleigh$1 as default };
//# sourceMappingURL=IconSleigh.svelte.js.map
