...
/* src/icons/IconWalletOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wallet-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWalletOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWalletOff$1 = IconWalletOff;

export { IconWalletOff$1 as default };
//# sourceMappingURL=IconWalletOff.svelte.js.map
