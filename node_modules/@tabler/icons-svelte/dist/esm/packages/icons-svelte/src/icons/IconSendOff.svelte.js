...
/* src/icons/IconSendOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "send-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSendOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSendOff$1 = IconSendOff;

export { IconSendOff$1 as default };
//# sourceMappingURL=IconSendOff.svelte.js.map
