...
/* src/icons/IconHeartbeat.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heartbeat" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartbeat extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartbeat$1 = IconHeartbeat;

export { IconHeartbeat$1 as default };
//# sourceMappingURL=IconHeartbeat.svelte.js.map
