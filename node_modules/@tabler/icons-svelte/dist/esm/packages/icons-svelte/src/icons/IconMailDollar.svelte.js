...
/* src/icons/IconMailDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailDollar$1 = IconMailDollar;

export { IconMailDollar$1 as default };
//# sourceMappingURL=IconMailDollar.svelte.js.map
