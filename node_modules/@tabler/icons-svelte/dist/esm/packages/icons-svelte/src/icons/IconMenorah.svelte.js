...
/* src/icons/IconMenorah.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "menorah" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMenorah extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMenorah$1 = IconMenorah;

export { IconMenorah$1 as default };
//# sourceMappingURL=IconMenorah.svelte.js.map
