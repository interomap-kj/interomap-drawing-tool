...
/* src/icons/IconFileFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileFilled$1 = IconFileFilled;

export { IconFileFilled$1 as default };
//# sourceMappingURL=IconFileFilled.svelte.js.map
