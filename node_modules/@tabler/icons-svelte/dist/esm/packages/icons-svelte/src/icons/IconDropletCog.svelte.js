...
/* src/icons/IconDropletCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "droplet-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDropletCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDropletCog$1 = IconDropletCog;

export { IconDropletCog$1 as default };
//# sourceMappingURL=IconDropletCog.svelte.js.map
