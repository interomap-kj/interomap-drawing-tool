...
/* src/icons/IconBusStop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bus-stop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBusStop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBusStop$1 = IconBusStop;

export { IconBusStop$1 as default };
//# sourceMappingURL=IconBusStop.svelte.js.map
