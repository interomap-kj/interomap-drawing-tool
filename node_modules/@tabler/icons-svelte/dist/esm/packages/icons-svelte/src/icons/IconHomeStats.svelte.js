...
/* src/icons/IconHomeStats.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-stats" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeStats extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeStats$1 = IconHomeStats;

export { IconHomeStats$1 as default };
//# sourceMappingURL=IconHomeStats.svelte.js.map
