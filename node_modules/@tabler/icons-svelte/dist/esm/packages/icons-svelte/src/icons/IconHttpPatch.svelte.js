...
/* src/icons/IconHttpPatch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-patch" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpPatch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpPatch$1 = IconHttpPatch;

export { IconHttpPatch$1 as default };
//# sourceMappingURL=IconHttpPatch.svelte.js.map
