...
/* src/icons/IconEPassport.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "e-passport" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEPassport extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEPassport$1 = IconEPassport;

export { IconEPassport$1 as default };
//# sourceMappingURL=IconEPassport.svelte.js.map
