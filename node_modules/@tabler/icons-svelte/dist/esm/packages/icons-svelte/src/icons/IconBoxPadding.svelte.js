...
/* src/icons/IconBoxPadding.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "box-padding" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoxPadding extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoxPadding$1 = IconBoxPadding;

export { IconBoxPadding$1 as default };
//# sourceMappingURL=IconBoxPadding.svelte.js.map
