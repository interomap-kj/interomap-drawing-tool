...
/* src/icons/IconKering.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "kering" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconKering extends SvelteComponent {
	constructor(options) {
		super();
...
var IconKering$1 = IconKering;

export { IconKering$1 as default };
//# sourceMappingURL=IconKering.svelte.js.map
