...
/* src/icons/IconUserCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserCancel$1 = IconUserCancel;

export { IconUserCancel$1 as default };
//# sourceMappingURL=IconUserCancel.svelte.js.map
