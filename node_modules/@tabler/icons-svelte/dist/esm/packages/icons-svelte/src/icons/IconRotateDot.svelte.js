...
/* src/icons/IconRotateDot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rotate-dot" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRotateDot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRotateDot$1 = IconRotateDot;

export { IconRotateDot$1 as default };
//# sourceMappingURL=IconRotateDot.svelte.js.map
