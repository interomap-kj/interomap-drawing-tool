...
/* src/icons/IconArrowsDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrows-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowsDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowsDown$1 = IconArrowsDown;

export { IconArrowsDown$1 as default };
//# sourceMappingURL=IconArrowsDown.svelte.js.map
