...
/* src/icons/IconAnalyzeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "analyze-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAnalyzeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAnalyzeOff$1 = IconAnalyzeOff;

export { IconAnalyzeOff$1 as default };
//# sourceMappingURL=IconAnalyzeOff.svelte.js.map
