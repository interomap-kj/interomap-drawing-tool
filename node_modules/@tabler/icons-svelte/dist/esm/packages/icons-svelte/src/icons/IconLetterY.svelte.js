...
/* src/icons/IconLetterY.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-y" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 4l5 9l5 -9" }], ["path", { "d": "M12 13l0 7" }]];
...
class IconLetterY extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterY$1 = IconLetterY;

export { IconLetterY$1 as default };
//# sourceMappingURL=IconLetterY.svelte.js.map
