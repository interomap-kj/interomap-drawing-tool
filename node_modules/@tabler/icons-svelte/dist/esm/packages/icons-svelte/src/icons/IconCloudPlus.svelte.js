...
/* src/icons/IconCloudPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudPlus$1 = IconCloudPlus;

export { IconCloudPlus$1 as default };
//# sourceMappingURL=IconCloudPlus.svelte.js.map
