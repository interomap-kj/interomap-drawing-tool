...
/* src/icons/IconEggFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "egg-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEggFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEggFilled$1 = IconEggFilled;

export { IconEggFilled$1 as default };
//# sourceMappingURL=IconEggFilled.svelte.js.map
