...
/* src/icons/IconBrandOpera.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-opera" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandOpera extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandOpera$1 = IconBrandOpera;

export { IconBrandOpera$1 as default };
//# sourceMappingURL=IconBrandOpera.svelte.js.map
