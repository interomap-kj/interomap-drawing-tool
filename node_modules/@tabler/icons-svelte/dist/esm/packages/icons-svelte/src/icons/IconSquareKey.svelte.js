...
/* src/icons/IconSquareKey.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-key" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareKey extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareKey$1 = IconSquareKey;

export { IconSquareKey$1 as default };
//# sourceMappingURL=IconSquareKey.svelte.js.map
