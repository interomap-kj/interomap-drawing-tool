...
/* src/icons/IconCameraPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraPlus$1 = IconCameraPlus;

export { IconCameraPlus$1 as default };
//# sourceMappingURL=IconCameraPlus.svelte.js.map
