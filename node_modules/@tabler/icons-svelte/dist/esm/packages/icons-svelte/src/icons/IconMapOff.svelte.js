...
/* src/icons/IconMapOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapOff$1 = IconMapOff;

export { IconMapOff$1 as default };
//# sourceMappingURL=IconMapOff.svelte.js.map
