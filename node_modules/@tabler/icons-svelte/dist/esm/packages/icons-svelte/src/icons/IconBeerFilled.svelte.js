...
/* src/icons/IconBeerFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "beer-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBeerFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBeerFilled$1 = IconBeerFilled;

export { IconBeerFilled$1 as default };
//# sourceMappingURL=IconBeerFilled.svelte.js.map
