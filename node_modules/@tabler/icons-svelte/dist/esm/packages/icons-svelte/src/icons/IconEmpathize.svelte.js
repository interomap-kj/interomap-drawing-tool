...
/* src/icons/IconEmpathize.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "empathize" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEmpathize extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEmpathize$1 = IconEmpathize;

export { IconEmpathize$1 as default };
//# sourceMappingURL=IconEmpathize.svelte.js.map
