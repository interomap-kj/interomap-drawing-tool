...
/* src/icons/IconTxt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "txt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTxt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTxt$1 = IconTxt;

export { IconTxt$1 as default };
//# sourceMappingURL=IconTxt.svelte.js.map
