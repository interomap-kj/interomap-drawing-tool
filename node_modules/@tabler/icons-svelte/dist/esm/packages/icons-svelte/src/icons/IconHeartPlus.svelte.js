...
/* src/icons/IconHeartPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartPlus$1 = IconHeartPlus;

export { IconHeartPlus$1 as default };
//# sourceMappingURL=IconHeartPlus.svelte.js.map
