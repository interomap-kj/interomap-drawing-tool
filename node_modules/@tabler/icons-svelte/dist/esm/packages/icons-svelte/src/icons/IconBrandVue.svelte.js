...
/* src/icons/IconBrandVue.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-vue" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandVue extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandVue$1 = IconBrandVue;

export { IconBrandVue$1 as default };
//# sourceMappingURL=IconBrandVue.svelte.js.map
