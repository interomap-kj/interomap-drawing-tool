...
/* src/icons/IconCup.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cup" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCup extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCup$1 = IconCup;

export { IconCup$1 as default };
//# sourceMappingURL=IconCup.svelte.js.map
