...
/* src/icons/IconCloudMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudMinus$1 = IconCloudMinus;

export { IconCloudMinus$1 as default };
//# sourceMappingURL=IconCloudMinus.svelte.js.map
