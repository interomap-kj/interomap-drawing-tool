...
/* src/icons/IconSquareF0.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f0" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF0 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF0$1 = IconSquareF0;

export { IconSquareF0$1 as default };
//# sourceMappingURL=IconSquareF0.svelte.js.map
