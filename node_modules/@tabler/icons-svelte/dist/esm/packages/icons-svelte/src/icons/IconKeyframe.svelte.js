...
/* src/icons/IconKeyframe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "keyframe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconKeyframe extends SvelteComponent {
	constructor(options) {
		super();
...
var IconKeyframe$1 = IconKeyframe;

export { IconKeyframe$1 as default };
//# sourceMappingURL=IconKeyframe.svelte.js.map
