...
/* src/icons/IconRosette.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rosette" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRosette extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRosette$1 = IconRosette;

export { IconRosette$1 as default };
//# sourceMappingURL=IconRosette.svelte.js.map
