...
/* src/icons/IconViewfinder.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "viewfinder" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconViewfinder extends SvelteComponent {
	constructor(options) {
		super();
...
var IconViewfinder$1 = IconViewfinder;

export { IconViewfinder$1 as default };
//# sourceMappingURL=IconViewfinder.svelte.js.map
