...
/* src/icons/IconPhonePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "phone-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhonePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhonePlus$1 = IconPhonePlus;

export { IconPhonePlus$1 as default };
//# sourceMappingURL=IconPhonePlus.svelte.js.map
