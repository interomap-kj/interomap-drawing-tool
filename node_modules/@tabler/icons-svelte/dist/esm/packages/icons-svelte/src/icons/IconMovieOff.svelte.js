...
/* src/icons/IconMovieOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "movie-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMovieOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMovieOff$1 = IconMovieOff;

export { IconMovieOff$1 as default };
//# sourceMappingURL=IconMovieOff.svelte.js.map
