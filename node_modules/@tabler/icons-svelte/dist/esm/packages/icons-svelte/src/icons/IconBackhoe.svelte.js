...
/* src/icons/IconBackhoe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "backhoe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBackhoe extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBackhoe$1 = IconBackhoe;

export { IconBackhoe$1 as default };
//# sourceMappingURL=IconBackhoe.svelte.js.map
