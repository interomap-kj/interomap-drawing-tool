...
/* src/icons/IconSunglasses.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sunglasses" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSunglasses extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSunglasses$1 = IconSunglasses;

export { IconSunglasses$1 as default };
//# sourceMappingURL=IconSunglasses.svelte.js.map
