...
/* src/icons/IconElevator.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "elevator" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconElevator extends SvelteComponent {
	constructor(options) {
		super();
...
var IconElevator$1 = IconElevator;

export { IconElevator$1 as default };
//# sourceMappingURL=IconElevator.svelte.js.map
