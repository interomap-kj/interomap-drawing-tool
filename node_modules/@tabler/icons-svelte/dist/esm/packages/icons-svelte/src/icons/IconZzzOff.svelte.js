...
/* src/icons/IconZzzOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zzz-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZzzOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZzzOff$1 = IconZzzOff;

export { IconZzzOff$1 as default };
//# sourceMappingURL=IconZzzOff.svelte.js.map
