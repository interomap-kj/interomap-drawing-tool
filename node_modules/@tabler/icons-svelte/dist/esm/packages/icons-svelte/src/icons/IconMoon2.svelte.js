...
/* src/icons/IconMoon2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "moon-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoon2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoon2$1 = IconMoon2;

export { IconMoon2$1 as default };
//# sourceMappingURL=IconMoon2.svelte.js.map
