...
/* src/icons/IconRainbowOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rainbow-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRainbowOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRainbowOff$1 = IconRainbowOff;

export { IconRainbowOff$1 as default };
//# sourceMappingURL=IconRainbowOff.svelte.js.map
