...
/* src/icons/IconBatteryOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "battery-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBatteryOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBatteryOff$1 = IconBatteryOff;

export { IconBatteryOff$1 as default };
//# sourceMappingURL=IconBatteryOff.svelte.js.map
