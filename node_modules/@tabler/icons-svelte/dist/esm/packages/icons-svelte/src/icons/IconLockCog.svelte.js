...
/* src/icons/IconLockCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockCog$1 = IconLockCog;

export { IconLockCog$1 as default };
//# sourceMappingURL=IconLockCog.svelte.js.map
