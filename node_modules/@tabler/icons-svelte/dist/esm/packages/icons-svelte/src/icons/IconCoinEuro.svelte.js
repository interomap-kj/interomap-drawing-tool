...
/* src/icons/IconCoinEuro.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-euro" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinEuro extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinEuro$1 = IconCoinEuro;

export { IconCoinEuro$1 as default };
//# sourceMappingURL=IconCoinEuro.svelte.js.map
