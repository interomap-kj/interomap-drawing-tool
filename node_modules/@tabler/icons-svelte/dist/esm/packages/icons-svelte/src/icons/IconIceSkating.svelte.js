...
/* src/icons/IconIceSkating.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ice-skating" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIceSkating extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIceSkating$1 = IconIceSkating;

export { IconIceSkating$1 as default };
//# sourceMappingURL=IconIceSkating.svelte.js.map
