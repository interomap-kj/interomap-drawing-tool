...
/* src/icons/IconDevicesX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevicesX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevicesX$1 = IconDevicesX;

export { IconDevicesX$1 as default };
//# sourceMappingURL=IconDevicesX.svelte.js.map
