...
/* src/icons/IconPolygonOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "polygon-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPolygonOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPolygonOff$1 = IconPolygonOff;

export { IconPolygonOff$1 as default };
//# sourceMappingURL=IconPolygonOff.svelte.js.map
