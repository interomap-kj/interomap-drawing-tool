...
/* src/icons/IconCloudHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudHeart$1 = IconCloudHeart;

export { IconCloudHeart$1 as default };
//# sourceMappingURL=IconCloudHeart.svelte.js.map
