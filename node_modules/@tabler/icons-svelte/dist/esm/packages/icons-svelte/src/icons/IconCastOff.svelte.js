...
/* src/icons/IconCastOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cast-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCastOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCastOff$1 = IconCastOff;

export { IconCastOff$1 as default };
//# sourceMappingURL=IconCastOff.svelte.js.map
