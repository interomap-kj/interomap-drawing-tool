...
/* src/icons/IconBrandBaidu.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-baidu" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandBaidu extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandBaidu$1 = IconBrandBaidu;

export { IconBrandBaidu$1 as default };
//# sourceMappingURL=IconBrandBaidu.svelte.js.map
