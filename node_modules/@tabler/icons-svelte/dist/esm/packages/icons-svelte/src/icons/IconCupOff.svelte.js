...
/* src/icons/IconCupOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cup-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCupOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCupOff$1 = IconCupOff;

export { IconCupOff$1 as default };
//# sourceMappingURL=IconCupOff.svelte.js.map
