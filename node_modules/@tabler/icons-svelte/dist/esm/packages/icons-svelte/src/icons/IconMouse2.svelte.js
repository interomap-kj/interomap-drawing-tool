...
/* src/icons/IconMouse2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mouse-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMouse2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMouse2$1 = IconMouse2;

export { IconMouse2$1 as default };
//# sourceMappingURL=IconMouse2.svelte.js.map
