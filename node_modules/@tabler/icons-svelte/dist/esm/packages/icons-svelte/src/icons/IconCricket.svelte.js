...
/* src/icons/IconCricket.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cricket" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCricket extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCricket$1 = IconCricket;

export { IconCricket$1 as default };
//# sourceMappingURL=IconCricket.svelte.js.map
