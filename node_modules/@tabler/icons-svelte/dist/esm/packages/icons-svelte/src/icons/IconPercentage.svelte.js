...
/* src/icons/IconPercentage.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "percentage" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPercentage extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPercentage$1 = IconPercentage;

export { IconPercentage$1 as default };
//# sourceMappingURL=IconPercentage.svelte.js.map
