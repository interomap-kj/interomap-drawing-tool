...
/* src/icons/IconSquareOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareOff$1 = IconSquareOff;

export { IconSquareOff$1 as default };
//# sourceMappingURL=IconSquareOff.svelte.js.map
