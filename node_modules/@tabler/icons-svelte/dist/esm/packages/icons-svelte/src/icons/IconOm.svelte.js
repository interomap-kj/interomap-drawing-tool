...
/* src/icons/IconOm.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "om" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOm extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconOm$1 as default };
//# sourceMappingURL=IconOm.svelte.js.map
