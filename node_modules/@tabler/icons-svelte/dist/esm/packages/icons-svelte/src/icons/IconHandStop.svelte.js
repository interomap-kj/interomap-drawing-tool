...
/* src/icons/IconHandStop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hand-stop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHandStop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHandStop$1 = IconHandStop;

export { IconHandStop$1 as default };
//# sourceMappingURL=IconHandStop.svelte.js.map
