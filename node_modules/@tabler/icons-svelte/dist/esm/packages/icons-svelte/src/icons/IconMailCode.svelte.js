...
/* src/icons/IconMailCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailCode$1 = IconMailCode;

export { IconMailCode$1 as default };
//# sourceMappingURL=IconMailCode.svelte.js.map
