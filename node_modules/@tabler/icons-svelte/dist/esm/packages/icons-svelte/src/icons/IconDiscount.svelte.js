...
/* src/icons/IconDiscount.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "discount" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiscount extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiscount$1 = IconDiscount;

export { IconDiscount$1 as default };
//# sourceMappingURL=IconDiscount.svelte.js.map
