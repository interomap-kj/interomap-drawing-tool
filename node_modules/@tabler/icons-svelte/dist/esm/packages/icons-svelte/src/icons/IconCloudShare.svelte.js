...
/* src/icons/IconCloudShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudShare$1 = IconCloudShare;

export { IconCloudShare$1 as default };
//# sourceMappingURL=IconCloudShare.svelte.js.map
