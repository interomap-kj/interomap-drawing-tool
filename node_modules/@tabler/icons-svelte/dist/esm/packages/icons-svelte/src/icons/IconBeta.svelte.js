...
/* src/icons/IconBeta.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "beta" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBeta extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBeta$1 = IconBeta;

export { IconBeta$1 as default };
//# sourceMappingURL=IconBeta.svelte.js.map
