...
/* src/icons/IconFishBone.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fish-bone" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFishBone extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFishBone$1 = IconFishBone;

export { IconFishBone$1 as default };
//# sourceMappingURL=IconFishBone.svelte.js.map
