...
/* src/icons/IconLockCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockCancel$1 = IconLockCancel;

export { IconLockCancel$1 as default };
//# sourceMappingURL=IconLockCancel.svelte.js.map
