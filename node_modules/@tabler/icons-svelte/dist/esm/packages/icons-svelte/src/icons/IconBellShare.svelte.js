...
/* src/icons/IconBellShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellShare$1 = IconBellShare;

export { IconBellShare$1 as default };
//# sourceMappingURL=IconBellShare.svelte.js.map
