...
/* src/icons/IconWash.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWash extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWash$1 = IconWash;

export { IconWash$1 as default };
//# sourceMappingURL=IconWash.svelte.js.map
