...
/* src/icons/IconYoga.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "yoga" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconYoga extends SvelteComponent {
	constructor(options) {
		super();
...
var IconYoga$1 = IconYoga;

export { IconYoga$1 as default };
//# sourceMappingURL=IconYoga.svelte.js.map
