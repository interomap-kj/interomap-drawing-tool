...
/* src/icons/IconWashDryF.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry-f" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDryF extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDryF$1 = IconWashDryF;

export { IconWashDryF$1 as default };
//# sourceMappingURL=IconWashDryF.svelte.js.map
