...
/* src/icons/IconAdOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ad-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAdOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAdOff$1 = IconAdOff;

export { IconAdOff$1 as default };
//# sourceMappingURL=IconAdOff.svelte.js.map
