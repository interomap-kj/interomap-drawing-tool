...
/* src/icons/IconMarkdown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "markdown" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMarkdown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMarkdown$1 = IconMarkdown;

export { IconMarkdown$1 as default };
//# sourceMappingURL=IconMarkdown.svelte.js.map
