...
/* src/icons/IconRecharging.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "recharging" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRecharging extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRecharging$1 = IconRecharging;

export { IconRecharging$1 as default };
//# sourceMappingURL=IconRecharging.svelte.js.map
