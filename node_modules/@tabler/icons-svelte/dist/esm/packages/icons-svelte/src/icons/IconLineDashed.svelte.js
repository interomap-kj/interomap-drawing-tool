...
/* src/icons/IconLineDashed.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "line-dashed" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLineDashed extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLineDashed$1 = IconLineDashed;

export { IconLineDashed$1 as default };
//# sourceMappingURL=IconLineDashed.svelte.js.map
