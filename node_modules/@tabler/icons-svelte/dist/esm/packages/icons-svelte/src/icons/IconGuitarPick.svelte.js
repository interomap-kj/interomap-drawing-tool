...
/* src/icons/IconGuitarPick.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "guitar-pick" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGuitarPick extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGuitarPick$1 = IconGuitarPick;

export { IconGuitarPick$1 as default };
//# sourceMappingURL=IconGuitarPick.svelte.js.map
