...
/* src/icons/IconDragDrop2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "drag-drop-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDragDrop2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDragDrop2$1 = IconDragDrop2;

export { IconDragDrop2$1 as default };
//# sourceMappingURL=IconDragDrop2.svelte.js.map
