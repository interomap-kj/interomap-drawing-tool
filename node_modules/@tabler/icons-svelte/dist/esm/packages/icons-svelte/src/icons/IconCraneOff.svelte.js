...
/* src/icons/IconCraneOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "crane-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCraneOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCraneOff$1 = IconCraneOff;

export { IconCraneOff$1 as default };
//# sourceMappingURL=IconCraneOff.svelte.js.map
