...
/* src/icons/IconPennant.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pennant" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPennant extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPennant$1 = IconPennant;

export { IconPennant$1 as default };
//# sourceMappingURL=IconPennant.svelte.js.map
