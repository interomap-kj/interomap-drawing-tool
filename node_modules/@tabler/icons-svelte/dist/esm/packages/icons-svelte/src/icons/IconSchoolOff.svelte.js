...
/* src/icons/IconSchoolOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "school-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSchoolOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSchoolOff$1 = IconSchoolOff;

export { IconSchoolOff$1 as default };
//# sourceMappingURL=IconSchoolOff.svelte.js.map
