...
/* src/icons/IconCubeSend.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cube-send" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCubeSend extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCubeSend$1 = IconCubeSend;

export { IconCubeSend$1 as default };
//# sourceMappingURL=IconCubeSend.svelte.js.map
