...
/* src/icons/IconPerspective.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "perspective" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPerspective extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPerspective$1 = IconPerspective;

export { IconPerspective$1 as default };
//# sourceMappingURL=IconPerspective.svelte.js.map
