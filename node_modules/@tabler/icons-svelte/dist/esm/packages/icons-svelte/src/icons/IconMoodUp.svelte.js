...
/* src/icons/IconMoodUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodUp$1 = IconMoodUp;

export { IconMoodUp$1 as default };
//# sourceMappingURL=IconMoodUp.svelte.js.map
