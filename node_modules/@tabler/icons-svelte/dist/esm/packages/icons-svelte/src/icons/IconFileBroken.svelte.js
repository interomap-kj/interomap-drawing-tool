...
/* src/icons/IconFileBroken.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-broken" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileBroken extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileBroken$1 = IconFileBroken;

export { IconFileBroken$1 as default };
//# sourceMappingURL=IconFileBroken.svelte.js.map
