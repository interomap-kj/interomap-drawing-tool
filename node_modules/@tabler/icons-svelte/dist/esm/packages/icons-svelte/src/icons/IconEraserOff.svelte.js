...
/* src/icons/IconEraserOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eraser-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEraserOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEraserOff$1 = IconEraserOff;

export { IconEraserOff$1 as default };
//# sourceMappingURL=IconEraserOff.svelte.js.map
