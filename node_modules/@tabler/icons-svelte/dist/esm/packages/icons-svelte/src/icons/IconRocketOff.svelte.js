...
/* src/icons/IconRocketOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rocket-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRocketOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRocketOff$1 = IconRocketOff;

export { IconRocketOff$1 as default };
//# sourceMappingURL=IconRocketOff.svelte.js.map
