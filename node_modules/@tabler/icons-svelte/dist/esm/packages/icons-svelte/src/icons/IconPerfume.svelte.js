...
/* src/icons/IconPerfume.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "perfume" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPerfume extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPerfume$1 = IconPerfume;

export { IconPerfume$1 as default };
//# sourceMappingURL=IconPerfume.svelte.js.map
