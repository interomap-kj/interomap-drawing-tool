...
/* src/icons/IconNews.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "news" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNews extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNews$1 = IconNews;

export { IconNews$1 as default };
//# sourceMappingURL=IconNews.svelte.js.map
