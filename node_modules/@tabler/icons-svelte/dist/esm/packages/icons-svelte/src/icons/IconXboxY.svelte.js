...
/* src/icons/IconXboxY.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "xbox-y" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconXboxY extends SvelteComponent {
	constructor(options) {
		super();
...
var IconXboxY$1 = IconXboxY;

export { IconXboxY$1 as default };
//# sourceMappingURL=IconXboxY.svelte.js.map
