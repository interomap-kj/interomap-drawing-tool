...
/* src/icons/IconReplaceOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "replace-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconReplaceOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconReplaceOff$1 = IconReplaceOff;

export { IconReplaceOff$1 as default };
//# sourceMappingURL=IconReplaceOff.svelte.js.map
