...
/* src/icons/IconSmartHome.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "smart-home" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSmartHome extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSmartHome$1 = IconSmartHome;

export { IconSmartHome$1 as default };
//# sourceMappingURL=IconSmartHome.svelte.js.map
