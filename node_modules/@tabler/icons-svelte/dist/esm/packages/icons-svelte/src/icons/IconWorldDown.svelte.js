...
/* src/icons/IconWorldDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldDown$1 = IconWorldDown;

export { IconWorldDown$1 as default };
//# sourceMappingURL=IconWorldDown.svelte.js.map
