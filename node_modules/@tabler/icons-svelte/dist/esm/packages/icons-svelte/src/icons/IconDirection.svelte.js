...
/* src/icons/IconDirection.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "direction" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M9 10l3 -3l3 3" }], ["path", { "d": "M9 14l3 3l3 -3" }]];
...
class IconDirection extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDirection$1 = IconDirection;

export { IconDirection$1 as default };
//# sourceMappingURL=IconDirection.svelte.js.map
