...
/* src/icons/IconUsersPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "users-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUsersPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUsersPlus$1 = IconUsersPlus;

export { IconUsersPlus$1 as default };
//# sourceMappingURL=IconUsersPlus.svelte.js.map
