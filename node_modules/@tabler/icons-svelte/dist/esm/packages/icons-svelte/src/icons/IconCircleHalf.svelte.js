...
/* src/icons/IconCircleHalf.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "circle-half" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCircleHalf extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCircleHalf$1 = IconCircleHalf;

export { IconCircleHalf$1 as default };
//# sourceMappingURL=IconCircleHalf.svelte.js.map
