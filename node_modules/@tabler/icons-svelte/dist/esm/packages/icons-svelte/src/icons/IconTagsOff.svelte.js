...
/* src/icons/IconTagsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tags-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTagsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTagsOff$1 = IconTagsOff;

export { IconTagsOff$1 as default };
//# sourceMappingURL=IconTagsOff.svelte.js.map
