...
/* src/icons/IconDevicesOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevicesOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevicesOff$1 = IconDevicesOff;

export { IconDevicesOff$1 as default };
//# sourceMappingURL=IconDevicesOff.svelte.js.map
