...
/* src/icons/IconClockCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockCheck$1 = IconClockCheck;

export { IconClockCheck$1 as default };
//# sourceMappingURL=IconClockCheck.svelte.js.map
