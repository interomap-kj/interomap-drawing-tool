...
/* src/icons/IconLassoOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lasso-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLassoOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLassoOff$1 = IconLassoOff;

export { IconLassoOff$1 as default };
//# sourceMappingURL=IconLassoOff.svelte.js.map
