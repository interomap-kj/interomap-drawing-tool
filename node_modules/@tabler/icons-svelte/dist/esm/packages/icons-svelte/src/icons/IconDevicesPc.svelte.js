...
/* src/icons/IconDevicesPc.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices-pc" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevicesPc extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevicesPc$1 = IconDevicesPc;

export { IconDevicesPc$1 as default };
//# sourceMappingURL=IconDevicesPc.svelte.js.map
