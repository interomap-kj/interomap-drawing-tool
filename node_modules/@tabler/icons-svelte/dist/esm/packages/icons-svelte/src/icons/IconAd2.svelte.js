...
/* src/icons/IconAd2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ad-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAd2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAd2$1 = IconAd2;

export { IconAd2$1 as default };
//# sourceMappingURL=IconAd2.svelte.js.map
