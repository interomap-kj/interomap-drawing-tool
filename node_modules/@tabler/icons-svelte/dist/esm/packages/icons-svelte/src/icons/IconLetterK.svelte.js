...
/* src/icons/IconLetterK.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-k" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterK extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterK$1 = IconLetterK;

export { IconLetterK$1 as default };
//# sourceMappingURL=IconLetterK.svelte.js.map
