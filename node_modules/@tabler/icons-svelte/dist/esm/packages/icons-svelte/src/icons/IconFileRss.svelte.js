...
/* src/icons/IconFileRss.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-rss" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileRss extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileRss$1 = IconFileRss;

export { IconFileRss$1 as default };
//# sourceMappingURL=IconFileRss.svelte.js.map
