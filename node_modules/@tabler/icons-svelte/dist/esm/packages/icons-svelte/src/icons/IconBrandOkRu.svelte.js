...
/* src/icons/IconBrandOkRu.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-ok-ru" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandOkRu extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandOkRu$1 = IconBrandOkRu;

export { IconBrandOkRu$1 as default };
//# sourceMappingURL=IconBrandOkRu.svelte.js.map
