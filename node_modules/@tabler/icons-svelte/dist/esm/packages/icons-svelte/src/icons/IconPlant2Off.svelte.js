...
/* src/icons/IconPlant2Off.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plant-2-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlant2Off extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlant2Off$1 = IconPlant2Off;

export { IconPlant2Off$1 as default };
//# sourceMappingURL=IconPlant2Off.svelte.js.map
