...
/* src/icons/IconView360.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "view-360" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconView360 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconView360$1 = IconView360;

export { IconView360$1 as default };
//# sourceMappingURL=IconView360.svelte.js.map
