...
/* src/icons/IconLockOpen.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-open" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockOpen extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockOpen$1 = IconLockOpen;

export { IconLockOpen$1 as default };
//# sourceMappingURL=IconLockOpen.svelte.js.map
