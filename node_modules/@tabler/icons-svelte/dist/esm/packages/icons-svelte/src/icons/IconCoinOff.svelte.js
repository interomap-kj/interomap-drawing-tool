...
/* src/icons/IconCoinOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinOff$1 = IconCoinOff;

export { IconCoinOff$1 as default };
//# sourceMappingURL=IconCoinOff.svelte.js.map
