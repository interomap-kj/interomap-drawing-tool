...
/* src/icons/IconReceiptOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "receipt-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconReceiptOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconReceiptOff$1 = IconReceiptOff;

export { IconReceiptOff$1 as default };
//# sourceMappingURL=IconReceiptOff.svelte.js.map
