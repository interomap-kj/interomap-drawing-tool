...
/* src/icons/IconPokerChip.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "poker-chip" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPokerChip extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPokerChip$1 = IconPokerChip;

export { IconPokerChip$1 as default };
//# sourceMappingURL=IconPokerChip.svelte.js.map
