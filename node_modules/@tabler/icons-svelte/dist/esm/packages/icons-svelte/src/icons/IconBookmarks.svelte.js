...
/* src/icons/IconBookmarks.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bookmarks" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBookmarks extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBookmarks$1 = IconBookmarks;

export { IconBookmarks$1 as default };
//# sourceMappingURL=IconBookmarks.svelte.js.map
