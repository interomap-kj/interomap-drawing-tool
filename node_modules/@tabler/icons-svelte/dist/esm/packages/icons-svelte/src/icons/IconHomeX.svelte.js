...
/* src/icons/IconHomeX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeX$1 = IconHomeX;

export { IconHomeX$1 as default };
//# sourceMappingURL=IconHomeX.svelte.js.map
