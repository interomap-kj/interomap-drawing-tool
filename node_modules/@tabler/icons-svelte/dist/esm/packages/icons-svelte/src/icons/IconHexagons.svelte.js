...
/* src/icons/IconHexagons.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hexagons" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHexagons extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHexagons$1 = IconHexagons;

export { IconHexagons$1 as default };
//# sourceMappingURL=IconHexagons.svelte.js.map
