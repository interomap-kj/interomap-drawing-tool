...
/* src/icons/IconBrandDcos.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-dcos" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandDcos extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandDcos$1 = IconBrandDcos;

export { IconBrandDcos$1 as default };
//# sourceMappingURL=IconBrandDcos.svelte.js.map
