...
/* src/icons/IconTallymarks.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tallymarks" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTallymarks extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTallymarks$1 = IconTallymarks;

export { IconTallymarks$1 as default };
//# sourceMappingURL=IconTallymarks.svelte.js.map
