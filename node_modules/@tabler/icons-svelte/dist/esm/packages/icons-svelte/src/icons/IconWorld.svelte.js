...
/* src/icons/IconWorld.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorld extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorld$1 = IconWorld;

export { IconWorld$1 as default };
//# sourceMappingURL=IconWorld.svelte.js.map
