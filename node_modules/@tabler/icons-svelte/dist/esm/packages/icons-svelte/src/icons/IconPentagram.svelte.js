...
/* src/icons/IconPentagram.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pentagram" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPentagram extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPentagram$1 = IconPentagram;

export { IconPentagram$1 as default };
//# sourceMappingURL=IconPentagram.svelte.js.map
