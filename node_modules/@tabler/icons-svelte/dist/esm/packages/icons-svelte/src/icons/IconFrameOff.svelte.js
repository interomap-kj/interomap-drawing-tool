...
/* src/icons/IconFrameOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "frame-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFrameOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFrameOff$1 = IconFrameOff;

export { IconFrameOff$1 as default };
//# sourceMappingURL=IconFrameOff.svelte.js.map
