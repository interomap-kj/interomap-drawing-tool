...
/* src/icons/IconLogicNand.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logic-nand" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogicNand extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogicNand$1 = IconLogicNand;

export { IconLogicNand$1 as default };
//# sourceMappingURL=IconLogicNand.svelte.js.map
