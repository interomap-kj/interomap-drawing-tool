...
/* src/icons/IconPhoneX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "phone-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhoneX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhoneX$1 = IconPhoneX;

export { IconPhoneX$1 as default };
//# sourceMappingURL=IconPhoneX.svelte.js.map
