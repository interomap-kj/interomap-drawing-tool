...
/* src/icons/IconRoadOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "road-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRoadOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRoadOff$1 = IconRoadOff;

export { IconRoadOff$1 as default };
//# sourceMappingURL=IconRoadOff.svelte.js.map
