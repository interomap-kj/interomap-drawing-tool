...
/* src/icons/IconRuler2Off.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ruler-2-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRuler2Off extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRuler2Off$1 = IconRuler2Off;

export { IconRuler2Off$1 as default };
//# sourceMappingURL=IconRuler2Off.svelte.js.map
