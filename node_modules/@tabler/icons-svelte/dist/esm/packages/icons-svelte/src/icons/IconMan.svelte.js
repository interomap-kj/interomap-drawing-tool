...
/* src/icons/IconMan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "man" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMan$1 = IconMan;

export { IconMan$1 as default };
//# sourceMappingURL=IconMan.svelte.js.map
