...
/* src/icons/IconTools.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tools" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTools extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTools$1 = IconTools;

export { IconTools$1 as default };
//# sourceMappingURL=IconTools.svelte.js.map
