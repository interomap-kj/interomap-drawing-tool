...
/* src/icons/IconBottle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bottle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBottle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBottle$1 = IconBottle;

export { IconBottle$1 as default };
//# sourceMappingURL=IconBottle.svelte.js.map
