...
/* src/icons/IconLockShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockShare$1 = IconLockShare;

export { IconLockShare$1 as default };
//# sourceMappingURL=IconLockShare.svelte.js.map
