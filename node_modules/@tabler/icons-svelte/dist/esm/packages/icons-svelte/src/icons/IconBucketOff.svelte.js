...
/* src/icons/IconBucketOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bucket-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBucketOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBucketOff$1 = IconBucketOff;

export { IconBucketOff$1 as default };
//# sourceMappingURL=IconBucketOff.svelte.js.map
