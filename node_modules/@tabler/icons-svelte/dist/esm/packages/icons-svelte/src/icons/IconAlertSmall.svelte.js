...
/* src/icons/IconAlertSmall.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "alert-small" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M12 8v4" }], ["path", { "d": "M12 16h.01" }]];
...
class IconAlertSmall extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAlertSmall$1 = IconAlertSmall;

export { IconAlertSmall$1 as default };
//# sourceMappingURL=IconAlertSmall.svelte.js.map
