...
/* src/icons/IconLetterS.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-s" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterS extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterS$1 = IconLetterS;

export { IconLetterS$1 as default };
//# sourceMappingURL=IconLetterS.svelte.js.map
