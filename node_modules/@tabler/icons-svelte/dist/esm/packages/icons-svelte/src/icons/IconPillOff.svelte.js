...
/* src/icons/IconPillOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pill-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPillOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPillOff$1 = IconPillOff;

export { IconPillOff$1 as default };
//# sourceMappingURL=IconPillOff.svelte.js.map
