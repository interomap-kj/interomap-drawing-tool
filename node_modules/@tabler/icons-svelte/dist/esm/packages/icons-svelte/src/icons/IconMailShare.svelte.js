...
/* src/icons/IconMailShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailShare$1 = IconMailShare;

export { IconMailShare$1 as default };
//# sourceMappingURL=IconMailShare.svelte.js.map
