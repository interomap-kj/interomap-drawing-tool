...
/* src/icons/IconMoodNerd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-nerd" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodNerd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodNerd$1 = IconMoodNerd;

export { IconMoodNerd$1 as default };
//# sourceMappingURL=IconMoodNerd.svelte.js.map
