...
/* src/icons/IconMacro.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "macro" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMacro extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMacro$1 = IconMacro;

export { IconMacro$1 as default };
//# sourceMappingURL=IconMacro.svelte.js.map
