...
/* src/icons/IconBarcodeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "barcode-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBarcodeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBarcodeOff$1 = IconBarcodeOff;

export { IconBarcodeOff$1 as default };
//# sourceMappingURL=IconBarcodeOff.svelte.js.map
