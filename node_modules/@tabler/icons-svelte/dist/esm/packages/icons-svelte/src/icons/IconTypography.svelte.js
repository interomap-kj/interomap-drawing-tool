...
/* src/icons/IconTypography.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "typography" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTypography extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTypography$1 = IconTypography;

export { IconTypography$1 as default };
//# sourceMappingURL=IconTypography.svelte.js.map
