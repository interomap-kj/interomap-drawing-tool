...
/* src/icons/IconStretching.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stretching" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStretching extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStretching$1 = IconStretching;

export { IconStretching$1 as default };
//# sourceMappingURL=IconStretching.svelte.js.map
