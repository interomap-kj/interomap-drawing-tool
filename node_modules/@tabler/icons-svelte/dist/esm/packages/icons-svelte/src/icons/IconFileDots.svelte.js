...
/* src/icons/IconFileDots.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-dots" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileDots extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileDots$1 = IconFileDots;

export { IconFileDots$1 as default };
//# sourceMappingURL=IconFileDots.svelte.js.map
