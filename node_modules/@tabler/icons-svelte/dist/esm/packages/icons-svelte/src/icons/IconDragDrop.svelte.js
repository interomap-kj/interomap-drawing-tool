...
/* src/icons/IconDragDrop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "drag-drop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDragDrop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDragDrop$1 = IconDragDrop;

export { IconDragDrop$1 as default };
//# sourceMappingURL=IconDragDrop.svelte.js.map
