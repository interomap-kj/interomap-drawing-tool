...
/* src/icons/IconFilePhone.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-phone" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilePhone extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilePhone$1 = IconFilePhone;

export { IconFilePhone$1 as default };
//# sourceMappingURL=IconFilePhone.svelte.js.map
