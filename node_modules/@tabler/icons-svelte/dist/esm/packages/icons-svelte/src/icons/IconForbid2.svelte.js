...
/* src/icons/IconForbid2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "forbid-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconForbid2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconForbid2$1 = IconForbid2;

export { IconForbid2$1 as default };
//# sourceMappingURL=IconForbid2.svelte.js.map
