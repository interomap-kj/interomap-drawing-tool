...
/* src/icons/IconRazor.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "razor" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRazor extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRazor$1 = IconRazor;

export { IconRazor$1 as default };
//# sourceMappingURL=IconRazor.svelte.js.map
