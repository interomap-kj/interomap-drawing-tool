...
/* src/icons/IconStairsUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stairs-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStairsUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStairsUp$1 = IconStairsUp;

export { IconStairsUp$1 as default };
//# sourceMappingURL=IconStairsUp.svelte.js.map
