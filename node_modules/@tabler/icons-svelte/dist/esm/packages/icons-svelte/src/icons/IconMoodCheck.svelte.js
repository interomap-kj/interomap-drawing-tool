...
/* src/icons/IconMoodCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodCheck$1 = IconMoodCheck;

export { IconMoodCheck$1 as default };
//# sourceMappingURL=IconMoodCheck.svelte.js.map
