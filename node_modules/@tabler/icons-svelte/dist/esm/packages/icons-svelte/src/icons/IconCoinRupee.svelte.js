...
/* src/icons/IconCoinRupee.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-rupee" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinRupee extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinRupee$1 = IconCoinRupee;

export { IconCoinRupee$1 as default };
//# sourceMappingURL=IconCoinRupee.svelte.js.map
