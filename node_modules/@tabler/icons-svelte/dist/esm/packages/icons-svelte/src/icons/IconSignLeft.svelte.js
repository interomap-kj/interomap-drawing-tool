...
/* src/icons/IconSignLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sign-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignLeft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignLeft$1 = IconSignLeft;

export { IconSignLeft$1 as default };
//# sourceMappingURL=IconSignLeft.svelte.js.map
