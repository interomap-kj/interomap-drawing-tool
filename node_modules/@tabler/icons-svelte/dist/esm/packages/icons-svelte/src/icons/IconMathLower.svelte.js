...
/* src/icons/IconMathLower.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-lower" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M19 18l-14 -6l14 -6" }]];
...
class IconMathLower extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathLower$1 = IconMathLower;

export { IconMathLower$1 as default };
//# sourceMappingURL=IconMathLower.svelte.js.map
