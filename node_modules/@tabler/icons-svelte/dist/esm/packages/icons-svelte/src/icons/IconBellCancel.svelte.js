...
/* src/icons/IconBellCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellCancel$1 = IconBellCancel;

export { IconBellCancel$1 as default };
//# sourceMappingURL=IconBellCancel.svelte.js.map
