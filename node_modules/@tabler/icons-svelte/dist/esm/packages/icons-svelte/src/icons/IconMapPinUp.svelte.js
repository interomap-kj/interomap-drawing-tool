...
/* src/icons/IconMapPinUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-pin-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapPinUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPinUp$1 = IconMapPinUp;

export { IconMapPinUp$1 as default };
//# sourceMappingURL=IconMapPinUp.svelte.js.map
