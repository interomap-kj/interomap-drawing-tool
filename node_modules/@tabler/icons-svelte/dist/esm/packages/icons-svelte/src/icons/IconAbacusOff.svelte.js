...
/* src/icons/IconAbacusOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "abacus-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAbacusOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAbacusOff$1 = IconAbacusOff;

export { IconAbacusOff$1 as default };
//# sourceMappingURL=IconAbacusOff.svelte.js.map
