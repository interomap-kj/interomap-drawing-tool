...
/* src/icons/IconSeedingOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "seeding-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSeedingOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSeedingOff$1 = IconSeedingOff;

export { IconSeedingOff$1 as default };
//# sourceMappingURL=IconSeedingOff.svelte.js.map
