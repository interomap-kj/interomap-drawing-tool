...
/* src/icons/IconVolume3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "volume-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVolume3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVolume3$1 = IconVolume3;

export { IconVolume3$1 as default };
//# sourceMappingURL=IconVolume3.svelte.js.map
