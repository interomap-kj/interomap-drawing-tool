...
/* src/icons/IconRouterOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "router-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRouterOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRouterOff$1 = IconRouterOff;

export { IconRouterOff$1 as default };
//# sourceMappingURL=IconRouterOff.svelte.js.map
