...
/* src/icons/IconMath.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMath extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMath$1 = IconMath;

export { IconMath$1 as default };
//# sourceMappingURL=IconMath.svelte.js.map
