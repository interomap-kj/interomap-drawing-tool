...
/* src/icons/IconBrandWindy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-windy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandWindy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandWindy$1 = IconBrandWindy;

export { IconBrandWindy$1 as default };
//# sourceMappingURL=IconBrandWindy.svelte.js.map
