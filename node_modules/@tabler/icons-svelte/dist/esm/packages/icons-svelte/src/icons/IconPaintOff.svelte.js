...
/* src/icons/IconPaintOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "paint-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPaintOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPaintOff$1 = IconPaintOff;

export { IconPaintOff$1 as default };
//# sourceMappingURL=IconPaintOff.svelte.js.map
