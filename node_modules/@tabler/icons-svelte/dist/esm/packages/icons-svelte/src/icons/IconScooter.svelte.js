...
/* src/icons/IconScooter.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "scooter" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScooter extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScooter$1 = IconScooter;

export { IconScooter$1 as default };
//# sourceMappingURL=IconScooter.svelte.js.map
