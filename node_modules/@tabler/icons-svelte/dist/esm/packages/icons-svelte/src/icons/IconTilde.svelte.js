...
/* src/icons/IconTilde.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tilde" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTilde extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTilde$1 = IconTilde;

export { IconTilde$1 as default };
//# sourceMappingURL=IconTilde.svelte.js.map
