...
/* src/icons/IconRectangle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rectangle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRectangle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRectangle$1 = IconRectangle;

export { IconRectangle$1 as default };
//# sourceMappingURL=IconRectangle.svelte.js.map
