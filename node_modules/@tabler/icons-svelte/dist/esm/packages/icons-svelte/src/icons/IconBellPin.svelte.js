...
/* src/icons/IconBellPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellPin$1 = IconBellPin;

export { IconBellPin$1 as default };
//# sourceMappingURL=IconBellPin.svelte.js.map
