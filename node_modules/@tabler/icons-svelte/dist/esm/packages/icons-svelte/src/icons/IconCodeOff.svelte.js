...
/* src/icons/IconCodeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "code-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCodeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCodeOff$1 = IconCodeOff;

export { IconCodeOff$1 as default };
//# sourceMappingURL=IconCodeOff.svelte.js.map
