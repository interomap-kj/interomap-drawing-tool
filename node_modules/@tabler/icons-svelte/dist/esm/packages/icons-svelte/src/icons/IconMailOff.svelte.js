...
/* src/icons/IconMailOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailOff$1 = IconMailOff;

export { IconMailOff$1 as default };
//# sourceMappingURL=IconMailOff.svelte.js.map
