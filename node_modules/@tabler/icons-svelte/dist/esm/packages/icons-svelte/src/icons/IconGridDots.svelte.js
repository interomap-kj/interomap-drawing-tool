...
/* src/icons/IconGridDots.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grid-dots" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGridDots extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGridDots$1 = IconGridDots;

export { IconGridDots$1 as default };
//# sourceMappingURL=IconGridDots.svelte.js.map
