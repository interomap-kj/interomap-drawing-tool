...
/* src/icons/IconGlassOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "glass-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGlassOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGlassOff$1 = IconGlassOff;

export { IconGlassOff$1 as default };
//# sourceMappingURL=IconGlassOff.svelte.js.map
