...
/* src/icons/IconLockStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockStar$1 = IconLockStar;

export { IconLockStar$1 as default };
//# sourceMappingURL=IconLockStar.svelte.js.map
