...
/* src/icons/IconClockBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockBolt$1 = IconClockBolt;

export { IconClockBolt$1 as default };
//# sourceMappingURL=IconClockBolt.svelte.js.map
