...
/* src/icons/IconCooker.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cooker" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCooker extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCooker$1 = IconCooker;

export { IconCooker$1 as default };
//# sourceMappingURL=IconCooker.svelte.js.map
