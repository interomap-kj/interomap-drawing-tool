...
/* src/icons/IconFishHook.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fish-hook" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFishHook extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFishHook$1 = IconFishHook;

export { IconFishHook$1 as default };
//# sourceMappingURL=IconFishHook.svelte.js.map
