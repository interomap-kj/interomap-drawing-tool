...
/* src/icons/IconDogBowl.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dog-bowl" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDogBowl extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDogBowl$1 = IconDogBowl;

export { IconDogBowl$1 as default };
//# sourceMappingURL=IconDogBowl.svelte.js.map
