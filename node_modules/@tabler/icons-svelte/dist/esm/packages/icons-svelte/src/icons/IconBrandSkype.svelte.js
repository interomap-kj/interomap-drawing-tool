...
/* src/icons/IconBrandSkype.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-skype" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandSkype extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandSkype$1 = IconBrandSkype;

export { IconBrandSkype$1 as default };
//# sourceMappingURL=IconBrandSkype.svelte.js.map
