...
/* src/icons/IconPackages.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "packages" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPackages extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPackages$1 = IconPackages;

export { IconPackages$1 as default };
//# sourceMappingURL=IconPackages.svelte.js.map
