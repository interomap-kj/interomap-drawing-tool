...
/* src/icons/IconSocial.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "social" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSocial extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSocial$1 = IconSocial;

export { IconSocial$1 as default };
//# sourceMappingURL=IconSocial.svelte.js.map
