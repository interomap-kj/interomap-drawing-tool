...
/* src/icons/IconFlask.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flask" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlask extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlask$1 = IconFlask;

export { IconFlask$1 as default };
//# sourceMappingURL=IconFlask.svelte.js.map
