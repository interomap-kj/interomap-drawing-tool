...
/* src/icons/IconPepper.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pepper" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPepper extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPepper$1 = IconPepper;

export { IconPepper$1 as default };
//# sourceMappingURL=IconPepper.svelte.js.map
