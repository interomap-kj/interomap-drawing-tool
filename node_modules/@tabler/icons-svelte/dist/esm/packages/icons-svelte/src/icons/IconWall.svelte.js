...
/* src/icons/IconWall.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wall" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWall extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWall$1 = IconWall;

export { IconWall$1 as default };
//# sourceMappingURL=IconWall.svelte.js.map
