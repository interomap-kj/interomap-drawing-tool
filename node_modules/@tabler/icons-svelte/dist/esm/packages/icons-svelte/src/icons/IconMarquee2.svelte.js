...
/* src/icons/IconMarquee2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "marquee-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMarquee2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMarquee2$1 = IconMarquee2;

export { IconMarquee2$1 as default };
//# sourceMappingURL=IconMarquee2.svelte.js.map
