...
/* src/icons/IconHistoryOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "history-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHistoryOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHistoryOff$1 = IconHistoryOff;

export { IconHistoryOff$1 as default };
//# sourceMappingURL=IconHistoryOff.svelte.js.map
