...
/* src/icons/IconHttpTrace.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-trace" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpTrace extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpTrace$1 = IconHttpTrace;

export { IconHttpTrace$1 as default };
//# sourceMappingURL=IconHttpTrace.svelte.js.map
