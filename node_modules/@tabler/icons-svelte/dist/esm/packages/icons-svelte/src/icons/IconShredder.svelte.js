...
/* src/icons/IconShredder.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shredder" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShredder extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShredder$1 = IconShredder;

export { IconShredder$1 as default };
//# sourceMappingURL=IconShredder.svelte.js.map
