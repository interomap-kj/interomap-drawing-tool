...
/* src/icons/IconAlbumOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "album-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAlbumOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAlbumOff$1 = IconAlbumOff;

export { IconAlbumOff$1 as default };
//# sourceMappingURL=IconAlbumOff.svelte.js.map
