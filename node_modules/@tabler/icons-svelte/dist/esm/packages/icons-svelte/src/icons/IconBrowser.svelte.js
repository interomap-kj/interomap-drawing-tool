...
/* src/icons/IconBrowser.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "browser" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrowser extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrowser$1 = IconBrowser;

export { IconBrowser$1 as default };
//# sourceMappingURL=IconBrowser.svelte.js.map
