...
/* src/icons/IconMoodShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodShare$1 = IconMoodShare;

export { IconMoodShare$1 as default };
//# sourceMappingURL=IconMoodShare.svelte.js.map
