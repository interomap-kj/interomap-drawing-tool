...
/* src/icons/IconLiveView.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "live-view" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLiveView extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLiveView$1 = IconLiveView;

export { IconLiveView$1 as default };
//# sourceMappingURL=IconLiveView.svelte.js.map
