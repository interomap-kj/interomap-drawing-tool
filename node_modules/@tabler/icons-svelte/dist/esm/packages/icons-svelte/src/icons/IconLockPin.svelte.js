...
/* src/icons/IconLockPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockPin$1 = IconLockPin;

export { IconLockPin$1 as default };
//# sourceMappingURL=IconLockPin.svelte.js.map
