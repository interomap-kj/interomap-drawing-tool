...
/* src/icons/IconTemperature.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "temperature" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTemperature extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTemperature$1 = IconTemperature;

export { IconTemperature$1 as default };
//# sourceMappingURL=IconTemperature.svelte.js.map
