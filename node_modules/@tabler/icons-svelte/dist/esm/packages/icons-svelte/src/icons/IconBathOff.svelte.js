...
/* src/icons/IconBathOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bath-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBathOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBathOff$1 = IconBathOff;

export { IconBathOff$1 as default };
//# sourceMappingURL=IconBathOff.svelte.js.map
