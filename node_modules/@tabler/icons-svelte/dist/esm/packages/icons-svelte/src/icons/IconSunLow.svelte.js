...
/* src/icons/IconSunLow.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sun-low" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSunLow extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSunLow$1 = IconSunLow;

export { IconSunLow$1 as default };
//# sourceMappingURL=IconSunLow.svelte.js.map
