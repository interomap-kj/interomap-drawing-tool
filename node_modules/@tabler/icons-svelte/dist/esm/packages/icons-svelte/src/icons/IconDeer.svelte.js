...
/* src/icons/IconDeer.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "deer" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDeer extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeer$1 = IconDeer;

export { IconDeer$1 as default };
//# sourceMappingURL=IconDeer.svelte.js.map
