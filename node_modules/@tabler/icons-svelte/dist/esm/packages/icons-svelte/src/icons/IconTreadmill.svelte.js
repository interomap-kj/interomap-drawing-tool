...
/* src/icons/IconTreadmill.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "treadmill" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTreadmill extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTreadmill$1 = IconTreadmill;

export { IconTreadmill$1 as default };
//# sourceMappingURL=IconTreadmill.svelte.js.map
