...
/* src/icons/IconTextResize.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "text-resize" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTextResize extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTextResize$1 = IconTextResize;

export { IconTextResize$1 as default };
//# sourceMappingURL=IconTextResize.svelte.js.map
