...
/* src/icons/IconGraph.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "graph" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGraph extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGraph$1 = IconGraph;

export { IconGraph$1 as default };
//# sourceMappingURL=IconGraph.svelte.js.map
