...
/* src/icons/IconFold.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fold" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFold extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFold$1 = IconFold;

export { IconFold$1 as default };
//# sourceMappingURL=IconFold.svelte.js.map
