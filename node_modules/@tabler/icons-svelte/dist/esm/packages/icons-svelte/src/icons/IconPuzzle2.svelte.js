...
/* src/icons/IconPuzzle2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "puzzle-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPuzzle2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPuzzle2$1 = IconPuzzle2;

export { IconPuzzle2$1 as default };
//# sourceMappingURL=IconPuzzle2.svelte.js.map
