...
/* src/icons/IconBadgeAr.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-ar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeAr extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeAr$1 = IconBadgeAr;

export { IconBadgeAr$1 as default };
//# sourceMappingURL=IconBadgeAr.svelte.js.map
