...
/* src/icons/IconDashboard.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dashboard" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDashboard extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDashboard$1 = IconDashboard;

export { IconDashboard$1 as default };
//# sourceMappingURL=IconDashboard.svelte.js.map
