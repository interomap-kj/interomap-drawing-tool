...
/* src/icons/IconLamp2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lamp-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLamp2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLamp2$1 = IconLamp2;

export { IconLamp2$1 as default };
//# sourceMappingURL=IconLamp2.svelte.js.map
