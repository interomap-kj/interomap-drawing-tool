...
/* src/icons/IconExposure0.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "exposure-0" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconExposure0 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconExposure0$1 = IconExposure0;

export { IconExposure0$1 as default };
//# sourceMappingURL=IconExposure0.svelte.js.map
