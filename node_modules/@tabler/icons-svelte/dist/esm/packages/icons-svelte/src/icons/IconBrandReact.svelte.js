...
/* src/icons/IconBrandReact.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-react" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandReact extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandReact$1 = IconBrandReact;

export { IconBrandReact$1 as default };
//# sourceMappingURL=IconBrandReact.svelte.js.map
