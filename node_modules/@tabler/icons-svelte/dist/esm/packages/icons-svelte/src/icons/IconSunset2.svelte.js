...
/* src/icons/IconSunset2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sunset-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSunset2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSunset2$1 = IconSunset2;

export { IconSunset2$1 as default };
//# sourceMappingURL=IconSunset2.svelte.js.map
