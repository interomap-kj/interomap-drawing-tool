...
/* src/icons/IconSquareF9.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f9" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF9 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF9$1 = IconSquareF9;

export { IconSquareF9$1 as default };
//# sourceMappingURL=IconSquareF9.svelte.js.map
