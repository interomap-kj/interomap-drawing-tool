...
/* src/icons/IconBellHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellHeart$1 = IconBellHeart;

export { IconBellHeart$1 as default };
//# sourceMappingURL=IconBellHeart.svelte.js.map
