...
/* src/icons/IconBellZ.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-z" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellZ extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellZ$1 = IconBellZ;

export { IconBellZ$1 as default };
//# sourceMappingURL=IconBellZ.svelte.js.map
