...
/* src/icons/IconDropletPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "droplet-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDropletPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDropletPin$1 = IconDropletPin;

export { IconDropletPin$1 as default };
//# sourceMappingURL=IconDropletPin.svelte.js.map
