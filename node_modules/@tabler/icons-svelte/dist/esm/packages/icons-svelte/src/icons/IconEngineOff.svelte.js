...
/* src/icons/IconEngineOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "engine-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEngineOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEngineOff$1 = IconEngineOff;

export { IconEngineOff$1 as default };
//# sourceMappingURL=IconEngineOff.svelte.js.map
