...
/* src/icons/IconShieldCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldCode$1 = IconShieldCode;

export { IconShieldCode$1 as default };
//# sourceMappingURL=IconShieldCode.svelte.js.map
