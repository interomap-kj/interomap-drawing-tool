...
/* src/icons/IconWalk.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "walk" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWalk extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWalk$1 = IconWalk;

export { IconWalk$1 as default };
//# sourceMappingURL=IconWalk.svelte.js.map
