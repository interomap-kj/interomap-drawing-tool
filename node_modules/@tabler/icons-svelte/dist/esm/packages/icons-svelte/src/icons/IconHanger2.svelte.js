...
/* src/icons/IconHanger2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hanger-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHanger2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHanger2$1 = IconHanger2;

export { IconHanger2$1 as default };
//# sourceMappingURL=IconHanger2.svelte.js.map
