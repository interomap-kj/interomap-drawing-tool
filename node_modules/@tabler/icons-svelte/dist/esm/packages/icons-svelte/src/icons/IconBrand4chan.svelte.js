...
/* src/icons/IconBrand4chan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-4chan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrand4chan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrand4chan$1 = IconBrand4chan;

export { IconBrand4chan$1 as default };
//# sourceMappingURL=IconBrand4chan.svelte.js.map
