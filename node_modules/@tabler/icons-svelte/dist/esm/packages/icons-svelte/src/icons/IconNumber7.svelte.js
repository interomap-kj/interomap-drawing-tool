...
/* src/icons/IconNumber7.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-7" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M8 4h8l-4 16" }]];
...
class IconNumber7 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber7$1 = IconNumber7;

export { IconNumber7$1 as default };
//# sourceMappingURL=IconNumber7.svelte.js.map
