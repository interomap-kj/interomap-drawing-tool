...
/* src/icons/IconWashDryP.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry-p" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDryP extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDryP$1 = IconWashDryP;

export { IconWashDryP$1 as default };
//# sourceMappingURL=IconWashDryP.svelte.js.map
