...
/* src/icons/IconMoodOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodOff$1 = IconMoodOff;

export { IconMoodOff$1 as default };
//# sourceMappingURL=IconMoodOff.svelte.js.map
