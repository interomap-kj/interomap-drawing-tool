...
/* src/icons/IconFlag2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flag-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M5 14h14v-9h-14v16" }]];
...
class IconFlag2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlag2$1 = IconFlag2;

export { IconFlag2$1 as default };
//# sourceMappingURL=IconFlag2.svelte.js.map
