...
/* src/icons/IconBrandTidal.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-tidal" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandTidal extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandTidal$1 = IconBrandTidal;

export { IconBrandTidal$1 as default };
//# sourceMappingURL=IconBrandTidal.svelte.js.map
