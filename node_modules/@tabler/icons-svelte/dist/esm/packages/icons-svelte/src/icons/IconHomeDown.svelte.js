...
/* src/icons/IconHomeDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeDown$1 = IconHomeDown;

export { IconHomeDown$1 as default };
//# sourceMappingURL=IconHomeDown.svelte.js.map
