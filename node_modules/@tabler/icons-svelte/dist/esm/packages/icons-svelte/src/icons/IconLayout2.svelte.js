...
/* src/icons/IconLayout2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "layout-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLayout2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLayout2$1 = IconLayout2;

export { IconLayout2$1 as default };
//# sourceMappingURL=IconLayout2.svelte.js.map
