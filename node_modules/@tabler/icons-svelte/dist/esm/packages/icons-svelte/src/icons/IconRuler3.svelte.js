...
/* src/icons/IconRuler3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ruler-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRuler3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRuler3$1 = IconRuler3;

export { IconRuler3$1 as default };
//# sourceMappingURL=IconRuler3.svelte.js.map
