...
/* src/icons/IconPhotoUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoUp$1 = IconPhotoUp;

export { IconPhotoUp$1 as default };
//# sourceMappingURL=IconPhotoUp.svelte.js.map
