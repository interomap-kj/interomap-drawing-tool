...
/* src/icons/IconLogicXor.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logic-xor" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogicXor extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogicXor$1 = IconLogicXor;

export { IconLogicXor$1 as default };
//# sourceMappingURL=IconLogicXor.svelte.js.map
