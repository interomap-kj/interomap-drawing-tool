...
/* src/icons/IconTowerOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tower-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTowerOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTowerOff$1 = IconTowerOff;

export { IconTowerOff$1 as default };
//# sourceMappingURL=IconTowerOff.svelte.js.map
