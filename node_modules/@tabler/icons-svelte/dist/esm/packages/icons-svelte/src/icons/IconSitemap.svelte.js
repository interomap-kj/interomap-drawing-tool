...
/* src/icons/IconSitemap.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sitemap" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSitemap extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSitemap$1 = IconSitemap;

export { IconSitemap$1 as default };
//# sourceMappingURL=IconSitemap.svelte.js.map
