...
/* src/icons/IconLetterE.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-e" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M17 4h-10v16h10" }], ["path", { "d": "M7 12l8 0" }]];
...
class IconLetterE extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterE$1 = IconLetterE;

export { IconLetterE$1 as default };
//# sourceMappingURL=IconLetterE.svelte.js.map
