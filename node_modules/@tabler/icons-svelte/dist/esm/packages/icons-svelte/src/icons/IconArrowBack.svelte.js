...
/* src/icons/IconArrowBack.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrow-back" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowBack extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowBack$1 = IconArrowBack;

export { IconArrowBack$1 as default };
//# sourceMappingURL=IconArrowBack.svelte.js.map
