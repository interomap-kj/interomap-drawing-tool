...
/* src/icons/IconWoman.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "woman" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWoman extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWoman$1 = IconWoman;

export { IconWoman$1 as default };
//# sourceMappingURL=IconWoman.svelte.js.map
