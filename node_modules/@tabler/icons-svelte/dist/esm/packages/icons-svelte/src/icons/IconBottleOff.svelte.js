...
/* src/icons/IconBottleOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bottle-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBottleOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBottleOff$1 = IconBottleOff;

export { IconBottleOff$1 as default };
//# sourceMappingURL=IconBottleOff.svelte.js.map
