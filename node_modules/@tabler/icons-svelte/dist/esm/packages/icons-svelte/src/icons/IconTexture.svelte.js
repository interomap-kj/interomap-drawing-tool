...
/* src/icons/IconTexture.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "texture" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTexture extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTexture$1 = IconTexture;

export { IconTexture$1 as default };
//# sourceMappingURL=IconTexture.svelte.js.map
