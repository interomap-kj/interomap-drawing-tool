...
/* src/icons/IconSofaOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sofa-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSofaOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSofaOff$1 = IconSofaOff;

export { IconSofaOff$1 as default };
//# sourceMappingURL=IconSofaOff.svelte.js.map
