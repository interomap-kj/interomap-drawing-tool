...
/* src/icons/IconLockAccess.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-access" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockAccess extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockAccess$1 = IconLockAccess;

export { IconLockAccess$1 as default };
//# sourceMappingURL=IconLockAccess.svelte.js.map
