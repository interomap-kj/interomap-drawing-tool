...
/* src/icons/IconChecklist.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "checklist" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChecklist extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChecklist$1 = IconChecklist;

export { IconChecklist$1 as default };
//# sourceMappingURL=IconChecklist.svelte.js.map
