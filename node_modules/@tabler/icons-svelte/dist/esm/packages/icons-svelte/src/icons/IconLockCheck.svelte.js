...
/* src/icons/IconLockCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockCheck$1 = IconLockCheck;

export { IconLockCheck$1 as default };
//# sourceMappingURL=IconLockCheck.svelte.js.map
