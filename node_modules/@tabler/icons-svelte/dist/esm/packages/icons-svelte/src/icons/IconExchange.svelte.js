...
/* src/icons/IconExchange.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "exchange" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconExchange extends SvelteComponent {
	constructor(options) {
		super();
...
var IconExchange$1 = IconExchange;

export { IconExchange$1 as default };
//# sourceMappingURL=IconExchange.svelte.js.map
