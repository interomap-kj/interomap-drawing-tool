...
/* src/icons/IconRotate.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rotate" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRotate extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRotate$1 = IconRotate;

export { IconRotate$1 as default };
//# sourceMappingURL=IconRotate.svelte.js.map
