...
/* src/icons/IconInboxOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "inbox-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconInboxOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconInboxOff$1 = IconInboxOff;

export { IconInboxOff$1 as default };
//# sourceMappingURL=IconInboxOff.svelte.js.map
