...
/* src/icons/IconOmega.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "omega" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOmega extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOmega$1 = IconOmega;

export { IconOmega$1 as default };
//# sourceMappingURL=IconOmega.svelte.js.map
