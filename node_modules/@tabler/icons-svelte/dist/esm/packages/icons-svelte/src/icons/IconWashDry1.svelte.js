...
/* src/icons/IconWashDry1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDry1 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDry1$1 = IconWashDry1;

export { IconWashDry1$1 as default };
//# sourceMappingURL=IconWashDry1.svelte.js.map
