...
/* src/icons/IconZoomCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomCode$1 = IconZoomCode;

export { IconZoomCode$1 as default };
//# sourceMappingURL=IconZoomCode.svelte.js.map
