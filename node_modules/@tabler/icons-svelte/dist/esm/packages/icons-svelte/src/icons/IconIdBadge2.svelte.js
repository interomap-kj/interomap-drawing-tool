...
/* src/icons/IconIdBadge2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "id-badge-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIdBadge2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIdBadge2$1 = IconIdBadge2;

export { IconIdBadge2$1 as default };
//# sourceMappingURL=IconIdBadge2.svelte.js.map
