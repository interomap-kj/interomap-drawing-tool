...
/* src/icons/IconDrone.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "drone" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDrone extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDrone$1 = IconDrone;

export { IconDrone$1 as default };
//# sourceMappingURL=IconDrone.svelte.js.map
