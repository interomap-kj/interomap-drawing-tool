...
/* src/icons/IconCarTurbine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "car-turbine" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCarTurbine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCarTurbine$1 = IconCarTurbine;

export { IconCarTurbine$1 as default };
//# sourceMappingURL=IconCarTurbine.svelte.js.map
