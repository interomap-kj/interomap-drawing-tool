...
/* src/icons/IconMessageUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessageUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessageUp$1 = IconMessageUp;

export { IconMessageUp$1 as default };
//# sourceMappingURL=IconMessageUp.svelte.js.map
