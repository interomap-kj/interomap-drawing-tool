...
/* src/icons/IconLambda.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lambda" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLambda extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLambda$1 = IconLambda;

export { IconLambda$1 as default };
//# sourceMappingURL=IconLambda.svelte.js.map
