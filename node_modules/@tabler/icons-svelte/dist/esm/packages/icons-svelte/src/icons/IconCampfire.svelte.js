...
/* src/icons/IconCampfire.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "campfire" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCampfire extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCampfire$1 = IconCampfire;

export { IconCampfire$1 as default };
//# sourceMappingURL=IconCampfire.svelte.js.map
