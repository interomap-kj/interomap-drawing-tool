...
/* src/icons/IconReportOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "report-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconReportOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconReportOff$1 = IconReportOff;

export { IconReportOff$1 as default };
//# sourceMappingURL=IconReportOff.svelte.js.map
