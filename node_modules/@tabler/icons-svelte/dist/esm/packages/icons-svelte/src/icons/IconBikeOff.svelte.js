...
/* src/icons/IconBikeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bike-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBikeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBikeOff$1 = IconBikeOff;

export { IconBikeOff$1 as default };
//# sourceMappingURL=IconBikeOff.svelte.js.map
