...
/* src/icons/IconH2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "h-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconH2 extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconH2$1 as default };
//# sourceMappingURL=IconH2.svelte.js.map
