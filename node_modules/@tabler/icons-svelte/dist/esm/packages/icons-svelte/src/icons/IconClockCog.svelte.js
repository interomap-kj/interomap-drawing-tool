...
/* src/icons/IconClockCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockCog$1 = IconClockCog;

export { IconClockCog$1 as default };
//# sourceMappingURL=IconClockCog.svelte.js.map
