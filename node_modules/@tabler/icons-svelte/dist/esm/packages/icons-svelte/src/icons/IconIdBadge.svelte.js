...
/* src/icons/IconIdBadge.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "id-badge" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIdBadge extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIdBadge$1 = IconIdBadge;

export { IconIdBadge$1 as default };
//# sourceMappingURL=IconIdBadge.svelte.js.map
