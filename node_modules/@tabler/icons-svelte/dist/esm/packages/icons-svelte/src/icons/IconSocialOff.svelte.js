...
/* src/icons/IconSocialOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "social-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSocialOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSocialOff$1 = IconSocialOff;

export { IconSocialOff$1 as default };
//# sourceMappingURL=IconSocialOff.svelte.js.map
