...
/* src/icons/IconHomeUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeUp$1 = IconHomeUp;

export { IconHomeUp$1 as default };
//# sourceMappingURL=IconHomeUp.svelte.js.map
