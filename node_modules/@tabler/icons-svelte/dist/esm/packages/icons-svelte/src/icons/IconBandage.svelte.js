...
/* src/icons/IconBandage.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bandage" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBandage extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBandage$1 = IconBandage;

export { IconBandage$1 as default };
//# sourceMappingURL=IconBandage.svelte.js.map
