...
/* src/icons/IconVectorOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vector-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVectorOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVectorOff$1 = IconVectorOff;

export { IconVectorOff$1 as default };
//# sourceMappingURL=IconVectorOff.svelte.js.map
