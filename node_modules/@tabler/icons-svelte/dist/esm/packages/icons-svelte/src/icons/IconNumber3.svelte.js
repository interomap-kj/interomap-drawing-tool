...
/* src/icons/IconNumber3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumber3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber3$1 = IconNumber3;

export { IconNumber3$1 as default };
//# sourceMappingURL=IconNumber3.svelte.js.map
