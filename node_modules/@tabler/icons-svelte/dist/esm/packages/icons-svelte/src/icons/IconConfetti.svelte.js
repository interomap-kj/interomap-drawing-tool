...
/* src/icons/IconConfetti.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "confetti" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconConfetti extends SvelteComponent {
	constructor(options) {
		super();
...
var IconConfetti$1 = IconConfetti;

export { IconConfetti$1 as default };
//# sourceMappingURL=IconConfetti.svelte.js.map
