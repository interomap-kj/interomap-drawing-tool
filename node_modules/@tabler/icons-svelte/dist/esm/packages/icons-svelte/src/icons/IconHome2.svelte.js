...
/* src/icons/IconHome2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHome2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHome2$1 = IconHome2;

export { IconHome2$1 as default };
//# sourceMappingURL=IconHome2.svelte.js.map
