...
/* src/icons/IconPackageOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "package-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPackageOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPackageOff$1 = IconPackageOff;

export { IconPackageOff$1 as default };
//# sourceMappingURL=IconPackageOff.svelte.js.map
