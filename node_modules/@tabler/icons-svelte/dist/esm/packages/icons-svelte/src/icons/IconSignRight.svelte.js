...
/* src/icons/IconSignRight.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sign-right" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignRight extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignRight$1 = IconSignRight;

export { IconSignRight$1 as default };
//# sourceMappingURL=IconSignRight.svelte.js.map
