...
/* src/icons/IconShieldDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldDown$1 = IconShieldDown;

export { IconShieldDown$1 as default };
//# sourceMappingURL=IconShieldDown.svelte.js.map
