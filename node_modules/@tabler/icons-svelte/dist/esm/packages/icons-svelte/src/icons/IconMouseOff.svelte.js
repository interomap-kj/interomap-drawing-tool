...
/* src/icons/IconMouseOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mouse-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMouseOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMouseOff$1 = IconMouseOff;

export { IconMouseOff$1 as default };
//# sourceMappingURL=IconMouseOff.svelte.js.map
