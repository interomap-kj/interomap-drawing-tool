...
/* src/icons/IconVolcano.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "volcano" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVolcano extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVolcano$1 = IconVolcano;

export { IconVolcano$1 as default };
//# sourceMappingURL=IconVolcano.svelte.js.map
