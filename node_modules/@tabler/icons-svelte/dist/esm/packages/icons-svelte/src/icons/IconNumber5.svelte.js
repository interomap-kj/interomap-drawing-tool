...
/* src/icons/IconNumber5.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-5" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M8 20h4a4 4 0 1 0 0 -8h-4v-8h8" }]];
...
class IconNumber5 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber5$1 = IconNumber5;

export { IconNumber5$1 as default };
//# sourceMappingURL=IconNumber5.svelte.js.map
