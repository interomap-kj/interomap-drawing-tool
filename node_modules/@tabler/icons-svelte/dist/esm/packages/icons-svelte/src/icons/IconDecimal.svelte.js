...
/* src/icons/IconDecimal.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "decimal" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDecimal extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDecimal$1 = IconDecimal;

export { IconDecimal$1 as default };
//# sourceMappingURL=IconDecimal.svelte.js.map
