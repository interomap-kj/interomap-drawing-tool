...
/* src/icons/IconBathFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bath-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBathFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBathFilled$1 = IconBathFilled;

export { IconBathFilled$1 as default };
//# sourceMappingURL=IconBathFilled.svelte.js.map
