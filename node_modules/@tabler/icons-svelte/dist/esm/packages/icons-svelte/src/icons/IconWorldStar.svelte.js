...
/* src/icons/IconWorldStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldStar$1 = IconWorldStar;

export { IconWorldStar$1 as default };
//# sourceMappingURL=IconWorldStar.svelte.js.map
