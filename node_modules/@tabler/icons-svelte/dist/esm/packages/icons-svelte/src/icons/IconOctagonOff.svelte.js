...
/* src/icons/IconOctagonOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "octagon-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOctagonOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOctagonOff$1 = IconOctagonOff;

export { IconOctagonOff$1 as default };
//# sourceMappingURL=IconOctagonOff.svelte.js.map
