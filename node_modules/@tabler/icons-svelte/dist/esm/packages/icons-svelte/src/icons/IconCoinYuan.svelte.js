...
/* src/icons/IconCoinYuan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-yuan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinYuan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinYuan$1 = IconCoinYuan;

export { IconCoinYuan$1 as default };
//# sourceMappingURL=IconCoinYuan.svelte.js.map
