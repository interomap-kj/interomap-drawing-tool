...
/* src/icons/IconClockPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockPin$1 = IconClockPin;

export { IconClockPin$1 as default };
//# sourceMappingURL=IconClockPin.svelte.js.map
