...
/* src/icons/IconOutlet.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "outlet" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOutlet extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOutlet$1 = IconOutlet;

export { IconOutlet$1 as default };
//# sourceMappingURL=IconOutlet.svelte.js.map
