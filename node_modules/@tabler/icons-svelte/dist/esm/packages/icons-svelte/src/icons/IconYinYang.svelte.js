...
/* src/icons/IconYinYang.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "yin-yang" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconYinYang extends SvelteComponent {
	constructor(options) {
		super();
...
var IconYinYang$1 = IconYinYang;

export { IconYinYang$1 as default };
//# sourceMappingURL=IconYinYang.svelte.js.map
