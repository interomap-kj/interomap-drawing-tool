...
/* src/icons/IconWashDryA.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry-a" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDryA extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDryA$1 = IconWashDryA;

export { IconWashDryA$1 as default };
//# sourceMappingURL=IconWashDryA.svelte.js.map
