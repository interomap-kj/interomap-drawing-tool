...
/* src/icons/IconFileChart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-chart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileChart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileChart$1 = IconFileChart;

export { IconFileChart$1 as default };
//# sourceMappingURL=IconFileChart.svelte.js.map
