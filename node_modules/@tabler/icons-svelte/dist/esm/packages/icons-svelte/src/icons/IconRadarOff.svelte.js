...
/* src/icons/IconRadarOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "radar-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRadarOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRadarOff$1 = IconRadarOff;

export { IconRadarOff$1 as default };
//# sourceMappingURL=IconRadarOff.svelte.js.map
