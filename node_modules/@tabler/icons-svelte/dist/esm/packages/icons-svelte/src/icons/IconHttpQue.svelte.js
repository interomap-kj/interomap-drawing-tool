...
/* src/icons/IconHttpQue.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-que" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpQue extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpQue$1 = IconHttpQue;

export { IconHttpQue$1 as default };
//# sourceMappingURL=IconHttpQue.svelte.js.map
