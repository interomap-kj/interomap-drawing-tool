...
/* src/icons/IconPhotoCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoCode$1 = IconPhotoCode;

export { IconPhotoCode$1 as default };
//# sourceMappingURL=IconPhotoCode.svelte.js.map
