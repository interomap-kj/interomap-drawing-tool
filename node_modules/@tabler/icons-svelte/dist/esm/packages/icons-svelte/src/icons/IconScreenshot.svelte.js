...
/* src/icons/IconScreenshot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "screenshot" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScreenshot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScreenshot$1 = IconScreenshot;

export { IconScreenshot$1 as default };
//# sourceMappingURL=IconScreenshot.svelte.js.map
