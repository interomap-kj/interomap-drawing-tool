...
/* src/icons/IconBucket.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bucket" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBucket extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBucket$1 = IconBucket;

export { IconBucket$1 as default };
//# sourceMappingURL=IconBucket.svelte.js.map
