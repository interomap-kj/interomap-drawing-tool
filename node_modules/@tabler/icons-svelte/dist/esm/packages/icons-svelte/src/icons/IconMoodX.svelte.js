...
/* src/icons/IconMoodX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodX$1 = IconMoodX;

export { IconMoodX$1 as default };
//# sourceMappingURL=IconMoodX.svelte.js.map
