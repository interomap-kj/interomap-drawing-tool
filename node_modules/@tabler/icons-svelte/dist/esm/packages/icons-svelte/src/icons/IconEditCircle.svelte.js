...
/* src/icons/IconEditCircle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "edit-circle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEditCircle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEditCircle$1 = IconEditCircle;

export { IconEditCircle$1 as default };
//# sourceMappingURL=IconEditCircle.svelte.js.map
