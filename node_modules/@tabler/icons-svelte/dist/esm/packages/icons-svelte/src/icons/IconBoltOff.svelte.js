...
/* src/icons/IconBoltOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bolt-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoltOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoltOff$1 = IconBoltOff;

export { IconBoltOff$1 as default };
//# sourceMappingURL=IconBoltOff.svelte.js.map
