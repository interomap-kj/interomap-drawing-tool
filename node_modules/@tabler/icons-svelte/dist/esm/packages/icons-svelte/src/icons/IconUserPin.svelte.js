...
/* src/icons/IconUserPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserPin$1 = IconUserPin;

export { IconUserPin$1 as default };
//# sourceMappingURL=IconUserPin.svelte.js.map
