...
/* src/icons/IconCaretDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "caret-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M6 10l6 6l6 -6h-12" }]];
...
class IconCaretDown extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconCaretDown$1 as default };
//# sourceMappingURL=IconCaretDown.svelte.js.map
