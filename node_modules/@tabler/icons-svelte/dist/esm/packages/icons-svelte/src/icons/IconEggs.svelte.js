...
/* src/icons/IconEggs.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eggs" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEggs extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEggs$1 = IconEggs;

export { IconEggs$1 as default };
//# sourceMappingURL=IconEggs.svelte.js.map
