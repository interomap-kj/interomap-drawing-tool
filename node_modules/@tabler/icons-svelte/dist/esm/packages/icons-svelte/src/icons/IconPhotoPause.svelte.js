...
/* src/icons/IconPhotoPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoPause$1 = IconPhotoPause;

export { IconPhotoPause$1 as default };
//# sourceMappingURL=IconPhotoPause.svelte.js.map
