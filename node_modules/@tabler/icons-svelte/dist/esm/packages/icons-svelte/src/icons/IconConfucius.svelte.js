...
/* src/icons/IconConfucius.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "confucius" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconConfucius extends SvelteComponent {
	constructor(options) {
		super();
...
var IconConfucius$1 = IconConfucius;

export { IconConfucius$1 as default };
//# sourceMappingURL=IconConfucius.svelte.js.map
