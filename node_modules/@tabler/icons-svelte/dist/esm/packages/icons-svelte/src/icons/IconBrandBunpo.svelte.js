...
/* src/icons/IconBrandBunpo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-bunpo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandBunpo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandBunpo$1 = IconBrandBunpo;

export { IconBrandBunpo$1 as default };
//# sourceMappingURL=IconBrandBunpo.svelte.js.map
