...
/* src/icons/IconWashDry2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDry2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDry2$1 = IconWashDry2;

export { IconWashDry2$1 as default };
//# sourceMappingURL=IconWashDry2.svelte.js.map
