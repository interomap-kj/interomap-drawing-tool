...
/* src/icons/IconPhotoPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoPlus$1 = IconPhotoPlus;

export { IconPhotoPlus$1 as default };
//# sourceMappingURL=IconPhotoPlus.svelte.js.map
