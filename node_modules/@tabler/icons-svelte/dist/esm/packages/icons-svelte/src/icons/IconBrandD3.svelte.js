...
/* src/icons/IconBrandD3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-d3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandD3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandD3$1 = IconBrandD3;

export { IconBrandD3$1 as default };
//# sourceMappingURL=IconBrandD3.svelte.js.map
