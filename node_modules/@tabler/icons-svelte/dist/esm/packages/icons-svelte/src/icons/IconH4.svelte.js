...
/* src/icons/IconH4.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "h-4" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconH4 extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconH4$1 as default };
//# sourceMappingURL=IconH4.svelte.js.map
