...
/* src/icons/IconMathNot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "math-not" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M5 12h14v4" }]];
...
class IconMathNot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMathNot$1 = IconMathNot;

export { IconMathNot$1 as default };
//# sourceMappingURL=IconMathNot.svelte.js.map
