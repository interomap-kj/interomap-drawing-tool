...
/* src/icons/IconVideoPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "video-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVideoPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVideoPlus$1 = IconVideoPlus;

export { IconVideoPlus$1 as default };
//# sourceMappingURL=IconVideoPlus.svelte.js.map
