...
/* src/icons/IconPlayerPlay.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "player-play" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlayerPlay extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlayerPlay$1 = IconPlayerPlay;

export { IconPlayerPlay$1 as default };
//# sourceMappingURL=IconPlayerPlay.svelte.js.map
