...
/* src/icons/IconFloatNone.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "float-none" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFloatNone extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFloatNone$1 = IconFloatNone;

export { IconFloatNone$1 as default };
//# sourceMappingURL=IconFloatNone.svelte.js.map
