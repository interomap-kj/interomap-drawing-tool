...
/* src/icons/IconPoo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "poo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPoo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPoo$1 = IconPoo;

export { IconPoo$1 as default };
//# sourceMappingURL=IconPoo.svelte.js.map
