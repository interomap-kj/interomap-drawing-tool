...
/* src/icons/IconNetworkOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "network-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNetworkOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNetworkOff$1 = IconNetworkOff;

export { IconNetworkOff$1 as default };
//# sourceMappingURL=IconNetworkOff.svelte.js.map
