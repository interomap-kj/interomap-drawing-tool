...
/* src/icons/IconDetails.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "details" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDetails extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDetails$1 = IconDetails;

export { IconDetails$1 as default };
//# sourceMappingURL=IconDetails.svelte.js.map
