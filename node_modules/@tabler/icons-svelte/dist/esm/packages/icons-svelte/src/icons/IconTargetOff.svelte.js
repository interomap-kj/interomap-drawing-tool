...
/* src/icons/IconTargetOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "target-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTargetOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTargetOff$1 = IconTargetOff;

export { IconTargetOff$1 as default };
//# sourceMappingURL=IconTargetOff.svelte.js.map
