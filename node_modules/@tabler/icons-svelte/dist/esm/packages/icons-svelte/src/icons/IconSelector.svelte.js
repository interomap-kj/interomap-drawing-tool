...
/* src/icons/IconSelector.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "selector" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M8 9l4 -4l4 4" }], ["path", { "d": "M16 15l-4 4l-4 -4" }]];
...
class IconSelector extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSelector$1 = IconSelector;

export { IconSelector$1 as default };
//# sourceMappingURL=IconSelector.svelte.js.map
