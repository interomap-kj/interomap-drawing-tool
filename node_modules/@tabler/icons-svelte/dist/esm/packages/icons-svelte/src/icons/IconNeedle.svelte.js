...
/* src/icons/IconNeedle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "needle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNeedle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNeedle$1 = IconNeedle;

export { IconNeedle$1 as default };
//# sourceMappingURL=IconNeedle.svelte.js.map
