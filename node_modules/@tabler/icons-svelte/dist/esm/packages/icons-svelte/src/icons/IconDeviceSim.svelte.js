...
/* src/icons/IconDeviceSim.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "device-sim" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDeviceSim extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDeviceSim$1 = IconDeviceSim;

export { IconDeviceSim$1 as default };
//# sourceMappingURL=IconDeviceSim.svelte.js.map
