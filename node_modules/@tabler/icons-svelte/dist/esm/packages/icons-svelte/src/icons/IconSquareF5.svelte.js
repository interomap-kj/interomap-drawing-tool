...
/* src/icons/IconSquareF5.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f5" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF5 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF5$1 = IconSquareF5;

export { IconSquareF5$1 as default };
//# sourceMappingURL=IconSquareF5.svelte.js.map
