...
/* src/icons/IconInfoCircle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "info-circle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconInfoCircle extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconInfoCircle$1 as default };
//# sourceMappingURL=IconInfoCircle.svelte.js.map
