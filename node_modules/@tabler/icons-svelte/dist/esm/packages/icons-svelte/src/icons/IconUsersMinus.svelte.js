...
/* src/icons/IconUsersMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "users-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUsersMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUsersMinus$1 = IconUsersMinus;

export { IconUsersMinus$1 as default };
//# sourceMappingURL=IconUsersMinus.svelte.js.map
