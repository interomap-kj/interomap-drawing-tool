...
/* src/icons/IconSpeedboat.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "speedboat" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpeedboat extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpeedboat$1 = IconSpeedboat;

export { IconSpeedboat$1 as default };
//# sourceMappingURL=IconSpeedboat.svelte.js.map
