...
/* src/icons/IconHelmetOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "helmet-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHelmetOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHelmetOff$1 = IconHelmetOff;

export { IconHelmetOff$1 as default };
//# sourceMappingURL=IconHelmetOff.svelte.js.map
