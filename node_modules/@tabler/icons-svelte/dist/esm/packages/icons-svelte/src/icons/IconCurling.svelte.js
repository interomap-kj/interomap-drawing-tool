...
/* src/icons/IconCurling.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "curling" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCurling extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCurling$1 = IconCurling;

export { IconCurling$1 as default };
//# sourceMappingURL=IconCurling.svelte.js.map
