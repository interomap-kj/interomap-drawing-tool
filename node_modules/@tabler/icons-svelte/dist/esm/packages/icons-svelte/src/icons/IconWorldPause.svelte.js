...
/* src/icons/IconWorldPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldPause$1 = IconWorldPause;

export { IconWorldPause$1 as default };
//# sourceMappingURL=IconWorldPause.svelte.js.map
