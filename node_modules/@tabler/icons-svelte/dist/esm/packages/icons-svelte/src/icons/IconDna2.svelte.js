...
/* src/icons/IconDna2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dna-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDna2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDna2$1 = IconDna2;

export { IconDna2$1 as default };
//# sourceMappingURL=IconDna2.svelte.js.map
