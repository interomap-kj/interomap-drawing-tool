...
/* src/icons/IconRobot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "robot" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRobot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRobot$1 = IconRobot;

export { IconRobot$1 as default };
//# sourceMappingURL=IconRobot.svelte.js.map
