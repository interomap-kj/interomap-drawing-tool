...
/* src/icons/IconLetterI.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-i" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M12 4l0 16" }]];
...
class IconLetterI extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterI$1 = IconLetterI;

export { IconLetterI$1 as default };
//# sourceMappingURL=IconLetterI.svelte.js.map
