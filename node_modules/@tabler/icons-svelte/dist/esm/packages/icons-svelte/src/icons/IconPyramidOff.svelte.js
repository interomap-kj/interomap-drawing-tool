...
/* src/icons/IconPyramidOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pyramid-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPyramidOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPyramidOff$1 = IconPyramidOff;

export { IconPyramidOff$1 as default };
//# sourceMappingURL=IconPyramidOff.svelte.js.map
