...
/* src/icons/IconDropletOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "droplet-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDropletOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDropletOff$1 = IconDropletOff;

export { IconDropletOff$1 as default };
//# sourceMappingURL=IconDropletOff.svelte.js.map
