...
/* src/icons/IconPolaroid.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "polaroid" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPolaroid extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPolaroid$1 = IconPolaroid;

export { IconPolaroid$1 as default };
//# sourceMappingURL=IconPolaroid.svelte.js.map
