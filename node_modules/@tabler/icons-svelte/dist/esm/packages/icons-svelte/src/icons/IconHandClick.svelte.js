...
/* src/icons/IconHandClick.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hand-click" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHandClick extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHandClick$1 = IconHandClick;

export { IconHandClick$1 as default };
//# sourceMappingURL=IconHandClick.svelte.js.map
