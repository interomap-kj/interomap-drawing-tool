...
/* src/icons/IconId.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "id" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconId extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconId$1 as default };
//# sourceMappingURL=IconId.svelte.js.map
