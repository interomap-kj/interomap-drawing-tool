...
/* src/icons/IconArticleOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "article-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArticleOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArticleOff$1 = IconArticleOff;

export { IconArticleOff$1 as default };
//# sourceMappingURL=IconArticleOff.svelte.js.map
