...
/* src/icons/IconBrandLoom.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-loom" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandLoom extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandLoom$1 = IconBrandLoom;

export { IconBrandLoom$1 as default };
//# sourceMappingURL=IconBrandLoom.svelte.js.map
