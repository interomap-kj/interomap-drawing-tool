...
/* src/icons/IconLetterR.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-r" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterR extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterR$1 = IconLetterR;

export { IconLetterR$1 as default };
//# sourceMappingURL=IconLetterR.svelte.js.map
