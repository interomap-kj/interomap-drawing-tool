...
/* src/icons/IconWheelchair.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wheelchair" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWheelchair extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWheelchair$1 = IconWheelchair;

export { IconWheelchair$1 as default };
//# sourceMappingURL=IconWheelchair.svelte.js.map
