...
/* src/icons/IconPaperBag.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "paper-bag" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPaperBag extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPaperBag$1 = IconPaperBag;

export { IconPaperBag$1 as default };
//# sourceMappingURL=IconPaperBag.svelte.js.map
