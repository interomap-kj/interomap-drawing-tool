...
/* src/icons/IconBasketOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasketOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasketOff$1 = IconBasketOff;

export { IconBasketOff$1 as default };
//# sourceMappingURL=IconBasketOff.svelte.js.map
