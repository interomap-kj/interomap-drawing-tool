...
/* src/icons/IconStorm.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "storm" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStorm extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStorm$1 = IconStorm;

export { IconStorm$1 as default };
//# sourceMappingURL=IconStorm.svelte.js.map
