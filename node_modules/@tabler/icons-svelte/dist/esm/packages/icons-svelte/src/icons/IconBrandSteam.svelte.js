...
/* src/icons/IconBrandSteam.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-steam" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandSteam extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandSteam$1 = IconBrandSteam;

export { IconBrandSteam$1 as default };
//# sourceMappingURL=IconBrandSteam.svelte.js.map
