...
/* src/icons/IconLockSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockSearch$1 = IconLockSearch;

export { IconLockSearch$1 as default };
//# sourceMappingURL=IconLockSearch.svelte.js.map
