...
/* src/icons/IconPokeball.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pokeball" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPokeball extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPokeball$1 = IconPokeball;

export { IconPokeball$1 as default };
//# sourceMappingURL=IconPokeball.svelte.js.map
