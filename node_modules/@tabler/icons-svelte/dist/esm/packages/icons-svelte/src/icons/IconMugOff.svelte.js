...
/* src/icons/IconMugOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mug-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMugOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMugOff$1 = IconMugOff;

export { IconMugOff$1 as default };
//# sourceMappingURL=IconMugOff.svelte.js.map
