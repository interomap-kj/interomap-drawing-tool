...
/* src/icons/IconAlpha.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "alpha" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAlpha extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAlpha$1 = IconAlpha;

export { IconAlpha$1 as default };
//# sourceMappingURL=IconAlpha.svelte.js.map
