...
/* src/icons/IconBrandUber.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-uber" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandUber extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandUber$1 = IconBrandUber;

export { IconBrandUber$1 as default };
//# sourceMappingURL=IconBrandUber.svelte.js.map
