...
/* src/icons/IconLetterM.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-m" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M6 20v-16l6 14l6 -14v16" }]];
...
class IconLetterM extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterM$1 = IconLetterM;

export { IconLetterM$1 as default };
//# sourceMappingURL=IconLetterM.svelte.js.map
