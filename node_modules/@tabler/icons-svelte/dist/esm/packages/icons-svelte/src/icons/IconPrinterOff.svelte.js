...
/* src/icons/IconPrinterOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "printer-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPrinterOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPrinterOff$1 = IconPrinterOff;

export { IconPrinterOff$1 as default };
//# sourceMappingURL=IconPrinterOff.svelte.js.map
