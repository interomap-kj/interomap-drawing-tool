...
/* src/icons/IconBasket.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "basket" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBasket extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBasket$1 = IconBasket;

export { IconBasket$1 as default };
//# sourceMappingURL=IconBasket.svelte.js.map
