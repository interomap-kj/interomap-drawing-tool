...
/* src/icons/IconDevices.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "devices" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDevices extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDevices$1 = IconDevices;

export { IconDevices$1 as default };
//# sourceMappingURL=IconDevices.svelte.js.map
