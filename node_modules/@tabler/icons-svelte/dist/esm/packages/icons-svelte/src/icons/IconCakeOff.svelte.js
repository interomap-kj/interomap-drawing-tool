...
/* src/icons/IconCakeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cake-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCakeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCakeOff$1 = IconCakeOff;

export { IconCakeOff$1 as default };
//# sourceMappingURL=IconCakeOff.svelte.js.map
