...
/* src/icons/IconMeat.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "meat" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMeat extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMeat$1 = IconMeat;

export { IconMeat$1 as default };
//# sourceMappingURL=IconMeat.svelte.js.map
