...
/* src/icons/IconSignal2g.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-2g" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignal2g extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignal2g$1 = IconSignal2g;

export { IconSignal2g$1 as default };
//# sourceMappingURL=IconSignal2g.svelte.js.map
