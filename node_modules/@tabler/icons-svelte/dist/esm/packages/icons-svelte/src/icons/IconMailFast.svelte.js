...
/* src/icons/IconMailFast.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-fast" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailFast extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailFast$1 = IconMailFast;

export { IconMailFast$1 as default };
//# sourceMappingURL=IconMailFast.svelte.js.map
