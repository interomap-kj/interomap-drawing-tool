...
/* src/icons/IconGlass.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "glass" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGlass extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGlass$1 = IconGlass;

export { IconGlass$1 as default };
//# sourceMappingURL=IconGlass.svelte.js.map
