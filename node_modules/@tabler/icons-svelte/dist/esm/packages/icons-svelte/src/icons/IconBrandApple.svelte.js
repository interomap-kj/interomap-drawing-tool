...
/* src/icons/IconBrandApple.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-apple" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandApple extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandApple$1 = IconBrandApple;

export { IconBrandApple$1 as default };
//# sourceMappingURL=IconBrandApple.svelte.js.map
