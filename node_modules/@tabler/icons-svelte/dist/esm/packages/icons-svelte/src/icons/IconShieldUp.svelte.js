...
/* src/icons/IconShieldUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldUp$1 = IconShieldUp;

export { IconShieldUp$1 as default };
//# sourceMappingURL=IconShieldUp.svelte.js.map
