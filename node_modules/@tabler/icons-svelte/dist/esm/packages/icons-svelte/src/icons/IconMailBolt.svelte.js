...
/* src/icons/IconMailBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailBolt$1 = IconMailBolt;

export { IconMailBolt$1 as default };
//# sourceMappingURL=IconMailBolt.svelte.js.map
