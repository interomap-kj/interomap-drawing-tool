...
/* src/icons/IconClockShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockShare$1 = IconClockShare;

export { IconClockShare$1 as default };
//# sourceMappingURL=IconClockShare.svelte.js.map
