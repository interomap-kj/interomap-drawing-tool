...
/* src/icons/IconBounceLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bounce-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBounceLeft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBounceLeft$1 = IconBounceLeft;

export { IconBounceLeft$1 as default };
//# sourceMappingURL=IconBounceLeft.svelte.js.map
