...
/* src/icons/IconFileReport.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-report" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileReport extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileReport$1 = IconFileReport;

export { IconFileReport$1 as default };
//# sourceMappingURL=IconFileReport.svelte.js.map
