...
/* src/icons/IconBrightness.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brightness" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrightness extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrightness$1 = IconBrightness;

export { IconBrightness$1 as default };
//# sourceMappingURL=IconBrightness.svelte.js.map
