...
/* src/icons/IconStackPop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stack-pop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStackPop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStackPop$1 = IconStackPop;

export { IconStackPop$1 as default };
//# sourceMappingURL=IconStackPop.svelte.js.map
