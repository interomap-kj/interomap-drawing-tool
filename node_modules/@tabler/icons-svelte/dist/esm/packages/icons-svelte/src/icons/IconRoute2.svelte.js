...
/* src/icons/IconRoute2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "route-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRoute2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRoute2$1 = IconRoute2;

export { IconRoute2$1 as default };
//# sourceMappingURL=IconRoute2.svelte.js.map
