...
/* src/icons/IconUsersGroup.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "users-group" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUsersGroup extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUsersGroup$1 = IconUsersGroup;

export { IconUsersGroup$1 as default };
//# sourceMappingURL=IconUsersGroup.svelte.js.map
