...
/* src/icons/IconTrident.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trident" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrident extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrident$1 = IconTrident;

export { IconTrident$1 as default };
//# sourceMappingURL=IconTrident.svelte.js.map
