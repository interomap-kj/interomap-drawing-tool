...
/* src/icons/IconArrowsLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrows-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowsLeft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowsLeft$1 = IconArrowsLeft;

export { IconArrowsLeft$1 as default };
//# sourceMappingURL=IconArrowsLeft.svelte.js.map
