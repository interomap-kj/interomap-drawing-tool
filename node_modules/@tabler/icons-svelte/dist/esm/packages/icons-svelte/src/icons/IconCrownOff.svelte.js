...
/* src/icons/IconCrownOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "crown-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCrownOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCrownOff$1 = IconCrownOff;

export { IconCrownOff$1 as default };
//# sourceMappingURL=IconCrownOff.svelte.js.map
