...
/* src/icons/IconPointerX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pointer-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPointerX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPointerX$1 = IconPointerX;

export { IconPointerX$1 as default };
//# sourceMappingURL=IconPointerX.svelte.js.map
