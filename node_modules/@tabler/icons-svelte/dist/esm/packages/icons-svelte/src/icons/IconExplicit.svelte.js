...
/* src/icons/IconExplicit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "explicit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconExplicit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconExplicit$1 = IconExplicit;

export { IconExplicit$1 as default };
//# sourceMappingURL=IconExplicit.svelte.js.map
