...
/* src/icons/IconRings.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rings" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRings extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRings$1 = IconRings;

export { IconRings$1 as default };
//# sourceMappingURL=IconRings.svelte.js.map
