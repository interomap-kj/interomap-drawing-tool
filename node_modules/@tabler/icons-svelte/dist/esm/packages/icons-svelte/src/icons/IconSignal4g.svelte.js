...
/* src/icons/IconSignal4g.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-4g" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignal4g extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignal4g$1 = IconSignal4g;

export { IconSignal4g$1 as default };
//# sourceMappingURL=IconSignal4g.svelte.js.map
