...
/* src/icons/IconServicemark.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "servicemark" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconServicemark extends SvelteComponent {
	constructor(options) {
		super();
...
var IconServicemark$1 = IconServicemark;

export { IconServicemark$1 as default };
//# sourceMappingURL=IconServicemark.svelte.js.map
