...
/* src/icons/IconSwordOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sword-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSwordOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwordOff$1 = IconSwordOff;

export { IconSwordOff$1 as default };
//# sourceMappingURL=IconSwordOff.svelte.js.map
