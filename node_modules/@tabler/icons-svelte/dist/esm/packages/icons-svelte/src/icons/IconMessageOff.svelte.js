...
/* src/icons/IconMessageOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessageOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessageOff$1 = IconMessageOff;

export { IconMessageOff$1 as default };
//# sourceMappingURL=IconMessageOff.svelte.js.map
