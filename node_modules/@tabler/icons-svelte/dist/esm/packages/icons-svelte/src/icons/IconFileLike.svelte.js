...
/* src/icons/IconFileLike.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-like" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileLike extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileLike$1 = IconFileLike;

export { IconFileLike$1 as default };
//# sourceMappingURL=IconFileLike.svelte.js.map
