...
/* src/icons/IconBrandRedux.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-redux" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandRedux extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandRedux$1 = IconBrandRedux;

export { IconBrandRedux$1 as default };
//# sourceMappingURL=IconBrandRedux.svelte.js.map
