...
/* src/icons/IconChartRadar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-radar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartRadar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartRadar$1 = IconChartRadar;

export { IconChartRadar$1 as default };
//# sourceMappingURL=IconChartRadar.svelte.js.map
