...
/* src/icons/IconLadder.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ladder" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLadder extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLadder$1 = IconLadder;

export { IconLadder$1 as default };
//# sourceMappingURL=IconLadder.svelte.js.map
