...
/* src/icons/IconPhotoCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoCheck$1 = IconPhotoCheck;

export { IconPhotoCheck$1 as default };
//# sourceMappingURL=IconPhotoCheck.svelte.js.map
