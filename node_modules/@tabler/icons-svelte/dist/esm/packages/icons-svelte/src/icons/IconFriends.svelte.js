...
/* src/icons/IconFriends.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "friends" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFriends extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFriends$1 = IconFriends;

export { IconFriends$1 as default };
//# sourceMappingURL=IconFriends.svelte.js.map
