...
/* src/icons/IconWriting.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "writing" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWriting extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWriting$1 = IconWriting;

export { IconWriting$1 as default };
//# sourceMappingURL=IconWriting.svelte.js.map
