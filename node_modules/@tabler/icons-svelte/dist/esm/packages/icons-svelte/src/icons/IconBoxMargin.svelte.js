...
/* src/icons/IconBoxMargin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "box-margin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoxMargin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoxMargin$1 = IconBoxMargin;

export { IconBoxMargin$1 as default };
//# sourceMappingURL=IconBoxMargin.svelte.js.map
