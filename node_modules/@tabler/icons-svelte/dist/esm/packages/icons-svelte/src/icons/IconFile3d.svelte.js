...
/* src/icons/IconFile3d.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-3d" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFile3d extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFile3d$1 = IconFile3d;

export { IconFile3d$1 as default };
//# sourceMappingURL=IconFile3d.svelte.js.map
