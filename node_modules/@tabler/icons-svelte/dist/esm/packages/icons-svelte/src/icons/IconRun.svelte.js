...
/* src/icons/IconRun.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "run" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRun extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRun$1 = IconRun;

export { IconRun$1 as default };
//# sourceMappingURL=IconRun.svelte.js.map
