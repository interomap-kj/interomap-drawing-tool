...
/* src/icons/IconBrandAdobe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-adobe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandAdobe extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandAdobe$1 = IconBrandAdobe;

export { IconBrandAdobe$1 as default };
//# sourceMappingURL=IconBrandAdobe.svelte.js.map
