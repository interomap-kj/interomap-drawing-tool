...
/* src/icons/IconFileDelta.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-delta" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileDelta extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileDelta$1 = IconFileDelta;

export { IconFileDelta$1 as default };
//# sourceMappingURL=IconFileDelta.svelte.js.map
