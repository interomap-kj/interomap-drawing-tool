...
/* src/icons/IconBookUpload.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "book-upload" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBookUpload extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBookUpload$1 = IconBookUpload;

export { IconBookUpload$1 as default };
//# sourceMappingURL=IconBookUpload.svelte.js.map
