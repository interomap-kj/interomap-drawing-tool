...
/* src/icons/IconLockDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockDollar$1 = IconLockDollar;

export { IconLockDollar$1 as default };
//# sourceMappingURL=IconLockDollar.svelte.js.map
