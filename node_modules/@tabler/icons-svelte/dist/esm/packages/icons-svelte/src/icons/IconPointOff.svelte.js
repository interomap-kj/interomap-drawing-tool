...
/* src/icons/IconPointOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "point-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPointOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPointOff$1 = IconPointOff;

export { IconPointOff$1 as default };
//# sourceMappingURL=IconPointOff.svelte.js.map
