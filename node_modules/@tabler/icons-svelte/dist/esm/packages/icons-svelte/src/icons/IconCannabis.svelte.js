...
/* src/icons/IconCannabis.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cannabis" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCannabis extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCannabis$1 = IconCannabis;

export { IconCannabis$1 as default };
//# sourceMappingURL=IconCannabis.svelte.js.map
