...
/* src/icons/IconPoint.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "point" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPoint extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPoint$1 = IconPoint;

export { IconPoint$1 as default };
//# sourceMappingURL=IconPoint.svelte.js.map
