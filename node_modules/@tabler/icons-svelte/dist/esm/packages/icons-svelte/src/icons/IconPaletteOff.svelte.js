...
/* src/icons/IconPaletteOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "palette-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPaletteOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPaletteOff$1 = IconPaletteOff;

export { IconPaletteOff$1 as default };
//# sourceMappingURL=IconPaletteOff.svelte.js.map
