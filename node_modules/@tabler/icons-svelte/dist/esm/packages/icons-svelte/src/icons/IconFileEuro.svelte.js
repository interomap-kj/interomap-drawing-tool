...
/* src/icons/IconFileEuro.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-euro" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileEuro extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileEuro$1 = IconFileEuro;

export { IconFileEuro$1 as default };
//# sourceMappingURL=IconFileEuro.svelte.js.map
