...
/* src/icons/IconParking.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "parking" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconParking extends SvelteComponent {
	constructor(options) {
		super();
...
var IconParking$1 = IconParking;

export { IconParking$1 as default };
//# sourceMappingURL=IconParking.svelte.js.map
