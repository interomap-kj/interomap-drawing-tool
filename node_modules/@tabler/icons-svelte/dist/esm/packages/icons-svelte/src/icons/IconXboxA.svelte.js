...
/* src/icons/IconXboxA.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "xbox-a" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconXboxA extends SvelteComponent {
	constructor(options) {
		super();
...
var IconXboxA$1 = IconXboxA;

export { IconXboxA$1 as default };
//# sourceMappingURL=IconXboxA.svelte.js.map
