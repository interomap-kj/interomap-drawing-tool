...
/* src/icons/IconCane.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cane" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCane extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCane$1 = IconCane;

export { IconCane$1 as default };
//# sourceMappingURL=IconCane.svelte.js.map
