...
/* src/icons/IconXd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "xd" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconXd extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconXd$1 as default };
//# sourceMappingURL=IconXd.svelte.js.map
