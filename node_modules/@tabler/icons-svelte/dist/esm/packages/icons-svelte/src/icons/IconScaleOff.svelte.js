...
/* src/icons/IconScaleOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "scale-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScaleOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScaleOff$1 = IconScaleOff;

export { IconScaleOff$1 as default };
//# sourceMappingURL=IconScaleOff.svelte.js.map
