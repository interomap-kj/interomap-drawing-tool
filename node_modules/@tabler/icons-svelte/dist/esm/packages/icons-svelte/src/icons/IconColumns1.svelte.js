...
/* src/icons/IconColumns1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "columns-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconColumns1 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconColumns1$1 = IconColumns1;

export { IconColumns1$1 as default };
//# sourceMappingURL=IconColumns1.svelte.js.map
