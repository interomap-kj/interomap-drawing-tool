...
/* src/icons/IconArrowFork.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrow-fork" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowFork extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowFork$1 = IconArrowFork;

export { IconArrowFork$1 as default };
//# sourceMappingURL=IconArrowFork.svelte.js.map
