...
/* src/icons/IconAlarm.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "alarm" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAlarm extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAlarm$1 = IconAlarm;

export { IconAlarm$1 as default };
//# sourceMappingURL=IconAlarm.svelte.js.map
