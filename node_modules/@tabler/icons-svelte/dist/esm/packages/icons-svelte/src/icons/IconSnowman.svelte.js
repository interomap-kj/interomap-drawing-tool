...
/* src/icons/IconSnowman.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "snowman" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSnowman extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSnowman$1 = IconSnowman;

export { IconSnowman$1 as default };
//# sourceMappingURL=IconSnowman.svelte.js.map
