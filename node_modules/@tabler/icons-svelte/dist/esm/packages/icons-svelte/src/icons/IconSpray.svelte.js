...
/* src/icons/IconSpray.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "spray" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpray extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpray$1 = IconSpray;

export { IconSpray$1 as default };
//# sourceMappingURL=IconSpray.svelte.js.map
