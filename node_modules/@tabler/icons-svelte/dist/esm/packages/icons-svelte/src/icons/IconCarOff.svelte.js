...
/* src/icons/IconCarOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "car-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCarOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCarOff$1 = IconCarOff;

export { IconCarOff$1 as default };
//# sourceMappingURL=IconCarOff.svelte.js.map
