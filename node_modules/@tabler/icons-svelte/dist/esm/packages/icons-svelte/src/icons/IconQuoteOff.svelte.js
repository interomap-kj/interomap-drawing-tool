...
/* src/icons/IconQuoteOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "quote-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconQuoteOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconQuoteOff$1 = IconQuoteOff;

export { IconQuoteOff$1 as default };
//# sourceMappingURL=IconQuoteOff.svelte.js.map
