...
/* src/icons/IconFreezeRow.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "freeze-row" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFreezeRow extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFreezeRow$1 = IconFreezeRow;

export { IconFreezeRow$1 as default };
//# sourceMappingURL=IconFreezeRow.svelte.js.map
