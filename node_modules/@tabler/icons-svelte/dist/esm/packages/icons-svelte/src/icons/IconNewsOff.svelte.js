...
/* src/icons/IconNewsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "news-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNewsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNewsOff$1 = IconNewsOff;

export { IconNewsOff$1 as default };
//# sourceMappingURL=IconNewsOff.svelte.js.map
