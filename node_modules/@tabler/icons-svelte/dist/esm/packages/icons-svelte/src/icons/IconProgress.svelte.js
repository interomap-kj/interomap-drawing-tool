...
/* src/icons/IconProgress.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "progress" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconProgress extends SvelteComponent {
	constructor(options) {
		super();
...
var IconProgress$1 = IconProgress;

export { IconProgress$1 as default };
//# sourceMappingURL=IconProgress.svelte.js.map
