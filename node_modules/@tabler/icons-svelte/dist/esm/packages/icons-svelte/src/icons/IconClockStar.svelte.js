...
/* src/icons/IconClockStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockStar$1 = IconClockStar;

export { IconClockStar$1 as default };
//# sourceMappingURL=IconClockStar.svelte.js.map
