...
/* src/icons/IconBoldOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bold-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoldOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoldOff$1 = IconBoldOff;

export { IconBoldOff$1 as default };
//# sourceMappingURL=IconBoldOff.svelte.js.map
