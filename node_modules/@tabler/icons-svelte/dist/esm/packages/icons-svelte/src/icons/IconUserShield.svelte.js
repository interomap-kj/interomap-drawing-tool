...
/* src/icons/IconUserShield.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-shield" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserShield extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserShield$1 = IconUserShield;

export { IconUserShield$1 as default };
//# sourceMappingURL=IconUserShield.svelte.js.map
