...
/* src/icons/IconPhotoMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoMinus$1 = IconPhotoMinus;

export { IconPhotoMinus$1 as default };
//# sourceMappingURL=IconPhotoMinus.svelte.js.map
