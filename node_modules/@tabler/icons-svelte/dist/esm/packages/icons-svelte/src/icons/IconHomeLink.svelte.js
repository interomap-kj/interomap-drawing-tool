...
/* src/icons/IconHomeLink.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-link" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeLink extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeLink$1 = IconHomeLink;

export { IconHomeLink$1 as default };
//# sourceMappingURL=IconHomeLink.svelte.js.map
