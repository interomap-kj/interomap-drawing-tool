...
/* src/icons/IconBadges.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badges" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadges extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadges$1 = IconBadges;

export { IconBadges$1 as default };
//# sourceMappingURL=IconBadges.svelte.js.map
