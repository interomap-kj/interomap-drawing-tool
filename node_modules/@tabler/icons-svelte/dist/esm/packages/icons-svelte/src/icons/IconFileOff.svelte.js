...
/* src/icons/IconFileOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileOff$1 = IconFileOff;

export { IconFileOff$1 as default };
//# sourceMappingURL=IconFileOff.svelte.js.map
