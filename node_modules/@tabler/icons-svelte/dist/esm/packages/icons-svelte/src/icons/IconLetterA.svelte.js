...
/* src/icons/IconLetterA.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-a" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterA extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterA$1 = IconLetterA;

export { IconLetterA$1 as default };
//# sourceMappingURL=IconLetterA.svelte.js.map
