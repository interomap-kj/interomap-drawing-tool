...
/* src/icons/IconPhotoEdit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-edit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoEdit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoEdit$1 = IconPhotoEdit;

export { IconPhotoEdit$1 as default };
//# sourceMappingURL=IconPhotoEdit.svelte.js.map
