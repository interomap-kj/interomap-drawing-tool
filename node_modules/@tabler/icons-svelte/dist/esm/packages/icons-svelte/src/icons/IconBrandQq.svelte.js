...
/* src/icons/IconBrandQq.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-qq" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandQq extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandQq$1 = IconBrandQq;

export { IconBrandQq$1 as default };
//# sourceMappingURL=IconBrandQq.svelte.js.map
