...
/* src/icons/IconBarbellOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "barbell-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBarbellOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBarbellOff$1 = IconBarbellOff;

export { IconBarbellOff$1 as default };
//# sourceMappingURL=IconBarbellOff.svelte.js.map
