...
/* src/icons/IconZoomCancel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-cancel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomCancel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomCancel$1 = IconZoomCancel;

export { IconZoomCancel$1 as default };
//# sourceMappingURL=IconZoomCancel.svelte.js.map
