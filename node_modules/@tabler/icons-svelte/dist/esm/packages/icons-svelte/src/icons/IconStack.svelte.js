...
/* src/icons/IconStack.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stack" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStack extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStack$1 = IconStack;

export { IconStack$1 as default };
//# sourceMappingURL=IconStack.svelte.js.map
