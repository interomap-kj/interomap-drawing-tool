...
/* src/icons/IconSTurnUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "s-turn-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSTurnUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSTurnUp$1 = IconSTurnUp;

export { IconSTurnUp$1 as default };
//# sourceMappingURL=IconSTurnUp.svelte.js.map
