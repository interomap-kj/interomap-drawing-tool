...
/* src/icons/IconPizzaOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pizza-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPizzaOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPizzaOff$1 = IconPizzaOff;

export { IconPizzaOff$1 as default };
//# sourceMappingURL=IconPizzaOff.svelte.js.map
