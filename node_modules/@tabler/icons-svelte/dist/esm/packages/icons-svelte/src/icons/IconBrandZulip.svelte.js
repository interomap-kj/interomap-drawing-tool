...
/* src/icons/IconBrandZulip.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-zulip" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandZulip extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandZulip$1 = IconBrandZulip;

export { IconBrandZulip$1 as default };
//# sourceMappingURL=IconBrandZulip.svelte.js.map
