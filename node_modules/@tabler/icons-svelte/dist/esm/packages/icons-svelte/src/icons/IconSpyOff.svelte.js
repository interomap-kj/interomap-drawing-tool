...
/* src/icons/IconSpyOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "spy-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpyOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpyOff$1 = IconSpyOff;

export { IconSpyOff$1 as default };
//# sourceMappingURL=IconSpyOff.svelte.js.map
