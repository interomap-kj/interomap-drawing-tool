...
/* src/icons/IconStack3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stack-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStack3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStack3$1 = IconStack3;

export { IconStack3$1 as default };
//# sourceMappingURL=IconStack3.svelte.js.map
