...
/* src/icons/IconPointerCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pointer-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPointerCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPointerCog$1 = IconPointerCog;

export { IconPointerCog$1 as default };
//# sourceMappingURL=IconPointerCog.svelte.js.map
