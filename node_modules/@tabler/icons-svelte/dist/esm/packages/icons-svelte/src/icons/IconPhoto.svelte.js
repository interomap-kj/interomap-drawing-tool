...
/* src/icons/IconPhoto.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhoto extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhoto$1 = IconPhoto;

export { IconPhoto$1 as default };
//# sourceMappingURL=IconPhoto.svelte.js.map
