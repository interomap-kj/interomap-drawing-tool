...
/* src/icons/IconBrandDrops.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-drops" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandDrops extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandDrops$1 = IconBrandDrops;

export { IconBrandDrops$1 as default };
//# sourceMappingURL=IconBrandDrops.svelte.js.map
