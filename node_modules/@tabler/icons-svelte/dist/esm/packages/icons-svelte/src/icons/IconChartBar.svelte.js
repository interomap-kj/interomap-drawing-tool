...
/* src/icons/IconChartBar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-bar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartBar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartBar$1 = IconChartBar;

export { IconChartBar$1 as default };
//# sourceMappingURL=IconChartBar.svelte.js.map
