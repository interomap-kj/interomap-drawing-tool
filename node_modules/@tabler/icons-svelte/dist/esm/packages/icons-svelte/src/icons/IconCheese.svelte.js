...
/* src/icons/IconCheese.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cheese" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCheese extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCheese$1 = IconCheese;

export { IconCheese$1 as default };
//# sourceMappingURL=IconCheese.svelte.js.map
