...
/* src/icons/IconMoped.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "moped" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoped extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoped$1 = IconMoped;

export { IconMoped$1 as default };
//# sourceMappingURL=IconMoped.svelte.js.map
