...
/* src/icons/IconStarFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "star-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStarFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStarFilled$1 = IconStarFilled;

export { IconStarFilled$1 as default };
//# sourceMappingURL=IconStarFilled.svelte.js.map
