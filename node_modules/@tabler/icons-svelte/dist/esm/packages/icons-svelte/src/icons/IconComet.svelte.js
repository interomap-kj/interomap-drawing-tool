...
/* src/icons/IconComet.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "comet" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconComet extends SvelteComponent {
	constructor(options) {
		super();
...
var IconComet$1 = IconComet;

export { IconComet$1 as default };
//# sourceMappingURL=IconComet.svelte.js.map
