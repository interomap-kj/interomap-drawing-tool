...
/* src/icons/IconShiJumping.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shi-jumping" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShiJumping extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShiJumping$1 = IconShiJumping;

export { IconShiJumping$1 as default };
//# sourceMappingURL=IconShiJumping.svelte.js.map
