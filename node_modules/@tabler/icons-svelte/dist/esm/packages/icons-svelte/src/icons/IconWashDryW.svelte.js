...
/* src/icons/IconWashDryW.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-dry-w" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashDryW extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashDryW$1 = IconWashDryW;

export { IconWashDryW$1 as default };
//# sourceMappingURL=IconWashDryW.svelte.js.map
