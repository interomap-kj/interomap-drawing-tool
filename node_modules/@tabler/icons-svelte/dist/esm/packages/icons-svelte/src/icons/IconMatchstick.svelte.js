...
/* src/icons/IconMatchstick.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "matchstick" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMatchstick extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMatchstick$1 = IconMatchstick;

export { IconMatchstick$1 as default };
//# sourceMappingURL=IconMatchstick.svelte.js.map
