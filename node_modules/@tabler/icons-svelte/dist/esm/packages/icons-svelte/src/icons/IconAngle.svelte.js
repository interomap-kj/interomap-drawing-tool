...
/* src/icons/IconAngle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "angle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAngle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAngle$1 = IconAngle;

export { IconAngle$1 as default };
//# sourceMappingURL=IconAngle.svelte.js.map
