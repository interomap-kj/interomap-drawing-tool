...
/* src/icons/IconTir.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tir" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTir extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTir$1 = IconTir;

export { IconTir$1 as default };
//# sourceMappingURL=IconTir.svelte.js.map
