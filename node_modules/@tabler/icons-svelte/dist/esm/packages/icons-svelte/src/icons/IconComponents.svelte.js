...
/* src/icons/IconComponents.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "components" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconComponents extends SvelteComponent {
	constructor(options) {
		super();
...
var IconComponents$1 = IconComponents;

export { IconComponents$1 as default };
//# sourceMappingURL=IconComponents.svelte.js.map
