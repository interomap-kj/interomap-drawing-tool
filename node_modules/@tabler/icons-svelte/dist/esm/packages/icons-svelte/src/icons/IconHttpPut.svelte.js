...
/* src/icons/IconHttpPut.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-put" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpPut extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpPut$1 = IconHttpPut;

export { IconHttpPut$1 as default };
//# sourceMappingURL=IconHttpPut.svelte.js.map
