...
/* src/icons/IconGasStation.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gas-station" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGasStation extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGasStation$1 = IconGasStation;

export { IconGasStation$1 as default };
//# sourceMappingURL=IconGasStation.svelte.js.map
