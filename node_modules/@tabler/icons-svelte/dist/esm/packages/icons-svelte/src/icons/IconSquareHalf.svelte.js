...
/* src/icons/IconSquareHalf.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-half" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareHalf extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareHalf$1 = IconSquareHalf;

export { IconSquareHalf$1 as default };
//# sourceMappingURL=IconSquareHalf.svelte.js.map
