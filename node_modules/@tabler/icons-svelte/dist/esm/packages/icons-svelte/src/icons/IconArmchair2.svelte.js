...
/* src/icons/IconArmchair2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "armchair-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArmchair2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArmchair2$1 = IconArmchair2;

export { IconArmchair2$1 as default };
//# sourceMappingURL=IconArmchair2.svelte.js.map
