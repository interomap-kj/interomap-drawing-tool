...
/* src/icons/IconClearAll.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clear-all" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClearAll extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClearAll$1 = IconClearAll;

export { IconClearAll$1 as default };
//# sourceMappingURL=IconClearAll.svelte.js.map
