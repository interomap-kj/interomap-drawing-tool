...
/* src/icons/IconMapPins.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-pins" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapPins extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapPins$1 = IconMapPins;

export { IconMapPins$1 as default };
//# sourceMappingURL=IconMapPins.svelte.js.map
