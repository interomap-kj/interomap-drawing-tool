...
/* src/icons/IconHttpPost.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-post" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpPost extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpPost$1 = IconHttpPost;

export { IconHttpPost$1 as default };
//# sourceMappingURL=IconHttpPost.svelte.js.map
