...
/* src/icons/IconInfoSmall.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "info-small" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M12 9h.01" }], ["path", { "d": "M11 12h1v4h1" }]];
...
class IconInfoSmall extends SvelteComponent {
	constructor(options) {
		super();
...
var IconInfoSmall$1 = IconInfoSmall;

export { IconInfoSmall$1 as default };
//# sourceMappingURL=IconInfoSmall.svelte.js.map
