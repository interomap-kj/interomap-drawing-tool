...
/* src/icons/IconDroneOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "drone-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDroneOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDroneOff$1 = IconDroneOff;

export { IconDroneOff$1 as default };
//# sourceMappingURL=IconDroneOff.svelte.js.map
