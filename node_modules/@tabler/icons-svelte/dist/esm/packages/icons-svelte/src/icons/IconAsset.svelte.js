...
/* src/icons/IconAsset.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "asset" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAsset extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAsset$1 = IconAsset;

export { IconAsset$1 as default };
//# sourceMappingURL=IconAsset.svelte.js.map
