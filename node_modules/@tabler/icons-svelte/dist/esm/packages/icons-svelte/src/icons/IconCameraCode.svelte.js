...
/* src/icons/IconCameraCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraCode$1 = IconCameraCode;

export { IconCameraCode$1 as default };
//# sourceMappingURL=IconCameraCode.svelte.js.map
