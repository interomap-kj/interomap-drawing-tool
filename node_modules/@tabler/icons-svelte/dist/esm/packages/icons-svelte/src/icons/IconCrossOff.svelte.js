...
/* src/icons/IconCrossOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cross-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCrossOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCrossOff$1 = IconCrossOff;

export { IconCrossOff$1 as default };
//# sourceMappingURL=IconCrossOff.svelte.js.map
