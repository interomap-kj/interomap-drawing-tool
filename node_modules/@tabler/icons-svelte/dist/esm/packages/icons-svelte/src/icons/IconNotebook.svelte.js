...
/* src/icons/IconNotebook.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "notebook" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNotebook extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNotebook$1 = IconNotebook;

export { IconNotebook$1 as default };
//# sourceMappingURL=IconNotebook.svelte.js.map
