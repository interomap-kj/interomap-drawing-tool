...
/* src/icons/IconMassage.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "massage" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMassage extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMassage$1 = IconMassage;

export { IconMassage$1 as default };
//# sourceMappingURL=IconMassage.svelte.js.map
