...
/* src/icons/IconReport.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "report" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconReport extends SvelteComponent {
	constructor(options) {
		super();
...
var IconReport$1 = IconReport;

export { IconReport$1 as default };
//# sourceMappingURL=IconReport.svelte.js.map
