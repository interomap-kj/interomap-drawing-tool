...
/* src/icons/IconCoffeeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coffee-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoffeeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoffeeOff$1 = IconCoffeeOff;

export { IconCoffeeOff$1 as default };
//# sourceMappingURL=IconCoffeeOff.svelte.js.map
