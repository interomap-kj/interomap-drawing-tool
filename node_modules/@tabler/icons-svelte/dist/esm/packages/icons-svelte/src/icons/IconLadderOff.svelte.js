...
/* src/icons/IconLadderOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ladder-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLadderOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLadderOff$1 = IconLadderOff;

export { IconLadderOff$1 as default };
//# sourceMappingURL=IconLadderOff.svelte.js.map
