...
/* src/icons/IconGrain.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grain" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrain extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrain$1 = IconGrain;

export { IconGrain$1 as default };
//# sourceMappingURL=IconGrain.svelte.js.map
