...
/* src/icons/IconBrandCupra.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-cupra" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandCupra extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandCupra$1 = IconBrandCupra;

export { IconBrandCupra$1 as default };
//# sourceMappingURL=IconBrandCupra.svelte.js.map
