...
/* src/icons/IconHomeEco.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-eco" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeEco extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeEco$1 = IconHomeEco;

export { IconHomeEco$1 as default };
//# sourceMappingURL=IconHomeEco.svelte.js.map
