...
/* src/icons/IconPlugOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plug-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlugOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlugOff$1 = IconPlugOff;

export { IconPlugOff$1 as default };
//# sourceMappingURL=IconPlugOff.svelte.js.map
