...
/* src/icons/IconBible.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bible" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBible extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBible$1 = IconBible;

export { IconBible$1 as default };
//# sourceMappingURL=IconBible.svelte.js.map
