...
/* src/icons/IconSpiral.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "spiral" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpiral extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpiral$1 = IconSpiral;

export { IconSpiral$1 as default };
//# sourceMappingURL=IconSpiral.svelte.js.map
