...
/* src/icons/IconAtOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "at-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAtOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAtOff$1 = IconAtOff;

export { IconAtOff$1 as default };
//# sourceMappingURL=IconAtOff.svelte.js.map
