...
/* src/icons/IconLetterD.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-d" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterD extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterD$1 = IconLetterD;

export { IconLetterD$1 as default };
//# sourceMappingURL=IconLetterD.svelte.js.map
