...
/* src/icons/IconBabyBottle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "baby-bottle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBabyBottle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBabyBottle$1 = IconBabyBottle;

export { IconBabyBottle$1 as default };
//# sourceMappingURL=IconBabyBottle.svelte.js.map
