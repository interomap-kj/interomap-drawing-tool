...
/* src/icons/IconMagnetOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "magnet-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMagnetOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMagnetOff$1 = IconMagnetOff;

export { IconMagnetOff$1 as default };
//# sourceMappingURL=IconMagnetOff.svelte.js.map
