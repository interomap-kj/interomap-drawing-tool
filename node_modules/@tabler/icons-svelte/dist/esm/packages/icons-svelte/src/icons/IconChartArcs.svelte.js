...
/* src/icons/IconChartArcs.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-arcs" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartArcs extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartArcs$1 = IconChartArcs;

export { IconChartArcs$1 as default };
//# sourceMappingURL=IconChartArcs.svelte.js.map
