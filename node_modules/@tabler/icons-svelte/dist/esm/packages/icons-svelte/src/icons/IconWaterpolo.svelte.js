...
/* src/icons/IconWaterpolo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "waterpolo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWaterpolo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWaterpolo$1 = IconWaterpolo;

export { IconWaterpolo$1 as default };
//# sourceMappingURL=IconWaterpolo.svelte.js.map
