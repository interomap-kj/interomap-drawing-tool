...
/* src/icons/IconStepInto.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "step-into" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStepInto extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStepInto$1 = IconStepInto;

export { IconStepInto$1 as default };
//# sourceMappingURL=IconStepInto.svelte.js.map
