...
/* src/icons/IconCamper.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camper" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCamper extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCamper$1 = IconCamper;

export { IconCamper$1 as default };
//# sourceMappingURL=IconCamper.svelte.js.map
