...
/* src/icons/IconWorldPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldPin$1 = IconWorldPin;

export { IconWorldPin$1 as default };
//# sourceMappingURL=IconWorldPin.svelte.js.map
