...
/* src/icons/IconBlade.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "blade" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBlade extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBlade$1 = IconBlade;

export { IconBlade$1 as default };
//# sourceMappingURL=IconBlade.svelte.js.map
