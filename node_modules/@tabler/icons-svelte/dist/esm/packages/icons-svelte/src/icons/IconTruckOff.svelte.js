...
/* src/icons/IconTruckOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "truck-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTruckOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTruckOff$1 = IconTruckOff;

export { IconTruckOff$1 as default };
//# sourceMappingURL=IconTruckOff.svelte.js.map
