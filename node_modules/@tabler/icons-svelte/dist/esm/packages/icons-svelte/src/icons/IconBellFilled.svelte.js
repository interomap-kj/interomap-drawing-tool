...
/* src/icons/IconBellFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellFilled$1 = IconBellFilled;

export { IconBellFilled$1 as default };
//# sourceMappingURL=IconBellFilled.svelte.js.map
