...
/* src/icons/IconGrill.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grill" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrill extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrill$1 = IconGrill;

export { IconGrill$1 as default };
//# sourceMappingURL=IconGrill.svelte.js.map
