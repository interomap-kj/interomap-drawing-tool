...
/* src/icons/IconVaccine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vaccine" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVaccine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVaccine$1 = IconVaccine;

export { IconVaccine$1 as default };
//# sourceMappingURL=IconVaccine.svelte.js.map
