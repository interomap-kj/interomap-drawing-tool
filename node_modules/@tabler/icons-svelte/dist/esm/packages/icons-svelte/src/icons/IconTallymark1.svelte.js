...
/* src/icons/IconTallymark1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tallymark-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M12 5l0 14" }]];
...
class IconTallymark1 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTallymark1$1 = IconTallymark1;

export { IconTallymark1$1 as default };
//# sourceMappingURL=IconTallymark1.svelte.js.map
