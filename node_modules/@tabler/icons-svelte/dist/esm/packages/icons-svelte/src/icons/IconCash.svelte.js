...
/* src/icons/IconCash.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cash" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCash extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCash$1 = IconCash;

export { IconCash$1 as default };
//# sourceMappingURL=IconCash.svelte.js.map
