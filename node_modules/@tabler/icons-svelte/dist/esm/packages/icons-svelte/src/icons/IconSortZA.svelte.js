...
/* src/icons/IconSortZA.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sort-z-a" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSortZA extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSortZA$1 = IconSortZA;

export { IconSortZA$1 as default };
//# sourceMappingURL=IconSortZA.svelte.js.map
