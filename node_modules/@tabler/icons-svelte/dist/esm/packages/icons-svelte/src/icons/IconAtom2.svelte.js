...
/* src/icons/IconAtom2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "atom-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAtom2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAtom2$1 = IconAtom2;

export { IconAtom2$1 as default };
//# sourceMappingURL=IconAtom2.svelte.js.map
