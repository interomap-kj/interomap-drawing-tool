...
/* src/icons/IconUfoOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ufo-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUfoOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUfoOff$1 = IconUfoOff;

export { IconUfoOff$1 as default };
//# sourceMappingURL=IconUfoOff.svelte.js.map
