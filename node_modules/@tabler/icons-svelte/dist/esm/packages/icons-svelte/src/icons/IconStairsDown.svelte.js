...
/* src/icons/IconStairsDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stairs-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStairsDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStairsDown$1 = IconStairsDown;

export { IconStairsDown$1 as default };
//# sourceMappingURL=IconStairsDown.svelte.js.map
