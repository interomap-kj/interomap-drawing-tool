...
/* src/icons/IconBulbOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bulb-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBulbOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBulbOff$1 = IconBulbOff;

export { IconBulbOff$1 as default };
//# sourceMappingURL=IconBulbOff.svelte.js.map
