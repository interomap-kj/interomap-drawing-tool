...
/* src/icons/IconCameraUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraUp$1 = IconCameraUp;

export { IconCameraUp$1 as default };
//# sourceMappingURL=IconCameraUp.svelte.js.map
