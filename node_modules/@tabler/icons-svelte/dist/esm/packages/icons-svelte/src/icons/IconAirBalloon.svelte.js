...
/* src/icons/IconAirBalloon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "air-balloon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAirBalloon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAirBalloon$1 = IconAirBalloon;

export { IconAirBalloon$1 as default };
//# sourceMappingURL=IconAirBalloon.svelte.js.map
