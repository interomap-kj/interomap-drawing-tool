...
/* src/icons/IconMailboxOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mailbox-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailboxOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailboxOff$1 = IconMailboxOff;

export { IconMailboxOff$1 as default };
//# sourceMappingURL=IconMailboxOff.svelte.js.map
