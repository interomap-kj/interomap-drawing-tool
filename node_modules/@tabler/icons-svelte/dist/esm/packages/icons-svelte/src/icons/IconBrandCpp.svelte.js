...
/* src/icons/IconBrandCpp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-cpp" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandCpp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandCpp$1 = IconBrandCpp;

export { IconBrandCpp$1 as default };
//# sourceMappingURL=IconBrandCpp.svelte.js.map
