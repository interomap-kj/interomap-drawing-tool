...
/* src/icons/IconReceiptTax.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "receipt-tax" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconReceiptTax extends SvelteComponent {
	constructor(options) {
		super();
...
var IconReceiptTax$1 = IconReceiptTax;

export { IconReceiptTax$1 as default };
//# sourceMappingURL=IconReceiptTax.svelte.js.map
