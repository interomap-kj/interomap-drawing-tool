...
/* src/icons/IconBrowserX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "browser-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrowserX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrowserX$1 = IconBrowserX;

export { IconBrowserX$1 as default };
//# sourceMappingURL=IconBrowserX.svelte.js.map
