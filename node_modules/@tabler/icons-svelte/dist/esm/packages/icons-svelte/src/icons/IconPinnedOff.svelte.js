...
/* src/icons/IconPinnedOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pinned-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPinnedOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPinnedOff$1 = IconPinnedOff;

export { IconPinnedOff$1 as default };
//# sourceMappingURL=IconPinnedOff.svelte.js.map
