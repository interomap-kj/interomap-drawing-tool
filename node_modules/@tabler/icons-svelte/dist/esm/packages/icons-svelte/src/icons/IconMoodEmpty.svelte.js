...
/* src/icons/IconMoodEmpty.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-empty" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodEmpty extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodEmpty$1 = IconMoodEmpty;

export { IconMoodEmpty$1 as default };
//# sourceMappingURL=IconMoodEmpty.svelte.js.map
