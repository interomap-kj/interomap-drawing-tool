...
/* src/icons/IconSourceCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "source-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSourceCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSourceCode$1 = IconSourceCode;

export { IconSourceCode$1 as default };
//# sourceMappingURL=IconSourceCode.svelte.js.map
