...
/* src/icons/IconSubtask.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "subtask" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSubtask extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSubtask$1 = IconSubtask;

export { IconSubtask$1 as default };
//# sourceMappingURL=IconSubtask.svelte.js.map
