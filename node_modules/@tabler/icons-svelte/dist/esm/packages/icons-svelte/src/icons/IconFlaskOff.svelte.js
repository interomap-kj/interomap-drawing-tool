...
/* src/icons/IconFlaskOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "flask-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFlaskOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFlaskOff$1 = IconFlaskOff;

export { IconFlaskOff$1 as default };
//# sourceMappingURL=IconFlaskOff.svelte.js.map
