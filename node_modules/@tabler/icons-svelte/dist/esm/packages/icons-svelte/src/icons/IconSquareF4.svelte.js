...
/* src/icons/IconSquareF4.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f4" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF4 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF4$1 = IconSquareF4;

export { IconSquareF4$1 as default };
//# sourceMappingURL=IconSquareF4.svelte.js.map
