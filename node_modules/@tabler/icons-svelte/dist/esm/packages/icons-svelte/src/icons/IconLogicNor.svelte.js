...
/* src/icons/IconLogicNor.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "logic-nor" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogicNor extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogicNor$1 = IconLogicNor;

export { IconLogicNor$1 as default };
//# sourceMappingURL=IconLogicNor.svelte.js.map
