...
/* src/icons/IconCrane.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "crane" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCrane extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCrane$1 = IconCrane;

export { IconCrane$1 as default };
//# sourceMappingURL=IconCrane.svelte.js.map
