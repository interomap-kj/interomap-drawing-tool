...
/* src/icons/IconBrandXbox.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-xbox" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandXbox extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandXbox$1 = IconBrandXbox;

export { IconBrandXbox$1 as default };
//# sourceMappingURL=IconBrandXbox.svelte.js.map
