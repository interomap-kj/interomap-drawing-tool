...
/* src/icons/IconBrandCss3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-css3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandCss3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandCss3$1 = IconBrandCss3;

export { IconBrandCss3$1 as default };
//# sourceMappingURL=IconBrandCss3.svelte.js.map
