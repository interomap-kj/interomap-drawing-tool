...
/* src/icons/IconNfcOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "nfc-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNfcOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNfcOff$1 = IconNfcOff;

export { IconNfcOff$1 as default };
//# sourceMappingURL=IconNfcOff.svelte.js.map
