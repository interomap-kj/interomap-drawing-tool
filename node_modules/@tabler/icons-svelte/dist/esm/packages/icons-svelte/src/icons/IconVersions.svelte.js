...
/* src/icons/IconVersions.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "versions" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVersions extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVersions$1 = IconVersions;

export { IconVersions$1 as default };
//# sourceMappingURL=IconVersions.svelte.js.map
