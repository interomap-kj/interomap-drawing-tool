...
/* src/icons/IconFridgeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fridge-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFridgeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFridgeOff$1 = IconFridgeOff;

export { IconFridgeOff$1 as default };
//# sourceMappingURL=IconFridgeOff.svelte.js.map
