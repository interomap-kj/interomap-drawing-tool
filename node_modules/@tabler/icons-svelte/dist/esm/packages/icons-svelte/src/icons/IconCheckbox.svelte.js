...
/* src/icons/IconCheckbox.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "checkbox" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCheckbox extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCheckbox$1 = IconCheckbox;

export { IconCheckbox$1 as default };
//# sourceMappingURL=IconCheckbox.svelte.js.map
