...
/* src/icons/IconFileInfo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-info" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileInfo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileInfo$1 = IconFileInfo;

export { IconFileInfo$1 as default };
//# sourceMappingURL=IconFileInfo.svelte.js.map
