...
/* src/icons/IconPointerPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pointer-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPointerPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPointerPin$1 = IconPointerPin;

export { IconPointerPin$1 as default };
//# sourceMappingURL=IconPointerPin.svelte.js.map
