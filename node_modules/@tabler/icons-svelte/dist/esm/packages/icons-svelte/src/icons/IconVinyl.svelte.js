...
/* src/icons/IconVinyl.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vinyl" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVinyl extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVinyl$1 = IconVinyl;

export { IconVinyl$1 as default };
//# sourceMappingURL=IconVinyl.svelte.js.map
