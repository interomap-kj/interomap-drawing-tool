...
/* src/icons/IconCeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ce-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCeOff$1 = IconCeOff;

export { IconCeOff$1 as default };
//# sourceMappingURL=IconCeOff.svelte.js.map
