...
/* src/icons/IconMarquee.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "marquee" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMarquee extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMarquee$1 = IconMarquee;

export { IconMarquee$1 as default };
//# sourceMappingURL=IconMarquee.svelte.js.map
