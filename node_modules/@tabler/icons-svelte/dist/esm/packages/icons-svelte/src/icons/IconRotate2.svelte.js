...
/* src/icons/IconRotate2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rotate-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRotate2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRotate2$1 = IconRotate2;

export { IconRotate2$1 as default };
//# sourceMappingURL=IconRotate2.svelte.js.map
