...
/* src/icons/IconCloudX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudX$1 = IconCloudX;

export { IconCloudX$1 as default };
//# sourceMappingURL=IconCloudX.svelte.js.map
