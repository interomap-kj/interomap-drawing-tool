...
/* src/icons/IconPlanetOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "planet-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlanetOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlanetOff$1 = IconPlanetOff;

export { IconPlanetOff$1 as default };
//# sourceMappingURL=IconPlanetOff.svelte.js.map
