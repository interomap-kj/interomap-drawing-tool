...
/* src/icons/IconJpg.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "jpg" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconJpg extends SvelteComponent {
	constructor(options) {
		super();
...
var IconJpg$1 = IconJpg;

export { IconJpg$1 as default };
//# sourceMappingURL=IconJpg.svelte.js.map
