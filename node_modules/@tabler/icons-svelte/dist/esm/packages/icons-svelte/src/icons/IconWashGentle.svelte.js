...
/* src/icons/IconWashGentle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-gentle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashGentle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashGentle$1 = IconWashGentle;

export { IconWashGentle$1 as default };
//# sourceMappingURL=IconWashGentle.svelte.js.map
