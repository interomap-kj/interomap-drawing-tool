...
/* src/icons/IconBaguette.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "baguette" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBaguette extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBaguette$1 = IconBaguette;

export { IconBaguette$1 as default };
//# sourceMappingURL=IconBaguette.svelte.js.map
