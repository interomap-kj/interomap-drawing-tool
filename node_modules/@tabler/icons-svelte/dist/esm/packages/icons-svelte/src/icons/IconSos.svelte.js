...
/* src/icons/IconSos.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sos" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSos extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSos$1 = IconSos;

export { IconSos$1 as default };
//# sourceMappingURL=IconSos.svelte.js.map
