...
/* src/icons/IconNumber9.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-9" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumber9 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber9$1 = IconNumber9;

export { IconNumber9$1 as default };
//# sourceMappingURL=IconNumber9.svelte.js.map
