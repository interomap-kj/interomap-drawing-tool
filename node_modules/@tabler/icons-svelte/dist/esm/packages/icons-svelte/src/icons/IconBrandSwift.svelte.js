...
/* src/icons/IconBrandSwift.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-swift" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandSwift extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandSwift$1 = IconBrandSwift;

export { IconBrandSwift$1 as default };
//# sourceMappingURL=IconBrandSwift.svelte.js.map
