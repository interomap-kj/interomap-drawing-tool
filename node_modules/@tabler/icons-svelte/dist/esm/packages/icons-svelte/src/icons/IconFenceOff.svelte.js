...
/* src/icons/IconFenceOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fence-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFenceOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFenceOff$1 = IconFenceOff;

export { IconFenceOff$1 as default };
//# sourceMappingURL=IconFenceOff.svelte.js.map
