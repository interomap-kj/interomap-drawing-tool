...
/* src/icons/IconAppsFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "apps-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAppsFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAppsFilled$1 = IconAppsFilled;

export { IconAppsFilled$1 as default };
//# sourceMappingURL=IconAppsFilled.svelte.js.map
