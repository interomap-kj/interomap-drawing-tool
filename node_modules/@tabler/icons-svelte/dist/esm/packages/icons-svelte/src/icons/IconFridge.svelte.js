...
/* src/icons/IconFridge.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fridge" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFridge extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFridge$1 = IconFridge;

export { IconFridge$1 as default };
//# sourceMappingURL=IconFridge.svelte.js.map
