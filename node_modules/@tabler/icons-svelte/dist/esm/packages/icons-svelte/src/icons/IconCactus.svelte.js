...
/* src/icons/IconCactus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cactus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCactus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCactus$1 = IconCactus;

export { IconCactus$1 as default };
//# sourceMappingURL=IconCactus.svelte.js.map
