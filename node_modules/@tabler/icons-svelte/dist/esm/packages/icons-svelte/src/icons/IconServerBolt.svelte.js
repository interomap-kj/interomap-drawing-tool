...
/* src/icons/IconServerBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "server-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconServerBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconServerBolt$1 = IconServerBolt;

export { IconServerBolt$1 as default };
//# sourceMappingURL=IconServerBolt.svelte.js.map
