...
/* src/icons/IconRepeatOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "repeat-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRepeatOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRepeatOff$1 = IconRepeatOff;

export { IconRepeatOff$1 as default };
//# sourceMappingURL=IconRepeatOff.svelte.js.map
