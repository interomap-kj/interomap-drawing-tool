...
/* src/icons/IconDetailsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "details-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDetailsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDetailsOff$1 = IconDetailsOff;

export { IconDetailsOff$1 as default };
//# sourceMappingURL=IconDetailsOff.svelte.js.map
