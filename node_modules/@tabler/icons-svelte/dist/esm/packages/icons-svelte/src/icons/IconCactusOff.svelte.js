...
/* src/icons/IconCactusOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cactus-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCactusOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCactusOff$1 = IconCactusOff;

export { IconCactusOff$1 as default };
//# sourceMappingURL=IconCactusOff.svelte.js.map
