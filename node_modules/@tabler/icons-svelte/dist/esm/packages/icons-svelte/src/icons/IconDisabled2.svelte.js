...
/* src/icons/IconDisabled2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "disabled-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDisabled2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDisabled2$1 = IconDisabled2;

export { IconDisabled2$1 as default };
//# sourceMappingURL=IconDisabled2.svelte.js.map
