...
/* src/icons/IconRuler2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ruler-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRuler2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRuler2$1 = IconRuler2;

export { IconRuler2$1 as default };
//# sourceMappingURL=IconRuler2.svelte.js.map
