...
/* src/icons/IconWorldWww.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-www" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldWww extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldWww$1 = IconWorldWww;

export { IconWorldWww$1 as default };
//# sourceMappingURL=IconWorldWww.svelte.js.map
