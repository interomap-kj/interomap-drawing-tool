...
/* src/icons/IconResize.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "resize" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconResize extends SvelteComponent {
	constructor(options) {
		super();
...
var IconResize$1 = IconResize;

export { IconResize$1 as default };
//# sourceMappingURL=IconResize.svelte.js.map
