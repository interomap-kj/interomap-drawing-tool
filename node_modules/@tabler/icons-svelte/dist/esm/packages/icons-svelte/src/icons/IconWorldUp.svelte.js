...
/* src/icons/IconWorldUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldUp$1 = IconWorldUp;

export { IconWorldUp$1 as default };
//# sourceMappingURL=IconWorldUp.svelte.js.map
