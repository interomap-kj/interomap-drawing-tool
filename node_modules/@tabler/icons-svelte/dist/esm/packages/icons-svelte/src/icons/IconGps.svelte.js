...
/* src/icons/IconGps.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gps" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGps extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGps$1 = IconGps;

export { IconGps$1 as default };
//# sourceMappingURL=IconGps.svelte.js.map
