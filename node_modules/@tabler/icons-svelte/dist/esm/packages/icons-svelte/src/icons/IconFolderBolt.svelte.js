...
/* src/icons/IconFolderBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "folder-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFolderBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFolderBolt$1 = IconFolderBolt;

export { IconFolderBolt$1 as default };
//# sourceMappingURL=IconFolderBolt.svelte.js.map
