...
/* src/icons/IconSubmarine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "submarine" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSubmarine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSubmarine$1 = IconSubmarine;

export { IconSubmarine$1 as default };
//# sourceMappingURL=IconSubmarine.svelte.js.map
