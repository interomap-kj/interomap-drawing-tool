...
/* src/icons/IconToml.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "toml" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconToml extends SvelteComponent {
	constructor(options) {
		super();
...
var IconToml$1 = IconToml;

export { IconToml$1 as default };
//# sourceMappingURL=IconToml.svelte.js.map
