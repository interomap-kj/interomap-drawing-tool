...
/* src/icons/IconFall.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "fall" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFall extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFall$1 = IconFall;

export { IconFall$1 as default };
//# sourceMappingURL=IconFall.svelte.js.map
