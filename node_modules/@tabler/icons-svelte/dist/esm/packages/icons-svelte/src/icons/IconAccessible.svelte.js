...
/* src/icons/IconAccessible.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "accessible" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAccessible extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAccessible$1 = IconAccessible;

export { IconAccessible$1 as default };
//# sourceMappingURL=IconAccessible.svelte.js.map
