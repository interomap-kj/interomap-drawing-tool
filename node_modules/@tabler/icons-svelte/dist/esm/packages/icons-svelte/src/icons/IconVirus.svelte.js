...
/* src/icons/IconVirus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "virus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVirus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVirus$1 = IconVirus;

export { IconVirus$1 as default };
//# sourceMappingURL=IconVirus.svelte.js.map
