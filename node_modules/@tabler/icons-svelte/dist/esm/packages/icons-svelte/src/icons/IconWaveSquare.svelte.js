...
/* src/icons/IconWaveSquare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wave-square" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M3 12h5v8h4v-16h4v8h5" }]];
...
class IconWaveSquare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWaveSquare$1 = IconWaveSquare;

export { IconWaveSquare$1 as default };
//# sourceMappingURL=IconWaveSquare.svelte.js.map
