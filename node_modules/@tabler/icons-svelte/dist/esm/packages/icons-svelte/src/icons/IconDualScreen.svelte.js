...
/* src/icons/IconDualScreen.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dual-screen" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M5 4l8 3v15l-8 -3z" }], ["path", { "d": "M13 19h6v-15h-14" }]];
...
class IconDualScreen extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDualScreen$1 = IconDualScreen;

export { IconDualScreen$1 as default };
//# sourceMappingURL=IconDualScreen.svelte.js.map
