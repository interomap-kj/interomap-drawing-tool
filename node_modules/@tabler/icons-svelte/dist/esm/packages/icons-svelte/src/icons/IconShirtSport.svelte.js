...
/* src/icons/IconShirtSport.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shirt-sport" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShirtSport extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShirtSport$1 = IconShirtSport;

export { IconShirtSport$1 as default };
//# sourceMappingURL=IconShirtSport.svelte.js.map
