...
/* src/icons/IconBrandItch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-itch" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandItch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandItch$1 = IconBrandItch;

export { IconBrandItch$1 as default };
//# sourceMappingURL=IconBrandItch.svelte.js.map
