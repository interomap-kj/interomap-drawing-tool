...
/* src/icons/IconSignalG.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "signal-g" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSignalG extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSignalG$1 = IconSignalG;

export { IconSignalG$1 as default };
//# sourceMappingURL=IconSignalG.svelte.js.map
