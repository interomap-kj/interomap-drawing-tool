...
/* src/icons/IconAdjustments.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "adjustments" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAdjustments extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconAdjustments$1 as default };
//# sourceMappingURL=IconAdjustments.svelte.js.map
