...
/* src/icons/IconMailUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailUp$1 = IconMailUp;

export { IconMailUp$1 as default };
//# sourceMappingURL=IconMailUp.svelte.js.map
