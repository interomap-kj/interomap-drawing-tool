...
/* src/icons/IconLetterCase.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-case" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterCase extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterCase$1 = IconLetterCase;

export { IconLetterCase$1 as default };
//# sourceMappingURL=IconLetterCase.svelte.js.map
