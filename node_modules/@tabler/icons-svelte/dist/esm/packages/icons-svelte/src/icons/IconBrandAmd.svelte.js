...
/* src/icons/IconBrandAmd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-amd" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandAmd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandAmd$1 = IconBrandAmd;

export { IconBrandAmd$1 as default };
//# sourceMappingURL=IconBrandAmd.svelte.js.map
