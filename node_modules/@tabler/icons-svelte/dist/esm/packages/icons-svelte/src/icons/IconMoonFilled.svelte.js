...
/* src/icons/IconMoonFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "moon-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoonFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoonFilled$1 = IconMoonFilled;

export { IconMoonFilled$1 as default };
//# sourceMappingURL=IconMoonFilled.svelte.js.map
