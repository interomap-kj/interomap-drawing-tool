...
/* src/icons/IconChartArea.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-area" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartArea extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartArea$1 = IconChartArea;

export { IconChartArea$1 as default };
//# sourceMappingURL=IconChartArea.svelte.js.map
