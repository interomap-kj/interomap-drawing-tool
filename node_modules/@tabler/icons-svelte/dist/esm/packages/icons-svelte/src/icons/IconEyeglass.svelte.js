...
/* src/icons/IconEyeglass.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eyeglass" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeglass extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeglass$1 = IconEyeglass;

export { IconEyeglass$1 as default };
//# sourceMappingURL=IconEyeglass.svelte.js.map
