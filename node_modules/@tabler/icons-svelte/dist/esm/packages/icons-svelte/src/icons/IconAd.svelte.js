...
/* src/icons/IconAd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ad" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAd extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconAd$1 as default };
//# sourceMappingURL=IconAd.svelte.js.map
