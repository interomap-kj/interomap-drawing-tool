...
/* src/icons/IconHelp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "help" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHelp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHelp$1 = IconHelp;

export { IconHelp$1 as default };
//# sourceMappingURL=IconHelp.svelte.js.map
