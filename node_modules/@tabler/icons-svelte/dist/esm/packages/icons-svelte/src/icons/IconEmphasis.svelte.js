...
/* src/icons/IconEmphasis.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "emphasis" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEmphasis extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEmphasis$1 = IconEmphasis;

export { IconEmphasis$1 as default };
//# sourceMappingURL=IconEmphasis.svelte.js.map
