...
/* src/icons/IconMovie.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "movie" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMovie extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMovie$1 = IconMovie;

export { IconMovie$1 as default };
//# sourceMappingURL=IconMovie.svelte.js.map
