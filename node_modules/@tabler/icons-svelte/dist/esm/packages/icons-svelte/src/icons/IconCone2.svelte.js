...
/* src/icons/IconCone2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cone-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M12 7m-7 0a7 3 0 1 0 14 0a7 3 0 1 0 -14 0"
			}
		],
...
class IconCone2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCone2$1 = IconCone2;

export { IconCone2$1 as default };
//# sourceMappingURL=IconCone2.svelte.js.map
