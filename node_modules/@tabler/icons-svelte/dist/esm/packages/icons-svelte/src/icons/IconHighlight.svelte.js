...
/* src/icons/IconHighlight.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "highlight" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHighlight extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHighlight$1 = IconHighlight;

export { IconHighlight$1 as default };
//# sourceMappingURL=IconHighlight.svelte.js.map
