...
/* src/icons/IconApps.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "apps" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconApps extends SvelteComponent {
	constructor(options) {
		super();
...
var IconApps$1 = IconApps;

export { IconApps$1 as default };
//# sourceMappingURL=IconApps.svelte.js.map
