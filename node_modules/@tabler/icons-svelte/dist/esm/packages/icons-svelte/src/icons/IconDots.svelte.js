...
/* src/icons/IconDots.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dots" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDots extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconDots$1 as default };
//# sourceMappingURL=IconDots.svelte.js.map
