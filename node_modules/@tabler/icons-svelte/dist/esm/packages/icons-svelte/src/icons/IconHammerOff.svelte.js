...
/* src/icons/IconHammerOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hammer-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHammerOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHammerOff$1 = IconHammerOff;

export { IconHammerOff$1 as default };
//# sourceMappingURL=IconHammerOff.svelte.js.map
