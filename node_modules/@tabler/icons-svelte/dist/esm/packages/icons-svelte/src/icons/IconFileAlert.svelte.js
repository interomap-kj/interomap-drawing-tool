...
/* src/icons/IconFileAlert.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-alert" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileAlert extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileAlert$1 = IconFileAlert;

export { IconFileAlert$1 as default };
//# sourceMappingURL=IconFileAlert.svelte.js.map
