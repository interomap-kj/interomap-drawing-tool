...
/* src/icons/IconHomeCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeCheck$1 = IconHomeCheck;

export { IconHomeCheck$1 as default };
//# sourceMappingURL=IconHomeCheck.svelte.js.map
