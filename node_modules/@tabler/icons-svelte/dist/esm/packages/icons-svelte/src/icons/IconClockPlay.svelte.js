...
/* src/icons/IconClockPlay.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-play" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockPlay extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockPlay$1 = IconClockPlay;

export { IconClockPlay$1 as default };
//# sourceMappingURL=IconClockPlay.svelte.js.map
