...
/* src/icons/IconFocus2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "focus-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFocus2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFocus2$1 = IconFocus2;

export { IconFocus2$1 as default };
//# sourceMappingURL=IconFocus2.svelte.js.map
