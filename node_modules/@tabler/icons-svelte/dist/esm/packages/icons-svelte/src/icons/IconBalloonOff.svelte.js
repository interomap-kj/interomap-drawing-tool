...
/* src/icons/IconBalloonOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "balloon-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBalloonOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBalloonOff$1 = IconBalloonOff;

export { IconBalloonOff$1 as default };
//# sourceMappingURL=IconBalloonOff.svelte.js.map
