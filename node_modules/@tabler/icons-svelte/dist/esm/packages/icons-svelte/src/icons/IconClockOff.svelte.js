...
/* src/icons/IconClockOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockOff$1 = IconClockOff;

export { IconClockOff$1 as default };
//# sourceMappingURL=IconClockOff.svelte.js.map
