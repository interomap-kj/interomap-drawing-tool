...
/* src/icons/IconMoodSad.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-sad" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodSad extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodSad$1 = IconMoodSad;

export { IconMoodSad$1 as default };
//# sourceMappingURL=IconMoodSad.svelte.js.map
