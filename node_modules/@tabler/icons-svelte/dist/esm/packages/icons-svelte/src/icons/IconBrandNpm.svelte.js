...
/* src/icons/IconBrandNpm.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-npm" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandNpm extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandNpm$1 = IconBrandNpm;

export { IconBrandNpm$1 as default };
//# sourceMappingURL=IconBrandNpm.svelte.js.map
