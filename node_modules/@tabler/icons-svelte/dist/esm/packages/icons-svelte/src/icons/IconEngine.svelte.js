...
/* src/icons/IconEngine.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "engine" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEngine extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEngine$1 = IconEngine;

export { IconEngine$1 as default };
//# sourceMappingURL=IconEngine.svelte.js.map
