...
/* src/icons/IconTrowel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trowel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrowel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrowel$1 = IconTrowel;

export { IconTrowel$1 as default };
//# sourceMappingURL=IconTrowel.svelte.js.map
