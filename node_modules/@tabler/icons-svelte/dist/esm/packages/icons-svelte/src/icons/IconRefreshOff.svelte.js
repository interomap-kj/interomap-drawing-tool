...
/* src/icons/IconRefreshOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "refresh-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRefreshOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRefreshOff$1 = IconRefreshOff;

export { IconRefreshOff$1 as default };
//# sourceMappingURL=IconRefreshOff.svelte.js.map
