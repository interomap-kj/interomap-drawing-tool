...
/* src/icons/IconAt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "at" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAt extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconAt$1 as default };
//# sourceMappingURL=IconAt.svelte.js.map
