...
/* src/icons/IconMailFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailFilled$1 = IconMailFilled;

export { IconMailFilled$1 as default };
//# sourceMappingURL=IconMailFilled.svelte.js.map
