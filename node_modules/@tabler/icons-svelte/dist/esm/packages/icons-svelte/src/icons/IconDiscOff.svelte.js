...
/* src/icons/IconDiscOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "disc-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiscOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiscOff$1 = IconDiscOff;

export { IconDiscOff$1 as default };
//# sourceMappingURL=IconDiscOff.svelte.js.map
