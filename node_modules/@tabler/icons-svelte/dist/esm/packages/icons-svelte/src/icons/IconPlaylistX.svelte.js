...
/* src/icons/IconPlaylistX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "playlist-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlaylistX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlaylistX$1 = IconPlaylistX;

export { IconPlaylistX$1 as default };
//# sourceMappingURL=IconPlaylistX.svelte.js.map
