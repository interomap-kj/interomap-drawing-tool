...
/* src/icons/IconWorldBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldBolt$1 = IconWorldBolt;

export { IconWorldBolt$1 as default };
//# sourceMappingURL=IconWorldBolt.svelte.js.map
