...
/* src/icons/IconBat.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bat" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBat extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBat$1 = IconBat;

export { IconBat$1 as default };
//# sourceMappingURL=IconBat.svelte.js.map
