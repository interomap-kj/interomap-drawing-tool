...
/* src/icons/IconPeace.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "peace" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPeace extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPeace$1 = IconPeace;

export { IconPeace$1 as default };
//# sourceMappingURL=IconPeace.svelte.js.map
