...
/* src/icons/IconHomeHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeHeart$1 = IconHomeHeart;

export { IconHomeHeart$1 as default };
//# sourceMappingURL=IconHomeHeart.svelte.js.map
