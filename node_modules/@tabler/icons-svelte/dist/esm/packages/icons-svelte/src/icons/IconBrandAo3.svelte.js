...
/* src/icons/IconBrandAo3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-ao3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandAo3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandAo3$1 = IconBrandAo3;

export { IconBrandAo3$1 as default };
//# sourceMappingURL=IconBrandAo3.svelte.js.map
