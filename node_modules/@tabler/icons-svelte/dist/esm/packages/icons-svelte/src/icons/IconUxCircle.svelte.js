...
/* src/icons/IconUxCircle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ux-circle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUxCircle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUxCircle$1 = IconUxCircle;

export { IconUxCircle$1 as default };
//# sourceMappingURL=IconUxCircle.svelte.js.map
