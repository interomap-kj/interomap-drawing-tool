...
/* src/icons/IconBongOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bong-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBongOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBongOff$1 = IconBongOff;

export { IconBongOff$1 as default };
//# sourceMappingURL=IconBongOff.svelte.js.map
