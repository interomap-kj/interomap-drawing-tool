...
/* src/icons/IconMoodCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodCog$1 = IconMoodCog;

export { IconMoodCog$1 as default };
//# sourceMappingURL=IconMoodCog.svelte.js.map
