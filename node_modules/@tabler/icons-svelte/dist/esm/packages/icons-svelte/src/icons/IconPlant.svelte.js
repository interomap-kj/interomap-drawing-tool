...
/* src/icons/IconPlant.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plant" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlant extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlant$1 = IconPlant;

export { IconPlant$1 as default };
//# sourceMappingURL=IconPlant.svelte.js.map
