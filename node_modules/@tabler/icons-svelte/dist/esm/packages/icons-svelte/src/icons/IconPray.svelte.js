...
/* src/icons/IconPray.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pray" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPray extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPray$1 = IconPray;

export { IconPray$1 as default };
//# sourceMappingURL=IconPray.svelte.js.map
