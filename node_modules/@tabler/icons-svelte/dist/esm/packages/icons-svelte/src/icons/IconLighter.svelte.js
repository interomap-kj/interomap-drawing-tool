...
/* src/icons/IconLighter.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lighter" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLighter extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLighter$1 = IconLighter;

export { IconLighter$1 as default };
//# sourceMappingURL=IconLighter.svelte.js.map
