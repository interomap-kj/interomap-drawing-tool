...
/* src/icons/IconBattery3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "battery-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBattery3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBattery3$1 = IconBattery3;

export { IconBattery3$1 as default };
//# sourceMappingURL=IconBattery3.svelte.js.map
