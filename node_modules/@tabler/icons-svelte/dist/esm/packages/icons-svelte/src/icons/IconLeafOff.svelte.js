...
/* src/icons/IconLeafOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "leaf-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLeafOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLeafOff$1 = IconLeafOff;

export { IconLeafOff$1 as default };
//# sourceMappingURL=IconLeafOff.svelte.js.map
