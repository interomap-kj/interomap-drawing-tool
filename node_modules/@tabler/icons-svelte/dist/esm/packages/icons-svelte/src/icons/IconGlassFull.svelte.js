...
/* src/icons/IconGlassFull.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "glass-full" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGlassFull extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGlassFull$1 = IconGlassFull;

export { IconGlassFull$1 as default };
//# sourceMappingURL=IconGlassFull.svelte.js.map
