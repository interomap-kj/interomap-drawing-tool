...
/* src/icons/IconBarbell.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "barbell" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBarbell extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBarbell$1 = IconBarbell;

export { IconBarbell$1 as default };
//# sourceMappingURL=IconBarbell.svelte.js.map
