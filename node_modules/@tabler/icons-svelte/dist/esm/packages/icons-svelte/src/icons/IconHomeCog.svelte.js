...
/* src/icons/IconHomeCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeCog$1 = IconHomeCog;

export { IconHomeCog$1 as default };
//# sourceMappingURL=IconHomeCog.svelte.js.map
