...
/* src/icons/IconAnchorOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "anchor-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAnchorOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAnchorOff$1 = IconAnchorOff;

export { IconAnchorOff$1 as default };
//# sourceMappingURL=IconAnchorOff.svelte.js.map
