...
/* src/icons/IconBrandWish.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-wish" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandWish extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandWish$1 = IconBrandWish;

export { IconBrandWish$1 as default };
//# sourceMappingURL=IconBrandWish.svelte.js.map
