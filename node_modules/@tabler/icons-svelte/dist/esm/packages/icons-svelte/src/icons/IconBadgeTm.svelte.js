...
/* src/icons/IconBadgeTm.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "badge-tm" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBadgeTm extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBadgeTm$1 = IconBadgeTm;

export { IconBadgeTm$1 as default };
//# sourceMappingURL=IconBadgeTm.svelte.js.map
