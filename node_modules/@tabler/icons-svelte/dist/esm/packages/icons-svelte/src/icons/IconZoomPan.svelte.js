...
/* src/icons/IconZoomPan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-pan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomPan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomPan$1 = IconZoomPan;

export { IconZoomPan$1 as default };
//# sourceMappingURL=IconZoomPan.svelte.js.map
