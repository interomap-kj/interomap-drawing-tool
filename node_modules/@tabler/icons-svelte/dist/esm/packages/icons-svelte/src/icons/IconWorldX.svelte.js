...
/* src/icons/IconWorldX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldX$1 = IconWorldX;

export { IconWorldX$1 as default };
//# sourceMappingURL=IconWorldX.svelte.js.map
