...
/* src/icons/IconSkateboard.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "skateboard" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSkateboard extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSkateboard$1 = IconSkateboard;

export { IconSkateboard$1 as default };
//# sourceMappingURL=IconSkateboard.svelte.js.map
