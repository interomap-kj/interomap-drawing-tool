...
/* src/icons/IconDropletX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "droplet-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDropletX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDropletX$1 = IconDropletX;

export { IconDropletX$1 as default };
//# sourceMappingURL=IconDropletX.svelte.js.map
