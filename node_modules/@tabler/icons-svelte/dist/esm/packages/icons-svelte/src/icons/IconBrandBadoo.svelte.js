...
/* src/icons/IconBrandBadoo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-badoo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandBadoo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandBadoo$1 = IconBrandBadoo;

export { IconBrandBadoo$1 as default };
//# sourceMappingURL=IconBrandBadoo.svelte.js.map
