...
/* src/icons/IconSelectAll.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "select-all" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSelectAll extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSelectAll$1 = IconSelectAll;

export { IconSelectAll$1 as default };
//# sourceMappingURL=IconSelectAll.svelte.js.map
