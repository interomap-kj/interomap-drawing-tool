...
/* src/icons/IconCaretLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "caret-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M14 6l-6 6l6 6v-12" }]];
...
class IconCaretLeft extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconCaretLeft$1 as default };
//# sourceMappingURL=IconCaretLeft.svelte.js.map
