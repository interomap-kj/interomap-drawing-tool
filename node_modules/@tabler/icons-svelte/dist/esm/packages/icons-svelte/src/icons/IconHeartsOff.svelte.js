...
/* src/icons/IconHeartsOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hearts-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartsOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartsOff$1 = IconHeartsOff;

export { IconHeartsOff$1 as default };
//# sourceMappingURL=IconHeartsOff.svelte.js.map
