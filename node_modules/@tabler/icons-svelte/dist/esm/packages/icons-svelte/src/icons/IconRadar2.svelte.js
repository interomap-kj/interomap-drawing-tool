...
/* src/icons/IconRadar2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "radar-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRadar2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRadar2$1 = IconRadar2;

export { IconRadar2$1 as default };
//# sourceMappingURL=IconRadar2.svelte.js.map
