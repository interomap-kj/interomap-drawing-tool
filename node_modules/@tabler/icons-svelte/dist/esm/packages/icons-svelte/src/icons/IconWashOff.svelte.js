...
/* src/icons/IconWashOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wash-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWashOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWashOff$1 = IconWashOff;

export { IconWashOff$1 as default };
//# sourceMappingURL=IconWashOff.svelte.js.map
