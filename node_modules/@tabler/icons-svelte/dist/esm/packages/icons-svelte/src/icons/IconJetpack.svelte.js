...
/* src/icons/IconJetpack.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "jetpack" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconJetpack extends SvelteComponent {
	constructor(options) {
		super();
...
var IconJetpack$1 = IconJetpack;

export { IconJetpack$1 as default };
//# sourceMappingURL=IconJetpack.svelte.js.map
