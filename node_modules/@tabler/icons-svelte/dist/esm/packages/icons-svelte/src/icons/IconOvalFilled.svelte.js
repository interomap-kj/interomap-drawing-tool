...
/* src/icons/IconOvalFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "oval-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconOvalFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconOvalFilled$1 = IconOvalFilled;

export { IconOvalFilled$1 as default };
//# sourceMappingURL=IconOvalFilled.svelte.js.map
