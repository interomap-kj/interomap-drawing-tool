...
/* src/icons/IconBorderLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "border-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBorderLeft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBorderLeft$1 = IconBorderLeft;

export { IconBorderLeft$1 as default };
//# sourceMappingURL=IconBorderLeft.svelte.js.map
