...
/* src/icons/IconEyeEdit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-edit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeEdit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeEdit$1 = IconEyeEdit;

export { IconEyeEdit$1 as default };
//# sourceMappingURL=IconEyeEdit.svelte.js.map
