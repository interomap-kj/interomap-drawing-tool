...
/* src/icons/IconCoinMonero.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-monero" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinMonero extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinMonero$1 = IconCoinMonero;

export { IconCoinMonero$1 as default };
//# sourceMappingURL=IconCoinMonero.svelte.js.map
