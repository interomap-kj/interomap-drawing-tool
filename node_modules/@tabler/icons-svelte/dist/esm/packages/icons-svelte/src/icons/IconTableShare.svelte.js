...
/* src/icons/IconTableShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTableShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTableShare$1 = IconTableShare;

export { IconTableShare$1 as default };
//# sourceMappingURL=IconTableShare.svelte.js.map
