...
/* src/icons/IconShape.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shape" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShape extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShape$1 = IconShape;

export { IconShape$1 as default };
//# sourceMappingURL=IconShape.svelte.js.map
