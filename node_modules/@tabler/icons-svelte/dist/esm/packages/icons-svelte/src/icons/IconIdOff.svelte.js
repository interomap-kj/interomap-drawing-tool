...
/* src/icons/IconIdOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "id-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIdOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIdOff$1 = IconIdOff;

export { IconIdOff$1 as default };
//# sourceMappingURL=IconIdOff.svelte.js.map
