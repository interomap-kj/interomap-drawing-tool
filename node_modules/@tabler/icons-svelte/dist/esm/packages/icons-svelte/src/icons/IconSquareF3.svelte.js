...
/* src/icons/IconSquareF3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF3$1 = IconSquareF3;

export { IconSquareF3$1 as default };
//# sourceMappingURL=IconSquareF3.svelte.js.map
