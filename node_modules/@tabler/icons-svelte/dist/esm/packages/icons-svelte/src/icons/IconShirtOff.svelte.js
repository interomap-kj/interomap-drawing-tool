...
/* src/icons/IconShirtOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shirt-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShirtOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShirtOff$1 = IconShirtOff;

export { IconShirtOff$1 as default };
//# sourceMappingURL=IconShirtOff.svelte.js.map
