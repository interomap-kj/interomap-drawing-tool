...
/* src/icons/IconTrashX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trash-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrashX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrashX$1 = IconTrashX;

export { IconTrashX$1 as default };
//# sourceMappingURL=IconTrashX.svelte.js.map
