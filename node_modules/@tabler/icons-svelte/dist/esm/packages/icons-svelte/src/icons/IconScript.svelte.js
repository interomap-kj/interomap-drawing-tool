...
/* src/icons/IconScript.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "script" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScript extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScript$1 = IconScript;

export { IconScript$1 as default };
//# sourceMappingURL=IconScript.svelte.js.map
