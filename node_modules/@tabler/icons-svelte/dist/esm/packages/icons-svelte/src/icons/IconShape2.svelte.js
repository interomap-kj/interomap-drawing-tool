...
/* src/icons/IconShape2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shape-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShape2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShape2$1 = IconShape2;

export { IconShape2$1 as default };
//# sourceMappingURL=IconShape2.svelte.js.map
