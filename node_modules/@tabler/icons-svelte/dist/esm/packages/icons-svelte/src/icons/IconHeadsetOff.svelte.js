...
/* src/icons/IconHeadsetOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "headset-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeadsetOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeadsetOff$1 = IconHeadsetOff;

export { IconHeadsetOff$1 as default };
//# sourceMappingURL=IconHeadsetOff.svelte.js.map
