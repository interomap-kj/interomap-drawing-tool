...
/* src/icons/IconUserDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserDown$1 = IconUserDown;

export { IconUserDown$1 as default };
//# sourceMappingURL=IconUserDown.svelte.js.map
