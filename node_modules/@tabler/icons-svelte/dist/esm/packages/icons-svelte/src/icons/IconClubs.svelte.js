...
/* src/icons/IconClubs.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clubs" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClubs extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClubs$1 = IconClubs;

export { IconClubs$1 as default };
//# sourceMappingURL=IconClubs.svelte.js.map
