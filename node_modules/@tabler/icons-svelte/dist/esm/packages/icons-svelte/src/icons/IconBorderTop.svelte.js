...
/* src/icons/IconBorderTop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "border-top" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBorderTop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBorderTop$1 = IconBorderTop;

export { IconBorderTop$1 as default };
//# sourceMappingURL=IconBorderTop.svelte.js.map
