...
/* src/icons/IconMicrophone.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "microphone" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMicrophone extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMicrophone$1 = IconMicrophone;

export { IconMicrophone$1 as default };
//# sourceMappingURL=IconMicrophone.svelte.js.map
