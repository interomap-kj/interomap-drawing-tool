...
/* src/icons/IconPassword.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "password" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPassword extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPassword$1 = IconPassword;

export { IconPassword$1 as default };
//# sourceMappingURL=IconPassword.svelte.js.map
