...
/* src/icons/IconMoodHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodHeart$1 = IconMoodHeart;

export { IconMoodHeart$1 as default };
//# sourceMappingURL=IconMoodHeart.svelte.js.map
