...
/* src/icons/IconHomeDollar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-dollar" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeDollar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeDollar$1 = IconHomeDollar;

export { IconHomeDollar$1 as default };
//# sourceMappingURL=IconHomeDollar.svelte.js.map
