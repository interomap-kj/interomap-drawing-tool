...
/* src/icons/IconPoolOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pool-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPoolOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPoolOff$1 = IconPoolOff;

export { IconPoolOff$1 as default };
//# sourceMappingURL=IconPoolOff.svelte.js.map
