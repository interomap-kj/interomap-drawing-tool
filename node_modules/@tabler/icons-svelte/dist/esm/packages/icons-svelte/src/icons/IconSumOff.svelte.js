...
/* src/icons/IconSumOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sum-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSumOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSumOff$1 = IconSumOff;

export { IconSumOff$1 as default };
//# sourceMappingURL=IconSumOff.svelte.js.map
