...
/* src/icons/IconTeapot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "teapot" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTeapot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTeapot$1 = IconTeapot;

export { IconTeapot$1 as default };
//# sourceMappingURL=IconTeapot.svelte.js.map
