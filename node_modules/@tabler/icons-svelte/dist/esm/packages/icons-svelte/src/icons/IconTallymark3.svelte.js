...
/* src/icons/IconTallymark3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tallymark-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTallymark3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTallymark3$1 = IconTallymark3;

export { IconTallymark3$1 as default };
//# sourceMappingURL=IconTallymark3.svelte.js.map
