...
/* src/icons/IconLicenseOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "license-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLicenseOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLicenseOff$1 = IconLicenseOff;

export { IconLicenseOff$1 as default };
//# sourceMappingURL=IconLicenseOff.svelte.js.map
