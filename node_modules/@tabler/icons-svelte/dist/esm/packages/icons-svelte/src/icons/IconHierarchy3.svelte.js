...
/* src/icons/IconHierarchy3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hierarchy-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHierarchy3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHierarchy3$1 = IconHierarchy3;

export { IconHierarchy3$1 as default };
//# sourceMappingURL=IconHierarchy3.svelte.js.map
