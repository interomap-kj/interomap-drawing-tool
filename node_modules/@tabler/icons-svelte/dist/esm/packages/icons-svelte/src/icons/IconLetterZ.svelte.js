...
/* src/icons/IconLetterZ.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-z" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M7 4h10l-10 16h10" }]];
...
class IconLetterZ extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterZ$1 = IconLetterZ;

export { IconLetterZ$1 as default };
//# sourceMappingURL=IconLetterZ.svelte.js.map
