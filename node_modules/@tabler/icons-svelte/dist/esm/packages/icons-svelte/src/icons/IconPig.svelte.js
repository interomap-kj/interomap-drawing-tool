...
/* src/icons/IconPig.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pig" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPig extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPig$1 = IconPig;

export { IconPig$1 as default };
//# sourceMappingURL=IconPig.svelte.js.map
