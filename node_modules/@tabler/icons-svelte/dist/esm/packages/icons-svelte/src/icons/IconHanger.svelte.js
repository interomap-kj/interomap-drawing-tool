...
/* src/icons/IconHanger.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hanger" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHanger extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHanger$1 = IconHanger;

export { IconHanger$1 as default };
//# sourceMappingURL=IconHanger.svelte.js.map
