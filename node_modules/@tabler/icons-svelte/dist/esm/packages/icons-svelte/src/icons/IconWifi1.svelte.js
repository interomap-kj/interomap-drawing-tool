...
/* src/icons/IconWifi1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wifi-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWifi1 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWifi1$1 = IconWifi1;

export { IconWifi1$1 as default };
//# sourceMappingURL=IconWifi1.svelte.js.map
