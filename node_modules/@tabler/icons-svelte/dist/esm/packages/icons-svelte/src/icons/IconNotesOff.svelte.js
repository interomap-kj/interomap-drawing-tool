...
/* src/icons/IconNotesOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "notes-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNotesOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNotesOff$1 = IconNotesOff;

export { IconNotesOff$1 as default };
//# sourceMappingURL=IconNotesOff.svelte.js.map
