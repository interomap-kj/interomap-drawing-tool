...
/* src/icons/IconSchema.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "schema" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSchema extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSchema$1 = IconSchema;

export { IconSchema$1 as default };
//# sourceMappingURL=IconSchema.svelte.js.map
