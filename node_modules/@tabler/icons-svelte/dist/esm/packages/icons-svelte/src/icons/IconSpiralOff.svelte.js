...
/* src/icons/IconSpiralOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "spiral-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpiralOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpiralOff$1 = IconSpiralOff;

export { IconSpiralOff$1 as default };
//# sourceMappingURL=IconSpiralOff.svelte.js.map
