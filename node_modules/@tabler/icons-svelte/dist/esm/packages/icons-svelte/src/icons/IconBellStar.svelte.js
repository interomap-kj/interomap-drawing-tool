...
/* src/icons/IconBellStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellStar$1 = IconBellStar;

export { IconBellStar$1 as default };
//# sourceMappingURL=IconBellStar.svelte.js.map
