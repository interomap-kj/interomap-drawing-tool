...
/* src/icons/IconSquareF7.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f7" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF7 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF7$1 = IconSquareF7;

export { IconSquareF7$1 as default };
//# sourceMappingURL=IconSquareF7.svelte.js.map
