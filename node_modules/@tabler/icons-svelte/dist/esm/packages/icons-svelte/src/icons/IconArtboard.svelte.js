...
/* src/icons/IconArtboard.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "artboard" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArtboard extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArtboard$1 = IconArtboard;

export { IconArtboard$1 as default };
//# sourceMappingURL=IconArtboard.svelte.js.map
