...
/* src/icons/IconDentalOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dental-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDentalOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDentalOff$1 = IconDentalOff;

export { IconDentalOff$1 as default };
//# sourceMappingURL=IconDentalOff.svelte.js.map
