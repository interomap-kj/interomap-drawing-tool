...
/* src/icons/IconPageBreak.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "page-break" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPageBreak extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPageBreak$1 = IconPageBreak;

export { IconPageBreak$1 as default };
//# sourceMappingURL=IconPageBreak.svelte.js.map
