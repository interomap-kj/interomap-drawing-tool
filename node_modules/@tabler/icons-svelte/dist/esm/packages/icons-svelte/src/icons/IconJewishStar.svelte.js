...
/* src/icons/IconJewishStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "jewish-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconJewishStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconJewishStar$1 = IconJewishStar;

export { IconJewishStar$1 as default };
//# sourceMappingURL=IconJewishStar.svelte.js.map
