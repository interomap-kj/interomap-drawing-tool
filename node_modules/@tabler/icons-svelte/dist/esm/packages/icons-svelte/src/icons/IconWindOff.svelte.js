...
/* src/icons/IconWindOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wind-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWindOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWindOff$1 = IconWindOff;

export { IconWindOff$1 as default };
//# sourceMappingURL=IconWindOff.svelte.js.map
