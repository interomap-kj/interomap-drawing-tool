...
/* src/icons/IconHttpHead.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-head" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpHead extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpHead$1 = IconHttpHead;

export { IconHttpHead$1 as default };
//# sourceMappingURL=IconHttpHead.svelte.js.map
