...
/* src/icons/IconRecordMail.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "record-mail" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRecordMail extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRecordMail$1 = IconRecordMail;

export { IconRecordMail$1 as default };
//# sourceMappingURL=IconRecordMail.svelte.js.map
