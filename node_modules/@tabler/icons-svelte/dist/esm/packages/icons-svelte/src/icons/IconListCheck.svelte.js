...
/* src/icons/IconListCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "list-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconListCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconListCheck$1 = IconListCheck;

export { IconListCheck$1 as default };
//# sourceMappingURL=IconListCheck.svelte.js.map
