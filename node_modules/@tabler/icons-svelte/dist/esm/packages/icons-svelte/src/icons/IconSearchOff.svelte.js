...
/* src/icons/IconSearchOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "search-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSearchOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSearchOff$1 = IconSearchOff;

export { IconSearchOff$1 as default };
//# sourceMappingURL=IconSearchOff.svelte.js.map
