...
/* src/icons/IconDoorExit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "door-exit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDoorExit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDoorExit$1 = IconDoorExit;

export { IconDoorExit$1 as default };
//# sourceMappingURL=IconDoorExit.svelte.js.map
