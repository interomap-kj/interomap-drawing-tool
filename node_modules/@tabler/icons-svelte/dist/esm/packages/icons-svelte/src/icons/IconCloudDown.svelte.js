...
/* src/icons/IconCloudDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudDown$1 = IconCloudDown;

export { IconCloudDown$1 as default };
//# sourceMappingURL=IconCloudDown.svelte.js.map
