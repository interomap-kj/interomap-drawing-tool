...
/* src/icons/IconCoffin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coffin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoffin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoffin$1 = IconCoffin;

export { IconCoffin$1 as default };
//# sourceMappingURL=IconCoffin.svelte.js.map
