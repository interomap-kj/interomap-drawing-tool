...
/* src/icons/IconChartPie2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-pie-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartPie2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartPie2$1 = IconChartPie2;

export { IconChartPie2$1 as default };
//# sourceMappingURL=IconChartPie2.svelte.js.map
