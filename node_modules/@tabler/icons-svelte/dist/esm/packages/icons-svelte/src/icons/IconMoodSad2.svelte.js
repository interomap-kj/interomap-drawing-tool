...
/* src/icons/IconMoodSad2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-sad-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodSad2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodSad2$1 = IconMoodSad2;

export { IconMoodSad2$1 as default };
//# sourceMappingURL=IconMoodSad2.svelte.js.map
