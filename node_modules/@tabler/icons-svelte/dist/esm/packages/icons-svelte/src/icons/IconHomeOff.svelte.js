...
/* src/icons/IconHomeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeOff$1 = IconHomeOff;

export { IconHomeOff$1 as default };
//# sourceMappingURL=IconHomeOff.svelte.js.map
