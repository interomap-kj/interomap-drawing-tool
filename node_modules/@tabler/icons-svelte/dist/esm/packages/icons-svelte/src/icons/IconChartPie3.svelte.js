...
/* src/icons/IconChartPie3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chart-pie-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChartPie3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChartPie3$1 = IconChartPie3;

export { IconChartPie3$1 as default };
//# sourceMappingURL=IconChartPie3.svelte.js.map
