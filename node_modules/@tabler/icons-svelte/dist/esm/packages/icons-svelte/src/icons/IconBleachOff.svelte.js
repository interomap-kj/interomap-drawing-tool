...
/* src/icons/IconBleachOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bleach-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBleachOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBleachOff$1 = IconBleachOff;

export { IconBleachOff$1 as default };
//# sourceMappingURL=IconBleachOff.svelte.js.map
