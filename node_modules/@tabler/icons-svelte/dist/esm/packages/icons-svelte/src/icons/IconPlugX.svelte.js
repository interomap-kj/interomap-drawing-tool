...
/* src/icons/IconPlugX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "plug-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlugX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlugX$1 = IconPlugX;

export { IconPlugX$1 as default };
//# sourceMappingURL=IconPlugX.svelte.js.map
