...
/* src/icons/IconFilterPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "filter-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFilterPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFilterPlus$1 = IconFilterPlus;

export { IconFilterPlus$1 as default };
//# sourceMappingURL=IconFilterPlus.svelte.js.map
