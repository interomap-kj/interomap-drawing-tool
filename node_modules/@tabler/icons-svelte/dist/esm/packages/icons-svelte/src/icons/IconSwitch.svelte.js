...
/* src/icons/IconSwitch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "switch" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSwitch extends SvelteComponent {
	constructor(options) {
		super();
...
//# sourceMappingURL=IconSwitch.svelte.js.map
