...
/* src/icons/IconBrandHtml5.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-html5" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandHtml5 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandHtml5$1 = IconBrandHtml5;

export { IconBrandHtml5$1 as default };
//# sourceMappingURL=IconBrandHtml5.svelte.js.map
