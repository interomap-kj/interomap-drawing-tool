...
/* src/icons/IconLineHeight.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "line-height" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLineHeight extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLineHeight$1 = IconLineHeight;

export { IconLineHeight$1 as default };
//# sourceMappingURL=IconLineHeight.svelte.js.map
