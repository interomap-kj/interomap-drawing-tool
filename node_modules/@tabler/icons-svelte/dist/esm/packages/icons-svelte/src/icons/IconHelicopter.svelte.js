...
/* src/icons/IconHelicopter.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "helicopter" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHelicopter extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHelicopter$1 = IconHelicopter;

export { IconHelicopter$1 as default };
//# sourceMappingURL=IconHelicopter.svelte.js.map
