...
/* src/icons/IconMailOpened.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-opened" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailOpened extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailOpened$1 = IconMailOpened;

export { IconMailOpened$1 as default };
//# sourceMappingURL=IconMailOpened.svelte.js.map
