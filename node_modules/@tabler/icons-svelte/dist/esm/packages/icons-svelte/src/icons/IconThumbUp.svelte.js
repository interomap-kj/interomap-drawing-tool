...
/* src/icons/IconThumbUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "thumb-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconThumbUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconThumbUp$1 = IconThumbUp;

export { IconThumbUp$1 as default };
//# sourceMappingURL=IconThumbUp.svelte.js.map
