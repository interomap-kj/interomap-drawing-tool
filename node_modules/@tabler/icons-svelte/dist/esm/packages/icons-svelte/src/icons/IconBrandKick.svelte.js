...
/* src/icons/IconBrandKick.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-kick" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandKick extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandKick$1 = IconBrandKick;

export { IconBrandKick$1 as default };
//# sourceMappingURL=IconBrandKick.svelte.js.map
