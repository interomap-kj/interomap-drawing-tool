...
/* src/icons/IconTransform.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "transform" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTransform extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTransform$1 = IconTransform;

export { IconTransform$1 as default };
//# sourceMappingURL=IconTransform.svelte.js.map
