...
/* src/icons/IconUserStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserStar$1 = IconUserStar;

export { IconUserStar$1 as default };
//# sourceMappingURL=IconUserStar.svelte.js.map
