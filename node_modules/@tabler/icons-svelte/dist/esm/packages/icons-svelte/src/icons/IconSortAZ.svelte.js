...
/* src/icons/IconSortAZ.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sort-a-z" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSortAZ extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSortAZ$1 = IconSortAZ;

export { IconSortAZ$1 as default };
//# sourceMappingURL=IconSortAZ.svelte.js.map
