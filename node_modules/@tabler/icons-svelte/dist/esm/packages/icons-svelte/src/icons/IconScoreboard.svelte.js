...
/* src/icons/IconScoreboard.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "scoreboard" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconScoreboard extends SvelteComponent {
	constructor(options) {
		super();
...
var IconScoreboard$1 = IconScoreboard;

export { IconScoreboard$1 as default };
//# sourceMappingURL=IconScoreboard.svelte.js.map
