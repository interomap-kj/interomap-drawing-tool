...
/* src/icons/IconUserUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserUp$1 = IconUserUp;

export { IconUserUp$1 as default };
//# sourceMappingURL=IconUserUp.svelte.js.map
