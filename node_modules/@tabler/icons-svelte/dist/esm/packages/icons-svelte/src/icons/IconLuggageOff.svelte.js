...
/* src/icons/IconLuggageOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "luggage-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLuggageOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLuggageOff$1 = IconLuggageOff;

export { IconLuggageOff$1 as default };
//# sourceMappingURL=IconLuggageOff.svelte.js.map
