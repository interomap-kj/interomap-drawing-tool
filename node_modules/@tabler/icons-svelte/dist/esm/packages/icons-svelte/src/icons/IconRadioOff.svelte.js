...
/* src/icons/IconRadioOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "radio-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRadioOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRadioOff$1 = IconRadioOff;

export { IconRadioOff$1 as default };
//# sourceMappingURL=IconRadioOff.svelte.js.map
