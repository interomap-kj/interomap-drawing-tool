...
/* src/icons/IconHelpSquare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "help-square" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHelpSquare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHelpSquare$1 = IconHelpSquare;

export { IconHelpSquare$1 as default };
//# sourceMappingURL=IconHelpSquare.svelte.js.map
