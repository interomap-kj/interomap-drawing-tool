...
/* src/icons/IconClockCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockCode$1 = IconClockCode;

export { IconClockCode$1 as default };
//# sourceMappingURL=IconClockCode.svelte.js.map
