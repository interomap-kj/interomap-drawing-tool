...
/* src/icons/IconClick.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "click" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClick extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClick$1 = IconClick;

export { IconClick$1 as default };
//# sourceMappingURL=IconClick.svelte.js.map
