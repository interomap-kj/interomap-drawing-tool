...
/* src/icons/IconShieldPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldPin$1 = IconShieldPin;

export { IconShieldPin$1 as default };
//# sourceMappingURL=IconShieldPin.svelte.js.map
