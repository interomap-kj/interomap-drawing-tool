...
/* src/icons/IconCookieOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cookie-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCookieOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCookieOff$1 = IconCookieOff;

export { IconCookieOff$1 as default };
//# sourceMappingURL=IconCookieOff.svelte.js.map
