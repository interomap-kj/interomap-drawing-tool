...
/* src/icons/IconMailPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailPause$1 = IconMailPause;

export { IconMailPause$1 as default };
//# sourceMappingURL=IconMailPause.svelte.js.map
