...
/* src/icons/IconCursorText.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cursor-text" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCursorText extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCursorText$1 = IconCursorText;

export { IconCursorText$1 as default };
//# sourceMappingURL=IconCursorText.svelte.js.map
