...
/* src/icons/IconJumpRope.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "jump-rope" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconJumpRope extends SvelteComponent {
	constructor(options) {
		super();
...
var IconJumpRope$1 = IconJumpRope;

export { IconJumpRope$1 as default };
//# sourceMappingURL=IconJumpRope.svelte.js.map
