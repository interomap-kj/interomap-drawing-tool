...
/* src/icons/IconBrandWix.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-wix" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandWix extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandWix$1 = IconBrandWix;

export { IconBrandWix$1 as default };
//# sourceMappingURL=IconBrandWix.svelte.js.map
