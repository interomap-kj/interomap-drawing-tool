...
/* src/icons/IconBrandEmber.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-ember" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandEmber extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandEmber$1 = IconBrandEmber;

export { IconBrandEmber$1 as default };
//# sourceMappingURL=IconBrandEmber.svelte.js.map
