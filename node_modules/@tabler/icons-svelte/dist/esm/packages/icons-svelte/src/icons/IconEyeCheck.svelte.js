...
/* src/icons/IconEyeCheck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "eye-check" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEyeCheck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEyeCheck$1 = IconEyeCheck;

export { IconEyeCheck$1 as default };
//# sourceMappingURL=IconEyeCheck.svelte.js.map
