...
/* src/icons/IconTablePlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTablePlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTablePlus$1 = IconTablePlus;

export { IconTablePlus$1 as default };
//# sourceMappingURL=IconTablePlus.svelte.js.map
