...
/* src/icons/IconFaceMask.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "face-mask" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFaceMask extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFaceMask$1 = IconFaceMask;

export { IconFaceMask$1 as default };
//# sourceMappingURL=IconFaceMask.svelte.js.map
