...
/* src/icons/IconMap2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMap2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMap2$1 = IconMap2;

export { IconMap2$1 as default };
//# sourceMappingURL=IconMap2.svelte.js.map
