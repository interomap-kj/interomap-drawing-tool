...
/* src/icons/IconBattery1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "battery-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBattery1 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBattery1$1 = IconBattery1;

export { IconBattery1$1 as default };
//# sourceMappingURL=IconBattery1.svelte.js.map
