...
/* src/icons/IconBookOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "book-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBookOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBookOff$1 = IconBookOff;

export { IconBookOff$1 as default };
//# sourceMappingURL=IconBookOff.svelte.js.map
