...
/* src/icons/IconFileVector.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-vector" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileVector extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileVector$1 = IconFileVector;

export { IconFileVector$1 as default };
//# sourceMappingURL=IconFileVector.svelte.js.map
