...
/* src/icons/IconHttpDelete.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "http-delete" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHttpDelete extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHttpDelete$1 = IconHttpDelete;

export { IconHttpDelete$1 as default };
//# sourceMappingURL=IconHttpDelete.svelte.js.map
