...
/* src/icons/IconMoodSick.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-sick" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodSick extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodSick$1 = IconMoodSick;

export { IconMoodSick$1 as default };
//# sourceMappingURL=IconMoodSick.svelte.js.map
