...
/* src/icons/IconShape3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shape-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShape3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShape3$1 = IconShape3;

export { IconShape3$1 as default };
//# sourceMappingURL=IconShape3.svelte.js.map
