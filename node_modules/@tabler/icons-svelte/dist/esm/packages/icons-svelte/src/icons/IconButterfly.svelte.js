...
/* src/icons/IconButterfly.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "butterfly" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconButterfly extends SvelteComponent {
	constructor(options) {
		super();
...
var IconButterfly$1 = IconButterfly;

export { IconButterfly$1 as default };
//# sourceMappingURL=IconButterfly.svelte.js.map
