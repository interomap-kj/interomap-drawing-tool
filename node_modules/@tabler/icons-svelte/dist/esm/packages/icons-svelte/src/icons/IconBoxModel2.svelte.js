...
/* src/icons/IconBoxModel2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "box-model-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBoxModel2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBoxModel2$1 = IconBoxModel2;

export { IconBoxModel2$1 as default };
//# sourceMappingURL=IconBoxModel2.svelte.js.map
