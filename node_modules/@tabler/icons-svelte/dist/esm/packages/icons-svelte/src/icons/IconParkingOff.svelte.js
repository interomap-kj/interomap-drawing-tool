...
/* src/icons/IconParkingOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "parking-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconParkingOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconParkingOff$1 = IconParkingOff;

export { IconParkingOff$1 as default };
//# sourceMappingURL=IconParkingOff.svelte.js.map
