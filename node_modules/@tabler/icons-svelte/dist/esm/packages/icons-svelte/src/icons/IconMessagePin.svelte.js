...
/* src/icons/IconMessagePin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessagePin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessagePin$1 = IconMessagePin;

export { IconMessagePin$1 as default };
//# sourceMappingURL=IconMessagePin.svelte.js.map
