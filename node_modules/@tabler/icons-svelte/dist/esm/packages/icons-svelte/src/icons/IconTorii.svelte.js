...
/* src/icons/IconTorii.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "torii" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTorii extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTorii$1 = IconTorii;

export { IconTorii$1 as default };
//# sourceMappingURL=IconTorii.svelte.js.map
