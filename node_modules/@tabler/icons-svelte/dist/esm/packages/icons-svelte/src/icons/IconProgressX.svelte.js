...
/* src/icons/IconProgressX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "progress-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconProgressX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconProgressX$1 = IconProgressX;

export { IconProgressX$1 as default };
//# sourceMappingURL=IconProgressX.svelte.js.map
