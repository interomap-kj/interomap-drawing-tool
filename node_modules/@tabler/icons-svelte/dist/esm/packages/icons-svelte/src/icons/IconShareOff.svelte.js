...
/* src/icons/IconShareOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "share-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShareOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShareOff$1 = IconShareOff;

export { IconShareOff$1 as default };
//# sourceMappingURL=IconShareOff.svelte.js.map
