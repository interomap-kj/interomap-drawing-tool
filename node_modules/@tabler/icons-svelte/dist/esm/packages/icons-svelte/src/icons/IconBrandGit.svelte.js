...
/* src/icons/IconBrandGit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-git" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandGit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandGit$1 = IconBrandGit;

export { IconBrandGit$1 as default };
//# sourceMappingURL=IconBrandGit.svelte.js.map
