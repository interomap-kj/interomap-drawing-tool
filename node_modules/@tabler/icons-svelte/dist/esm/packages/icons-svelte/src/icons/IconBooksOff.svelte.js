...
/* src/icons/IconBooksOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "books-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBooksOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBooksOff$1 = IconBooksOff;

export { IconBooksOff$1 as default };
//# sourceMappingURL=IconBooksOff.svelte.js.map
