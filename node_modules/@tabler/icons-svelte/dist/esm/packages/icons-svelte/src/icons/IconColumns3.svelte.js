...
/* src/icons/IconColumns3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "columns-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconColumns3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconColumns3$1 = IconColumns3;

export { IconColumns3$1 as default };
//# sourceMappingURL=IconColumns3.svelte.js.map
