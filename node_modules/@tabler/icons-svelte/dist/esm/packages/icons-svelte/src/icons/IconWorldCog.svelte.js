...
/* src/icons/IconWorldCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "world-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWorldCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWorldCog$1 = IconWorldCog;

export { IconWorldCog$1 as default };
//# sourceMappingURL=IconWorldCog.svelte.js.map
