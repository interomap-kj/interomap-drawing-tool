...
/* src/icons/IconMobiledata.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mobiledata" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMobiledata extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMobiledata$1 = IconMobiledata;

export { IconMobiledata$1 as default };
//# sourceMappingURL=IconMobiledata.svelte.js.map
