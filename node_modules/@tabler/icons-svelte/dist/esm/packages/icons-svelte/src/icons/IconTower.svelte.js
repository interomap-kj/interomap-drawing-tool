...
/* src/icons/IconTower.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tower" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTower extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTower$1 = IconTower;

export { IconTower$1 as default };
//# sourceMappingURL=IconTower.svelte.js.map
