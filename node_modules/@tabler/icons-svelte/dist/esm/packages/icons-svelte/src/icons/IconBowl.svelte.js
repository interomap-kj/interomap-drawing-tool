...
/* src/icons/IconBowl.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bowl" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBowl extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBowl$1 = IconBowl;

export { IconBowl$1 as default };
//# sourceMappingURL=IconBowl.svelte.js.map
