...
/* src/icons/IconPennantOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pennant-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPennantOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPennantOff$1 = IconPennantOff;

export { IconPennantOff$1 as default };
//# sourceMappingURL=IconPennantOff.svelte.js.map
