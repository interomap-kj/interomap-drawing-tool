...
/* src/icons/IconCloudStorm.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-storm" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudStorm extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudStorm$1 = IconCloudStorm;

export { IconCloudStorm$1 as default };
//# sourceMappingURL=IconCloudStorm.svelte.js.map
