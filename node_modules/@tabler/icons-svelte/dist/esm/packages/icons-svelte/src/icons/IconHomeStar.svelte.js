...
/* src/icons/IconHomeStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeStar$1 = IconHomeStar;

export { IconHomeStar$1 as default };
//# sourceMappingURL=IconHomeStar.svelte.js.map
