...
/* src/icons/IconBrandWeibo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-weibo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandWeibo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandWeibo$1 = IconBrandWeibo;

export { IconBrandWeibo$1 as default };
//# sourceMappingURL=IconBrandWeibo.svelte.js.map
