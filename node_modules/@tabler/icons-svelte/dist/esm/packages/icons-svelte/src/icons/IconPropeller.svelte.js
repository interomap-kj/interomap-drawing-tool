...
/* src/icons/IconPropeller.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "propeller" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPropeller extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPropeller$1 = IconPropeller;

export { IconPropeller$1 as default };
//# sourceMappingURL=IconPropeller.svelte.js.map
