...
/* src/icons/IconMessageX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "message-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessageX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessageX$1 = IconMessageX;

export { IconMessageX$1 as default };
//# sourceMappingURL=IconMessageX.svelte.js.map
