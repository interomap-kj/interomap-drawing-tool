...
/* src/icons/IconHomeShield.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-shield" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeShield extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeShield$1 = IconHomeShield;

export { IconHomeShield$1 as default };
//# sourceMappingURL=IconHomeShield.svelte.js.map
