...
/* src/icons/IconCloudCode.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cloud-code" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCloudCode extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCloudCode$1 = IconCloudCode;

export { IconCloudCode$1 as default };
//# sourceMappingURL=IconCloudCode.svelte.js.map
