...
/* src/icons/IconNumber1.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "number-1" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M13 20v-16l-5 5" }]];
...
class IconNumber1 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumber1$1 = IconNumber1;

export { IconNumber1$1 as default };
//# sourceMappingURL=IconNumber1.svelte.js.map
