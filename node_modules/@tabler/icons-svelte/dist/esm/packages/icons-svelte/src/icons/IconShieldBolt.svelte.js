...
/* src/icons/IconShieldBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldBolt$1 = IconShieldBolt;

export { IconShieldBolt$1 as default };
//# sourceMappingURL=IconShieldBolt.svelte.js.map
