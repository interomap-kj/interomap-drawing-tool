...
/* src/icons/IconVipOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vip-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVipOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVipOff$1 = IconVipOff;

export { IconVipOff$1 as default };
//# sourceMappingURL=IconVipOff.svelte.js.map
