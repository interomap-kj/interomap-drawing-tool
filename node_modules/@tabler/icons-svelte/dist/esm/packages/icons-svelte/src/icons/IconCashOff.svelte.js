...
/* src/icons/IconCashOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cash-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCashOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCashOff$1 = IconCashOff;

export { IconCashOff$1 as default };
//# sourceMappingURL=IconCashOff.svelte.js.map
