...
/* src/icons/IconApiAppOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "api-app-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconApiAppOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconApiAppOff$1 = IconApiAppOff;

export { IconApiAppOff$1 as default };
//# sourceMappingURL=IconApiAppOff.svelte.js.map
