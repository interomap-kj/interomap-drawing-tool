...
/* src/icons/IconLockDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockDown$1 = IconLockDown;

export { IconLockDown$1 as default };
//# sourceMappingURL=IconLockDown.svelte.js.map
