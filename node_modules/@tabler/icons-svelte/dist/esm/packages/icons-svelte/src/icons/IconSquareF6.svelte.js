...
/* src/icons/IconSquareF6.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-f6" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareF6 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareF6$1 = IconSquareF6;

export { IconSquareF6$1 as default };
//# sourceMappingURL=IconSquareF6.svelte.js.map
