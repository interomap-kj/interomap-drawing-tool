...
/* src/icons/IconBooks.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "books" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBooks extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBooks$1 = IconBooks;

export { IconBooks$1 as default };
//# sourceMappingURL=IconBooks.svelte.js.map
