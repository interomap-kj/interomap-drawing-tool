...
/* src/icons/IconPigMoney.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pig-money" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPigMoney extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPigMoney$1 = IconPigMoney;

export { IconPigMoney$1 as default };
//# sourceMappingURL=IconPigMoney.svelte.js.map
