...
/* src/icons/IconLetterH.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "letter-h" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLetterH extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLetterH$1 = IconLetterH;

export { IconLetterH$1 as default };
//# sourceMappingURL=IconLetterH.svelte.js.map
