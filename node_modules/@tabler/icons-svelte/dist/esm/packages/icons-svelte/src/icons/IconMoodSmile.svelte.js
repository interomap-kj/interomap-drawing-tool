...
/* src/icons/IconMoodSmile.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-smile" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodSmile extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodSmile$1 = IconMoodSmile;

export { IconMoodSmile$1 as default };
//# sourceMappingURL=IconMoodSmile.svelte.js.map
