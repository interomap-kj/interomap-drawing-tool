...
/* src/icons/IconMessages.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "messages" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMessages extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMessages$1 = IconMessages;

export { IconMessages$1 as default };
//# sourceMappingURL=IconMessages.svelte.js.map
