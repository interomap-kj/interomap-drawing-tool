...
/* src/icons/IconDoorEnter.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "door-enter" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDoorEnter extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDoorEnter$1 = IconDoorEnter;

export { IconDoorEnter$1 as default };
//# sourceMappingURL=IconDoorEnter.svelte.js.map
