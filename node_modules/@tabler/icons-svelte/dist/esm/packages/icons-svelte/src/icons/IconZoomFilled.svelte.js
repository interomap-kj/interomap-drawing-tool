...
/* src/icons/IconZoomFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomFilled$1 = IconZoomFilled;

export { IconZoomFilled$1 as default };
//# sourceMappingURL=IconZoomFilled.svelte.js.map
