...
/* src/icons/IconSquareX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "square-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSquareX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSquareX$1 = IconSquareX;

export { IconSquareX$1 as default };
//# sourceMappingURL=IconSquareX.svelte.js.map
