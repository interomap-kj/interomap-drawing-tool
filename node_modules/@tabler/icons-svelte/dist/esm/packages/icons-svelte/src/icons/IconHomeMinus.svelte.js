...
/* src/icons/IconHomeMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeMinus$1 = IconHomeMinus;

export { IconHomeMinus$1 as default };
//# sourceMappingURL=IconHomeMinus.svelte.js.map
