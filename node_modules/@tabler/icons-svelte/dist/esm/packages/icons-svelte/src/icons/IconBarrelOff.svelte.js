...
/* src/icons/IconBarrelOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "barrel-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBarrelOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBarrelOff$1 = IconBarrelOff;

export { IconBarrelOff$1 as default };
//# sourceMappingURL=IconBarrelOff.svelte.js.map
