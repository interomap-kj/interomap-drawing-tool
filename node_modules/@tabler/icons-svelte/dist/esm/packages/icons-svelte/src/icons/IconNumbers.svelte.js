...
/* src/icons/IconNumbers.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "numbers" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNumbers extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNumbers$1 = IconNumbers;

export { IconNumbers$1 as default };
//# sourceMappingURL=IconNumbers.svelte.js.map
