...
/* src/icons/IconUserPause.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-pause" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserPause extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserPause$1 = IconUserPause;

export { IconUserPause$1 as default };
//# sourceMappingURL=IconUserPause.svelte.js.map
