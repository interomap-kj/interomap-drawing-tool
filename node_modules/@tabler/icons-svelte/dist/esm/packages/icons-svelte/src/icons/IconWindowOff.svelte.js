...
/* src/icons/IconWindowOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "window-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWindowOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWindowOff$1 = IconWindowOff;

export { IconWindowOff$1 as default };
//# sourceMappingURL=IconWindowOff.svelte.js.map
