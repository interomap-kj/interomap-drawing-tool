...
/* src/icons/IconTicketOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ticket-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTicketOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTicketOff$1 = IconTicketOff;

export { IconTicketOff$1 as default };
//# sourceMappingURL=IconTicketOff.svelte.js.map
