...
/* src/icons/IconPencilOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilOff$1 = IconPencilOff;

export { IconPencilOff$1 as default };
//# sourceMappingURL=IconPencilOff.svelte.js.map
