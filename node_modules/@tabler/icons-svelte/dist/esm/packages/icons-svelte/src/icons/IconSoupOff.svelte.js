...
/* src/icons/IconSoupOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "soup-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSoupOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSoupOff$1 = IconSoupOff;

export { IconSoupOff$1 as default };
//# sourceMappingURL=IconSoupOff.svelte.js.map
