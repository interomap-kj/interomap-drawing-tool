...
/* src/icons/IconGiftOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gift-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGiftOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGiftOff$1 = IconGiftOff;

export { IconGiftOff$1 as default };
//# sourceMappingURL=IconGiftOff.svelte.js.map
