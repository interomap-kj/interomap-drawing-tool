...
/* src/icons/IconH3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "h-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconH3 extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconH3$1 as default };
//# sourceMappingURL=IconH3.svelte.js.map
