...
/* src/icons/IconSql.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sql" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSql extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSql$1 = IconSql;

export { IconSql$1 as default };
//# sourceMappingURL=IconSql.svelte.js.map
