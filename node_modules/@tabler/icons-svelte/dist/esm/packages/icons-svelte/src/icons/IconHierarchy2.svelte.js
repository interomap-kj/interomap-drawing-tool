...
/* src/icons/IconHierarchy2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hierarchy-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHierarchy2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHierarchy2$1 = IconHierarchy2;

export { IconHierarchy2$1 as default };
//# sourceMappingURL=IconHierarchy2.svelte.js.map
