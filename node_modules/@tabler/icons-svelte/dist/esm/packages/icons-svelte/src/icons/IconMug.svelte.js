...
/* src/icons/IconMug.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mug" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMug extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMug$1 = IconMug;

export { IconMug$1 as default };
//# sourceMappingURL=IconMug.svelte.js.map
