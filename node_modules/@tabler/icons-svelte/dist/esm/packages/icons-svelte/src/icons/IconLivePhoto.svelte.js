...
/* src/icons/IconLivePhoto.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "live-photo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLivePhoto extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLivePhoto$1 = IconLivePhoto;

export { IconLivePhoto$1 as default };
//# sourceMappingURL=IconLivePhoto.svelte.js.map
