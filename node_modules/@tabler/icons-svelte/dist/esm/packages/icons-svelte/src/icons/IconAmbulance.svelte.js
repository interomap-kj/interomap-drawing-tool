...
/* src/icons/IconAmbulance.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ambulance" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAmbulance extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAmbulance$1 = IconAmbulance;

export { IconAmbulance$1 as default };
//# sourceMappingURL=IconAmbulance.svelte.js.map
