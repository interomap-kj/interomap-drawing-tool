...
/* src/icons/IconMoodEdit.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-edit" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodEdit extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodEdit$1 = IconMoodEdit;

export { IconMoodEdit$1 as default };
//# sourceMappingURL=IconMoodEdit.svelte.js.map
