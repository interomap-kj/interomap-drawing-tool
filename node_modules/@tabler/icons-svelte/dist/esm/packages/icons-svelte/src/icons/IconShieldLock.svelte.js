...
/* src/icons/IconShieldLock.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-lock" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldLock extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldLock$1 = IconShieldLock;

export { IconShieldLock$1 as default };
//# sourceMappingURL=IconShieldLock.svelte.js.map
