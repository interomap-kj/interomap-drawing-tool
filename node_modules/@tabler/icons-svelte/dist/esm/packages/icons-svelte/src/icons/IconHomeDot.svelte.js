...
/* src/icons/IconHomeDot.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-dot" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeDot extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeDot$1 = IconHomeDot;

export { IconHomeDot$1 as default };
//# sourceMappingURL=IconHomeDot.svelte.js.map
