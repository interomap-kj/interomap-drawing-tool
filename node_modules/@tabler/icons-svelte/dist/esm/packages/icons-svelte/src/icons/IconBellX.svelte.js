...
/* src/icons/IconBellX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellX$1 = IconBellX;

export { IconBellX$1 as default };
//# sourceMappingURL=IconBellX.svelte.js.map
