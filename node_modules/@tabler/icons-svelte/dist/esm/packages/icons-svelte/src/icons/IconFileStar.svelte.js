...
/* src/icons/IconFileStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileStar$1 = IconFileStar;

export { IconFileStar$1 as default };
//# sourceMappingURL=IconFileStar.svelte.js.map
