...
/* src/icons/IconLockHeart.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "lock-heart" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLockHeart extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLockHeart$1 = IconLockHeart;

export { IconLockHeart$1 as default };
//# sourceMappingURL=IconLockHeart.svelte.js.map
