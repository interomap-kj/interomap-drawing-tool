...
/* src/icons/IconCodeCircle.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "code-circle" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCodeCircle extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCodeCircle$1 = IconCodeCircle;

export { IconCodeCircle$1 as default };
//# sourceMappingURL=IconCodeCircle.svelte.js.map
