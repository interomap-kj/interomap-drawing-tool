...
/* src/icons/IconMarqueeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "marquee-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMarqueeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMarqueeOff$1 = IconMarqueeOff;

export { IconMarqueeOff$1 as default };
//# sourceMappingURL=IconMarqueeOff.svelte.js.map
