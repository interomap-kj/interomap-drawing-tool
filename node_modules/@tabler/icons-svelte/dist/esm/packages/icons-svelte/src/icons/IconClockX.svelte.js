...
/* src/icons/IconClockX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockX$1 = IconClockX;

export { IconClockX$1 as default };
//# sourceMappingURL=IconClockX.svelte.js.map
