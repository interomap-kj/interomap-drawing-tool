...
/* src/icons/IconPlayerStop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "player-stop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlayerStop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlayerStop$1 = IconPlayerStop;

export { IconPlayerStop$1 as default };
//# sourceMappingURL=IconPlayerStop.svelte.js.map
