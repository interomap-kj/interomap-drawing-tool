...
/* src/icons/IconMailStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailStar$1 = IconMailStar;

export { IconMailStar$1 as default };
//# sourceMappingURL=IconMailStar.svelte.js.map
