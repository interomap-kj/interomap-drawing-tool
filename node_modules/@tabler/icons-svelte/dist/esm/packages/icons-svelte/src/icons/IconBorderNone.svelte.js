...
/* src/icons/IconBorderNone.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "border-none" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBorderNone extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBorderNone$1 = IconBorderNone;

export { IconBorderNone$1 as default };
//# sourceMappingURL=IconBorderNone.svelte.js.map
