...
/* src/icons/IconMotorbike.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "motorbike" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMotorbike extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMotorbike$1 = IconMotorbike;

export { IconMotorbike$1 as default };
//# sourceMappingURL=IconMotorbike.svelte.js.map
