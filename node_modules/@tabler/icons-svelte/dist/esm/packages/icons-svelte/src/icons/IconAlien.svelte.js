...
/* src/icons/IconAlien.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "alien" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconAlien extends SvelteComponent {
	constructor(options) {
		super();
...
var IconAlien$1 = IconAlien;

export { IconAlien$1 as default };
//# sourceMappingURL=IconAlien.svelte.js.map
