...
/* src/icons/IconTallymark2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tallymark-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M10 5l0 14" }], ["path", { "d": "M14 5l0 14" }]];
...
class IconTallymark2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTallymark2$1 = IconTallymark2;

export { IconTallymark2$1 as default };
//# sourceMappingURL=IconTallymark2.svelte.js.map
