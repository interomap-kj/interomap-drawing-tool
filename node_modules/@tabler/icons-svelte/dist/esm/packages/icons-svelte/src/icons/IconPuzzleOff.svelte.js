...
/* src/icons/IconPuzzleOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "puzzle-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPuzzleOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPuzzleOff$1 = IconPuzzleOff;

export { IconPuzzleOff$1 as default };
//# sourceMappingURL=IconPuzzleOff.svelte.js.map
