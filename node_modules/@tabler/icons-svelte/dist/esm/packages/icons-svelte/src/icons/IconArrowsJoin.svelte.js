...
/* src/icons/IconArrowsJoin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrows-join" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowsJoin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowsJoin$1 = IconArrowsJoin;

export { IconArrowsJoin$1 as default };
//# sourceMappingURL=IconArrowsJoin.svelte.js.map
