...
/* src/icons/IconRobotOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "robot-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRobotOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRobotOff$1 = IconRobotOff;

export { IconRobotOff$1 as default };
//# sourceMappingURL=IconRobotOff.svelte.js.map
