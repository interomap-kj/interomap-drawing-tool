...
/* src/icons/IconCpu2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "cpu-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCpu2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCpu2$1 = IconCpu2;

export { IconCpu2$1 as default };
//# sourceMappingURL=IconCpu2.svelte.js.map
