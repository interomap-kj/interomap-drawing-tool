...
/* src/icons/IconNorthStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "north-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconNorthStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconNorthStar$1 = IconNorthStar;

export { IconNorthStar$1 as default };
//# sourceMappingURL=IconNorthStar.svelte.js.map
