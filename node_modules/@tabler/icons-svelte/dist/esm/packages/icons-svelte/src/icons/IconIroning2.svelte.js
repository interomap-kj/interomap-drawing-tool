...
/* src/icons/IconIroning2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ironing-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIroning2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIroning2$1 = IconIroning2;

export { IconIroning2$1 as default };
//# sourceMappingURL=IconIroning2.svelte.js.map
