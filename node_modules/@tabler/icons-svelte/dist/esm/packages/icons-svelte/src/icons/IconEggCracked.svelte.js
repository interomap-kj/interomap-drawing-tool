...
/* src/icons/IconEggCracked.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "egg-cracked" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEggCracked extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEggCracked$1 = IconEggCracked;

export { IconEggCracked$1 as default };
//# sourceMappingURL=IconEggCracked.svelte.js.map
