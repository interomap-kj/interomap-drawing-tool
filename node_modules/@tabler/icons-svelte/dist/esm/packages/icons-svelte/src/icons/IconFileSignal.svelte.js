...
/* src/icons/IconFileSignal.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-signal" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileSignal extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileSignal$1 = IconFileSignal;

export { IconFileSignal$1 as default };
//# sourceMappingURL=IconFileSignal.svelte.js.map
