...
/* src/icons/IconZip.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zip" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZip extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZip$1 = IconZip;

export { IconZip$1 as default };
//# sourceMappingURL=IconZip.svelte.js.map
