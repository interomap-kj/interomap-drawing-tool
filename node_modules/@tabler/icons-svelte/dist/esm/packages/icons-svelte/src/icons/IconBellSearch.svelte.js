...
/* src/icons/IconBellSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bell-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBellSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBellSearch$1 = IconBellSearch;

export { IconBellSearch$1 as default };
//# sourceMappingURL=IconBellSearch.svelte.js.map
