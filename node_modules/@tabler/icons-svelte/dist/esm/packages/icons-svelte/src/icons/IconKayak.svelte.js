...
/* src/icons/IconKayak.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "kayak" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconKayak extends SvelteComponent {
	constructor(options) {
		super();
...
var IconKayak$1 = IconKayak;

export { IconKayak$1 as default };
//# sourceMappingURL=IconKayak.svelte.js.map
