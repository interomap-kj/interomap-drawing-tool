...
/* src/icons/IconChisel.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chisel" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChisel extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChisel$1 = IconChisel;

export { IconChisel$1 as default };
//# sourceMappingURL=IconChisel.svelte.js.map
