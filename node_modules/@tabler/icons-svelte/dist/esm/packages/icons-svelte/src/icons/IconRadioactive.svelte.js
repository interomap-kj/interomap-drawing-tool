...
/* src/icons/IconRadioactive.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "radioactive" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRadioactive extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRadioactive$1 = IconRadioactive;

export { IconRadioactive$1 as default };
//# sourceMappingURL=IconRadioactive.svelte.js.map
