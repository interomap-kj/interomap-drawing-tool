...
/* src/icons/IconIroning3.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ironing-3" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconIroning3 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconIroning3$1 = IconIroning3;

export { IconIroning3$1 as default };
//# sourceMappingURL=IconIroning3.svelte.js.map
