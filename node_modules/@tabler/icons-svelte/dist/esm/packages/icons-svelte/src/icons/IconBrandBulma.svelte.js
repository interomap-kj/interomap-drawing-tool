...
/* src/icons/IconBrandBulma.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-bulma" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandBulma extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandBulma$1 = IconBrandBulma;

export { IconBrandBulma$1 as default };
//# sourceMappingURL=IconBrandBulma.svelte.js.map
