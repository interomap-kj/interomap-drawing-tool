...
/* src/icons/IconHomeSearch.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-search" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeSearch extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeSearch$1 = IconHomeSearch;

export { IconHomeSearch$1 as default };
//# sourceMappingURL=IconHomeSearch.svelte.js.map
