...
/* src/icons/IconCameraDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraDown$1 = IconCameraDown;

export { IconCameraDown$1 as default };
//# sourceMappingURL=IconCameraDown.svelte.js.map
