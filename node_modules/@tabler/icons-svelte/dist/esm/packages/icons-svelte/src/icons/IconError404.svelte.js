...
/* src/icons/IconError404.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "error-404" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconError404 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconError404$1 = IconError404;

export { IconError404$1 as default };
//# sourceMappingURL=IconError404.svelte.js.map
