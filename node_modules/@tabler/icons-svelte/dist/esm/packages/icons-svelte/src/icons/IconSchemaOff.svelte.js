...
/* src/icons/IconSchemaOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "schema-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSchemaOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSchemaOff$1 = IconSchemaOff;

export { IconSchemaOff$1 as default };
//# sourceMappingURL=IconSchemaOff.svelte.js.map
