...
/* src/icons/IconCe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ce" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCe extends SvelteComponent {
	constructor(options) {
		super();
...
export { IconCe$1 as default };
//# sourceMappingURL=IconCe.svelte.js.map
