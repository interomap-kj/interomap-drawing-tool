...
/* src/icons/IconTrashOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "trash-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTrashOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTrashOff$1 = IconTrashOff;

export { IconTrashOff$1 as default };
//# sourceMappingURL=IconTrashOff.svelte.js.map
