...
/* src/icons/IconShieldCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shield-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShieldCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShieldCog$1 = IconShieldCog;

export { IconShieldCog$1 as default };
//# sourceMappingURL=IconShieldCog.svelte.js.map
