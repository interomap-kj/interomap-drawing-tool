...
/* src/icons/IconMenuOrder.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "menu-order" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMenuOrder extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMenuOrder$1 = IconMenuOrder;

export { IconMenuOrder$1 as default };
//# sourceMappingURL=IconMenuOrder.svelte.js.map
