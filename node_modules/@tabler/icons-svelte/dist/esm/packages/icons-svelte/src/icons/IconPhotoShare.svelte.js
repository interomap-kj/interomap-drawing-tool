...
/* src/icons/IconPhotoShare.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-share" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoShare extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoShare$1 = IconPhotoShare;

export { IconPhotoShare$1 as default };
//# sourceMappingURL=IconPhotoShare.svelte.js.map
