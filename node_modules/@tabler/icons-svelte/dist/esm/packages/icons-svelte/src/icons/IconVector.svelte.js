...
/* src/icons/IconVector.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "vector" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconVector extends SvelteComponent {
	constructor(options) {
		super();
...
var IconVector$1 = IconVector;

export { IconVector$1 as default };
//# sourceMappingURL=IconVector.svelte.js.map
