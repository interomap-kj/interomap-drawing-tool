...
/* src/icons/IconArrowGuide.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "arrow-guide" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconArrowGuide extends SvelteComponent {
	constructor(options) {
		super();
...
var IconArrowGuide$1 = IconArrowGuide;

export { IconArrowGuide$1 as default };
//# sourceMappingURL=IconArrowGuide.svelte.js.map
