...
/* src/icons/IconStairs.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stairs" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M4 18h4v-4h4v-4h4v-4h4" }]];
...
class IconStairs extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStairs$1 = IconStairs;

export { IconStairs$1 as default };
//# sourceMappingURL=IconStairs.svelte.js.map
