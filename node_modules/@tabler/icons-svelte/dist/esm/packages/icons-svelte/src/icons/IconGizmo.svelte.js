...
/* src/icons/IconGizmo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gizmo" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGizmo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGizmo$1 = IconGizmo;

export { IconGizmo$1 as default };
//# sourceMappingURL=IconGizmo.svelte.js.map
