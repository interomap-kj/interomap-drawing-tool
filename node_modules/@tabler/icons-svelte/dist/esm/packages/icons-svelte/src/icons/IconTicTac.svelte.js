...
/* src/icons/IconTicTac.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tic-tac" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTicTac extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTicTac$1 = IconTicTac;

export { IconTicTac$1 as default };
//# sourceMappingURL=IconTicTac.svelte.js.map
