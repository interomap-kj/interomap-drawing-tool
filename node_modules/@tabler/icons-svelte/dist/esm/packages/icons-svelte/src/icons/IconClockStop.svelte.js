...
/* src/icons/IconClockStop.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clock-stop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClockStop extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClockStop$1 = IconClockStop;

export { IconClockStop$1 as default };
//# sourceMappingURL=IconClockStop.svelte.js.map
