...
/* src/icons/IconHtml.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "html" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHtml extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHtml$1 = IconHtml;

export { IconHtml$1 as default };
//# sourceMappingURL=IconHtml.svelte.js.map
