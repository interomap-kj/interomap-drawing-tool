...
/* src/icons/IconPlaceholder.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "placeholder" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPlaceholder extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPlaceholder$1 = IconPlaceholder;

export { IconPlaceholder$1 as default };
//# sourceMappingURL=IconPlaceholder.svelte.js.map
