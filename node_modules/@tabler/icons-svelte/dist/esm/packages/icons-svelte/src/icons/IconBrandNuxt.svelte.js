...
/* src/icons/IconBrandNuxt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-nuxt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandNuxt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandNuxt$1 = IconBrandNuxt;

export { IconBrandNuxt$1 as default };
//# sourceMappingURL=IconBrandNuxt.svelte.js.map
