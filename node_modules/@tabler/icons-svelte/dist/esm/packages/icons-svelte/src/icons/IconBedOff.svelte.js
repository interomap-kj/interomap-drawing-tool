...
/* src/icons/IconBedOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bed-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBedOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBedOff$1 = IconBedOff;

export { IconBedOff$1 as default };
//# sourceMappingURL=IconBedOff.svelte.js.map
