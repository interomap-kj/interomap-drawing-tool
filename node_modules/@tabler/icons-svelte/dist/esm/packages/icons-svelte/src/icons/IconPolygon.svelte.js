...
/* src/icons/IconPolygon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "polygon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPolygon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPolygon$1 = IconPolygon;

export { IconPolygon$1 as default };
//# sourceMappingURL=IconPolygon.svelte.js.map
