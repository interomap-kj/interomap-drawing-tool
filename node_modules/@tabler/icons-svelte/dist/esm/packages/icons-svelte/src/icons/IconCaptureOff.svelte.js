...
/* src/icons/IconCaptureOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "capture-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCaptureOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCaptureOff$1 = IconCaptureOff;

export { IconCaptureOff$1 as default };
//# sourceMappingURL=IconCaptureOff.svelte.js.map
