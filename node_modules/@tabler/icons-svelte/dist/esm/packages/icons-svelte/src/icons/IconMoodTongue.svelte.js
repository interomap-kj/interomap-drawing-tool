...
/* src/icons/IconMoodTongue.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mood-tongue" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMoodTongue extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMoodTongue$1 = IconMoodTongue;

export { IconMoodTongue$1 as default };
//# sourceMappingURL=IconMoodTongue.svelte.js.map
