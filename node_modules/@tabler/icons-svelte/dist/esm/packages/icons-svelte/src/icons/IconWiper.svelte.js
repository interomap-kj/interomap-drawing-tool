...
/* src/icons/IconWiper.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wiper" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWiper extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWiper$1 = IconWiper;

export { IconWiper$1 as default };
//# sourceMappingURL=IconWiper.svelte.js.map
