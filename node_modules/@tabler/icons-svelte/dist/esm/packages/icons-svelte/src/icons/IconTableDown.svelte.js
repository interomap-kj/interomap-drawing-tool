...
/* src/icons/IconTableDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "table-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTableDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTableDown$1 = IconTableDown;

export { IconTableDown$1 as default };
//# sourceMappingURL=IconTableDown.svelte.js.map
