...
/* src/icons/IconSpy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "spy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSpy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSpy$1 = IconSpy;

export { IconSpy$1 as default };
//# sourceMappingURL=IconSpy.svelte.js.map
