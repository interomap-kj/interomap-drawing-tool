...
/* src/icons/IconCodeMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "code-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCodeMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCodeMinus$1 = IconCodeMinus;

export { IconCodeMinus$1 as default };
//# sourceMappingURL=IconCodeMinus.svelte.js.map
