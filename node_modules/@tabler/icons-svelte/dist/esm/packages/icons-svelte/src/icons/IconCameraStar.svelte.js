...
/* src/icons/IconCameraStar.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "camera-star" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCameraStar extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCameraStar$1 = IconCameraStar;

export { IconCameraStar$1 as default };
//# sourceMappingURL=IconCameraStar.svelte.js.map
