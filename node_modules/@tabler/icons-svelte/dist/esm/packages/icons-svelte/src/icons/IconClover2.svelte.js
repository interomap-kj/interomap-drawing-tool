...
/* src/icons/IconClover2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clover-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconClover2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconClover2$1 = IconClover2;

export { IconClover2$1 as default };
//# sourceMappingURL=IconClover2.svelte.js.map
