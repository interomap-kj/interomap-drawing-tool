...
/* src/icons/IconHexagonOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hexagon-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHexagonOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHexagonOff$1 = IconHexagonOff;

export { IconHexagonOff$1 as default };
//# sourceMappingURL=IconHexagonOff.svelte.js.map
