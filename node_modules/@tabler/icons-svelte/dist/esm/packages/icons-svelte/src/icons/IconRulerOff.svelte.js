...
/* src/icons/IconRulerOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ruler-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRulerOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRulerOff$1 = IconRulerOff;

export { IconRulerOff$1 as default };
//# sourceMappingURL=IconRulerOff.svelte.js.map
