...
/* src/icons/IconPencilPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pencil-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPencilPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPencilPlus$1 = IconPencilPlus;

export { IconPencilPlus$1 as default };
//# sourceMappingURL=IconPencilPlus.svelte.js.map
