...
/* src/icons/IconBrandXing.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-xing" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandXing extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandXing$1 = IconBrandXing;

export { IconBrandXing$1 as default };
//# sourceMappingURL=IconBrandXing.svelte.js.map
