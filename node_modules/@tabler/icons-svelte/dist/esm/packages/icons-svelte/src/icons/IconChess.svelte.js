...
/* src/icons/IconChess.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "chess" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconChess extends SvelteComponent {
	constructor(options) {
		super();
...
var IconChess$1 = IconChess;

export { IconChess$1 as default };
//# sourceMappingURL=IconChess.svelte.js.map
