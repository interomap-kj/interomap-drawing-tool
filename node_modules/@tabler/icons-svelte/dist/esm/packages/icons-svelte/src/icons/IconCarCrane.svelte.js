...
/* src/icons/IconCarCrane.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "car-crane" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCarCrane extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCarCrane$1 = IconCarCrane;

export { IconCarCrane$1 as default };
//# sourceMappingURL=IconCarCrane.svelte.js.map
