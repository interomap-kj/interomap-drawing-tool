...
/* src/icons/IconMailCog.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "mail-cog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMailCog extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMailCog$1 = IconMailCog;

export { IconMailCog$1 as default };
//# sourceMappingURL=IconMailCog.svelte.js.map
