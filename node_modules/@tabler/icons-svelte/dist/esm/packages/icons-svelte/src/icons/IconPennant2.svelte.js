...
/* src/icons/IconPennant2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pennant-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPennant2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPennant2$1 = IconPennant2;

export { IconPennant2$1 as default };
//# sourceMappingURL=IconPennant2.svelte.js.map
