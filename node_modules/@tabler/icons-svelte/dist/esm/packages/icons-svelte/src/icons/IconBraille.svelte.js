...
/* src/icons/IconBraille.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "braille" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBraille extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBraille$1 = IconBraille;

export { IconBraille$1 as default };
//# sourceMappingURL=IconBraille.svelte.js.map
