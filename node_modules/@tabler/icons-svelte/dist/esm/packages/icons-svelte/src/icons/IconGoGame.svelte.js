...
/* src/icons/IconGoGame.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "go-game" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGoGame extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGoGame$1 = IconGoGame;

export { IconGoGame$1 as default };
//# sourceMappingURL=IconGoGame.svelte.js.map
