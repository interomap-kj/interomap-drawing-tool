...
/* src/icons/IconShoe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "shoe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconShoe extends SvelteComponent {
	constructor(options) {
		super();
...
var IconShoe$1 = IconShoe;

export { IconShoe$1 as default };
//# sourceMappingURL=IconShoe.svelte.js.map
