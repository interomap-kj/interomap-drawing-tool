...
/* src/icons/IconHomeBolt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "home-bolt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHomeBolt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHomeBolt$1 = IconHomeBolt;

export { IconHomeBolt$1 as default };
//# sourceMappingURL=IconHomeBolt.svelte.js.map
