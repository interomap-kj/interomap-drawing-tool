...
/* src/icons/IconPhotoPin.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-pin" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoPin extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoPin$1 = IconPhotoPin;

export { IconPhotoPin$1 as default };
//# sourceMappingURL=IconPhotoPin.svelte.js.map
