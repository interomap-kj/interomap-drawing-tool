...
/* src/icons/IconPhotoAi.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-ai" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoAi extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoAi$1 = IconPhotoAi;

export { IconPhotoAi$1 as default };
//# sourceMappingURL=IconPhotoAi.svelte.js.map
