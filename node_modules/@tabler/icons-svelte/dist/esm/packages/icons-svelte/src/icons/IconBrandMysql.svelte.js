...
/* src/icons/IconBrandMysql.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-mysql" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandMysql extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandMysql$1 = IconBrandMysql;

export { IconBrandMysql$1 as default };
//# sourceMappingURL=IconBrandMysql.svelte.js.map
