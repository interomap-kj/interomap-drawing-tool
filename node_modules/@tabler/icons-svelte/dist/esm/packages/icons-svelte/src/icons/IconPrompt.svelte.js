...
/* src/icons/IconPrompt.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "prompt" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [["path", { "d": "M5 7l5 5l-5 5" }], ["path", { "d": "M13 17l6 0" }]];
...
class IconPrompt extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPrompt$1 = IconPrompt;

export { IconPrompt$1 as default };
//# sourceMappingURL=IconPrompt.svelte.js.map
