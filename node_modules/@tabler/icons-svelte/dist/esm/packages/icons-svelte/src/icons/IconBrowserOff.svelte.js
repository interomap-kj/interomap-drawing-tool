...
/* src/icons/IconBrowserOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "browser-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrowserOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrowserOff$1 = IconBrowserOff;

export { IconBrowserOff$1 as default };
//# sourceMappingURL=IconBrowserOff.svelte.js.map
