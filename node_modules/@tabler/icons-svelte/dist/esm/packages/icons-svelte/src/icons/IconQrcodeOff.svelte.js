...
/* src/icons/IconQrcodeOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "qrcode-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconQrcodeOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconQrcodeOff$1 = IconQrcodeOff;

export { IconQrcodeOff$1 as default };
//# sourceMappingURL=IconQrcodeOff.svelte.js.map
