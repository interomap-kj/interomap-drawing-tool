...
/* src/icons/IconWood.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "wood" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconWood extends SvelteComponent {
	constructor(options) {
		super();
...
var IconWood$1 = IconWood;

export { IconWood$1 as default };
//# sourceMappingURL=IconWood.svelte.js.map
