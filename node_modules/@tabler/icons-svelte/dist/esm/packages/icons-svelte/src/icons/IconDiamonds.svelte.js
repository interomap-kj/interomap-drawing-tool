...
/* src/icons/IconDiamonds.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "diamonds" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDiamonds extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDiamonds$1 = IconDiamonds;

export { IconDiamonds$1 as default };
//# sourceMappingURL=IconDiamonds.svelte.js.map
