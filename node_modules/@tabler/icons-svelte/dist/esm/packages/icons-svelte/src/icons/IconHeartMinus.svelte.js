...
/* src/icons/IconHeartMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "heart-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHeartMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHeartMinus$1 = IconHeartMinus;

export { IconHeartMinus$1 as default };
//# sourceMappingURL=IconHeartMinus.svelte.js.map
