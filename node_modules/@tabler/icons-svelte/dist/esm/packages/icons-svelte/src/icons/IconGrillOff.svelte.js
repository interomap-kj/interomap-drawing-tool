...
/* src/icons/IconGrillOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grill-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrillOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrillOff$1 = IconGrillOff;

export { IconGrillOff$1 as default };
//# sourceMappingURL=IconGrillOff.svelte.js.map
