...
/* src/icons/IconRipple.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ripple" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRipple extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRipple$1 = IconRipple;

export { IconRipple$1 as default };
//# sourceMappingURL=IconRipple.svelte.js.map
