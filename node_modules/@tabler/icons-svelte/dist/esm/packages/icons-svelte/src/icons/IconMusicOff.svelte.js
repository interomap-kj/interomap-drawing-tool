...
/* src/icons/IconMusicOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "music-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMusicOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMusicOff$1 = IconMusicOff;

export { IconMusicOff$1 as default };
//# sourceMappingURL=IconMusicOff.svelte.js.map
