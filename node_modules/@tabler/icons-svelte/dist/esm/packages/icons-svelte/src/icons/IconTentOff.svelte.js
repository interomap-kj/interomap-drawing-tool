...
/* src/icons/IconTentOff.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tent-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTentOff extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTentOff$1 = IconTentOff;

export { IconTentOff$1 as default };
//# sourceMappingURL=IconTentOff.svelte.js.map
